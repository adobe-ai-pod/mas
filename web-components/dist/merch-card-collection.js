var _i=Object.defineProperty;var Pi=e=>{throw TypeError(e)};var Ns=(e,r,t)=>r in e?_i(e,r,{enumerable:!0,configurable:!0,writable:!0,value:t}):e[r]=t;var Is=(e,r)=>{for(var t in r)_i(e,t,{get:r[t],enumerable:!0})};var g=(e,r,t)=>Ns(e,typeof r!="symbol"?r+"":r,t),Yr=(e,r,t)=>r.has(e)||Pi("Cannot "+t);var v=(e,r,t)=>(Yr(e,r,"read from private field"),t?t.call(e):r.get(e)),M=(e,r,t)=>r.has(e)?Pi("Cannot add the same private member more than once"):r instanceof WeakSet?r.add(e):r.set(e,t),T=(e,r,t,a)=>(Yr(e,r,"write to private field"),a?a.call(e,t):r.set(e,t),t),j=(e,r,t)=>(Yr(e,r,"access private method"),t);import{html as Me,LitElement as Ss,css as As,unsafeCSS as Es,nothing as fe}from"./lit-all.min.js";var D="(max-width: 767px)",X="(max-width: 1199px)",I="(min-width: 768px)",k="(min-width: 1200px)",ee="(min-width: 1600px)",Li="(min-width: 1280px)",Mi={matchMobile:window.matchMedia(D),matchDesktop:window.matchMedia(`${k} and (not ${ee})`),matchDesktopOrUp:window.matchMedia(k),matchLargeDesktop:window.matchMedia(ee),get isMobile(){return this.matchMobile.matches},get isDesktop(){return this.matchDesktop.matches},get isDesktopOrUp(){return this.matchDesktopOrUp.matches}},_=Mi;function or(){return Mi.isDesktop}var Tt=class{constructor(r,t){this.key=Symbol("match-media-key"),this.matches=!1,this.host=r,this.host.addController(this),this.media=window.matchMedia(t),this.matches=this.media.matches,this.onChange=this.onChange.bind(this),r.addController(this)}hostConnected(){var r;(r=this.media)==null||r.addEventListener("change",this.onChange)}hostDisconnected(){var r;(r=this.media)==null||r.removeEventListener("change",this.onChange)}onChange(r){this.matches!==r.matches&&(this.matches=r.matches,this.host.requestUpdate(this.key,!this.matches))}};var Ri="hashchange";function Ds(e=window.location.hash){let r=[],t=e.replace(/^#/,"").split("&");for(let a of t){let[i,n=""]=a.split("=");i&&r.push([i,decodeURIComponent(n.replace(/\+/g," "))])}return Object.fromEntries(r)}function kt(e){let r=new URLSearchParams(window.location.hash.slice(1));Object.entries(e).forEach(([i,n])=>{n?r.set(i,n):r.delete(i)}),r.sort();let t=r.toString();if(t===window.location.hash)return;let a=window.scrollY||document.documentElement.scrollTop;window.location.hash=t,window.scrollTo(0,a)}function Oi(e){let r=()=>{if(window.location.hash&&!window.location.hash.includes("="))return;let t=Ds(window.location.hash);e(t)};return r(),window.addEventListener(Ri,r),()=>{window.removeEventListener(Ri,r)}}var ya={};Is(ya,{CLASS_NAME_FAILED:()=>ia,CLASS_NAME_HIDDEN:()=>Hs,CLASS_NAME_PENDING:()=>na,CLASS_NAME_RESOLVED:()=>oa,CheckoutWorkflow:()=>Js,CheckoutWorkflowStep:()=>ie,Commitment:()=>Ue,ERROR_MESSAGE_BAD_REQUEST:()=>sa,ERROR_MESSAGE_MISSING_LITERALS_URL:()=>Ks,ERROR_MESSAGE_OFFER_NOT_FOUND:()=>ca,EVENT_AEM_ERROR:()=>ra,EVENT_AEM_LOAD:()=>ta,EVENT_COMPARE_CHART_REHYDRATE:()=>Ys,EVENT_EXPANDED_GROUPS_CHANGE:()=>Xs,EVENT_MAS_ERROR:()=>aa,EVENT_MAS_READY:()=>lr,EVENT_MERCH_ADDON_AND_QUANTITY_UPDATE:()=>js,EVENT_MERCH_CARD_ACTION_MENU_TOGGLE:()=>Zr,EVENT_MERCH_CARD_COLLECTION_LITERALS_CHANGED:()=>me,EVENT_MERCH_CARD_COLLECTION_SHOWMORE:()=>Jr,EVENT_MERCH_CARD_COLLECTION_SIDENAV_ATTACHED:()=>_t,EVENT_MERCH_CARD_COLLECTION_SORT:()=>Qr,EVENT_MERCH_CARD_QUANTITY_CHANGE:()=>cr,EVENT_MERCH_OFFER_READY:()=>Us,EVENT_MERCH_OFFER_SELECT_READY:()=>$s,EVENT_MERCH_QUANTITY_SELECTOR_CHANGE:()=>ae,EVENT_MERCH_SEARCH_CHANGE:()=>Ws,EVENT_MERCH_SIDENAV_SELECT:()=>ea,EVENT_MERCH_STOCK_CHANGE:()=>qs,EVENT_MERCH_STORAGE_CHANGE:()=>Vs,EVENT_OFFER_SELECTED:()=>Gs,EVENT_TYPE_FAILED:()=>la,EVENT_TYPE_READY:()=>sr,EVENT_TYPE_RESOLVED:()=>Se,Env:()=>ve,FF_ANNUAL_PRICE:()=>at,FF_DEFAULTS:()=>Ce,HEADER_X_REQUEST_ID:()=>Pt,LOG_NAMESPACE:()=>da,Landscape:()=>Oe,MARK_DURATION_SUFFIX:()=>xa,MARK_START_SUFFIX:()=>va,MERCH_CARD_LOAD_TIMEOUT:()=>Xr,MODAL_TYPE_3_IN_1:()=>$e,NAMESPACE:()=>zs,PARAM_AOS_API_KEY:()=>Zs,PARAM_ENV:()=>pa,PARAM_LANDSCAPE:()=>ma,PARAM_MAS_PREVIEW:()=>ha,PARAM_WCS_API_KEY:()=>Qs,PROVIDER_ENVIRONMENT:()=>fa,SELECTOR_MAS_CHECKOUT_LINK:()=>Ni,SELECTOR_MAS_ELEMENT:()=>Kr,SELECTOR_MAS_INLINE_PRICE:()=>W,SELECTOR_MAS_SP_BUTTON:()=>Fs,SELECTOR_MAS_UPT_LINK:()=>Ii,SORT_ORDER:()=>ge,STATE_FAILED:()=>ue,STATE_PENDING:()=>Re,STATE_RESOLVED:()=>Ae,SUPPORTED_COUNTRIES:()=>ba,TAG_NAME_SERVICE:()=>Bs,TEMPLATE_PRICE:()=>ec,TEMPLATE_PRICE_ANNUAL:()=>rc,TEMPLATE_PRICE_LEGAL:()=>te,TEMPLATE_PRICE_STRIKETHROUGH:()=>tc,Term:()=>he,WCS_PROD_URL:()=>ua,WCS_STAGE_URL:()=>ga});var Ue=Object.freeze({MONTH:"MONTH",YEAR:"YEAR",TWO_YEARS:"TWO_YEARS",THREE_YEARS:"THREE_YEARS",PERPETUAL:"PERPETUAL",TERM_LICENSE:"TERM_LICENSE",ACCESS_PASS:"ACCESS_PASS",THREE_MONTHS:"THREE_MONTHS",SIX_MONTHS:"SIX_MONTHS"}),he=Object.freeze({ANNUAL:"ANNUAL",MONTHLY:"MONTHLY",TWO_YEARS:"TWO_YEARS",THREE_YEARS:"THREE_YEARS",P1D:"P1D",P1Y:"P1Y",P3Y:"P3Y",P10Y:"P10Y",P15Y:"P15Y",P3D:"P3D",P7D:"P7D",P30D:"P30D",HALF_YEARLY:"HALF_YEARLY",QUARTERLY:"QUARTERLY"}),zs="merch",Xr=2e4,Hs="hidden",sr="wcms:commerce:ready",Bs="mas-commerce-service",W='span[is="inline-price"][data-wcs-osi]',Ni='a[is="checkout-link"][data-wcs-osi],button[is="checkout-button"][data-wcs-osi]',Fs="sp-button[data-wcs-osi]",Ii='a[is="upt-link"]',Kr=`${W},${Ni},${Ii}`,Us="merch-offer:ready",$s="merch-offer-select:ready",Zr="merch-card:action-menu-toggle",Gs="merch-offer:selected",qs="merch-stock:change",Vs="merch-storage:change",ae="merch-quantity-selector:change",cr="merch-card-quantity:change",js="merch-modal:addon-and-quantity-update",Ws="merch-search:change",Qr="merch-card-collection:sort",me="merch-card-collection:literals-changed",_t="merch-card-collection:sidenav-attached",Jr="merch-card-collection:showmore",ea="merch-sidenav:select",ta="aem:load",ra="aem:error",lr="mas:ready",aa="mas:error",Ys="mas-compare-chart:rehydrate",Xs="expanded-groups-change",ia="placeholder-failed",na="placeholder-pending",oa="placeholder-resolved",sa="Bad WCS request",ca="Commerce offer not found",Ks="Literals URL not provided",la="mas:failed",Se="mas:resolved",da="mas/commerce",ha="mas.preview",pa="commerce.env",ma="commerce.landscape",Zs="commerce.aosKey",Qs="commerce.wcsKey",ua="https://www.adobe.com/web_commerce_artifact",ga="https://www.stage.adobe.com/web_commerce_artifact_stage",ue="failed",Re="pending",Ae="resolved",Oe={DRAFT:"DRAFT",PUBLISHED:"PUBLISHED"},Pt="X-Request-Id",ie=Object.freeze({SEGMENTATION:"segmentation",BUNDLE:"bundle",COMMITMENT:"commitment",RECOMMENDATION:"recommendation",EMAIL:"email",PAYMENT:"payment",CHANGE_PLAN_TEAM_PLANS:"change-plan/team-upgrade/plans",CHANGE_PLAN_TEAM_PAYMENT:"change-plan/team-upgrade/payment"}),Js="UCv3",ve=Object.freeze({STAGE:"STAGE",PRODUCTION:"PRODUCTION",LOCAL:"LOCAL"}),fa={PRODUCTION:"PRODUCTION"},$e={TWP:"twp",D2P:"d2p",CRM:"crm"},va=":start",xa=":duration",ec="price",tc="price-strikethrough",rc="annual",te="legal",Ce="mas-ff-defaults",at="mas-ff-annual-price",ge={alphabetical:"alphabetical",authored:"authored"},ba=["AE","AM","AR","AT","AU","AZ","BB","BD","BE","BG","BH","BO","BR","BS","BY","CA","CH","CL","CN","CO","CR","CY","CZ","DE","DK","DO","DZ","EC","EE","EG","ES","FI","FR","GB","GE","GH","GR","GT","HK","HN","HR","HU","ID","IE","IL","IN","IQ","IS","IT","JM","JO","JP","KE","KG","KR","KW","KZ","LA","LB","LK","LT","LU","LV","MA","MD","MO","MT","MU","MX","MY","NG","NI","NL","NO","NP","NZ","OM","PA","PE","PH","PK","PL","PR","PT","PY","QA","RO","RS","RU","SA","SE","SG","SI","SK","SV","TH","TJ","TM","TN","TR","TT","TW","TZ","UA","US","UY","UZ","VE","VN","YE","ZA"];var ac="mas-commerce-service";function Di(e,r){let t;return function(){let a=this,i=arguments;clearTimeout(t),t=setTimeout(()=>e.apply(a,i),r)}}var Lt=(e,r)=>e?.querySelector(`[slot="${r}"]`)?.textContent?.trim();function xe(e,r={},t=null,a=null){let i=a?document.createElement(e,{is:a}):document.createElement(e);t instanceof HTMLElement?i.appendChild(t):i.innerHTML=t;for(let[n,s]of Object.entries(r))i.setAttribute(n,s);return i}function dr(e){return`startTime:${e.startTime.toFixed(2)}|duration:${e.duration.toFixed(2)}`}function wa(){return window.matchMedia("(max-width: 1024px)").matches}function Mt(){return document.getElementsByTagName(ac)?.[0]}function Rt(e){let r=window.getComputedStyle(e);return e.offsetHeight+parseFloat(r.marginTop)+parseFloat(r.marginBottom)}var ic=["adobe.com","adobeioruntime.net","aem.live","aem.page"],nc=["localhost","127.0.0.1"];function zi(e){try{let r=new URL(e);return nc.includes(r.hostname)?r.protocol==="http:"||r.protocol==="https:":r.protocol!=="https:"?!1:ic.some(t=>r.hostname===t||r.hostname.endsWith(`.${t}`))}catch{return!1}}import{html as hr,nothing as oc}from"./lit-all.min.js";var it,Ot=class Ot{constructor(r){g(this,"card");M(this,it);this.card=r,this.insertVariantStyle()}getContainer(){return T(this,it,v(this,it)??this.card.closest('merch-card-collection, [class*="-merch-cards"]')??this.card.parentElement),v(this,it)}insertVariantStyle(){let r=this.constructor.name;if(!Ot.styleMap[r]){Ot.styleMap[r]=!0;let t=document.createElement("style");t.innerHTML=this.getGlobalCSS(),document.head.appendChild(t)}}updateCardElementMinHeight(r,t){if(!r||this.card.heightSync===!1)return;let a=`--consonant-merch-card-${this.card.variant}-${t}-height`,i=Math.max(0,parseInt(window.getComputedStyle(r).height)||0),n=this.getContainer(),s=parseInt(n.style.getPropertyValue(a))||0;i>s&&n.style.setProperty(a,`${i}px`)}syncRowHeights(r){if(this.card.heightSync===!1)return;let t=this.getContainer();if(!t)return;let a=this.card.variant,i=Array.from(t.querySelectorAll(`merch-card[variant="${a}"]`)).filter(s=>s.variantLayout?.card?.heightSync!==!1);if(i.length===0)return;for(let{name:s}of r){let o=`--consonant-merch-card-${a}-${s}-height`;t.style.getPropertyValue(o)&&t.style.removeProperty(o)}let n=new Map;for(let s of i){let o=s.getBoundingClientRect();if(o.width<=2)continue;let c=Math.round(o.top),l=n.get(c);l||(l=[],n.set(c,l)),l.push(s)}for(let s of n.values())for(let{name:o,getElement:c}of r){let l=`--consonant-merch-card-${a}-${o}-height`,d=s.map(m=>m.style.getPropertyValue(l)),p=0;for(let m of s){m.style.removeProperty(l);let h=c(m);if(!h)continue;let u=Math.max(0,parseInt(window.getComputedStyle(h).height)||0);u>p&&(p=u)}s.forEach((m,h)=>{p>0?m.style.setProperty(l,`${p}px`):d[h]&&m.style.setProperty(l,d[h])})}}get legalDisplayDot(){return!0}get badge(){let r;if(!(!this.card.badgeBackgroundColor||!this.card.badgeColor||!this.card.badgeText))return this.evergreen&&(r=`border: 1px solid ${this.card.badgeBackgroundColor}; border-right: none;`),hr`
            <div
                id="badge"
...
merch-card[variant="catalog"] [slot="footer"] .spectrum-Link--primary {
  ...
  font-weight: 700;
            ...
            <slot></slot>`}getGlobalCSS(){return Hi}setAriaExpanded(t,a){t.setAttribute("aria-expanded",a)}connectedCallbackHook(){this.card.addEventListener("mouseenter",this.showActionMenuOnHover),this.card.addEventListener("mouseleave",this.toggleActionMenuFromCard),this.card.addEventListener("focusin",this.showActionMenuOnHover),this.card.addEventListener("focusout",this.handleCardFocusOut),this.card.addEventListener("keydown",this.handleKeyDown)}disconnectedCallbackHook(){this.card.removeEventListener("mouseenter",this.showActionMenuOnHover),this.card.removeEventListener("mouseleave",this.toggleActionMenuFromCard),this.card.removeEventListener("focusin",this.showActionMenuOnHover),this.card.removeEventListener("focusout",this.handleCardFocusOut),this.card.removeEventListener("keydown",this.handleKeyDown)}};g(nt,"variantStyle",sc`
    ...
    `);import{html as Nt,css as cc}from"./lit-all.min.js";var Fi=`
:root {
...
`;var Ui={cardName:{attribute:"name"},badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300-plans"},badgeIcon:!0,borderColor:{attribute:"border-color"},allowedBadgeColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-gray-700-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],allowedBorderColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],ctas:{slot:"footer",size:"m"},description:{tag:"div",slot:"body-xs"},mnemonics:{size:"l"},prices:{tag:"h3",slot:"heading-xs"},promoText:{tag:"p",slot:"promo-text"},size:["wide","super-wide"],title:{tag:"h3",slot:"heading-xs"},subtitle:{tag:"p",slot:"body-xxs"},backgroundImage:{tag:"div",slot:"bg-image"}},Ge=class extends w{constructor(r){super(r)}getGlobalCSS(){return Fi}renderLayout(){return Nt`<div class="image">
    ...
    `);import{html as Gi}from"./lit-all.min.js";var $i=`
:root {
...
`;var mr=class extends w{constructor(r){super(r)}getGlobalCSS(){return $i}renderLayout(){return Gi` ${this.badge}
            <div class="body">
                <div class="top-section">
                    <slot name="icons"></slot>
                    <slot name="heading-xs"></slot>
            ...
            ${this.card.customHr?"":Gi`<hr />`} ${this.secureLabelFooter}`}};import{html as Ne,css as lc,unsafeCSS as Vi}from"./lit-all.min.js";var qi=`
  :root {
...
`;var dc=32,ji={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},subtitle:{tag:"p",slot:"subtitle"},prices:{tag:"p",slot:"heading-m-price"},promoText:{tag:"div",slot:"promo-text"},shortDescription:{tag:"div",slot:"body-xxs"},description:{tag:"div",slot:"body-m"},mnemonics:{size:"l"},quantitySelect:{tag:"div",slot:"quantity-select"},callout:{tag:"div",slot:"callout-content"},addon:!0,secureLabel:!0,planType:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300-plans"},allowedBadgeColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-gray-700-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],allowedBorderColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],whatsIncludedDividerColor:{attribute:"whats-included-divider-color"},allowedWhatsIncludedDividerColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],borderColor:{attribute:"border-color"},size:["wide","super-wide"],whatsIncluded:{tag:"div",slot:"footer-rows"},ctas:{slot:"footer",size:"l"},style:"consonant"},ot=class extends w{constructor(t){super(t);g(this,"getRowMinHeightPropertyName",t=>`--consonant-merch-card-footer-row-${t}-min-height`);g(this,"getMiniCompareFooter",()=>{let t=this.card.secureLabel?Ne`<slot name="secure-transaction-label">
    ...
    `);import{html as ur,css as hc,unsafeCSS as Sa,nothing as pc}from"./lit-all.min.js";var Wi=`
  :root {
...
`;var mc=32,Yi={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},subtitle:{tag:"p",slot:"subtitle"},prices:{tag:"p",slot:"heading-m-price"},promoText:{tag:"div",slot:"promo-text"},shortDescription:{tag:"div",slot:"body-m"},description:{tag:"div",slot:"body-xs"},mnemonics:{size:"l"},secureLabel:!0,planType:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300-plans"},allowedBadgeColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-gray-700-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],allowedBorderColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],borderColor:{attribute:"border-color"},size:["wide","super-wide"],ctas:{slot:"footer",size:"l"},style:"consonant"},be,st=class extends w{constructor(t){super(t);M(this,be);g(this,"getRowMinHeightPropertyName",t=>`--consonant-merch-card-footer-row-${t}-min-height`);g(this,"getMiniCompareFooter",()=>ur` <footer>
    ...
    `);import{html as It,css as uc,nothing as gr}from"./lit-all.min.js";var Xi=`
:root {
...
`;var fr={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},subtitle:{tag:"p",slot:"subtitle"},prices:{tag:"p",slot:"heading-m"},promoText:{tag:"p",slot:"promo-text"},description:{tag:"div",slot:"body-xs"},mnemonics:{size:"l"},callout:{tag:"div",slot:"callout-content"},quantitySelect:{tag:"div",slot:"quantity-select"},addon:!0,secureLabel:!0,planType:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300-plans"},allowedBadgeColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-gray-700-plans","spectrum-green-900-plans","gradient-purple-blue"],allowedBorderColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-green-900-plans","gradient-purple-blue"],borderColor:{attribute:"border-color"},size:["wide","super-wide"],whatsIncluded:{tag:"div",slot:"whats-included"},ctas:{slot:"footer",size:"m"},style:"consonant",perUnitLabel:{tag:"span",slot:"per-unit-label"}},Ki={...function(){let{whatsIncluded:e,size:r,...t}=fr;return t}(),title:{tag:"h3",slot:"heading-s"},secureLabel:!1},Zi={...function(){let{subtitle:e,whatsIncluded:r,size:t,quantitySelect:a,...i}=fr;return i}()},ye,we,ne=class extends w{constructor(t){super(t);M(this,ye);M(this,we);this.adaptForMedia=this.adaptForMedia.bind(this)}priceOptionsProvider(t,a){t.dataset.template===te&&(a.displayPlanType=this.card?.settings?.displayPlanType??!1)}getGlobalCSS(){return Xi}adjustSlotPlacement(t,a,i){let n=this.card.shadowRoot,s=n.querySelector("footer"),o=this.card.getAttribute("size");if(!o)return;let c=n.querySelector(`footer slot[name="${t}"]`),l=n.querySelector(`.body slot[name="${t}"]`),d=n.querySelector(".body");if(o.includes("wide")||(s?.classList.remove("wide-footer"),c&&c.remove()),!!a.includes(o)){if(s?.classList.toggle("wide-footer",_.isDesktopOrUp),!i&&c){if(l)c.remove();else{let p=d.querySelector(`[data-placeholder-for="${t}"]`);p?p.replaceWith(c):d.appendChild(c)}return}if(i&&l){let p=document.createElement("div");if(p.setAttribute("data-placeholder-for",t),p.classList.add("slot-placeholder"),!c){let m=l.cloneNode(!0);s.prepend(m)}l.replaceWith(p)}}}adaptForMedia(){if(!this.card.closest("merch-card-collection,overlay-trigger,.two-merch-cards,.three-merch-cards,.four-merch-cards, .columns")){this.card.removeAttribute("size");return}this.adjustSlotPlacement("addon",["super-wide"],_.isDesktopOrUp),this.adjustSlotPlacement("callout-content",["super-wide"],_.isDesktopOrUp)}adjustCallout(){let t=this.card.querySelector('[slot="callout-content"] .icon-button');t&&t.title&&(t.dataset.tooltip=t.title,t.removeAttribute("title"),t.classList.add("hide-tooltip"),document.addEventListener("touchstart",a=>{a.preventDefault(),a.target!==t?t.classList.add("hide-tooltip"):a.target.classList.toggle("hide-tooltip")}),document.addEventListener("mouseover",a=>{a.preventDefault(),a.target!==t?t.classList.add("hide-tooltip"):a.target.classList.remove("hide-tooltip")}))}syncHeights(){if(this.card.getBoundingClientRect().width<=2){v(this,ye)||(T(this,ye,new ResizeObserver(()=>{this.card.getBoundingClientRect().width>2&&(v(this,ye)?.disconnect(),T(this,ye,null),this.syncHeights())})),v(this,ye).observe(this.card));return}let t=["heading-xs","subtitle","heading-m","promo-text","body-xs"];this.syncRowHeights(t.map(a=>({name:a,getElement:i=>i.querySelector(`[slot="${a}"]`)})))}async adjustEduLists(){if(this.card.variant!=="plans-education"||this.card.querySelector(".spacer"))return;let a=this.card.querySelector('[slot="body-xs"]');if(!a)return;let i=a.querySelector("ul");if(!i)return;let n=i.previousElementSibling,s=document.createElement("div");s.classList.add("spacer"),a.insertBefore(s,n);let o=new IntersectionObserver(([c])=>{if(c.boundingClientRect.height===0)return;let l=0,d=this.card.querySelector('[slot="heading-s"]');d&&(l+=Rt(d));let p=this.card.querySelector('[slot="subtitle"]');p&&(l+=Rt(p));let m=this.card.querySelector('[slot="heading-m"]');m&&(l+=8+Rt(m));for(let u of a.childNodes){if(u.classList.contains("spacer"))break;l+=Rt(u)}let h=this.card.parentElement.style.getPropertyValue("--merch-card-plans-edu-list-max-offset");l>(parseFloat(h)||0)&&this.card.parentElement.style.setProperty("--merch-card-plans-edu-list-max-offset",`${l}px`),this.card.style.setProperty("--merch-card-plans-edu-list-offset",`${l}px`),o.disconnect()});o.observe(this.card)}async postCardUpdateHook(){this.adaptForMedia(),this.adjustAddon(),this.adjustCallout(),this.legalAdjusted||(await this.adjustLegal(),await this.adjustEduLists()),await super.postCardUpdateHook(),window.matchMedia("(min-width: 768px)").matches&&this.card===this.card.parentElement.firstElementChild&&requestAnimationFrame(()=>{this.syncHeights()})}get headingM(){return this.card.querySelector('[slot="heading-m"]')}get mainPrice(){return this.headingM?.querySelector(`${W}[data-template="price"]`)}get divider(){return this.card.variant==="plans-education"?It`<div class="divider"></div>`:gr}async adjustLegal(){if(!this.legalAdjusted)try{this.legalAdjusted=!0,await this.card.updateComplete,await customElements.whenDefined("inline-price");let t=[],a=this.card.querySelector(`[slot="heading-m"] ${W}[data-template="price"]`);a&&t.push(a);let i=t.map(async n=>{let s=n.cloneNode(!0);await n.onceSettled(),n?.options&&(n.options.displayPerUnit&&(n.dataset.displayPerUnit="false"),n.options.displayTax&&(n.dataset.displayTax="false"),n.options.displayPlanType&&(n.dataset.displayPlanType="false"),s.setAttribute("data-template","legal"),n.parentNode.insertBefore(s,n.nextSibling),await s.onceSettled())});await Promise.all(i)}catch{}}async adjustAddon(){await this.card.updateComplete;let t=this.card.addon;if(!t)return;t.setAttribute("custom-checkbox","");let a=this.mainPrice;if(!a)return;await a.onceSettled?.();let i=a.value?.[0]?.planType;i&&(t.planType=i)}get stockCheckbox(){return this.card.checkboxLabel?It`<label id="stock-checkbox">
            ...
            ${this.secureLabelFooter}
            <slot></slot>`}};ye=new WeakMap,we=new WeakMap,g(ne,"variantStyle",uc`
        :host([variant^='plans']) {
            min-height: 273px;
    ...
    `),g(ne,"collectionOptions",{customHeaderArea:t=>t.sidenav?It`<slot name="resultsText"></slot>`:gr,headerVisibility:{search:!1,sort:!1,result:["mobile","tablet"],custom:["desktop"]},onSidenavAttached:t=>{let a=()=>{let i=t.querySelectorAll("merch-card");for(let s of i)s.hasAttribute("data-size")&&(s.setAttribute("size",s.getAttribute("data-size")),s.removeAttribute("data-size"));if(!_.isDesktop)return;let n=0;for(let s of i){if(s.style.display==="none")continue;let o=s.getAttribute("size"),c=o==="wide"?2:o==="super-wide"?3:1;c===2&&n%3===2&&(s.setAttribute("data-size",o),s.removeAttribute("size"),c=1),n+=c}};_.matchDesktop.addEventListener("change",a),t.addEventListener(me,a),t.onUnmount.push(()=>{_.matchDesktop.removeEventListener("change",a),t.removeEventListener(me,a)})}});import{html as Te,css as gc,unsafeCSS as Ji,nothing as vr}from"./lit-all.min.js";var Qi=`
:root {
...
`)[0].trim()}updateShortDescriptionVisibility(){let r=this.card.querySelector('[slot="short-description"]');if(!r)return;let t=r.querySelector("strong, b, p");t&&(_.isMobile?t.style.display="none":t.style.display="")}toggleShortDescription(){this.shortDescriptionExpanded=!this.shortDescriptionExpanded,this.card.requestUpdate()}get shortDescriptionToggle(){return this.hasShortDescription?_.isMobile?Te`
        ...
        `:Te`
            ...
            <slot></slot>`}};g(Ie,"variantStyle",gc`
    ...
    `),g(Ie,"collectionOptions",{customHeaderArea:r=>r.sidenav?Te`<slot name="resultsText"></slot>`:vr,headerVisibility:{search:!1,sort:!1,result:["mobile","tablet"],custom:["desktop"]},onSidenavAttached:r=>{let t=()=>{let a=r.querySelectorAll("merch-card");if(a.forEach(n=>{n.hasAttribute("data-size")&&(n.setAttribute("size",n.getAttribute("data-size")),n.removeAttribute("data-size"))}),!_.isDesktop)return;let i=0;a.forEach(n=>{if(n.style.display==="none")return;let s=n.getAttribute("size"),o=s==="wide"?2:s==="super-wide"?3:1;o===2&&i%3===2&&(n.setAttribute("data-size",s),n.removeAttribute("size"),o=1),i+=o})};_.matchDesktop.addEventListener("change",t),r.addEventListener(me,t),r.onUnmount.push(()=>{_.matchDesktop.removeEventListener("change",t),r.removeEventListener(me,t)})}});import{html as De,css as fc,nothing as Dt,unsafeCSS as vc}from"./lit-all.min.js";var tn=`
:root {
...
`;var[cp,lp,rn,an,nn,on]=["ArrowLeft","ArrowRight","ArrowUp","ArrowDown","Enter","Tab"];var xc="pro",sn=`--consonant-merch-card-${xc}-top-card-height`,cn={cardName:{attribute:"name"},subtitle:{tag:"p",slot:"subtitle"},title:{tag:"h3",slot:"heading-xs"},description:{tag:"div",slot:"body-xs"},mnemonics:{size:"s"},size:["wide","edu"],prices:{tag:"p",slot:"heading-m"},promoText:{tag:"p",slot:"promo-text"},perUnitLabel:{tag:"span",slot:"per-unit-label"},callout:{tag:"div",slot:"callout-content",editorLabel:"License callout"},quantitySelect:{tag:"div",slot:"quantity-select"},shortDescription:{tag:"div",slot:"legal-text"},secureLabel:!0,planType:!0,addon:!0,ctas:{slot:"footer",size:"m"},whatsIncluded:{tag:"div",slot:"whats-included"},backgroundColor:{attribute:"background-color",editorLabel:"Theme",specialValues:{Light:"light",Dark:"dark"}},borderColor:{attribute:"border-color",specialValues:{Black:"black"}},allowedBorderColors:[],style:"consonant"},ke,qe,Ft,Y,ln,zt,dn,Ht,Aa,xr,br=class br extends w{constructor(t){super(t);M(this,Y);g(this,"expanded",!1);g(this,"licenseOpen",!1);g(this,"licenseQty",null);g(this,"licenseHighlightedIndex",0);M(this,ke,null);M(this,qe,null);g(this,"lastSyncKey",null);M(this,Ft,({detail:t})=>{let a=t?.quantity==null?null:String(t.quantity);a==null||a===this.licenseQty||this.licenseOptions?.includes(a)&&(this.licenseQty=a,this.card.requestUpdate())});g(this,"toggleExpanded",t=>{t.preventDefault();let a=!this.expanded;for(let i of j(this,Y,ln).call(this)){let n=i.variantLayout;n instanceof br&&(n.expanded=a,i._proExpanded=a,i.requestUpdate())}});g(this,"toggleLicensePopover",t=>{t.preventDefault(),t.stopPropagation(),this.licenseOpen?j(this,Y,Aa).call(this):j(this,Y,Ht).call(this),this.card.requestUpdate()});M(this,xr,t=>{let a=this.licenseOptions;if(!a?.length)return;let i=a.length-1;switch(t.key){case an:t.preventDefault(),this.licenseOpen?this.licenseHighlightedIndex=(this.licenseHighlightedIndex+1)%a.length:j(this,Y,Ht).call(this);break;case rn:t.preventDefault(),this.licenseOpen?this.licenseHighlightedIndex=(this.licenseHighlightedIndex-1+a.length)%a.length:j(this,Y,Ht).call(this);break;case"Home":if(!this.licenseOpen)return;t.preventDefault(),this.licenseHighlightedIndex=0;break;case"End":if(!this.licenseOpen)return;t.preventDefault(),this.licenseHighlightedIndex=i;break;case nn:case" ":if(t.preventDefault(),this.licenseOpen){this.selectLicenseQty(a[this.licenseHighlightedIndex]);return}j(this,Y,Ht).call(this);break;case"Escape":if(!this.licenseOpen)return;t.preventDefault(),j(this,Y,Aa).call(this);break;case on:this.licenseOpen&&this.selectLicenseQty(a[this.licenseHighlightedIndex]);return;default:return}this.card.requestUpdate()});g(this,"selectLicenseQty",t=>{this.licenseQty=t,this.licenseOpen=!1,j(this,Y,zt).call(this);let a=this.quantitySelectEl;a&&(a.selectedValue=Number(t),a.dispatchEvent(new CustomEvent(ae,{detail:{option:Number(t)},bubbles:!0}))),this.card.requestUpdate()});this.updatePriceQuantity=this.updatePriceQuantity.bind(this),this.expanded=t._proExpanded??!1}getGlobalCSS(){return tn}priceOptionsProvider(t,a){t.dataset.template===te&&(a.displayPlanType=this.card?.settings?.displayPlanType??!1)}async adjustLegal(){if(!this.legalAdjusted)try{this.legalAdjusted=!0,await this.card.updateComplete,await customElements.whenDefined("inline-price");let t=this.mainPrice;if(!t)return;let a=t.cloneNode(!0);if(await t.onceSettled(),!t?.options)return;t.options.displayTax&&(t.dataset.displayTax="false"),t.options.displayPlanType&&(t.dataset.displayPlanType="false"),a.setAttribute("data-template","legal"),a.dataset.displayPerUnit="false",t.parentNode.insertBefore(a,t.nextSibling),await a.onceSettled(),this.legalResolvedHandler||(this.legalResolvedHandler=()=>this.adjustShortDescription(),a.addEventListener(Se,this.legalResolvedHandler)),this.adjustShortDescription()}catch{}}adjustShortDescription(){let t=this.card.querySelector('[slot="legal-text"]')?.textContent?.trim();if(!t)return;let a=this.card.querySelector('[slot="heading-m"] [data-template="legal"]'),i=a?.querySelector(".price-plan-type");if(!i)return;i.textContent=t;let n=a.querySelector(".price-tax-inclusivity:not(.disabled)");n?.textContent&&!/\s$/.test(n.textContent)&&(n.textContent+=". ")}get hasWhatsIncluded(){return!!this.card.querySelector('[slot="whats-included"]')}get whatsIncludedToggleLabel(){return this.card.querySelector('[slot="whats-included"] .whats-included-label')?.textContent.trim()||"See what's included:"}get hasCallout(){return!!this.card.querySelector('[slot="callout-content"]')}get hasQuantitySelect(){let t=this.quantitySelectEl;return t?!!t.getAttribute("title")||parseInt(t.getAttribute("min"),10)>0||parseInt(t.getAttribute("step"),10)>0:!1}get hasAddOn(){return!!this.card.querySelector('[slot="addon"]')}get mainPrice(){return this.card.querySelector(`[slot="heading-m"] ${W}[data-template="price"]`)}updatePriceQuantity({detail:t}){!this.mainPrice||!t?.option||(this.mainPrice.dataset.quantity=t.option)}async adjustAddon(){await this.card.updateComplete;let t=this.card.addon;if(!t)return;t.setAttribute("custom-checkbox","");let a=this.mainPrice;if(!a)return;await a.onceSettled?.();let i=a.value?.[0]?.planType;i&&(t.planType=i)}async postCardUpdateHook(){await this.adjustAddon(),this.legalAdjusted||await this.adjustLegal(),this.adjustShortDescription(),await super.postCardUpdateHook(),window.matchMedia("(min-width: 768px)").matches&&this.syncHeights()}async waitForContentFonts(){let t=[this.card.querySelector('[slot="heading-xs"]'),this.card.querySelector('[slot="body-xs"]')].filter(Boolean);document.fonts?.load&&await Promise.all(t.map(a=>{let i=window.getComputedStyle(a),n=`${i.fontWeight} ${i.fontSize} ${i.fontFamily}`;return document.fonts.load(n,a.textContent).catch(()=>null)})),await document.fonts?.ready}async syncHeights(){if(this.card.heightSync===!1)return;await this.waitForContentFonts(),await new Promise(o=>requestAnimationFrame(o)),await new Promise(o=>requestAnimationFrame(o));let t=this.getContainer();if(!t||this.card.getBoundingClientRect().width<=2)return;let a=this.card.variant,i=sn,n=[...t.querySelectorAll(`merch-card[variant="${a}"]`)].filter(o=>o.getBoundingClientRect().width>2&&o.variantLayout?.card?.heightSync!==!1),s=new Map;for(let o of n){let c=s.get(o.offsetTop)??[];c.push(o),s.set(o.offsetTop,c)}for(let o of s.values()){let c=0;for(let l of o){l.style.removeProperty(i);let d=l.shadowRoot?.querySelector(".top-card");d&&(c=Math.max(c,parseInt(getComputedStyle(d).height)||0))}c>0&&o.length>1&&o.forEach(l=>l.style.setProperty(i,`${c}px`))}}resyncOnReflow(){let t=this.card.getBoundingClientRect().width;if(t<=2)return;let a=this.card.querySelector('[slot="body-xs"]'),i=a?Math.round(a.getBoundingClientRect().height):0,n=`${Math.round(t)}:${i}`;n!==this.lastSyncKey&&(this.lastSyncKey=n,this.syncHeights())}connectedCallbackHook(){if(!this.card||(this.card.addEventListener(cr,v(this,Ft)),this.card.addEventListener(ae,this.updatePriceQuantity),typeof ResizeObserver>"u"))return;T(this,qe,new ResizeObserver(()=>this.resyncOnReflow())),v(this,qe).observe(this.card);let t=this.card.querySelector('[slot="body-xs"]');t&&v(this,qe).observe(t)}disconnectedCallbackHook(){this.card?.removeEventListener(ae,this.updatePriceQuantity),j(this,Y,zt).call(this),v(this,qe)?.disconnect(),this.card?.removeEventListener(cr,v(this,Ft))}get quantitySelectEl(){return this.card.querySelector("merch-quantity-select")}get licenseOptions(){let t=this.quantitySelectEl;if(!t)return null;let a=parseInt(t.getAttribute("min"),10),i=parseInt(t.getAttribute("max"),10),n=parseInt(t.getAttribute("step"),10)||1;if(Number.isNaN(a)||Number.isNaN(i)||i<a)return null;let s=[];for(let o=a;o<=i;o+=n)s.push(String(o));return s.length?s:null}licenseLabel(t){let a=this.quantitySelectEl?.getAttribute("title")||"License",[i,n]=a.split("|").map(s=>s.trim());return Number(t)===1?i:n||i}get hasLicenseSelector(){return(this.licenseOptions?.length??0)>0}get currentLicenseValue(){let t=this.licenseOptions;if(!t?.length)return null;if(this.licenseQty!=null)return this.licenseQty;let a=this.quantitySelectEl?.getAttribute("default-value");return a!=null&&t.includes(a)?a:t[0]}renderLicenseSelector(){if(!this.hasLicenseSelector)return De`<slot name="quantity-select"></slot>`;let t=this.licenseOptions,a=this.currentLicenseValue,i=!!this.licenseOpen,n=this.licenseLabel(Number(a));return De`
            <div class="license-select" ?data-open=${i}>
                ...
                >
                    ...
                    ${t.map((s,o)=>De`
                            <li
                                class="license-select-option ${o===this.licenseHighlightedIndex?"highlighted":""}${s===a?" selected":""}"
                                id="license-option-${o}"
                                role="option"
                                aria-selected=${s===a?"true":"false"}
                                @click=${()=>this.selectLicenseQty(s)}
                                @mouseenter=${()=>{this.licenseHighlightedIndex=o,this.card.requestUpdate()}}
                            >
                                ${s}
                            </li>
                        `)}
        ...
        `}renderLayout(){let t=!!this.expanded;return De`
            ...
            ${this.hasWhatsIncluded?De`
                  ...
                  `:Dt}
            <slot></slot>
        `}};ke=new WeakMap,qe=new WeakMap,Ft=new WeakMap,Y=new WeakSet,ln=function(){let t=this.card.offsetTop,a=Array.from(this.getContainer()?.querySelectorAll(`merch-card[variant="${this.card.variant}"]`)??[]).filter(i=>i.getBoundingClientRect().width>2&&i.offsetTop===t);return a.length?a:[this.card]},zt=function(){v(this,ke)&&(document.removeEventListener("mousedown",v(this,ke)),T(this,ke,null))},dn=function(){let t=this.licenseOptions?.indexOf(this.currentLicenseValue);return t>0?t:0},Ht=function(){this.licenseOpen=!0,this.licenseHighlightedIndex=j(this,Y,dn).call(this),v(this,ke)||(T(this,ke,t=>{t.composedPath().includes(this.card)||(this.licenseOpen=!1,this.card.requestUpdate(),j(this,Y,zt).call(this))}),document.addEventListener("mousedown",v(this,ke)))},Aa=function(){this.licenseOpen=!1,j(this,Y,zt).call(this)},xr=new WeakMap,g(br,"variantStyle",fc`
        :host([variant='pro']) {
            display: flex;
            flex-direction: column;
            background: var(
    ...
    `);var Bt=br;import{html as Ca,css as bc}from"./lit-all.min.js";var hn=`
:root {
...
`;var pn={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},prices:{tag:"p",slot:"heading-xs"},promoText:{tag:"p",slot:"promo-text"},description:{tag:"div",slot:"body-xs"},shortDescription:{tag:"div",slot:"short-description"},mnemonics:{size:"l"},callout:{tag:"div",slot:"callout-content"},quantitySelect:{tag:"div",slot:"quantity-select"},secureLabel:!0,planType:!0,addon:!0,addonBackground:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"color-yellow-300-variation"},allowedBadgeColors:["color-yellow-300-variation","color-gray-300-variation","color-gray-700-variation","color-green-900-variation","gradient-purple-blue"],allowedBorderColors:["color-yellow-300-variation","color-gray-300-variation","color-green-900-variation","gradient-purple-blue"],borderColor:{attribute:"border-color"},whatsIncluded:{tag:"div",slot:"whats-included"},ctas:{slot:"footer",size:"m"},style:"consonant",perUnitLabel:{tag:"span",slot:"per-unit-label"}},Ee,ct=class extends w{constructor(t){super(t);M(this,Ee);this.postCardUpdateHook=this.postCardUpdateHook.bind(this),this.updatePriceQuantity=this.updatePriceQuantity.bind(this)}getGlobalCSS(){return hn}priceOptionsProvider(t,a){t.dataset.template===te&&(a.displayPlanType=this.card?.settings?.displayPlanType??!1,(t.dataset.template==="strikethrough"||t.dataset.template==="price")&&(a.displayPerUnit=!1))}adjustProductBodySlots(){if(this.card.getBoundingClientRect().width===0)return;["heading-xs","body-xxs","body-xs","promo-text","callout-content","addon","body-lower"].forEach(a=>this.updateCardElementMinHeight(this.card.shadowRoot.querySelector(`slot[name="${a}"]`),a))}renderLayout(){return Ca` ${this.badge}
    ...
    `);import{html as Ta,css as yc}from"./lit-all.min.js";var mn=`
:root {
...
`;var un={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},prices:{tag:"p",slot:"heading-xs"},promoText:{tag:"p",slot:"promo-text"},description:{tag:"div",slot:"body-xs"},callout:{tag:"div",slot:"callout-content"},planType:!0,secureLabel:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"color-red-700-variation"},allowedBadgeColors:["color-yellow-300-variation","color-gray-300-variation","color-gray-700-variation","color-green-900-variation","color-red-700-variation","gradient-purple-blue"],allowedBorderColors:["color-yellow-300-variation","color-gray-300-variation","color-green-900-variation","color-red-700-variation","gradient-purple-blue"],borderColor:{attribute:"border-color"},ctas:{slot:"footer",size:"m"},style:"consonant",perUnitLabel:{tag:"span",slot:"per-unit-label"}},lt=class extends w{constructor(r){super(r)}priceOptionsProvider(r,t){r.dataset.template===te&&(t.displayPlanType=this.card?.settings?.displayPlanType??!1,(r.dataset.template==="strikethrough"||r.dataset.template==="price")&&(t.displayPerUnit=!1))}getGlobalCSS(){return mn}get badgeElement(){return this.card.querySelector('[slot="badge"]')}get mainPrice(){return this.card.querySelector(`[slot="heading-xs"] ${W}[data-template="price"]`)}async postCardUpdateHook(){this.legalAdjusted||await this.adjustLegal(),await super.postCardUpdateHook()}async adjustLegal(){if(!(this.legalAdjusted||!this.card.id))try{this.legalAdjusted=!0,await this.card.updateComplete,await customElements.whenDefined("inline-price");let r=this.mainPrice;if(!r)return;let t=r.cloneNode(!0);if(await r.onceSettled(),!r?.options)return;r.options.displayPerUnit&&(r.dataset.displayPerUnit="false"),r.options.displayTax&&(r.dataset.displayTax="false"),r.options.displayPlanType&&(r.dataset.displayPlanType="false"),t.setAttribute("data-template","legal"),r.parentNode.insertBefore(t,r.nextSibling),await t.onceSettled()}catch{}}renderLayout(){return Ta`
            ${this.badge}
            <div class="body">
                <slot name="heading-xs"></slot>
                <slot name="body-xxs"></slot>
    ...
    `);import{html as wc,css as Ec}from"./lit-all.min.js";var gn=`
...
`;var fn={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},subtitle:{tag:"p",slot:"body-xxs"},description:{tag:"div",slot:"body-xs"},ctas:{slot:"footer",size:"m"},backgroundImage:{tag:"div",slot:"bg-image"},style:"consonant"},dt=class extends w{constructor(r){super(r)}getGlobalCSS(){return gn}removeFocusFromModalClose(){let r=this.card.closest(".dialog-modal");r&&r.querySelector(".dialog-close")?.blur()}async postCardUpdateHook(){this.removeFocusFromModalClose(),await super.postCardUpdateHook()}renderLayout(){return wc`
            <div class="media-row">
                <div class="text">
                    <slot name="body-xxs"></slot>
                    <slot name="heading-xs"></slot>
    ...
    `);import{html as ka,css as Sc}from"./lit-all.min.js";var vn=`
:root {
...
`;var xn={cardName:{attribute:"name"},backgroundImage:{tag:"div",slot:"bg-image"},subtitle:{tag:"p",slot:"detail-m"},title:{tag:"h3",slot:"heading-xs"},prices:{tag:"p",slot:"heading-xs-price"},description:{tag:"div",slot:"body-xs"},ctas:{slot:"footer",size:"l"},badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300-special-offers"},allowedBadgeColors:["spectrum-yellow-300-special-offers","spectrum-gray-300-special-offers","spectrum-green-900-special-offers"],allowedBorderColors:["spectrum-yellow-300-special-offers","spectrum-gray-300-special-offers","spectrum-green-900-special-offers"],borderColor:{attribute:"border-color"}},ht=class extends w{constructor(r){super(r)}get headingSelector(){return'[slot="detail-m"]'}getGlobalCSS(){return vn}renderLayout(){return ka`${this.cardImage}
            ...
            ${this.evergreen?ka`
                  ...
                  `:ka`
                      ...
                      ${this.secureLabelFooter}
                  `}
            <slot></slot>`}};g(ht,"variantStyle",Sc`
    ...
    `);import{html as Ac,css as Cc}from"./lit-all.min.js";var bn=`
:root {
...
`;var _a={title:{tag:"h3",slot:"heading-xs",maxCount:250,withSuffix:!0},badge:{tag:"div",slot:"badge",default:"spectrum-blue-400"},allowedBadgeColors:["spectrum-blue-400","spectrum-gray-300","spectrum-yellow-300","gradient-purple-blue","gradient-firefly-spectrum"],description:{tag:"div",slot:"body-xs",maxCount:2e3,withSuffix:!1},prices:{tag:"div",slot:"price"},callout:{tag:"div",slot:"callout-content",editorLabel:"Price description"},ctas:{slot:"cta",size:"XL"},borderColor:{attribute:"border-color",specialValues:{gray:"var(--spectrum-gray-300)",blue:"var(--spectrum-blue-400)","gradient-purple-blue":"linear-gradient(96deg, #B539C8 0%, #7155FA 66%, #3B63FB 100%)","gradient-firefly-spectrum":"linear-gradient(96deg, #D73220 0%, #D92361 33%, #7155FA 100%)"}},disabledAttributes:["badgeColor","badgeBorderColor","trialBadgeColor","trialBadgeBorderColor"],supportsDefaultChild:!0},pt=class extends w{getGlobalCSS(){return bn}get aemFragmentMapping(){return _a}get headingSelector(){return'[slot="heading-xs"]'}get badge(){return this.card.querySelector('[slot="badge"]')}syncHeights(){if(this.card.getBoundingClientRect().width===0)return;let r=this.card.shadowRoot;if(!r)return;["header","price-container","cta"].forEach(i=>this.updateCardElementMinHeight(r.querySelector(`.${i}`),i));let t=this.card.querySelector('[slot="body-xs"]');t&&this.updateCardElementMinHeight(t,"description");let a=this.card.querySelector('[slot="body-xs"] p:has(mas-mnemonic)');a&&this.updateCardElementMinHeight(a,"icons")}async postCardUpdateHook(){if(!this.card.isConnected)return;await super.postCardUpdateHook();let r=this.getContainer();if(!r)return;let t=r.querySelectorAll(`merch-card[variant="${this.card.variant}"]`),a=34;t.forEach(i=>{i.classList.remove("small-font-size-button"),i.querySelectorAll('[slot="cta"] sp-button, [slot="cta"] button, [slot="cta"] a.con-button, [slot="cta"] a.spectrum-Button, a[slot="cta"]').forEach(s=>{let o=s.textContent.trim().length>a;s.classList.toggle("small-font-size-button",o)})}),_.isDesktopOrUp&&t.forEach(i=>i.variantLayout?.syncHeights?.())}connectedCallbackHook(){!this.card||this.card.failed||(this.setupAccordion(),this.card?.hasAttribute("data-default-card")&&!or()&&this.card.setAttribute("data-expanded","true"),this.observeVisibility())}resyncSiblings(){let r=this.getContainer();r&&r.querySelectorAll(`merch-card[variant="${this.card.variant}"]`).forEach(t=>t.variantLayout?.syncHeights?.())}observeVisibility(){typeof ResizeObserver>"u"||(this.lastSyncedWidth=0,this.sizeObserver=new ResizeObserver(()=>{let r=this.card.getBoundingClientRect().width;r<=2||r===this.lastSyncedWidth||(this.lastSyncedWidth=r,this.resyncSiblings())}),this.sizeObserver.observe(this.card))}setupAccordion(){let r=this.card;if(!r)return;let t=()=>{if(or())r.removeAttribute("data-expanded");else{let i=r.hasAttribute("data-default-card");r.setAttribute("data-expanded",i?"true":"false")}};t();let a=window.matchMedia(D);this.mediaQueryListener=()=>{t()},a.addEventListener("change",this.mediaQueryListener)}disconnectedCallbackHook(){this.mediaQueryListener&&window.matchMedia(D).removeEventListener("change",this.mediaQueryListener),this.sizeObserver?.disconnect(),this.sizeObserver=null}handleChevronClick(r){r.preventDefault(),r.stopPropagation(),this.toggleExpanded()}handleCardClick(r){r.target.closest('.chevron-button, mas-mnemonic, button, a, [role="button"]')||(r.preventDefault(),this.toggleExpanded())}toggleExpanded(){let r=this.card;if(!r||or())return;let i=r.getAttribute("data-expanded")==="true"?"false":"true";r.setAttribute("data-expanded",i)}renderLayout(){return Ac`
    ...
    `);import{html as wn,css as Tc}from"./lit-all.min.js";var yn=`
:root {
...
`;var Pa={title:{tag:"h3",slot:"heading-xs",maxCount:250,withSuffix:!0},badge:{tag:"div",slot:"badge",default:"spectrum-blue-400"},allowedBadgeColors:["spectrum-blue-400","spectrum-gray-300","spectrum-yellow-300","gradient-purple-blue","gradient-firefly-spectrum"],description:{tag:"div",slot:"body-s",maxCount:2e3,withSuffix:!1},shortDescription:{tag:"div",slot:"short-description",maxCount:3e3,withSuffix:!1},callout:{tag:"div",slot:"callout-content",editorLabel:"Price description"},prices:{tag:"div",slot:"price"},trialBadge:{tag:"div",slot:"trial-badge"},ctas:{slot:"cta",size:"XL"},mnemonics:{size:"xs"},borderColor:{attribute:"border-color",specialValues:{gray:"var(--spectrum-gray-300)",blue:"var(--spectrum-blue-400)","gradient-purple-blue":"linear-gradient(96deg, #B539C8 0%, #7155FA 66%, #3B63FB 100%)","gradient-firefly-spectrum":"linear-gradient(96deg, #D73220 0%, #D92361 33%, #7155FA 100%)"}},showAllSpectrumColors:!0,multiWhatsIncluded:"true",disabledAttributes:[]},Ut=class Ut extends w{getGlobalCSS(){return yn}get aemFragmentMapping(){return Pa}get headingSelector(){return'[slot="heading-xs"]'}get badgeElement(){return this.card.querySelector('[slot="badge"]')}get badge(){return wn`
        ...
        `}async waitForTitleFont(){let r=this.card.querySelector(this.headingSelector);if(r&&document.fonts?.load){let t=window.getComputedStyle(r),a=`${t.fontWeight} ${t.fontSize} ${t.fontFamily}`;await document.fonts.load(a,r.textContent).catch(()=>null)}await document.fonts.ready}async syncHeights(){if(await this.waitForTitleFont(),await new Promise(o=>requestAnimationFrame(o)),await new Promise(o=>requestAnimationFrame(o)),this.card.getBoundingClientRect().width<=2)return;let r=Ut.SYNCED_SECTIONS.map(o=>({name:o,getElement:c=>c.shadowRoot?.querySelector(`.${o}`)})),t=this.getContainer(),a=t?t.querySelectorAll(`merch-card[variant="${this.card.variant}"]`):[this.card],i='[slot="body-s"] > *',n=Math.max(0,...Array.from(a,o=>o.querySelectorAll(i).length)),s=Array.from({length:n},(o,c)=>({name:`description-row-${c}`,getElement:l=>l.querySelectorAll(i)[c]}));this.syncRowHeights([...r,...s])}async postCardUpdateHook(){if(!this.card.isConnected)return;await super.postCardUpdateHook();let r=this.getContainer();if(r){let t=r.querySelectorAll(`merch-card[variant="${this.card.variant}"]`),a=49;t.forEach(i=>{i.classList.remove("small-font-size-button"),i.querySelectorAll('[slot="cta"] sp-button, [slot="cta"] button, [slot="cta"] a.con-button, [slot="cta"] a.spectrum-Button, a[slot="cta"]').forEach(s=>{let o=s.textContent.trim().length>a;s.classList.toggle("small-font-size-button",o)})})}window.matchMedia("(min-width: 768px)").matches&&this.syncHeights()}resyncOnReflow(){let r=this.card.getBoundingClientRect().width;if(r<=2)return;let t=this.card.querySelector(this.headingSelector),a=t?Math.round(t.getBoundingClientRect().height):0,i=`${Math.round(r)}:${a}`;i!==this.lastSyncedKey&&(this.lastSyncedKey=i,this.syncHeights())}connectedCallbackHook(){if(!this.card||typeof ResizeObserver>"u")return;this.lastSyncedKey="",this.sizeObserver=new ResizeObserver(()=>this.resyncOnReflow()),this.sizeObserver.observe(this.card);let r=this.card.querySelector(this.headingSelector);r&&this.sizeObserver.observe(r)}disconnectedCallbackHook(){this.sizeObserver?.disconnect(),this.sizeObserver=null}renderLayout(){return wn`
            ...
            <slot></slot>
        `}};g(Ut,"SYNCED_SECTIONS",["header","short-description","price-container","cta"]),g(Ut,"variantStyle",Tc`
    ...
    `);var $t=Ut;import{html as La,css as kc,nothing as _c}from"./lit-all.min.js";var En=`
...
`;var Sn={cardName:{attribute:"name"},title:{tag:"p",slot:"heading-xs"},cardTitle:{tag:"p",slot:"heading-xs"},subtitle:{tag:"p",slot:"body-xxs"},description:{tag:"div",slot:"body-xs"},promoText:{tag:"p",slot:"promo-text"},shortDescription:{tag:"p",slot:"short-description"},callout:{tag:"div",slot:"callout-content"},quantitySelect:{tag:"div",slot:"quantity-select"},whatsIncluded:{tag:"div",slot:"whats-included"},addonConfirmation:{tag:"div",slot:"addon-confirmation"},badge:{tag:"div",slot:"badge"},trialBadge:{tag:"div",slot:"trial-badge"},prices:{tag:"p",slot:"prices"},backgroundImage:{tag:"div",slot:"bg-image"},ctas:{slot:"footer",size:"m"},addon:!0,secureLabel:!0,borderColor:{attribute:"border-color"},backgroundColor:{attribute:"background-color"},size:[],mnemonics:{size:"m"}},Pc=[{slot:"bg-image",label:"Background Image"},{slot:"badge",label:"Badge"},{slot:"icons",label:"Mnemonic icon"},{slot:"heading-xs",label:"Title"},{slot:"body-xxs",label:"Subtitle"},{slot:"body-xs",label:"Product description"},{slot:"promo-text",label:"Promo Text"},{slot:"callout-content",label:"Callout text"},{slot:"short-description",label:"Short Description"},{slot:"trial-badge",label:"Trial Badge"},{slot:"prices",label:"Product price"},{slot:"quantity-select",label:"Quantity select"},{slot:"addon",label:"Addon"},{slot:"whats-included",label:"What's included"},{slot:"addon-confirmation",label:"Addon confirmation"},{slot:"footer",label:"CTAs"}],mt=class extends w{constructor(r){super(r)}getGlobalCSS(){return En}renderLayout(){return La`
    ...
    `);import{css as Lc,html as Mc}from"./lit-all.min.js";var An=`
...
`;var Cn={title:{tag:"p",slot:"title"},prices:{tag:"p",slot:"prices"},description:{tag:"p",slot:"description"},planType:!0,ctas:{slot:"ctas",size:"S"}},ut=class extends w{constructor(){super(...arguments);g(this,"legal")}async postCardUpdateHook(){await super.postCardUpdateHook(),this.adjustLegal()}getGlobalCSS(){return An}get headingSelector(){return'[slot="title"]'}priceOptionsProvider(t,a){a.literals={...a.literals,strikethroughAriaLabel:"",alternativePriceAriaLabel:""},a.space=!0,a.displayAnnual=this.card.settings?.displayAnnual??!1}adjustLegal(){if(this.legal!==void 0)return;let t=this.card.querySelector(`${W}[data-template="price"]`);if(!t)return;let a=t.cloneNode(!0);this.legal=a,t.dataset.displayTax="false",t.dataset.displayPerUnit="false",a.dataset.template="legal",a.dataset.displayPlanType=this.card?.settings?.displayPlanType??!0,a.setAttribute("slot","legal"),this.card.appendChild(a)}renderLayout(){return Mc`
            ${this.badge}
            <div class="body">
    ...
    `);import{html as Rc,css as Oc}from"./lit-all.min.js";var Tn=`
...
`;var Ma={mnemonics:{size:"l"},title:{tag:"h3",slot:"header",maxCount:100},prices:{tag:"p",slot:"price"},description:{tag:"div",slot:"detail",maxCount:1e3},ctas:{slot:"cta",size:"M"},features:{tag:"div",slot:"features",unwrap:!0}},Nc=[{key:"header",selector:".seg-header"},{key:"price",selector:".seg-price"},{key:"detail",selector:".seg-detail"},{key:"cta",selector:".seg-cta"}],yr,kn,gt=class extends w{constructor(t){super(t);M(this,yr);this.postCardUpdateHook=this.postCardUpdateHook.bind(this)}getGlobalCSS(){return Tn}get aemFragmentMapping(){return Ma}getContainer(){return this.card.closest("mas-compare-chart")??this.card.parentElement}connectedCallbackHook(){window.addEventListener("resize",this.postCardUpdateHook)}disconnectedCallbackHook(){window.removeEventListener("resize",this.postCardUpdateHook)}async postCardUpdateHook(){this.card.isConnected&&(await this.card.updateComplete,j(this,yr,kn).call(this))}renderLayout(){return Rc`
            <div class="card">
            ...
            <slot></slot>
        `}};yr=new WeakSet,kn=function(){if(this.card.getBoundingClientRect().width===0)return;let t=this.card.shadowRoot;Nc.forEach(({key:a,selector:i})=>this.updateCardElementMinHeight(t.querySelector(i),a))},g(gt,"variantStyle",Oc`
    ...
    `);import{html as Ic,css as Dc}from"./lit-all.min.js";var _n=`
...
`;var Ra={mnemonics:{size:"s"},title:{tag:"h3",slot:"heading-xxs",maxCount:250,withSuffix:!0},description:{tag:"div",slot:"body-s",maxCount:2e3,withSuffix:!1},whatsIncluded:{tag:"div",slot:"whats-included"},badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300"},trialBadge:{tag:"div",slot:"trial-badge",default:"spectrum-green-800"},prices:{tag:"p",slot:"price"},ctas:{slot:"cta",size:"M"},addonConfirmation:{tag:"div",slot:"addon-confirmation"},borderColor:{attribute:"border-color",specialValues:{gray:"--spectrum-gray-300","gradient-purple-blue":"var(--gradient-purple-blue)","gradient-firefly-spectrum":"var(--gradient-firefly-spectrum)"}}},ft=class extends w{getGlobalCSS(){return _n}get aemFragmentMapping(){return Ra}renderLayout(){return Ic`
    ...
    `);var Pn=new Map;var G=(e,r,t=null,a=null,i)=>{Pn.set(e,{class:r,fragmentMapping:t,style:a,collectionOptions:i})};G("catalog",nt,Bi,nt.variantStyle);G("image",Ge);G("inline-heading",mr);G("mini-compare-chart",ot,ji,ot.variantStyle);G("mini-compare-chart-mweb",st,Yi,st.variantStyle);G("plans",ne,fr,ne.variantStyle,ne.collectionOptions);G("plans-students",ne,Zi,ne.variantStyle,ne.collectionOptions);G("plans-education",ne,Ki,ne.variantStyle,ne.collectionOptions);G("plans-v2",Ie,en,Ie.variantStyle,Ie.collectionOptions);G("pro",Bt,cn,Bt.variantStyle);G("product",ct,pn,ct.variantStyle);G("segment",lt,un,lt.variantStyle);G("media",dt,fn,dt.variantStyle);G("headless",mt,Sn,mt.variantStyle);G("special-offers",ht,xn,ht.variantStyle);G("simplified-pricing-express",pt,_a,pt.variantStyle);G("full-pricing-express",$t,Pa,$t.variantStyle);G("mini",ut,Cn,ut.variantStyle);G("image",Ge,Ui,Ge.variantStyle);G("compare-chart-column",gt,Ma,gt.variantStyle);G("fries",ft,Ra,ft.variantStyle);function pr(e){return Pn.get(e)?.fragmentMapping}var Ln="tacocat.js";var Oa=(e,r)=>String(e??"").toLowerCase()==String(r??"").toLowerCase(),Mn=e=>`${e??""}`.replace(/[&<>'"]/g,r=>({"&":"&amp;","<":"&lt;",">":"&gt;","'":"&#39;",'"':"&quot;"})[r]??r)??"";function H(e,r={},{metadata:t=!0,search:a=!0,storage:i=!0}={}){let n;if(a&&n==null){let s=new URLSearchParams(window.location.search),o=vt(a)?a:e;n=s.get(o)}if(i&&n==null){let s=vt(i)?i:e;n=window.sessionStorage.getItem(s)??window.localStorage.getItem(s)}if(t&&n==null){let s=Hc(vt(t)?t:e);n=document.documentElement.querySelector(`meta[name="${s}"]`)?.content}return n??r[e]}var zc=e=>typeof e=="boolean",wr=e=>typeof e=="function",Er=e=>typeof e=="number",Rn=e=>e!=null&&typeof e=="object";var vt=e=>typeof e=="string",On=e=>vt(e)&&e,xt=e=>Er(e)&&Number.isFinite(e)&&e>0;function Sr(e,r=t=>t==null||t===""){return e!=null&&Object.entries(e).forEach(([t,a])=>{r(a)&&delete e[t]}),e}function E(e,r){if(zc(e))return e;let t=String(e);return t==="1"||t==="true"?!0:t==="0"||t==="false"?!1:r}function Gt(e,r,t){let a=Object.values(r);return a.find(i=>Oa(i,e))??t??a[0]}function Hc(e=""){return String(e).replace(/(\p{Lowercase_Letter})(\p{Uppercase_Letter})/gu,(r,t,a)=>`${t}-${a}`).replace(/\W+/gu,"-").toLowerCase()}function Nn(e,r=1){return Er(e)||(e=Number.parseInt(e,10)),!Number.isNaN(e)&&e>0&&Number.isFinite(e)?e:r}var Bc=Date.now(),Na=()=>`(+${Date.now()-Bc}ms)`,Ar=new Set,Fc=E(H("tacocat.debug",{},{metadata:!1}),!1);function In(e){let r=`[${Ln}/${e}]`,t=(s,o,...c)=>s?!0:(i(o,...c),!1),a=Fc?(s,...o)=>{console.debug(`${r} ${s}`,...o,Na())}:()=>{},i=(s,...o)=>{let c=`${r} ${s}`;Ar.forEach(([l])=>l(c,...o))};return{assert:t,debug:a,error:i,warn:(s,...o)=>{let c=`${r} ${s}`;Ar.forEach(([,l])=>l(c,...o))}}}function Uc(e,r){let t=[e,r];return Ar.add(t),()=>{Ar.delete(t)}}Uc((e,...r)=>{console.error(e,...r,Na())},(e,...r)=>{console.warn(e,...r,Na())});var $c="no promo",Dn="promo-tag",Gc="yellow",qc="neutral",Vc=(e,r,t)=>{let a=n=>n||$c,i=t?` (was "${a(r)}")`:"";return`${a(e)}${i}`},Cr="cancel-context",Tr=(e,r)=>{let t=e===Cr,a=!t&&e?.length>0,i=(a||t)&&(r&&r!=e||!r&&!t),n=i&&a||!i&&!!r,s=n?e||r:void 0;return{effectivePromoCode:s,overridenPromoCode:e,className:n?Dn:`${Dn} no-promo`,text:Vc(s,r,i),variant:n?Gc:qc,isOverriden:i}};var Ia;(function(e){e.BASE="BASE",e.TRIAL="TRIAL",e.PROMOTION="PROMOTION"})(Ia||(Ia={}));var le;(function(e){e.MONTH="MONTH",e.YEAR="YEAR",e.TWO_YEARS="TWO_YEARS",e.THREE_YEARS="THREE_YEARS",e.PERPETUAL="PERPETUAL",e.TERM_LICENSE="TERM_LICENSE",e.ACCESS_PASS="ACCESS_PASS",e.THREE_MONTHS="THREE_MONTHS",e.SIX_MONTHS="SIX_MONTHS"})(le||(le={}));var pe;(function(e){e.ANNUAL="ANNUAL",e.MONTHLY="MONTHLY",e.TWO_YEARS="TWO_YEARS",e.THREE_YEARS="THREE_YEARS",e.P1D="P1D",e.P1Y="P1Y",e.P3Y="P3Y",e.P10Y="P10Y",e.P15Y="P15Y",e.P3D="P3D",e.P7D="P7D",e.P30D="P30D",e.HALF_YEARLY="HALF_YEARLY",e.QUARTERLY="QUARTERLY"})(pe||(pe={}));var Da;(function(e){e.INDIVIDUAL="INDIVIDUAL",e.TEAM="TEAM",e.ENTERPRISE="ENTERPRISE"})(Da||(Da={}));var za;(function(e){e.COM="COM",e.EDU="EDU",e.GOV="GOV"})(za||(za={}));var Ha;(function(e){e.DIRECT="DIRECT",e.INDIRECT="INDIRECT"})(Ha||(Ha={}));var Ba;(function(e){e.ENTERPRISE_PRODUCT="ENTERPRISE_PRODUCT",e.ETLA="ETLA",e.RETAIL="RETAIL",e.VIP="VIP",e.VIPMP="VIPMP",e.FREE="FREE"})(Ba||(Ba={}));var Fa="ABM",Ua="PUF",$a="M2M",Ga="PERPETUAL",qa="P3Y",jc="TAX_INCLUSIVE_DETAILS",Wc="TAX_EXCLUSIVE",zn={ABM:Fa,PUF:Ua,M2M:$a,PERPETUAL:Ga,P3Y:qa},cu={[Fa]:{commitment:le.YEAR,term:pe.MONTHLY},[Ua]:{commitment:le.YEAR,term:pe.ANNUAL},[$a]:{commitment:le.MONTH,term:pe.MONTHLY},[Ga]:{commitment:le.PERPETUAL,term:void 0},[qa]:{commitment:le.THREE_MONTHS,term:pe.P3Y}},Hn="Value is not an offer",kr=e=>{if(typeof e!="object")return Hn;let{commitment:r,term:t}=e,a=Yc(r,t);return{...e,planType:a}};var Yc=(e,r)=>{switch(e){case void 0:return Hn;case"":return"";case le.YEAR:return r===pe.MONTHLY?Fa:r===pe.ANNUAL?Ua:"";case le.MONTH:return r===pe.MONTHLY?$a:"";case le.PERPETUAL:return Ga;case le.TERM_LICENSE:return r===pe.P3Y?qa:"";default:return""}};function Bn(e){let{priceDetails:r}=e,{price:t,priceWithoutDiscount:a,priceWithoutTax:i,priceWithoutDiscountAndTax:n,taxDisplay:s}=r;if(s!==jc)return e;let o={...e,priceDetails:{...r,price:i??t,priceWithoutDiscount:n??a,taxDisplay:Wc}};return o.offerType==="TRIAL"&&o.priceDetails.price===0&&(o.priceDetails.price=o.priceDetails.priceWithoutDiscount),o}var Ve={clientId:"merch-at-scale",delimiter:"\xB6",ignoredProperties:["analytics","literals","element"],serializableTypes:["Array","Object"],sampleRate:1,severity:"e",tags:"acom",isProdDomain:!1},Fn=1e3;function Xc(e){return e instanceof Error||typeof e?.originatingRequest=="string"}function Un(e){if(e==null)return;let r=typeof e;if(r==="function")return e.name?`function ${e.name}`:"function";if(r==="object"){if(e instanceof Error)return e.message;if(typeof e.originatingRequest=="string"){let{message:a,originatingRequest:i,status:n}=e;return[a,n,i].filter(Boolean).join(" ")}let t=e[Symbol.toStringTag]??Object.getPrototypeOf(e).constructor.name;if(!Ve.serializableTypes.includes(t))return t}return e}function Kc(e,r){if(!Ve.ignoredProperties.includes(e))return Un(r)}var Va={append(e){if(e.level!=="error")return;let{message:r,params:t}=e,a=[],i=[],n=r;t.forEach(l=>{l!=null&&(Xc(l)?a:i).push(l)}),a.length&&(n+=` ${a.map(Un).join(" ")}`);let{pathname:s,search:o}=window.location,c=`${Ve.delimiter}page=${s}${o}`;c.length>Fn&&(c=`${c.slice(0,Fn)}<trunc>`),n+=c,i.length&&(n+=`${Ve.delimiter}facts=`,n+=JSON.stringify(i,Kc)),window.lana?.log(n,Ve)}};function _r(e){Object.assign(Ve,Object.fromEntries(Object.entries(e).filter(([r,t])=>r in Ve&&t!==""&&t!==null&&t!==void 0&&!Number.isNaN(t))))}var $n={LOCAL:"local",PROD:"prod",STAGE:"stage"},ja={DEBUG:"debug",ERROR:"error",INFO:"info",WARN:"warn"},Wa=new Set,Ya=new Set,Gn=new Map,qn={append({level:e,message:r,params:t,timestamp:a,source:i}){console[e](`${a}ms [${i}] %c${r}`,"font-weight: bold;",...t)}},Vn={filter:({level:e})=>e!==ja.DEBUG},Zc={filter:()=>!1};function Qc(e,r,t,a,i){return{level:e,message:r,namespace:t,get params(){return a.length===1&&wr(a[0])&&(a=a[0](),Array.isArray(a)||(a=[a])),a},source:i,timestamp:performance.now().toFixed(3)}}function Jc(e){[...Ya].every(r=>r(e))&&Wa.forEach(r=>r(e))}function jn(e){let r=(Gn.get(e)??0)+1;Gn.set(e,r);let t=`${e} #${r}`,a={id:t,namespace:e,module:i=>jn(`${a.namespace}/${i}`),updateConfig:_r};return Object.values(ja).forEach(i=>{a[i]=(n,...s)=>Jc(Qc(i,n,e,s,t))}),Object.seal(a)}function Pr(...e){e.forEach(r=>{let{append:t,filter:a}=r;wr(a)&&Ya.add(a),wr(t)&&Wa.add(t)})}function el(e={}){let{name:r}=e,t=E(H("commerce.debug",{search:!0,storage:!0}),r===$n.LOCAL);return Pr(t?qn:Vn),r===$n.PROD&&Pr(Va),oe}function tl(){Wa.clear(),Ya.clear()}var oe={...jn(da),Level:ja,Plugins:{consoleAppender:qn,debugFilter:Vn,quietFilter:Zc,lanaAppender:Va},init:el,reset:tl,use:Pr};var rl="mas-commerce-service",al=oe.module("utilities"),il={requestId:Pt,etag:"Etag",lastModified:"Last-Modified",serverTiming:"server-timing"};function qt(e,{country:r,forceTaxExclusive:t}){let a;if(e.length<2)a=e;else{let i=r==="GB"?"EN":"MULT";e.sort((n,s)=>n.language===i?-1:s.language===i?1:0),e.sort((n,s)=>!n.term&&s.term?-1:n.term&&!s.term?1:0),a=[e[0]]}return t&&(a=a.map(Bn)),a}var Wn=(e,r)=>{let t=e.reduce((a,i)=>a+(r(i)||0),0);return t>0?Math.round(t*100)/100:void 0};function Xa(e){if(!e||e.length===0)return null;if(e.length===1)return e[0];let[r,...t]=e;for(let o of t){let c=[["commitment","commitment types"],["term","terms"],["priceDetails.formatString","currency formats"]];for(let[l,d]of c){let p=l.includes(".")?r.priceDetails?.formatString:r[l],m=l.includes(".")?o.priceDetails?.formatString:o[l];m!==p&&al.warn(`Offers have different ${d}, summing may produce unexpected results`,{expected:p,actual:m})}}let a=[["price",o=>o.priceDetails?.price],["priceWithoutDiscount",o=>o.priceDetails?.priceWithoutDiscount],["priceWithoutTax",o=>o.priceDetails?.priceWithoutTax],["priceWithoutDiscountAndTax",o=>o.priceDetails?.priceWithoutDiscountAndTax]],i={};for(let[o,c]of a){let l=Wn(e,c);l!==void 0&&(i[o]=l)}let n=e.some(o=>o.priceDetails?.annualized),s;if(n){let o=[["annualizedPrice",c=>c.priceDetails?.annualized?.annualizedPrice],["annualizedPriceWithoutTax",c=>c.priceDetails?.annualized?.annualizedPriceWithoutTax],["annualizedPriceWithoutDiscount",c=>c.priceDetails?.annualized?.annualizedPriceWithoutDiscount],["annualizedPriceWithoutDiscountAndTax",c=>c.priceDetails?.annualized?.annualizedPriceWithoutDiscountAndTax]];s={};for(let[c,l]of o){let d=Wn(e,l);d!==void 0&&(s[c]=d)}}return{...r,offerSelectorIds:e.flatMap(o=>o.offerSelectorIds||[]),priceDetails:{...r.priceDetails,...i,...s&&{annualized:s}}}}var Lr=e=>window.setTimeout(e);function bt(e,r=1){if(e==null)return[r];let t=(Array.isArray(e)?e:String(e).split(",")).map(Nn).filter(xt);return t.length||(t=[r]),t}function Mr(e){return e==null?[]:(Array.isArray(e)?e:String(e).split(",")).filter(On)}function se(){return document.getElementsByTagName(rl)?.[0]}function Yn(e){let r={};if(!e?.headers)return r;let t=e.headers;for(let[a,i]of Object.entries(il)){let n=t.get(i);n&&(n=n.replace(/[,;]/g,"|"),n=n.replace(/[| ]+/g,"|"),r[a]=n)}return r}var yt=class e extends Error{constructor(r,t,a){if(super(r,{cause:a}),this.name="MasError",t.response){let i=t.response.headers?.get(Pt);i&&(t.requestId=i),t.response.status&&(t.status=t.response.status,t.statusText=t.response.statusText),t.response.url&&(t.url=t.response.url)}delete t.response,this.context=t,Error.captureStackTrace&&Error.captureStackTrace(this,e)}toString(){let r=Object.entries(this.context||{}).map(([a,i])=>`${a}: ${JSON.stringify(i)}`).join(", "),t=`${this.name}: ${this.message}`;return r&&(t+=` (${r})`),this.cause&&(t+=`
Caused by: ${this.cause}`),t}};var nl={[ue]:ia,[Re]:na,[Ae]:oa},ol={[ue]:la,[Ae]:Se},Vt,ze=class{constructor(r){M(this,Vt);g(this,"changes",new Map);g(this,"connected",!1);g(this,"error");g(this,"log");g(this,"options");g(this,"promises",[]);g(this,"state",Re);g(this,"timer",null);g(this,"value");g(this,"version",0);g(this,"wrapperElement");this.wrapperElement=r,this.log=oe.module("mas-element")}update(){[ue,Re,Ae].forEach(r=>{this.wrapperElement.classList.toggle(nl[r],r===this.state)})}notify(){(this.state===Ae||this.state===ue)&&(this.state===Ae?this.promises.forEach(({resolve:t})=>t(this.wrapperElement)):this.state===ue&&this.promises.forEach(({reject:t})=>t(this.error)),this.promises=[]);let r=this.error;this.error instanceof yt&&(r={message:this.error.message,...this.error.context}),this.wrapperElement.dispatchEvent(new CustomEvent(ol[this.state],{bubbles:!0,composed:!0,detail:r}))}attributeChangedCallback(r,t,a){this.changes.set(r,a),this.requestUpdate()}connectedCallback(){T(this,Vt,se()),this.requestUpdate(!0)}disconnectedCallback(){this.connected&&(this.connected=!1,this.log?.debug("Disconnected:",{element:this.wrapperElement}))}onceSettled(){let{error:r,promises:t,state:a}=this;return Ae===a?Promise.resolve(this.wrapperElement):ue===a?Promise.reject(r):new Promise((i,n)=>{t.push({resolve:i,reject:n})})}toggleResolved(r,t,a){return r!==this.version?!1:(a!==void 0&&(this.options=a),this.state=Ae,this.value=t,this.update(),this.log?.debug("Resolved:",{element:this.wrapperElement,value:t}),Lr(()=>this.notify()),!0)}toggleFailed(r,t,a){if(r!==this.version)return!1;a!==void 0&&(this.options=a),this.error=t,this.state=ue,this.update();let i=this.wrapperElement.getAttribute("is");return this.log?.error(`${i}: Failed to render: ${t.message}`,{element:this.wrapperElement,...t.context,...v(this,Vt)?.duration}),Lr(()=>this.notify()),!0}togglePending(r){return this.version++,r&&(this.options=r),this.state=Re,this.update(),this.log?.debug("Pending:",{osi:this.wrapperElement?.options?.wcsOsi}),this.version}requestUpdate(r=!1){if(!this.wrapperElement.isConnected||!se()||this.timer)return;let{error:t,options:a,state:i,value:n,version:s}=this;this.state=Re,this.timer=Lr(async()=>{this.timer=null;let o=null;if(this.changes.size&&(o=Object.fromEntries(this.changes.entries()),this.changes.clear()),this.connected?this.log?.debug("Updated:",{element:this.wrapperElement,changes:o}):(this.connected=!0,this.log?.debug("Connected:",{element:this.wrapperElement,changes:o})),o||r)try{await this.wrapperElement.render?.()===!1&&this.state===Re&&this.version===s&&(this.state=i,this.error=t,this.value=n,this.update(),this.notify())}catch(c){this.toggleFailed(this.version,c,a)}})}};Vt=new WeakMap;function Xn(e={}){return Object.entries(e).forEach(([r,t])=>{(t==null||t===""||t?.length===0)&&delete e[r]}),e}function Rr(e,r={}){let{tag:t,is:a}=e,i=document.createElement(t,{is:a});return i.setAttribute("is",a),Object.assign(i.dataset,Xn(r)),i}function Kn(e,r={}){return e instanceof HTMLElement?(Object.assign(e.dataset,Xn(r)),e):null}function sl(e){return`https://${e==="PRODUCTION"?"www.adobe.com":"www.stage.adobe.com"}/offers/promo-terms.html`}var Ye,je=class je extends HTMLAnchorElement{constructor(){super();g(this,"masElement",new ze(this));M(this,Ye);this.setAttribute("is",je.is)}get isUptLink(){return!0}initializeWcsData(t,a){this.setAttribute("data-wcs-osi",t),a&&this.setAttribute("data-promotion-code",a)}attributeChangedCallback(t,a,i){this.masElement.attributeChangedCallback(t,a,i)}connectedCallback(){this.masElement.connectedCallback(),T(this,Ye,Mt()),v(this,Ye)&&(this.log=v(this,Ye).log.module("upt-link"))}disconnectedCallback(){this.masElement.disconnectedCallback(),T(this,Ye,void 0)}requestUpdate(t=!1){this.masElement.requestUpdate(t)}onceSettled(){return this.masElement.onceSettled()}async render(){let t=Mt();if(!t)return!1;this.dataset.imsCountry||t.imsCountryPromise.then(s=>{s&&(this.dataset.imsCountry=s)});let a=t.collectCheckoutOptions({},this);if(!a.wcsOsi)return this.log.error("Missing 'data-wcs-osi' attribute on upt-link."),!1;let i=this.masElement.togglePending(a),n=t.resolveOfferSelectors(a);try{let[[s]]=await Promise.all(n),{country:o,language:c,env:l}=a,d=`locale=${c}_${o}&country=${o}&offer_id=${s.offerId}`,p=this.getAttribute("data-promotion-code");p&&(d+=`&promotion_code=${encodeURIComponent(p)}`),this.href=`${sl(l)}?${d}`,this.masElement.toggleResolved(i,s,a)}catch(s){let o=new Error(`Could not resolve offer selectors for id: ${a.wcsOsi}.`,s.message);return this.masElement.toggleFailed(i,o,a),!1}}static createFrom(t){let a=new je;for(let i of t.attributes)i.name!=="is"&&(i.name==="class"&&i.value.includes("upt-link")?a.setAttribute("class",i.value.replace("upt-link","").trim()):a.setAttribute(i.name,i.value));return a.innerHTML=t.innerHTML,a.setAttribute("tabindex",0),a}};Ye=new WeakMap,g(je,"is","upt-link"),g(je,"tag","a"),g(je,"observedAttributes",["data-wcs-osi","data-promotion-code","data-ims-country"]);var We=je;window.customElements.get(We.is)||window.customElements.define(We.is,We,{extends:We.tag});function Zn(e){return e&&(e==="bizpro"&&(e="pro"),e==="pro"||e.startsWith("plans")?"plans":e)}var cl="p_draft_landscape",ll="/store/",dl=new Map([["countrySpecific","cs"],["customerSegment","cs"],["quantity","q"],["authCode","code"],["checkoutPromoCode","apc"],["rurl","rUrl"],["curl","cUrl"],["ctxrturl","ctxRtUrl"],["country","co"],["language","lang"],["clientId","cli"],["context","ctx"],["productArrangementCode","pa"],["addonProductArrangementCode","ao"],["offerType","ot"],["marketSegment","ms"]]),Ka=new Set(["af","ai","ao","apc","appctxid","cli","co","cs","csm","ctx","ctxRtUrl","DCWATC","dp","fr","gsp","ijt","lang","lo","mal","ms","mv","mv2","nglwfdata","ot","otac","pa","pcid","promoid","q","rf","sc","scl","sdid","sid","spint","svar","th","thm","trackingid","usid","workflowid","context.guid","so.ca","so.su","so.tr","so.va"]),hl=["env","workflowStep","clientId","country"],pl=["/tw/","/hk_zh/"];function ml(e){let r=e??"";return pl.some(t=>r.startsWith(t))}function ul(){if(typeof window>"u")return!1;let e=[window.location.pathname];try{window.parent!==window&&e.push(window.parent.location.pathname)}catch{}return e.some(ml)}function Za(e){if(!ul())return e instanceof URL?e.toString():String(e);let r;try{r=e instanceof URL?e:new URL(e)}catch{return String(e)}r.searchParams.set("lang","zh-Hant");for(let t of[...r.searchParams.keys()])/^items\[\d+]\[lang]$/.test(t)&&r.searchParams.set(t,"zh-Hant");return r.toString()}var Qn=new Set(["gid","gtoken","notifauditid","cohortid","productname","sdid","attimer","gcsrc","gcprog","gcprogcat","gcpagetype","mv","mv2"]),Jn=e=>dl.get(e)??e;function Or(e,r,t){for(let[a,i]of Object.entries(e)){let n=Jn(a);i!=null&&t.has(n)&&r.set(n,i)}}function gl(e){switch(e){case fa.PRODUCTION:return"https://commerce.adobe.com";default:return"https://commerce-stg.adobe.com"}}function fl(e,r){for(let t in e){let a=e[t];for(let[i,n]of Object.entries(a)){if(n==null)continue;let s=Jn(i);r.set(`items[${t}][${s}]`,n)}}}function vl({url:e,modal:r,is3in1:t}){if(!t||!e?.searchParams)return e;e.searchParams.set("rtc","t"),e.searchParams.set("lo","sl");let a=e.searchParams.get("af");return e.searchParams.set("af",[a,"uc_new_user_iframe","uc_new_system_close"].filter(Boolean).join(",")),e.searchParams.get("cli")!=="doc_cloud"&&e.searchParams.set("cli",r===$e.CRM?"creative":"mini_plans"),e}function xl(e){let r=new URLSearchParams(window.location.search),t={};Qn.forEach(a=>{let i=r.get(a);i!==null&&(t[a]=i)}),Object.keys(t).length>0&&Or(t,e.searchParams,Qn)}function eo(e){bl(e);let{env:r,items:t,workflowStep:a,marketSegment:i,customerSegment:n,offerType:s,productArrangementCode:o,landscape:c,modal:l,is3in1:d,preselectPlan:p,...m}=e,h=new URL(gl(r));if(h.pathname=`${ll}${a}`,a!==ie.SEGMENTATION&&a!==ie.CHANGE_PLAN_TEAM_PLANS&&fl(t,h.searchParams),Or({...m},h.searchParams,Ka),xl(h),c===Oe.DRAFT&&Or({af:cl},h.searchParams,Ka),a===ie.SEGMENTATION){let u={marketSegment:i,offerType:s,customerSegment:n,productArrangementCode:o,quantity:t?.[0]?.quantity,addonProductArrangementCode:o?t?.find(f=>f.productArrangementCode!==o)?.productArrangementCode:t?.[1]?.productArrangementCode};p?.toLowerCase()==="edu"?h.searchParams.set("ms","EDU"):p?.toLowerCase()==="team"&&h.searchParams.set("cs","TEAM"),Or(u,h.searchParams,Ka),h.searchParams.get("ot")==="PROMOTION"&&h.searchParams.delete("ot"),h=vl({url:h,modal:l,is3in1:d})}return Za(h)}function bl(e){for(let r of hl)if(!e[r])throw new Error(`Argument "checkoutData" is not valid, missing: ${r}`);if(e.workflowStep!==ie.SEGMENTATION&&e.workflowStep!==ie.CHANGE_PLAN_TEAM_PLANS&&!e.items)throw new Error('Argument "checkoutData" is not valid, missing: items');return!0}var yl=/[0-9\-+#]/,wl=/[^\d\-+#]/g;function to(e){return e.search(yl)}function El(e="#.##"){let r={},t=e.length,a=to(e);r.prefix=a>0?e.substring(0,a):"";let i=to(e.split("").reverse().join("")),n=t-i,s=e.substring(n,n+1),o=n+(s==="."||s===","?1:0);r.suffix=i>0?e.substring(o,t):"",r.mask=e.substring(a,o),r.maskHasNegativeSign=r.mask.charAt(0)==="-",r.maskHasPositiveSign=r.mask.charAt(0)==="+";let c=r.mask.match(wl);return r.decimal=c&&c[c.length-1]||".",r.separator=c&&c[1]&&c[0]||",",c=r.mask.split(r.decimal),r.integer=c[0],r.fraction=c[1],r}function Sl(e,r,t){let a=!1,i={value:e};e<0&&(a=!0,i.value=-i.value),i.sign=a?"-":"",i.value=Number(i.value).toFixed(r.fraction&&r.fraction.length),i.value=Number(i.value).toString();let n=r.fraction&&r.fraction.lastIndexOf("0"),[s="0",o=""]=i.value.split(".");return(!o||o&&o.length<=n)&&(o=n<0?"":(+`0.${o}`).toFixed(n+1).replace("0.","")),i.integer=s,i.fraction=o,Al(i,r),(i.result==="0"||i.result==="")&&(a=!1,i.sign=""),!a&&r.maskHasPositiveSign?i.sign="+":a&&r.maskHasPositiveSign?i.sign="-":a&&(i.sign=t&&t.enforceMaskSign&&!r.maskHasNegativeSign?"":"-"),i}function Al(e,r){e.result="";let t=r.integer.split(r.separator),a=t.join(""),i=a&&a.indexOf("0");if(i>-1)for(;e.integer.length<a.length-i;)e.integer=`0${e.integer}`;else Number(e.integer)===0&&(e.integer="");let n=t[1]&&t[t.length-1].length;if(n){let s=e.integer.length,o=s%n;for(let c=0;c<s;c++)e.result+=e.integer.charAt(c),!((c-o+1)%n)&&c<s-n&&(e.result+=r.separator)}else e.result=e.integer;return e.result+=r.fraction&&e.fraction?r.decimal+e.fraction:"",e}function Cl(e,r,t={}){if(!e||isNaN(Number(r)))return r;let a=El(e),i=Sl(r,a,t);return a.prefix+i.sign+i.result+a.suffix}var ro=Cl;var ao=".",Tl=",",no=/^\s+/,oo=/\s+$/,io="&nbsp;",Qa=e=>e*12,Ke=(e,r,t=1)=>{if(!e)return!1;let{start:a,end:i,displaySummary:{amount:n,duration:s,minProductQuantity:o=1,outcomeType:c}={}}=e;if(!(n&&s&&c)||t<o)return!1;let l=r?new Date(r):new Date;if(!a||!i)return!1;let d=new Date(a),p=new Date(i);return l>=d&&l<=p},Xe={MONTH:"MONTH",YEAR:"YEAR"},kl={[he.ANNUAL]:12,[he.MONTHLY]:1,[he.THREE_YEARS]:36,[he.TWO_YEARS]:24},Ja=(e,r)=>({accept:e,round:r}),_l=[Ja(({divisor:e,price:r})=>r%e==0,({divisor:e,price:r})=>r/e),Ja(({usePrecision:e})=>e,({divisor:e,price:r})=>Math.round(r/e*100)/100),Ja(()=>!0,({divisor:e,price:r})=>Math.ceil(Math.floor(r*100/e)/100))],ei={[Ue.YEAR]:{[he.MONTHLY]:Xe.MONTH,[he.ANNUAL]:Xe.YEAR},[Ue.MONTH]:{[he.MONTHLY]:Xe.MONTH}},Pl=(e,r)=>e.indexOf(`'${r}'`)===0,Ll=(e,r=!0)=>{let t=e.replace(/'.*?'/,"").trim(),a=co(t);return!!a?r||(t=t.replace(/[,\.]0+/,a)):t=t.replace(/\s?(#.*0)(?!\s)?/,`$&${Rl(e)}`),t},Ml=e=>{let r=Ol(e),t=Pl(e,r),a=e.replace(/'.*?'/,""),i=no.test(a)||oo.test(a);return{currencySymbol:r,isCurrencyFirst:t,hasCurrencySpace:i}},so=e=>e.replace(no,io).replace(oo,io),Rl=e=>e.match(/#(.?)#/)?.[1]===ao?Tl:ao,Ol=e=>e.match(/'(.*?)'/)?.[1]??"",co=e=>e.match(/0(.?)0/)?.[1]??"";function wt({formatString:e,price:r,usePrecision:t,isIndianPrice:a=!1},i,n=s=>s){let{currencySymbol:s,isCurrencyFirst:o,hasCurrencySpace:c}=Ml(e),l=t?co(e):"",d=Ll(e,t),p=t?2:0,m=n(r,{currencySymbol:s}),h=a?m.toLocaleString("hi-IN",{minimumFractionDigits:p,maximumFractionDigits:p}):ro(d,m),u=t?h.lastIndexOf(l):h.length,f=h.substring(0,u),x=h.substring(u+1);return{accessiblePrice:e.replace(/'.*?'/,"SYMBOL").replace(/#.*0/,h).replace(/SYMBOL/,s),currencySymbol:s,decimals:x,decimalsDelimiter:l,hasCurrencySpace:c,integer:f,isCurrencyFirst:o,recurrenceTerm:i}}var lo=e=>{let{commitment:r,term:t,usePrecision:a}=e,i=kl[t]??1;return wt(e,i>1?Xe.MONTH:ei[r]?.[t],n=>{let s={divisor:i,price:n,usePrecision:a},{round:o}=_l.find(({accept:c})=>c(s));if(!o)throw new Error(`Missing rounding rule for: ${JSON.stringify(s)}`);return o(s)})},ho=({commitment:e,term:r,...t})=>wt(t,ei[e]?.[r]),po=e=>{let{commitment:r,instant:t,price:a,originalPrice:i,priceWithoutDiscount:n,promotion:s,quantity:o=1,term:c}=e;if(r===Ue.YEAR&&c===he.MONTHLY){if(!s)return wt(e,Xe.YEAR,Qa);let{displaySummary:{outcomeType:l,duration:d}={}}=s;switch(l){case"PERCENTAGE_DISCOUNT":if(Ke(s,t,o)){let p=parseInt(d.replace("P","").replace("M",""));if(isNaN(p))return Qa(a);let m=i*p,h=n*(12-p),u=Math.round((m+h)*100)/100;return wt({...e,price:u},Xe.YEAR)}default:return wt(e,Xe.YEAR,()=>Qa(n??a))}}return wt(e,ei[r]?.[c])};var mo="download",uo="upgrade",go={e:"EDU",t:"TEAM"};function fo(e,r={},t=""){let a=se();if(!a)return null;let{checkoutMarketSegment:i,checkoutWorkflow:n,checkoutWorkflowStep:s,entitlement:o,upgrade:c,modal:l,perpetual:d,promotionCode:p,quantity:m,wcsOsi:h,extraOptions:u,analyticsId:f}=a.collectCheckoutOptions(r),x=Rr(e,{checkoutMarketSegment:i,checkoutWorkflow:n,checkoutWorkflowStep:s,entitlement:o,upgrade:c,modal:l,perpetual:d,promotionCode:r.promotionCode===Cr?Cr:p,quantity:m,wcsOsi:h,extraOptions:u,analyticsId:f});return t&&(x.innerHTML=`<span style="pointer-events: none;">${t}</span>`),x}function vo(e){return class extends e{constructor(){super(...arguments);g(this,"checkoutActionHandler");g(this,"masElement",new ze(this))}attributeChangedCallback(a,i,n){this.masElement.attributeChangedCallback(a,i,n)}connectedCallback(){this.masElement.connectedCallback(),this.addEventListener("click",this.clickHandler)}disconnectedCallback(){this.masElement.disconnectedCallback(),this.removeEventListener("click",this.clickHandler)}onceSettled(){return this.masElement.onceSettled()}get value(){return this.masElement.value}get options(){return this.masElement.options}get marketSegment(){let a=this.options?.ms??this.value?.[0].marketSegments?.[0];return go[a]??a}get customerSegment(){let a=this.options?.cs??this.value?.[0]?.customerSegment;return go[a]??a}get is3in1Modal(){return Object.values($e).includes(this.getAttribute("data-modal"))}get isOpen3in1Modal(){let a=document.querySelector("meta[name=mas-ff-3in1]");return this.is3in1Modal&&(!a||a.content!=="off")}requestUpdate(a=!1){return this.masElement.requestUpdate(a)}static get observedAttributes(){return["data-checkout-workflow","data-checkout-workflow-step","data-extra-options","data-ims-country","data-perpetual","data-promotion-code","data-quantity","data-template","data-wcs-osi","data-entitlement","data-upgrade","data-modal"]}async render(a={}){let i=se();if(!i)return!1;this.dataset.imsCountry||i.imsCountryPromise.then(h=>{h&&(this.dataset.imsCountry=h)}),a.imsCountry=null;let n=i.collectCheckoutOptions(a,this);if(!n.wcsOsi.length)return!1;let s;try{s=JSON.parse(n.extraOptions??"{}")}catch(h){this.masElement.log?.error("cannot parse exta checkout options",h)}let o=this.masElement.togglePending(n);this.setCheckoutUrl("");let c=i.resolveOfferSelectors(n),l=await Promise.all(c);l=l.map(h=>qt(h,n));let d=l.flat().find(h=>h.promotion);!Ke(d?.promotion,d?.promotion?.displaySummary?.instant,n.quantity[0])&&n.promotionCode&&delete n.promotionCode,n.country=this.dataset.imsCountry||n.country;let m=await i.buildCheckoutAction?.(l.flat(),{...s,...n},this);return this.renderOffers(l.flat(),n,{},m,o)}renderOffers(a,i,n={},s=void 0,o=void 0){let c=se();if(!c)return!1;if(i={...JSON.parse(this.dataset.extraOptions??"{}"),...i,...n},o??(o=this.masElement.togglePending(i)),this.checkoutActionHandler&&(this.checkoutActionHandler=void 0),s){this.classList.remove(mo,uo),this.masElement.toggleResolved(o,a,i);let{url:d,text:p,className:m,handler:h}=s;d&&this.setCheckoutUrl(Za(d)),p&&(this.firstElementChild.innerHTML=p),m&&this.classList.add(...m.split(" ")),h&&(this.setCheckoutUrl("#"),this.checkoutActionHandler=h.bind(this))}if(a.length){if(this.masElement.toggleResolved(o,a,i)){if(!this.classList.contains(mo)&&!this.classList.contains(uo)){let d=c.buildCheckoutURL(a,i);this.setCheckoutUrl(i.modal==="true"?"#":d)}return!0}}else{let d=new Error(`Not provided: ${i?.wcsOsi??"-"}`);if(this.masElement.toggleFailed(o,d,i))return this.setCheckoutUrl("#"),!0}}setCheckoutUrl(){}clickHandler(a){}updateOptions(a={}){let i=se();if(!i)return!1;let{checkoutMarketSegment:n,checkoutWorkflow:s,checkoutWorkflowStep:o,entitlement:c,upgrade:l,modal:d,perpetual:p,promotionCode:m,quantity:h,wcsOsi:u}=i.collectCheckoutOptions(a);return Kn(this,{checkoutMarketSegment:n,checkoutWorkflow:s,checkoutWorkflowStep:o,entitlement:c,upgrade:l,modal:d,perpetual:p,promotionCode:m,quantity:h,wcsOsi:u}),!0}}}var jt=class jt extends vo(HTMLAnchorElement){static createCheckoutLink(r={},t=""){return fo(jt,r,t)}setCheckoutUrl(r){this.setAttribute("href",r)}get isCheckoutLink(){return!0}clickHandler(r){if(this.checkoutActionHandler){this.checkoutActionHandler?.(r);return}}};g(jt,"is","checkout-link"),g(jt,"tag","a");var _e=jt;window.customElements.get(_e.is)||window.customElements.define(_e.is,_e,{extends:_e.tag});var R=Object.freeze({checkoutClientId:"adobe_com",checkoutWorkflowStep:ie.EMAIL,country:"US",displayOldPrice:!0,displayPerUnit:!1,displayRecurrence:!0,displayTax:!1,displayPlanType:!1,env:ve.PRODUCTION,forceTaxExclusive:!1,language:"en",entitlement:!1,extraOptions:{},modal:!1,promotionCode:"",quantity:1,alternativePrice:!1,wcsApiKey:"wcms-commerce-ims-ro-user-milo",wcsURL:"https://www.adobe.com/web_commerce_artifact",landscape:Oe.PUBLISHED});function xo({settings:e,providers:r}){function t(n,s){let{checkoutClientId:o,checkoutWorkflowStep:c,country:l,language:d,promotionCode:p,quantity:m,preselectPlan:h,env:u}=e,f={checkoutClientId:o,checkoutWorkflowStep:c,country:l,language:d,promotionCode:p,quantity:m,preselectPlan:h,env:u};if(s)for(let tt of r.checkout)tt(s,f);let{checkoutMarketSegment:x,checkoutWorkflowStep:y=c,imsCountry:A,country:b=A??l,language:C=d,quantity:z=m,entitlement:N,upgrade:U,modal:V,perpetual:J,promotionCode:Z=p,wcsOsi:F,extraOptions:O,...re}=Object.assign(f,s?.dataset??{},n??{}),de=Gt(y,ie,R.checkoutWorkflowStep);return f=Sr({...re,extraOptions:O,checkoutClientId:o,checkoutMarketSegment:x,country:b,quantity:bt(z,R.quantity),checkoutWorkflowStep:de,language:C,entitlement:E(N),upgrade:E(U),modal:V,perpetual:E(J),promotionCode:Tr(Z).effectivePromoCode,wcsOsi:Mr(F),preselectPlan:h}),f}function a(n,s){if(!Array.isArray(n)||!n.length||!s)return"";let{env:o,landscape:c}=e,{checkoutClientId:l,checkoutMarketSegment:d,checkoutWorkflowStep:p,country:m,promotionCode:h,quantity:u,preselectPlan:f,ms:x,cs:y,...A}=t(s),b=document.querySelector("meta[name=mas-ff-3in1]"),C=Object.values($e).includes(s.modal)&&(!b||b.content!=="off"),z=window.frameElement||C?"if":"fp",[{productArrangementCode:N,marketSegments:[U],customerSegment:V,offerType:J}]=n,Z=x??U??d,F=y??V;f?.toLowerCase()==="edu"?Z="EDU":f?.toLowerCase()==="team"&&(F="TEAM");let O={is3in1:C,checkoutPromoCode:h,clientId:l,context:z,country:m,env:o,items:[],marketSegment:Z,customerSegment:F,offerType:J,productArrangementCode:N,workflowStep:p,landscape:c,...A},re=u[0]>1?u[0]:void 0;if(n.length===1){let{offerId:de}=n[0];O.items.push({id:de,quantity:re})}else O.items.push(...n.map(({offerId:de,productArrangementCode:tt})=>({id:de,quantity:re,...C?{productArrangementCode:tt}:{}})));return eo(O)}let{createCheckoutLink:i}=_e;return{CheckoutLink:_e,CheckoutWorkflowStep:ie,buildCheckoutURL:a,collectCheckoutOptions:t,createCheckoutLink:i}}function Nl({interval:e=200,maxAttempts:r=25}={}){let t=oe.module("ims");return new Promise(a=>{t.debug("Waing for IMS to be ready");let i=0;function n(){window.adobeIMS?.initialized?a():++i>r?(t.debug("Timeout"),a()):setTimeout(n,e)}n()})}function Il(e){return e.then(()=>window.adobeIMS?.isSignedInUser()??!1)}function Dl(e){let r=oe.module("ims");return e.then(t=>t?window.adobeIMS.getProfile().then(({countryCode:a})=>(r.debug("Got user country:",a),a),a=>{r.error("Unable to get user country:",a)}):null)}function bo({}){let e=Nl(),r=Il(e),t=Dl(r);return{imsReadyPromise:e,imsSignedInPromise:r,imsCountryPromise:t}}var yo=window.masPriceLiterals;function wo(e){if(Array.isArray(yo)){let r;switch(e.locale){case"id_ID":r="in";break;case"zh_TW":r="zh-hant";break;case"zh_HK":r="zh-hant";break;default:r=e.language}let t=i=>yo.find(n=>Oa(n.lang,i)),a=t(r)??t(R.language);if(a)return Object.freeze(a)}return{}}var ti=function(e,r){return ti=Object.setPrototypeOf||{__proto__:[]}instanceof Array&&function(t,a){t.__proto__=a}||function(t,a){for(var i in a)Object.prototype.hasOwnProperty.call(a,i)&&(t[i]=a[i])},ti(e,r)};function Wt(e,r){if(typeof r!="function"&&r!==null)throw new TypeError("Class extends value "+String(r)+" is not a constructor or null");ti(e,r);function t(){this.constructor=e}e.prototype=r===null?Object.create(r):(t.prototype=r.prototype,new t)}var P=function(){return P=Object.assign||function(r){for(var t,a=1,i=arguments.length;a<i;a++){t=arguments[a];for(var n in t)Object.prototype.hasOwnProperty.call(t,n)&&(r[n]=t[n])}return r},P.apply(this,arguments)};function Nr(e,r,t){if(t||arguments.length===2)for(var a=0,i=r.length,n;a<i;a++)(n||!(a in r))&&(n||(n=Array.prototype.slice.call(r,0,a)),n[a]=r[a]);return e.concat(n||Array.prototype.slice.call(r))}var S;(function(e){e[e.EXPECT_ARGUMENT_CLOSING_BRACE=1]="EXPECT_ARGUMENT_CLOSING_BRACE",e[e.EMPTY_ARGUMENT=2]="EMPTY_ARGUMENT",e[e.MALFORMED_ARGUMENT=3]="MALFORMED_ARGUMENT",e[e.EXPECT_ARGUMENT_TYPE=4]="EXPECT_ARGUMENT_TYPE",e[e.INVALID_ARGUMENT_TYPE=5]="INVALID_ARGUMENT_TYPE",e[e.EXPECT_ARGUMENT_STYLE=6]="EXPECT_ARGUMENT_STYLE",e[e.INVALID_NUMBER_SKELETON=7]="INVALID_NUMBER_SKELETON",e[e.INVALID_DATE_TIME_SKELETON=8]="INVALID_DATE_TIME_SKELETON",e[e.EXPECT_NUMBER_SKELETON=9]="EXPECT_NUMBER_SKELETON",e[e.EXPECT_DATE_TIME_SKELETON=10]="EXPECT_DATE_TIME_SKELETON",e[e.UNCLOSED_QUOTE_IN_ARGUMENT_STYLE=11]="UNCLOSED_QUOTE_IN_ARGUMENT_STYLE",e[e.EXPECT_SELECT_ARGUMENT_OPTIONS=12]="EXPECT_SELECT_ARGUMENT_OPTIONS",e[e.EXPECT_PLURAL_ARGUMENT_OFFSET_VALUE=13]="EXPECT_PLURAL_ARGUMENT_OFFSET_VALUE",e[e.INVALID_PLURAL_ARGUMENT_OFFSET_VALUE=14]="INVALID_PLURAL_ARGUMENT_OFFSET_VALUE",e[e.EXPECT_SELECT_ARGUMENT_SELECTOR=15]="EXPECT_SELECT_ARGUMENT_SELECTOR",e[e.EXPECT_PLURAL_ARGUMENT_SELECTOR=16]="EXPECT_PLURAL_ARGUMENT_SELECTOR",e[e.EXPECT_SELECT_ARGUMENT_SELECTOR_FRAGMENT=17]="EXPECT_SELECT_ARGUMENT_SELECTOR_FRAGMENT",e[e.EXPECT_PLURAL_ARGUMENT_SELECTOR_FRAGMENT=18]="EXPECT_PLURAL_ARGUMENT_SELECTOR_FRAGMENT",e[e.INVALID_PLURAL_ARGUMENT_SELECTOR=19]="INVALID_PLURAL_ARGUMENT_SELECTOR",e[e.DUPLICATE_PLURAL_ARGUMENT_SELECTOR=20]="DUPLICATE_PLURAL_ARGUMENT_SELECTOR",e[e.DUPLICATE_SELECT_ARGUMENT_SELECTOR=21]="DUPLICATE_SELECT_ARGUMENT_SELECTOR",e[e.MISSING_OTHER_CLAUSE=22]="MISSING_OTHER_CLAUSE",e[e.INVALID_TAG=23]="INVALID_TAG",e[e.INVALID_TAG_NAME=25]="INVALID_TAG_NAME",e[e.UNMATCHED_CLOSING_TAG=26]="UNMATCHED_CLOSING_TAG",e[e.UNCLOSED_TAG=27]="UNCLOSED_TAG"})(S||(S={}));var B;(function(e){e[e.literal=0]="literal",e[e.argument=1]="argument",e[e.number=2]="number",e[e.date=3]="date",e[e.time=4]="time",e[e.select=5]="select",e[e.plural=6]="plural",e[e.pound=7]="pound",e[e.tag=8]="tag"})(B||(B={}));var Ze;(function(e){e[e.number=0]="number",e[e.dateTime=1]="dateTime"})(Ze||(Ze={}));function ri(e){return e.type===B.literal}function Eo(e){return e.type===B.argument}function Ir(e){return e.type===B.number}function Dr(e){return e.type===B.date}function zr(e){return e.type===B.time}function Hr(e){return e.type===B.select}function Br(e){return e.type===B.plural}function So(e){return e.type===B.pound}function Fr(e){return e.type===B.tag}function Ur(e){return!!(e&&typeof e=="object"&&e.type===Ze.number)}function Yt(e){return!!(e&&typeof e=="object"&&e.type===Ze.dateTime)}var ai=/[ \xA0\u1680\u2000-\u200A\u202F\u205F\u3000]/;var zl=/(?:[Eec]{1,6}|G{1,5}|[Qq]{1,5}|(?:[yYur]+|U{1,5})|[ML]{1,5}|d{1,2}|D{1,3}|F{1}|[abB]{1,5}|[hkHK]{1,2}|w{1,2}|W{1}|m{1,2}|s{1,2}|[zZOvVxX]{1,4})(?=([^']*'[^']*')*[^']*$)/g;function Ao(e){var r={};return e.replace(zl,function(t){var a=t.length;switch(t[0]){case"G":r.era=a===4?"long":a===5?"narrow":"short";break;case"y":r.year=a===2?"2-digit":"numeric";break;case"Y":case"u":case"U":case"r":throw new RangeError("`Y/u/U/r` (year) patterns are not supported, use `y` instead");case"q":case"Q":throw new RangeError("`q/Q` (quarter) patterns are not supported");case"M":case"L":r.month=["numeric","2-digit","short","long","narrow"][a-1];break;case"w":case"W":throw new RangeError("`w/W` (week) patterns are not supported");case"d":r.day=["numeric","2-digit"][a-1];break;case"D":case"F":case"g":throw new RangeError("`D/F/g` (day) patterns are not supported, use `d` instead");case"E":r.weekday=a===4?"short":a===5?"narrow":"short";break;case"e":if(a<4)throw new RangeError("`e..eee` (weekday) patterns are not supported");r.weekday=["short","long","narrow","short"][a-4];break;case"c":if(a<4)throw new RangeError("`c..ccc` (weekday) patterns are not supported");r.weekday=["short","long","narrow","short"][a-4];break;case"a":r.hour12=!0;break;case"b":case"B":throw new RangeError("`b/B` (period) patterns are not supported, use `a` instead");case"h":r.hourCycle="h12",r.hour=["numeric","2-digit"][a-1];break;case"H":r.hourCycle="h23",r.hour=["numeric","2-digit"][a-1];break;case"K":r.hourCycle="h11",r.hour=["numeric","2-digit"][a-1];break;case"k":r.hourCycle="h24",r.hour=["numeric","2-digit"][a-1];break;case"j":case"J":case"C":throw new RangeError("`j/J/C` (hour) patterns are not supported, use `h/H/K/k` instead");case"m":r.minute=["numeric","2-digit"][a-1];break;case"s":r.second=["numeric","2-digit"][a-1];break;case"S":case"A":throw new RangeError("`S/A` (second) patterns are not supported, use `s` instead");case"z":r.timeZoneName=a<4?"short":"long";break;case"Z":case"O":case"v":case"V":case"X":case"x":throw new RangeError("`Z/O/v/V/X/x` (timeZone) patterns are not supported, use `z` instead")}return""}),r}var Co=/[\t-\r \x85\u200E\u200F\u2028\u2029]/i;function Po(e){if(e.length===0)throw new Error("Number skeleton cannot be empty");for(var r=e.split(Co).filter(function(m){return m.length>0}),t=[],a=0,i=r;a<i.length;a++){var n=i[a],s=n.split("/");if(s.length===0)throw new Error("Invalid number skeleton");for(var o=s[0],c=s.slice(1),l=0,d=c;l<d.length;l++){var p=d[l];if(p.length===0)throw new Error("Invalid number skeleton")}t.push({stem:o,options:c})}return t}function Hl(e){return e.replace(/^(.*?)-/,"")}var To=/^\.(?:(0+)(\*)?|(#+)|(0+)(#+))$/g,Lo=/^(@+)?(\+|#+)?[rs]?$/g,Bl=/(\*)(0+)|(#+)(0+)|(0+)/g,Mo=/^(0+)$/;function ko(e){var r={};return e[e.length-1]==="r"?r.roundingPriority="morePrecision":e[e.length-1]==="s"&&(r.roundingPriority="lessPrecision"),e.replace(Lo,function(t,a,i){return typeof i!="string"?(r.minimumSignificantDigits=a.length,r.maximumSignificantDigits=a.length):i==="+"?r.minimumSignificantDigits=a.length:a[0]==="#"?r.maximumSignificantDigits=a.length:(r.minimumSignificantDigits=a.length,r.maximumSignificantDigits=a.length+(typeof i=="string"?i.length:0)),""}),r}function Ro(e){switch(e){case"sign-auto":return{signDisplay:"auto"};case"sign-accounting":case"()":return{currencySign:"accounting"};case"sign-always":case"+!":return{signDisplay:"always"};case"sign-accounting-always":case"()!":return{signDisplay:"always",currencySign:"accounting"};case"sign-except-zero":case"+?":return{signDisplay:"exceptZero"};case"sign-accounting-except-zero":case"()?":return{signDisplay:"exceptZero",currencySign:"accounting"};case"sign-never":case"+_":return{signDisplay:"never"}}}function Fl(e){var r;if(e[0]==="E"&&e[1]==="E"?(r={notation:"engineering"},e=e.slice(2)):e[0]==="E"&&(r={notation:"scientific"},e=e.slice(1)),r){var t=e.slice(0,2);if(t==="+!"?(r.signDisplay="always",e=e.slice(2)):t==="+?"&&(r.signDisplay="exceptZero",e=e.slice(2)),!Mo.test(e))throw new Error("Malformed concise eng/scientific notation");r.minimumIntegerDigits=e.length}return r}function _o(e){var r={},t=Ro(e);return t||r}function Oo(e){for(var r={},t=0,a=e;t<a.length;t++){var i=a[t];switch(i.stem){case"percent":case"%":r.style="percent";continue;case"%x100":r.style="percent",r.scale=100;continue;case"currency":r.style="currency",r.currency=i.options[0];continue;case"group-off":case",_":r.useGrouping=!1;continue;case"precision-integer":case".":r.maximumFractionDigits=0;continue;case"measure-unit":case"unit":r.style="unit",r.unit=Hl(i.options[0]);continue;case"compact-short":case"K":r.notation="compact",r.compactDisplay="short";continue;case"compact-long":case"KK":r.notation="compact",r.compactDisplay="long";continue;case"scientific":r=P(P(P({},r),{notation:"scientific"}),i.options.reduce(function(c,l){return P(P({},c),_o(l))},{}));continue;case"engineering":r=P(P(P({},r),{notation:"engineering"}),i.options.reduce(function(c,l){return P(P({},c),_o(l))},{}));continue;case"notation-simple":r.notation="standard";continue;case"unit-width-narrow":r.currencyDisplay="narrowSymbol",r.unitDisplay="narrow";continue;case"unit-width-short":r.currencyDisplay="code",r.unitDisplay="short";continue;case"unit-width-full-name":r.currencyDisplay="name",r.unitDisplay="long";continue;case"unit-width-iso-code":r.currencyDisplay="symbol";continue;case"scale":r.scale=parseFloat(i.options[0]);continue;case"integer-width":if(i.options.length>1)throw new RangeError("integer-width stems only accept a single optional option");i.options[0].replace(Bl,function(c,l,d,p,m,h){if(l)r.minimumIntegerDigits=d.length;else{if(p&&m)throw new Error("We currently do not support maximum integer digits");if(h)throw new Error("We currently do not support exact integer digits")}return""});continue}if(Mo.test(i.stem)){r.minimumIntegerDigits=i.stem.length;continue}if(To.test(i.stem)){if(i.options.length>1)throw new RangeError("Fraction-precision stems only accept a single optional option");i.stem.replace(To,function(c,l,d,p,m,h){return d==="*"?r.minimumFractionDigits=l.length:p&&p[0]==="#"?r.maximumFractionDigits=p.length:m&&h?(r.minimumFractionDigits=m.length,r.maximumFractionDigits=m.length+h.length):(r.minimumFractionDigits=l.length,r.maximumFractionDigits=l.length),""});var n=i.options[0];n==="w"?r=P(P({},r),{trailingZeroDisplay:"stripIfInteger"}):n&&(r=P(P({},r),ko(n)));continue}if(Lo.test(i.stem)){r=P(P({},r),ko(i.stem));continue}var s=Ro(i.stem);s&&(r=P(P({},r),s));var o=Fl(i.stem);o&&(r=P(P({},r),o))}return r}var Xt={AX:["H"],BQ:["H"],CP:["H"],CZ:["H"],DK:["H"],FI:["H"],ID:["H"],IS:["H"],ML:["H"],NE:["H"],RU:["H"],SE:["H"],SJ:["H"],SK:["H"],AS:["h","H"],BT:["h","H"],DJ:["h","H"],ER:["h","H"],GH:["h","H"],IN:["h","H"],LS:["h","H"],PG:["h","H"],PW:["h","H"],SO:["h","H"],TO:["h","H"],VU:["h","H"],WS:["h","H"],"001":["H","h"],AL:["h","H","hB"],TD:["h","H","hB"],"ca-ES":["H","h","hB"],CF:["H","h","hB"],CM:["H","h","hB"],"fr-CA":["H","h","hB"],"gl-ES":["H","h","hB"],"it-CH":["H","h","hB"],"it-IT":["H","h","hB"],LU:["H","h","hB"],NP:["H","h","hB"],PF:["H","h","hB"],SC:["H","h","hB"],SM:["H","h","hB"],SN:["H","h","hB"],TF:["H","h","hB"],VA:["H","h","hB"],CY:["h","H","hb","hB"],GR:["h","H","hb","hB"],CO:["h","H","hB","hb"],DO:["h","H","hB","hb"],KP:["h","H","hB","hb"],KR:["h","H","hB","hb"],NA:["h","H","hB","hb"],PA:["h","H","hB","hb"],PR:["h","H","hB","hb"],VE:["h","H","hB","hb"],AC:["H","h","hb","hB"],AI:["H","h","hb","hB"],BW:["H","h","hb","hB"],BZ:["H","h","hb","hB"],CC:["H","h","hb","hB"],CK:["H","h","hb","hB"],CX:["H","h","hb","hB"],DG:["H","h","hb","hB"],FK:["H","h","hb","hB"],GB:["H","h","hb","hB"],GG:["H","h","hb","hB"],GI:["H","h","hb","hB"],IE:["H","h","hb","hB"],IM:["H","h","hb","hB"],IO:["H","h","hb","hB"],JE:["H","h","hb","hB"],LT:["H","h","hb","hB"],MK:["H","h","hb","hB"],MN:["H","h","hb","hB"],MS:["H","h","hb","hB"],NF:["H","h","hb","hB"],NG:["H","h","hb","hB"],NR:["H","h","hb","hB"],NU:["H","h","hb","hB"],PN:["H","h","hb","hB"],SH:["H","h","hb","hB"],SX:["H","h","hb","hB"],TA:["H","h","hb","hB"],ZA:["H","h","hb","hB"],"af-ZA":["H","h","hB","hb"],AR:["H","h","hB","hb"],CL:["H","h","hB","hb"],CR:["H","h","hB","hb"],CU:["H","h","hB","hb"],EA:["H","h","hB","hb"],"es-BO":["H","h","hB","hb"],"es-BR":["H","h","hB","hb"],"es-EC":["H","h","hB","hb"],"es-ES":["H","h","hB","hb"],"es-GQ":["H","h","hB","hb"],"es-PE":["H","h","hB","hb"],GT:["H","h","hB","hb"],HN:["H","h","hB","hb"],IC:["H","h","hB","hb"],KG:["H","h","hB","hb"],KM:["H","h","hB","hb"],LK:["H","h","hB","hb"],MA:["H","h","hB","hb"],MX:["H","h","hB","hb"],NI:["H","h","hB","hb"],PY:["H","h","hB","hb"],SV:["H","h","hB","hb"],UY:["H","h","hB","hb"],JP:["H","h","K"],AD:["H","hB"],AM:["H","hB"],AO:["H","hB"],AT:["H","hB"],AW:["H","hB"],BE:["H","hB"],BF:["H","hB"],BJ:["H","hB"],BL:["H","hB"],BR:["H","hB"],CG:["H","hB"],CI:["H","hB"],CV:["H","hB"],DE:["H","hB"],EE:["H","hB"],FR:["H","hB"],GA:["H","hB"],GF:["H","hB"],GN:["H","hB"],GP:["H","hB"],GW:["H","hB"],HR:["H","hB"],IL:["H","hB"],IT:["H","hB"],KZ:["H","hB"],MC:["H","hB"],MD:["H","hB"],MF:["H","hB"],MQ:["H","hB"],MZ:["H","hB"],NC:["H","hB"],NL:["H","hB"],PM:["H","hB"],PT:["H","hB"],RE:["H","hB"],RO:["H","hB"],SI:["H","hB"],SR:["H","hB"],ST:["H","hB"],TG:["H","hB"],TR:["H","hB"],WF:["H","hB"],YT:["H","hB"],BD:["h","hB","H"],PK:["h","hB","H"],AZ:["H","hB","h"],BA:["H","hB","h"],BG:["H","hB","h"],CH:["H","hB","h"],GE:["H","hB","h"],LI:["H","hB","h"],ME:["H","hB","h"],RS:["H","hB","h"],UA:["H","hB","h"],UZ:["H","hB","h"],XK:["H","hB","h"],AG:["h","hb","H","hB"],AU:["h","hb","H","hB"],BB:["h","hb","H","hB"],BM:["h","hb","H","hB"],BS:["h","hb","H","hB"],CA:["h","hb","H","hB"],DM:["h","hb","H","hB"],"en-001":["h","hb","H","hB"],FJ:["h","hb","H","hB"],FM:["h","hb","H","hB"],GD:["h","hb","H","hB"],GM:["h","hb","H","hB"],GU:["h","hb","H","hB"],GY:["h","hb","H","hB"],JM:["h","hb","H","hB"],KI:["h","hb","H","hB"],KN:["h","hb","H","hB"],KY:["h","hb","H","hB"],LC:["h","hb","H","hB"],LR:["h","hb","H","hB"],MH:["h","hb","H","hB"],MP:["h","hb","H","hB"],MW:["h","hb","H","hB"],NZ:["h","hb","H","hB"],SB:["h","hb","H","hB"],SG:["h","hb","H","hB"],SL:["h","hb","H","hB"],SS:["h","hb","H","hB"],SZ:["h","hb","H","hB"],TC:["h","hb","H","hB"],TT:["h","hb","H","hB"],UM:["h","hb","H","hB"],US:["h","hb","H","hB"],VC:["h","hb","H","hB"],VG:["h","hb","H","hB"],VI:["h","hb","H","hB"],ZM:["h","hb","H","hB"],BO:["H","hB","h","hb"],EC:["H","hB","h","hb"],ES:["H","hB","h","hb"],GQ:["H","hB","h","hb"],PE:["H","hB","h","hb"],AE:["h","hB","hb","H"],"ar-001":["h","hB","hb","H"],BH:["h","hB","hb","H"],DZ:["h","hB","hb","H"],EG:["h","hB","hb","H"],EH:["h","hB","hb","H"],HK:["h","hB","hb","H"],IQ:["h","hB","hb","H"],JO:["h","hB","hb","H"],KW:["h","hB","hb","H"],LB:["h","hB","hb","H"],LY:["h","hB","hb","H"],MO:["h","hB","hb","H"],MR:["h","hB","hb","H"],OM:["h","hB","hb","H"],PH:["h","hB","hb","H"],PS:["h","hB","hb","H"],QA:["h","hB","hb","H"],SA:["h","hB","hb","H"],SD:["h","hB","hb","H"],SY:["h","hB","hb","H"],TN:["h","hB","hb","H"],YE:["h","hB","hb","H"],AF:["H","hb","hB","h"],LA:["H","hb","hB","h"],CN:["H","hB","hb","h"],LV:["H","hB","hb","h"],TL:["H","hB","hb","h"],"zu-ZA":["H","hB","hb","h"],CD:["hB","H"],IR:["hB","H"],"hi-IN":["hB","h","H"],"kn-IN":["hB","h","H"],"ml-IN":["hB","h","H"],"te-IN":["hB","h","H"],KH:["hB","h","H","hb"],"ta-IN":["hB","h","hb","H"],BN:["hb","hB","h","H"],MY:["hb","hB","h","H"],ET:["hB","hb","h","H"],"gu-IN":["hB","hb","h","H"],"mr-IN":["hB","hb","h","H"],"pa-IN":["hB","hb","h","H"],TW:["hB","hb","h","H"],KE:["hB","hb","H","h"],MM:["hB","hb","H","h"],TZ:["hB","hb","H","h"],UG:["hB","hb","H","h"]};function No(e,r){for(var t="",a=0;a<e.length;a++){var i=e.charAt(a);if(i==="j"){for(var n=0;a+1<e.length&&e.charAt(a+1)===i;)n++,a++;var s=1+(n&1),o=n<2?1:3+(n>>1),c="a",l=Ul(r);for((l=="H"||l=="k")&&(o=0);o-- >0;)t+=c;for(;s-- >0;)t=l+t}else i==="J"?t+="H":t+=i}return t}function Ul(e){var r=e.hourCycle;if(r===void 0&&e.hourCycles&&e.hourCycles.length&&(r=e.hourCycles[0]),r)switch(r){case"h24":return"k";case"h23":return"H";case"h12":return"h";case"h11":return"K";default:throw new Error("Invalid hourCycle")}var t=e.language,a;t!=="root"&&(a=e.maximize().region);var i=Xt[a||""]||Xt[t||""]||Xt["".concat(t,"-001")]||Xt["001"];return i[0]}var ii,$l=new RegExp("^".concat(ai.source,"*")),Gl=new RegExp("".concat(ai.source,"*$"));function L(e,r){return{start:e,end:r}}var ql=!!String.prototype.startsWith,Vl=!!String.fromCodePoint,jl=!!Object.fromEntries,Wl=!!String.prototype.codePointAt,Yl=!!String.prototype.trimStart,Xl=!!String.prototype.trimEnd,Kl=!!Number.isSafeInteger,Zl=Kl?Number.isSafeInteger:function(e){return typeof e=="number"&&isFinite(e)&&Math.floor(e)===e&&Math.abs(e)<=9007199254740991},oi=!0;try{Io=Bo("([^\\p{White_Space}\\p{Pattern_Syntax}]*)","yu"),oi=((ii=Io.exec("a"))===null||ii===void 0?void 0:ii[0])==="a"}catch{oi=!1}var Io,Do=ql?function(r,t,a){return r.startsWith(t,a)}:function(r,t,a){return r.slice(a,a+t.length)===t},si=Vl?String.fromCodePoint:function(){for(var r=[],t=0;t<arguments.length;t++)r[t]=arguments[t];for(var a="",i=r.length,n=0,s;i>n;){if(s=r[n++],s>1114111)throw RangeError(s+" is not a valid code point");a+=s<65536?String.fromCharCode(s):String.fromCharCode(((s-=65536)>>10)+55296,s%1024+56320)}return a},zo=jl?Object.fromEntries:function(r){for(var t={},a=0,i=r;a<i.length;a++){var n=i[a],s=n[0],o=n[1];t[s]=o}return t},Ho=Wl?function(r,t){return r.codePointAt(t)}:function(r,t){var a=r.length;if(!(t<0||t>=a)){var i=r.charCodeAt(t),n;return i<55296||i>56319||t+1===a||(n=r.charCodeAt(t+1))<56320||n>57343?i:(i-55296<<10)+(n-56320)+65536}},Ql=Yl?function(r){return r.trimStart()}:function(r){return r.replace($l,"")},Jl=Xl?function(r){return r.trimEnd()}:function(r){return r.replace(Gl,"")};function Bo(e,r){return new RegExp(e,r)}var ci;oi?(ni=Bo("([^\\p{White_Space}\\p{Pattern_Syntax}]*)","yu"),ci=function(r,t){var a;ni.lastIndex=t;var i=ni.exec(r);return(a=i[1])!==null&&a!==void 0?a:""}):ci=function(r,t){for(var a=[];;){var i=Ho(r,t);if(i===void 0||Uo(i)||rd(i))break;a.push(i),t+=i>=65536?2:1}return si.apply(void 0,a)};var ni,Fo=function(){function e(r,t){t===void 0&&(t={}),this.message=r,this.position={offset:0,line:1,column:1},this.ignoreTag=!!t.ignoreTag,this.locale=t.locale,this.requiresOtherClause=!!t.requiresOtherClause,this.shouldParseSkeletons=!!t.shouldParseSkeletons}return e.prototype.parse=function(){if(this.offset()!==0)throw Error("parser can only be used once");return this.parseMessage(0,"",!1)},e.prototype.parseMessage=function(r,t,a){for(var i=[];!this.isEOF();){var n=this.char();if(n===123){var s=this.parseArgument(r,a);if(s.err)return s;i.push(s.val)}else{if(n===125&&r>0)break;if(n===35&&(t==="plural"||t==="selectordinal")){var o=this.clonePosition();this.bump(),i.push({type:B.pound,location:L(o,this.clonePosition())})}else if(n===60&&!this.ignoreTag&&this.peek()===47){if(a)break;return this.error(S.UNMATCHED_CLOSING_TAG,L(this.clonePosition(),this.clonePosition()))}else if(n===60&&!this.ignoreTag&&li(this.peek()||0)){var s=this.parseTag(r,t);if(s.err)return s;i.push(s.val)}else{var s=this.parseLiteral(r,t);if(s.err)return s;i.push(s.val)}}}return{val:i,err:null}},e.prototype.parseTag=function(r,t){var a=this.clonePosition();this.bump();var i=this.parseTagName();if(this.bumpSpace(),this.bumpIf("/>"))return{val:{type:B.literal,value:"<".concat(i,"/>"),location:L(a,this.clonePosition())},err:null};if(this.bumpIf(">")){var n=this.parseMessage(r+1,t,!0);if(n.err)return n;var s=n.val,o=this.clonePosition();if(this.bumpIf("</")){if(this.isEOF()||!li(this.char()))return this.error(S.INVALID_TAG,L(o,this.clonePosition()));var c=this.clonePosition(),l=this.parseTagName();return i!==l?this.error(S.UNMATCHED_CLOSING_TAG,L(c,this.clonePosition())):(this.bumpSpace(),this.bumpIf(">")?{val:{type:B.tag,value:i,children:s,location:L(a,this.clonePosition())},err:null}:this.error(S.INVALID_TAG,L(o,this.clonePosition())))}else return this.error(S.UNCLOSED_TAG,L(a,this.clonePosition()))}else return this.error(S.INVALID_TAG,L(a,this.clonePosition()))},e.prototype.parseTagName=function(){var r=this.offset();for(this.bump();!this.isEOF()&&td(this.char());)this.bump();return this.message.slice(r,this.offset())},e.prototype.parseLiteral=function(r,t){for(var a=this.clonePosition(),i="";;){var n=this.tryParseQuote(t);if(n){i+=n;continue}var s=this.tryParseUnquoted(r,t);if(s){i+=s;continue}var o=this.tryParseLeftAngleBracket();if(o){i+=o;continue}break}var c=L(a,this.clonePosition());return{val:{type:B.literal,value:i,location:c},err:null}},e.prototype.tryParseLeftAngleBracket=function(){return!this.isEOF()&&this.char()===60&&(this.ignoreTag||!ed(this.peek()||0))?(this.bump(),"<"):null},e.prototype.tryParseQuote=function(r){if(this.isEOF()||this.char()!==39)return null;switch(this.peek()){case 39:return this.bump(),this.bump(),"'";case 123:case 60:case 62:case 125:break;case 35:if(r==="plural"||r==="selectordinal")break;return null;default:return null}this.bump();var t=[this.char()];for(this.bump();!this.isEOF();){var a=this.char();if(a===39)if(this.peek()===39)t.push(39),this.bump();else{this.bump();break}else t.push(a);this.bump()}return si.apply(void 0,t)},e.prototype.tryParseUnquoted=function(r,t){if(this.isEOF())return null;var a=this.char();return a===60||a===123||a===35&&(t==="plural"||t==="selectordinal")||a===125&&r>0?null:(this.bump(),si(a))},e.prototype.parseArgument=function(r,t){var a=this.clonePosition();if(this.bump(),this.bumpSpace(),this.isEOF())return this.error(S.EXPECT_ARGUMENT_CLOSING_BRACE,L(a,this.clonePosition()));if(this.char()===125)return this.bump(),this.error(S.EMPTY_ARGUMENT,L(a,this.clonePosition()));var i=this.parseIdentifierIfPossible().value;if(!i)return this.error(S.MALFORMED_ARGUMENT,L(a,this.clonePosition()));if(this.bumpSpace(),this.isEOF())return this.error(S.EXPECT_ARGUMENT_CLOSING_BRACE,L(a,this.clonePosition()));switch(this.char()){case 125:return this.bump(),{val:{type:B.argument,value:i,location:L(a,this.clonePosition())},err:null};case 44:return this.bump(),this.bumpSpace(),this.isEOF()?this.error(S.EXPECT_ARGUMENT_CLOSING_BRACE,L(a,this.clonePosition())):this.parseArgumentOptions(r,t,i,a);default:return this.error(S.MALFORMED_ARGUMENT,L(a,this.clonePosition()))}},e.prototype.parseIdentifierIfPossible=function(){var r=this.clonePosition(),t=this.offset(),a=ci(this.message,t),i=t+a.length;this.bumpTo(i);var n=this.clonePosition(),s=L(r,n);return{value:a,location:s}},e.prototype.parseArgumentOptions=function(r,t,a,i){var n,s=this.clonePosition(),o=this.parseIdentifierIfPossible().value,c=this.clonePosition();switch(o){case"":return this.error(S.EXPECT_ARGUMENT_TYPE,L(s,c));case"number":case"date":case"time":{this.bumpSpace();var l=null;if(this.bumpIf(",")){this.bumpSpace();var d=this.clonePosition(),p=this.parseSimpleArgStyleIfPossible();if(p.err)return p;var m=Jl(p.val);if(m.length===0)return this.error(S.EXPECT_ARGUMENT_STYLE,L(this.clonePosition(),this.clonePosition()));var h=L(d,this.clonePosition());l={style:m,styleLocation:h}}var u=this.tryParseArgumentClose(i);if(u.err)return u;var f=L(i,this.clonePosition());if(l&&Do(l?.style,"::",0)){var x=Ql(l.style.slice(2));if(o==="number"){var p=this.parseNumberSkeletonFromString(x,l.styleLocation);return p.err?p:{val:{type:B.number,value:a,location:f,style:p.val},err:null}}else{if(x.length===0)return this.error(S.EXPECT_DATE_TIME_SKELETON,f);var y=x;this.locale&&(y=No(x,this.locale));var m={type:Ze.dateTime,pattern:y,location:l.styleLocation,parsedOptions:this.shouldParseSkeletons?Ao(y):{}},A=o==="date"?B.date:B.time;return{val:{type:A,value:a,location:f,style:m},err:null}}}return{val:{type:o==="number"?B.number:o==="date"?B.date:B.time,value:a,location:f,style:(n=l?.style)!==null&&n!==void 0?n:null},err:null}}case"plural":case"selectordinal":case"select":{var b=this.clonePosition();if(this.bumpSpace(),!this.bumpIf(","))return this.error(S.EXPECT_SELECT_ARGUMENT_OPTIONS,L(b,P({},b)));this.bumpSpace();var C=this.parseIdentifierIfPossible(),z=0;if(o!=="select"&&C.value==="offset"){if(!this.bumpIf(":"))return this.error(S.EXPECT_PLURAL_ARGUMENT_OFFSET_VALUE,L(this.clonePosition(),this.clonePosition()));this.bumpSpace();var p=this.tryParseDecimalInteger(S.EXPECT_PLURAL_ARGUMENT_OFFSET_VALUE,S.INVALID_PLURAL_ARGUMENT_OFFSET_VALUE);if(p.err)return p;this.bumpSpace(),C=this.parseIdentifierIfPossible(),z=p.val}var N=this.tryParsePluralOrSelectOptions(r,o,t,C);if(N.err)return N;var u=this.tryParseArgumentClose(i);if(u.err)return u;var U=L(i,this.clonePosition());return o==="select"?{val:{type:B.select,value:a,options:zo(N.val),location:U},err:null}:{val:{type:B.plural,value:a,options:zo(N.val),offset:z,pluralType:o==="plural"?"cardinal":"ordinal",location:U},err:null}}default:return this.error(S.INVALID_ARGUMENT_TYPE,L(s,c))}},e.prototype.tryParseArgumentClose=function(r){return this.isEOF()||this.char()!==125?this.error(S.EXPECT_ARGUMENT_CLOSING_BRACE,L(r,this.clonePosition())):(this.bump(),{val:!0,err:null})},e.prototype.parseSimpleArgStyleIfPossible=function(){for(var r=0,t=this.clonePosition();!this.isEOF();){var a=this.char();switch(a){case 39:{this.bump();var i=this.clonePosition();if(!this.bumpUntil("'"))return this.error(S.UNCLOSED_QUOTE_IN_ARGUMENT_STYLE,L(i,this.clonePosition()));this.bump();break}case 123:{r+=1,this.bump();break}case 125:{if(r>0)r-=1;else return{val:this.message.slice(t.offset,this.offset()),err:null};break}default:this.bump();break}}return{val:this.message.slice(t.offset,this.offset()),err:null}},e.prototype.parseNumberSkeletonFromString=function(r,t){var a=[];try{a=Po(r)}catch{return this.error(S.INVALID_NUMBER_SKELETON,t)}return{val:{type:Ze.number,tokens:a,location:t,parsedOptions:this.shouldParseSkeletons?Oo(a):{}},err:null}},e.prototype.tryParsePluralOrSelectOptions=function(r,t,a,i){for(var n,s=!1,o=[],c=new Set,l=i.value,d=i.location;;){if(l.length===0){var p=this.clonePosition();if(t!=="select"&&this.bumpIf("=")){var m=this.tryParseDecimalInteger(S.EXPECT_PLURAL_ARGUMENT_SELECTOR,S.INVALID_PLURAL_ARGUMENT_SELECTOR);if(m.err)return m;d=L(p,this.clonePosition()),l=this.message.slice(p.offset,this.offset())}else break}if(c.has(l))return this.error(t==="select"?S.DUPLICATE_SELECT_ARGUMENT_SELECTOR:S.DUPLICATE_PLURAL_ARGUMENT_SELECTOR,d);l==="other"&&(s=!0),this.bumpSpace();var h=this.clonePosition();if(!this.bumpIf("{"))return this.error(t==="select"?S.EXPECT_SELECT_ARGUMENT_SELECTOR_FRAGMENT:S.EXPECT_PLURAL_ARGUMENT_SELECTOR_FRAGMENT,L(this.clonePosition(),this.clonePosition()));var u=this.parseMessage(r+1,t,a);if(u.err)return u;var f=this.tryParseArgumentClose(h);if(f.err)return f;o.push([l,{value:u.val,location:L(h,this.clonePosition())}]),c.add(l),this.bumpSpace(),n=this.parseIdentifierIfPossible(),l=n.value,d=n.location}return o.length===0?this.error(t==="select"?S.EXPECT_SELECT_ARGUMENT_SELECTOR:S.EXPECT_PLURAL_ARGUMENT_SELECTOR,L(this.clonePosition(),this.clonePosition())):this.requiresOtherClause&&!s?this.error(S.MISSING_OTHER_CLAUSE,L(this.clonePosition(),this.clonePosition())):{val:o,err:null}},e.prototype.tryParseDecimalInteger=function(r,t){var a=1,i=this.clonePosition();this.bumpIf("+")||this.bumpIf("-")&&(a=-1);for(var n=!1,s=0;!this.isEOF();){var o=this.char();if(o>=48&&o<=57)n=!0,s=s*10+(o-48),this.bump();else break}var c=L(i,this.clonePosition());return n?(s*=a,Zl(s)?{val:s,err:null}:this.error(t,c)):this.error(r,c)},e.prototype.offset=function(){return this.position.offset},e.prototype.isEOF=function(){return this.offset()===this.message.length},e.prototype.clonePosition=function(){return{offset:this.position.offset,line:this.position.line,column:this.position.column}},e.prototype.char=function(){var r=this.position.offset;if(r>=this.message.length)throw Error("out of bound");var t=Ho(this.message,r);if(t===void 0)throw Error("Offset ".concat(r," is at invalid UTF-16 code unit boundary"));return t},e.prototype.error=function(r,t){return{val:null,err:{kind:r,message:this.message,location:t}}},e.prototype.bump=function(){if(!this.isEOF()){var r=this.char();r===10?(this.position.line+=1,this.position.column=1,this.position.offset+=1):(this.position.column+=1,this.position.offset+=r<65536?1:2)}},e.prototype.bumpIf=function(r){if(Do(this.message,r,this.offset())){for(var t=0;t<r.length;t++)this.bump();return!0}return!1},e.prototype.bumpUntil=function(r){var t=this.offset(),a=this.message.indexOf(r,t);return a>=0?(this.bumpTo(a),!0):(this.bumpTo(this.message.length),!1)},e.prototype.bumpTo=function(r){if(this.offset()>r)throw Error("targetOffset ".concat(r," must be greater than or equal to the current offset ").concat(this.offset()));for(r=Math.min(r,this.message.length);;){var t=this.offset();if(t===r)break;if(t>r)throw Error("targetOffset ".concat(r," is at invalid UTF-16 code unit boundary"));if(this.bump(),this.isEOF())break}},e.prototype.bumpSpace=function(){for(;!this.isEOF()&&Uo(this.char());)this.bump()},e.prototype.peek=function(){if(this.isEOF())return null;var r=this.char(),t=this.offset(),a=this.message.charCodeAt(t+(r>=65536?2:1));return a??null},e}();function li(e){return e>=97&&e<=122||e>=65&&e<=90}function ed(e){return li(e)||e===47}function td(e){return e===45||e===46||e>=48&&e<=57||e===95||e>=97&&e<=122||e>=65&&e<=90||e==183||e>=192&&e<=214||e>=216&&e<=246||e>=248&&e<=893||e>=895&&e<=8191||e>=8204&&e<=8205||e>=8255&&e<=8256||e>=8304&&e<=8591||e>=11264&&e<=12271||e>=12289&&e<=55295||e>=63744&&e<=64975||e>=65008&&e<=65533||e>=65536&&e<=983039}function Uo(e){return e>=9&&e<=13||e===32||e===133||e>=8206&&e<=8207||e===8232||e===8233}function rd(e){return e>=33&&e<=35||e===36||e>=37&&e<=39||e===40||e===41||e===42||e===43||e===44||e===45||e>=46&&e<=47||e>=58&&e<=59||e>=60&&e<=62||e>=63&&e<=64||e===91||e===92||e===93||e===94||e===96||e===123||e===124||e===125||e===126||e===161||e>=162&&e<=165||e===166||e===167||e===169||e===171||e===172||e===174||e===176||e===177||e===182||e===187||e===191||e===215||e===247||e>=8208&&e<=8213||e>=8214&&e<=8215||e===8216||e===8217||e===8218||e>=8219&&e<=8220||e===8221||e===8222||e===8223||e>=8224&&e<=8231||e>=8240&&e<=8248||e===8249||e===8250||e>=8251&&e<=8254||e>=8257&&e<=8259||e===8260||e===8261||e===8262||e>=8263&&e<=8273||e===8274||e===8275||e>=8277&&e<=8286||e>=8592&&e<=8596||e>=8597&&e<=8601||e>=8602&&e<=8603||e>=8604&&e<=8607||e===8608||e>=8609&&e<=8610||e===8611||e>=8612&&e<=8613||e===8614||e>=8615&&e<=8621||e===8622||e>=8623&&e<=8653||e>=8654&&e<=8655||e>=8656&&e<=8657||e===8658||e===8659||e===8660||e>=8661&&e<=8691||e>=8692&&e<=8959||e>=8960&&e<=8967||e===8968||e===8969||e===8970||e===8971||e>=8972&&e<=8991||e>=8992&&e<=8993||e>=8994&&e<=9e3||e===9001||e===9002||e>=9003&&e<=9083||e===9084||e>=9085&&e<=9114||e>=9115&&e<=9139||e>=9140&&e<=9179||e>=9180&&e<=9185||e>=9186&&e<=9254||e>=9255&&e<=9279||e>=9280&&e<=9290||e>=9291&&e<=9311||e>=9472&&e<=9654||e===9655||e>=9656&&e<=9664||e===9665||e>=9666&&e<=9719||e>=9720&&e<=9727||e>=9728&&e<=9838||e===9839||e>=9840&&e<=10087||e===10088||e===10089||e===10090||e===10091||e===10092||e===10093||e===10094||e===10095||e===10096||e===10097||e===10098||e===10099||e===10100||e===10101||e>=10132&&e<=10175||e>=10176&&e<=10180||e===10181||e===10182||e>=10183&&e<=10213||e===10214||e===10215||e===10216||e===10217||e===10218||e===10219||e===10220||e===10221||e===10222||e===10223||e>=10224&&e<=10239||e>=10240&&e<=10495||e>=10496&&e<=10626||e===10627||e===10628||e===10629||e===10630||e===10631||e===10632||e===10633||e===10634||e===10635||e===10636||e===10637||e===10638||e===10639||e===10640||e===10641||e===10642||e===10643||e===10644||e===10645||e===10646||e===10647||e===10648||e>=10649&&e<=10711||e===10712||e===10713||e===10714||e===10715||e>=10716&&e<=10747||e===10748||e===10749||e>=10750&&e<=11007||e>=11008&&e<=11055||e>=11056&&e<=11076||e>=11077&&e<=11078||e>=11079&&e<=11084||e>=11085&&e<=11123||e>=11124&&e<=11125||e>=11126&&e<=11157||e===11158||e>=11159&&e<=11263||e>=11776&&e<=11777||e===11778||e===11779||e===11780||e===11781||e>=11782&&e<=11784||e===11785||e===11786||e===11787||e===11788||e===11789||e>=11790&&e<=11798||e===11799||e>=11800&&e<=11801||e===11802||e===11803||e===11804||e===11805||e>=11806&&e<=11807||e===11808||e===11809||e===11810||e===11811||e===11812||e===11813||e===11814||e===11815||e===11816||e===11817||e>=11818&&e<=11822||e===11823||e>=11824&&e<=11833||e>=11834&&e<=11835||e>=11836&&e<=11839||e===11840||e===11841||e===11842||e>=11843&&e<=11855||e>=11856&&e<=11857||e===11858||e>=11859&&e<=11903||e>=12289&&e<=12291||e===12296||e===12297||e===12298||e===12299||e===12300||e===12301||e===12302||e===12303||e===12304||e===12305||e>=12306&&e<=12307||e===12308||e===12309||e===12310||e===12311||e===12312||e===12313||e===12314||e===12315||e===12316||e===12317||e>=12318&&e<=12319||e===12320||e===12336||e===64830||e===64831||e>=65093&&e<=65094}function di(e){e.forEach(function(r){if(delete r.location,Hr(r)||Br(r))for(var t in r.options)delete r.options[t].location,di(r.options[t].value);else Ir(r)&&Ur(r.style)||(Dr(r)||zr(r))&&Yt(r.style)?delete r.style.location:Fr(r)&&di(r.children)})}function $o(e,r){r===void 0&&(r={}),r=P({shouldParseSkeletons:!0,requiresOtherClause:!0},r);var t=new Fo(e,r).parse();if(t.err){var a=SyntaxError(S[t.err.kind]);throw a.location=t.err.location,a.originalMessage=t.err.message,a}return r?.captureLocation||di(t.val),t.val}function Kt(e,r){var t=r&&r.cache?r.cache:cd,a=r&&r.serializer?r.serializer:sd,i=r&&r.strategy?r.strategy:id;return i(e,{cache:t,serializer:a})}function ad(e){return e==null||typeof e=="number"||typeof e=="boolean"}function Go(e,r,t,a){var i=ad(a)?a:t(a),n=r.get(i);return typeof n>"u"&&(n=e.call(this,a),r.set(i,n)),n}function qo(e,r,t){var a=Array.prototype.slice.call(arguments,3),i=t(a),n=r.get(i);return typeof n>"u"&&(n=e.apply(this,a),r.set(i,n)),n}function hi(e,r,t,a,i){return t.bind(r,e,a,i)}function id(e,r){var t=e.length===1?Go:qo;return hi(e,this,t,r.cache.create(),r.serializer)}function nd(e,r){return hi(e,this,qo,r.cache.create(),r.serializer)}function od(e,r){return hi(e,this,Go,r.cache.create(),r.serializer)}var sd=function(){return JSON.stringify(arguments)};function pi(){this.cache=Object.create(null)}pi.prototype.get=function(e){return this.cache[e]};pi.prototype.set=function(e,r){this.cache[e]=r};var cd={create:function(){return new pi}},$r={variadic:nd,monadic:od};var Qe;(function(e){e.MISSING_VALUE="MISSING_VALUE",e.INVALID_VALUE="INVALID_VALUE",e.MISSING_INTL_API="MISSING_INTL_API"})(Qe||(Qe={}));var Zt=function(e){Wt(r,e);function r(t,a,i){var n=e.call(this,t)||this;return n.code=a,n.originalMessage=i,n}return r.prototype.toString=function(){return"[formatjs Error: ".concat(this.code,"] ").concat(this.message)},r}(Error);var mi=function(e){Wt(r,e);function r(t,a,i,n){return e.call(this,'Invalid values for "'.concat(t,'": "').concat(a,'". Options are "').concat(Object.keys(i).join('", "'),'"'),Qe.INVALID_VALUE,n)||this}return r}(Zt);var Vo=function(e){Wt(r,e);function r(t,a,i){return e.call(this,'Value for "'.concat(t,'" must be of type ').concat(a),Qe.INVALID_VALUE,i)||this}return r}(Zt);var jo=function(e){Wt(r,e);function r(t,a){return e.call(this,'The intl string context variable "'.concat(t,'" was not provided to the string "').concat(a,'"'),Qe.MISSING_VALUE,a)||this}return r}(Zt);var Q;(function(e){e[e.literal=0]="literal",e[e.object=1]="object"})(Q||(Q={}));function ld(e){return e.length<2?e:e.reduce(function(r,t){var a=r[r.length-1];return!a||a.type!==Q.literal||t.type!==Q.literal?r.push(t):a.value+=t.value,r},[])}function dd(e){return typeof e=="function"}function Qt(e,r,t,a,i,n,s){if(e.length===1&&ri(e[0]))return[{type:Q.literal,value:e[0].value}];for(var o=[],c=0,l=e;c<l.length;c++){var d=l[c];if(ri(d)){o.push({type:Q.literal,value:d.value});continue}if(So(d)){typeof n=="number"&&o.push({type:Q.literal,value:t.getNumberFormat(r).format(n)});continue}var p=d.value;if(!(i&&p in i))throw new jo(p,s);var m=i[p];if(Eo(d)){(!m||typeof m=="string"||typeof m=="number")&&(m=typeof m=="string"||typeof m=="number"?String(m):""),o.push({type:typeof m=="string"?Q.literal:Q.object,value:m});continue}if(Dr(d)){var h=typeof d.style=="string"?a.date[d.style]:Yt(d.style)?d.style.parsedOptions:void 0;o.push({type:Q.literal,value:t.getDateTimeFormat(r,h).format(m)});continue}if(zr(d)){var h=typeof d.style=="string"?a.time[d.style]:Yt(d.style)?d.style.parsedOptions:a.time.medium;o.push({type:Q.literal,value:t.getDateTimeFormat(r,h).format(m)});continue}if(Ir(d)){var h=typeof d.style=="string"?a.number[d.style]:Ur(d.style)?d.style.parsedOptions:void 0;h&&h.scale&&(m=m*(h.scale||1)),o.push({type:Q.literal,value:t.getNumberFormat(r,h).format(m)});continue}if(Fr(d)){var u=d.children,f=d.value,x=i[f];if(!dd(x))throw new Vo(f,"function",s);var y=Qt(u,r,t,a,i,n),A=x(y.map(function(z){return z.value}));Array.isArray(A)||(A=[A]),o.push.apply(o,A.map(function(z){return{type:typeof z=="string"?Q.literal:Q.object,value:z}}))}if(Hr(d)){var b=d.options[m]||d.options.other;if(!b)throw new mi(d.value,m,Object.keys(d.options),s);o.push.apply(o,Qt(b.value,r,t,a,i));continue}if(Br(d)){var b=d.options["=".concat(m)];if(!b){if(!Intl.PluralRules)throw new Zt(`Intl.PluralRules is not available in this environment.
Try polyfilling it using "@formatjs/intl-pluralrules"
`,Qe.MISSING_INTL_API,s);var C=t.getPluralRules(r,{type:d.pluralType}).select(m-(d.offset||0));b=d.options[C]||d.options.other}if(!b)throw new mi(d.value,m,Object.keys(d.options),s);o.push.apply(o,Qt(b.value,r,t,a,i,m-(d.offset||0)));continue}}return ld(o)}function hd(e,r){return r?P(P(P({},e||{}),r||{}),Object.keys(e).reduce(function(t,a){return t[a]=P(P({},e[a]),r[a]||{}),t},{})):e}function pd(e,r){return r?Object.keys(e).reduce(function(t,a){return t[a]=hd(e[a],r[a]),t},P({},e)):e}function ui(e){return{create:function(){return{get:function(r){return e[r]},set:function(r,t){e[r]=t}}}}}function md(e){return e===void 0&&(e={number:{},dateTime:{},pluralRules:{}}),{getNumberFormat:Kt(function(){for(var r,t=[],a=0;a<arguments.length;a++)t[a]=arguments[a];return new((r=Intl.NumberFormat).bind.apply(r,Nr([void 0],t,!1)))},{cache:ui(e.number),strategy:$r.variadic}),getDateTimeFormat:Kt(function(){for(var r,t=[],a=0;a<arguments.length;a++)t[a]=arguments[a];return new((r=Intl.DateTimeFormat).bind.apply(r,Nr([void 0],t,!1)))},{cache:ui(e.dateTime),strategy:$r.variadic}),getPluralRules:Kt(function(){for(var r,t=[],a=0;a<arguments.length;a++)t[a]=arguments[a];return new((r=Intl.PluralRules).bind.apply(r,Nr([void 0],t,!1)))},{cache:ui(e.pluralRules),strategy:$r.variadic})}}var Wo=function(){function e(r,t,a,i){var n=this;if(t===void 0&&(t=e.defaultLocale),this.formatterCache={number:{},dateTime:{},pluralRules:{}},this.format=function(s){var o=n.formatToParts(s);if(o.length===1)return o[0].value;var c=o.reduce(function(l,d){return!l.length||d.type!==Q.literal||typeof l[l.length-1]!="string"?l.push(d.value):l[l.length-1]+=d.value,l},[]);return c.length<=1?c[0]||"":c},this.formatToParts=function(s){return Qt(n.ast,n.locales,n.formatters,n.formats,s,void 0,n.message)},this.resolvedOptions=function(){return{locale:n.resolvedLocale.toString()}},this.getAst=function(){return n.ast},this.locales=t,this.resolvedLocale=e.resolveLocale(t),typeof r=="string"){if(this.message=r,!e.__parse)throw new TypeError("IntlMessageFormat.__parse must be set to process `message` of type `string`");this.ast=e.__parse(r,{ignoreTag:i?.ignoreTag,locale:this.resolvedLocale})}else this.ast=r;if(!Array.isArray(this.ast))throw new TypeError("A message must be provided as a String or AST.");this.formats=pd(e.formats,a),this.formatters=i&&i.formatters||md(this.formatterCache)}return Object.defineProperty(e,"defaultLocale",{get:function(){return e.memoizedDefaultLocale||(e.memoizedDefaultLocale=new Intl.NumberFormat().resolvedOptions().locale),e.memoizedDefaultLocale},enumerable:!1,configurable:!0}),e.memoizedDefaultLocale=null,e.resolveLocale=function(r){var t=Intl.NumberFormat.supportedLocalesOf(r);return t.length>0?new Intl.Locale(t[0]):new Intl.Locale(typeof r=="string"?r:r[0])},e.__parse=$o,e.formats={number:{integer:{maximumFractionDigits:0},currency:{style:"currency"},percent:{style:"percent"}},date:{short:{month:"numeric",day:"numeric",year:"2-digit"},medium:{month:"short",day:"numeric",year:"numeric"},long:{month:"long",day:"numeric",year:"numeric"},full:{weekday:"long",month:"long",day:"numeric",year:"numeric"}},time:{short:{hour:"numeric",minute:"numeric"},medium:{hour:"numeric",minute:"numeric",second:"numeric"},long:{hour:"numeric",minute:"numeric",second:"numeric",timeZoneName:"short"},full:{hour:"numeric",minute:"numeric",second:"numeric",timeZoneName:"short"}}},e}();var Yo=Wo;var gi={recurrenceLabel:"{recurrenceTerm, select, MONTH {/mo} YEAR {/yr} other {}}",recurrenceAriaLabel:"{recurrenceTerm, select, MONTH {per month} YEAR {per year} other {}}",perUnitLabel:"{perUnit, select, LICENSE {per license} other {}}",perUnitAriaLabel:"{perUnit, select, LICENSE {per license} other {}}",freeLabel:"Free",freeAriaLabel:"Free",taxExclusiveLabel:"{taxTerm, select, GST {excl. GST} VAT {excl. VAT} TAX {excl. tax} IVA {excl. IVA} SST {excl. SST} KDV {excl. KDV} other {}}",taxInclusiveLabel:"{taxTerm, select, GST {incl. GST} VAT {incl. VAT} TAX {incl. tax} IVA {incl. IVA} SST {incl. SST} KDV {incl. KDV} other {}}",alternativePriceAriaLabel:"Alternatively at",strikethroughAriaLabel:"Regularly at",planTypeLabel:"{planType, select, ABM {Annual, billed monthly} other {}}"},ud=In("ConsonantTemplates/price"),gd=/<\/?[^>]+(>|$)/g,$={container:"price",containerOptical:"price-optical",containerStrikethrough:"price-strikethrough",containerPromoStrikethrough:"price-promo-strikethrough",containerAlternative:"price-alternative",containerAnnual:"price-annual",containerAnnualPrefix:"price-annual-prefix",containerAnnualSuffix:"price-annual-suffix",disabled:"disabled",currencySpace:"price-currency-space",currencySymbol:"price-currency-symbol",decimals:"price-decimals",decimalsDelimiter:"price-decimals-delimiter",integer:"price-integer",recurrence:"price-recurrence",taxInclusivity:"price-tax-inclusivity",unitType:"price-unit-type"},He={perUnitLabel:"perUnitLabel",perUnitAriaLabel:"perUnitAriaLabel",recurrenceLabel:"recurrenceLabel",recurrenceAriaLabel:"recurrenceAriaLabel",taxExclusiveLabel:"taxExclusiveLabel",taxInclusiveLabel:"taxInclusiveLabel",strikethroughAriaLabel:"strikethroughAriaLabel",alternativePriceAriaLabel:"alternativePriceAriaLabel"},fi="TAX_EXCLUSIVE",fd=e=>Rn(e)?Object.entries(e).filter(([,r])=>vt(r)||Er(r)||r===!0).reduce((r,[t,a])=>`${r} ${t}${a===!0?"":`="${Mn(a)}"`}`,""):"",q=(e,r,t,a=!1)=>`<span class="${e}${r?"":` ${$.disabled}`}"${fd(t)}>${a?so(r):r??""}</span>`;function vd(e){e=e.replaceAll("</a>","&lt;/a&gt;");let r=/<a [^>]+(>|$)/g;return e.match(r)?.forEach(a=>{let i=a.replace("<a ","&lt;a ").replace(">","&gt;");e=e.replaceAll(a,i)}),e}function xd(e){e=e.replaceAll("&lt;/a&gt;","</a>");let r=/&lt;a (?!&gt;)(.*?)(&gt;|$)/g;return e.match(r)?.forEach(a=>{let i=a.replace("&lt;a ","<a ").replace("&gt;",">");e=e.replaceAll(a,i)}),e}function Pe(e,r,t,a){let i=e[t];if(i==null)return"";let n=i.includes("<"),s=i.includes("<a ");try{i=s?vd(i):i,i=n?i.replace(gd,""):i;let o=new Yo(i,r).format(a);return s?xd(o):o}catch{return ud.error("Failed to format literal:",i),""}}function bd(e,{accessibleLabel:r,altAccessibleLabel:t,currencySymbol:a,decimals:i,decimalsDelimiter:n,hasCurrencySpace:s,integer:o,isCurrencyFirst:c,recurrenceLabel:l,perUnitLabel:d,taxInclusivityLabel:p},m={}){let h=q($.currencySymbol,a),u=q($.currencySpace,s?"&nbsp;":""),f="";return r?f=`<sr-only class="strikethrough-aria-label">${r}</sr-only>`:t&&(f=`<sr-only class="alt-aria-label">${t}</sr-only>`),c&&(f+=h+u),f+=q($.integer,o),f+=q($.decimalsDelimiter,n),f+=q($.decimals,i),c||(f+=u+h),f+=q($.recurrence,l,null,!0),f+=q($.unitType,d,null,!0),f+=q($.taxInclusivity,p,!0),q(e,f,{...m})}var K=({isAlternativePrice:e=!1,displayOptical:r=!1,displayStrikethrough:t=!1,displayPromoStrikethrough:a=!1,displayAnnual:i=!1,instant:n=void 0}={})=>({country:s,displayFormatted:o=!0,displayRecurrence:c=!0,displayPerUnit:l=!1,displayTax:d=!1,language:p,literals:m={},quantity:h=1,space:u=!1,isPromoApplied:f=!1}={},{commitment:x,offerSelectorIds:y,formatString:A,price:b,priceWithoutDiscount:C,taxDisplay:z,taxTerm:N,term:U,usePrecision:V,promotion:J}={},Z={})=>{Object.entries({country:s,formatString:A,language:p,price:b}).forEach(([Rs,Os])=>{if(Os==null)throw new Error(`Argument "${Rs}" is missing for osi ${y?.toString()}, country ${s}, language ${p}`)});let F={...gi,...m},O=`${p.toLowerCase()}-${s.toUpperCase()}`,re;J&&!f&&C?re=e||a?b:C:t&&C?re=C:re=b;let de=r?lo:ho;i&&(de=po);let{accessiblePrice:tt,recurrenceTerm:Ai,...Ci}=de({commitment:x,formatString:A,instant:n,isIndianPrice:s==="IN",originalPrice:b,priceWithoutDiscount:C,price:r?b:re,promotion:J,quantity:h,term:U,usePrecision:V}),Vr="",jr="",Wr="";E(c)&&Ai&&(Wr=Pe(F,O,He.recurrenceLabel,{recurrenceTerm:Ai}));let ir="";E(l)&&(u&&(ir+=" "),ir+=Pe(F,O,He.perUnitLabel,{perUnit:"LICENSE"}));let nr="";E(d)&&N&&(u&&(nr+=" "),nr+=Pe(F,O,z===fi?He.taxExclusiveLabel:He.taxInclusiveLabel,{taxTerm:N})),t&&(Vr=Pe(F,O,He.strikethroughAriaLabel,{strikethroughPrice:Vr})),e&&(jr=Pe(F,O,He.alternativePriceAriaLabel,{alternativePrice:jr}));let Fe=$.container;if(r&&(Fe+=` ${$.containerOptical}`),t&&(Fe+=` ${$.containerStrikethrough}`),a&&(Fe+=` ${$.containerPromoStrikethrough}`),e&&(Fe+=` ${$.containerAlternative}`),i&&(Fe+=` ${$.containerAnnual}`),E(o))return bd(Fe,{...Ci,accessibleLabel:Vr,altAccessibleLabel:jr,recurrenceLabel:Wr,perUnitLabel:ir,taxInclusivityLabel:nr},Z);let{currencySymbol:Ti,decimals:ks,decimalsDelimiter:_s,hasCurrencySpace:ki,integer:Ps,isCurrencyFirst:Ls}=Ci,rt=[Ps,_s,ks];Ls?(rt.unshift(ki?"\xA0":""),rt.unshift(Ti)):(rt.push(ki?"\xA0":""),rt.push(Ti)),rt.push(Wr,ir,nr);let Ms=rt.join("");return q(Fe,Ms,Z)},Xo=()=>(e,r,t)=>{let a=Ke(r.promotion,r.promotion?.displaySummary?.instant,Array.isArray(e.quantity)?e.quantity[0]:e.quantity),n=(e.displayOldPrice===void 0||E(e.displayOldPrice))&&r.priceWithoutDiscount&&r.priceWithoutDiscount!=r.price&&(!r.promotion||a);return`${n?`${K({displayStrikethrough:!0})({isPromoApplied:a,...e,displayPerUnit:!1,displayTax:!1},r,t)}&nbsp;`:""}${K({isAlternativePrice:n})({isPromoApplied:a,...e},r,t)}`},Ko=()=>(e,r,t)=>{let{instant:a}=e;try{a||(a=new URLSearchParams(document.location.search).get("instant")),a&&(a=new Date(a))}catch{a=void 0}let i=Ke(r.promotion,a,Array.isArray(e.quantity)?e.quantity[0]:e.quantity),n={...e,displayTax:!1,displayPerUnit:!1,isPromoApplied:i};if(!i)return K()(e,{...r,price:r.priceWithoutDiscount},t)+q($.containerAnnualPrefix," (")+K({displayAnnual:!0,instant:a})(n,{...r,price:r.priceWithoutDiscount},t)+q($.containerAnnualSuffix,")");let o=(e.displayOldPrice===void 0||E(e.displayOldPrice))&&r.priceWithoutDiscount&&r.priceWithoutDiscount!=r.price;return`${o?`${K({displayStrikethrough:!0})(n,r,t)}&nbsp;`:""}${K({isAlternativePrice:o})({isPromoApplied:i,...e},r,t)}${q($.containerAnnualPrefix," (")}${K({displayAnnual:!0,instant:a})(n,r,t)}${q($.containerAnnualSuffix,")")}`},Zo=()=>(e,r,t)=>{let a={...e,displayTax:!1,displayPerUnit:!1};return`${K({isAlternativePrice:e.displayOldPrice})(e,r,t)}${q($.containerAnnualPrefix," (")}${K({displayAnnual:!0})(a,r,t)}${q($.containerAnnualSuffix,")")}`};var Jt={...$,containerLegal:"price-legal",planType:"price-plan-type"},Gr={...He,planTypeLabel:"planTypeLabel"};function yd(e,{perUnitLabel:r,taxInclusivityLabel:t,planTypeLabel:a},i={},n=!0){let s="";return s+=q(Jt.unitType,r,null,!0),t&&a&&n&&(t+=t.endsWith(".")?" ":". "),s+=q(Jt.taxInclusivity,t,!0),s+=q(Jt.planType,a,null),q(e,s,{...i})}var Qo=({country:e,displayPerUnit:r=!1,displayTax:t=!1,displayPlanType:a=!1,displayDot:i=!0,language:n,literals:s={}}={},{taxDisplay:o,taxTerm:c,planType:l}={},d={})=>{let p={...gi,...s},m=`${n.toLowerCase()}-${e.toUpperCase()}`,h="";E(r)&&(h=Pe(p,m,Gr.perUnitLabel,{perUnit:"LICENSE"}));let u="";e==="US"&&n==="en"&&(t=!1),E(t)&&c&&(u=Pe(p,m,o===fi?Gr.taxExclusiveLabel:Gr.taxInclusiveLabel,{taxTerm:c}));let f="";E(a)&&l&&(f=Pe(p,m,Gr.planTypeLabel,{planType:l}));let x=Jt.container;return x+=` ${Jt.containerLegal}`,yd(x,{perUnitLabel:h,taxInclusivityLabel:u,planTypeLabel:f},d,i)};var Jo=K(),es=Xo(),ts=K({displayOptical:!0}),rs=K({displayStrikethrough:!0}),as=K({displayPromoStrikethrough:!0}),is=K({displayAnnual:!0}),ns=K({displayOptical:!0,isAlternativePrice:!0}),os=K({isAlternativePrice:!0}),ss=Zo(),cs=Ko(),ls=Qo;var wd=(e,r)=>{if(!r&&xt(e))return 0;if(!(!xt(e)||!xt(r)))return Math.floor((r-e)/r*100)},ds=()=>(e,r)=>{let{price:t,priceWithoutDiscount:a}=r,i=wd(t,a);return i===void 0?'<span class="no-discount"></span>':`<span class="discount">${i}%</span>`};var hs=ds();var ps="INDIVIDUAL_COM",xi="TEAM_COM",ms="INDIVIDUAL_EDU",bi="TEAM_EDU",Ed=["AT_de","AU_en","BE_en","BE_fr","BE_nl","BG_bg","CH_de","CH_fr","CH_it","CZ_cs","CO_es","DE_de","DK_da","EE_et","EG_ar","EG_en","ES_es","FI_fi","FR_fr","GB_en","GR_el","GR_en","HU_hu","ID_en","ID_id","ID_in","IE_en","IN_en","IN_hi","IT_it","JP_ja","KR_ko","LU_de","LU_en","LU_fr","LT_lt","LV_lv","MY_en","MY_ms","MU_en","NL_nl","NG_en","NO_nb","NZ_en","PE_es","PL_pl","PT_pt","RO_ro","SE_sv","SI_sl","SK_sk","SG_en","TH_en","TH_th","TR_tr","UA_uk","ZA_en","SA_ar","SA_en","MX_es","CL_es","PE_es","PH_en","PH_fil","VN_vi","VN_en","TW_zh"],Sd={[ps]:[],[xi]:[],[ms]:[],[bi]:[]},Ad={MU_en:[!0,!0,!0,!0],NG_en:[!1,!1,!1,!1],AU_en:[!1,!1,!1,!1],JP_ja:[!1,!1,!1,!1],NZ_en:[!1,!1,!1,!1],TH_en:[!1,!1,!1,!1],TH_th:[!1,!1,!1,!1],ZA_en:[!1,!1,!1,!1],PE_es:[!1,!1,!1,!1]},Cd=[ps,xi,ms,bi],Td=e=>[xi,bi].includes(e);function vi(e,r,t,a){if(e[r])return e[r];let i=`${r}_${t}`;if(e[i])return e[i];let n;if(a)n=e.find(s=>s.startsWith(`${r}_`));else{let s=Object.keys(e).find(o=>o.startsWith(`${r}_`));n=s?e[s]:null}return n}var kd=(e,r,t,a)=>{let i=`${t}_${a}`,n=vi(Ad,e,r,!1);if(n){let s=Cd.indexOf(i);return n[s]}return Td(i)},_d=(e,r,t,a)=>{if(vi(Ed,e,r,!0))return!0;let i=Sd[`${t}_${a}`];return i?vi(i,e,r,!0)?!0:R.displayTax:R.displayTax},yi=async(e,r,t,a)=>{let i=_d(e,r,t,a);return{displayTax:i,forceTaxExclusive:i?kd(e,r,t,a):R.forceTaxExclusive}},er=class er extends HTMLSpanElement{constructor(){super();g(this,"masElement",new ze(this));this.handleClick=this.handleClick.bind(this)}static get observedAttributes(){return["data-display-old-price","data-display-per-unit","data-display-recurrence","data-display-tax","data-display-plan-type","data-display-annual","data-perpetual","data-promotion-code","data-force-tax-exclusive","data-template","data-wcs-osi","data-quantity"]}static createInlinePrice(t){let a=se();if(!a)return null;let{displayOldPrice:i,displayPerUnit:n,displayRecurrence:s,displayTax:o,displayPlanType:c,displayAnnual:l,forceTaxExclusive:d,perpetual:p,promotionCode:m,quantity:h,alternativePrice:u,template:f,wcsOsi:x}=a.collectPriceOptions(t);return Rr(er,{displayOldPrice:i,displayPerUnit:n,displayRecurrence:s,displayTax:o,displayPlanType:c,displayAnnual:l,forceTaxExclusive:d,perpetual:p,promotionCode:m,quantity:h,alternativePrice:u,template:f,wcsOsi:x})}get isInlinePrice(){return!0}attributeChangedCallback(t,a,i){this.masElement.attributeChangedCallback(t,a,i)}connectedCallback(){this.masElement.connectedCallback(),this.addEventListener("click",this.handleClick)}disconnectedCallback(){this.masElement.disconnectedCallback(),this.removeEventListener("click",this.handleClick)}handleClick(t){t.target!==this&&(t.stopImmediatePropagation(),this.dispatchEvent(new MouseEvent("click",{bubbles:!0,cancelable:!0,view:window})))}onceSettled(){return this.masElement.onceSettled()}get value(){return this.masElement.value}get options(){return this.masElement.options}get isFailed(){return this.masElement.state===ue}requestUpdate(t=!1){return this.masElement.requestUpdate(t)}async render(t={}){if(!this.isConnected)return!1;let a=se();if(!a)return!1;let i=a.collectPriceOptions(t,this),n={...a.settings,...i};if(!n.wcsOsi.length)return!1;try{let s=this.masElement.togglePending({});this.innerHTML="";let o=a.resolveOfferSelectors(n),c=await Promise.all(o),l=c.map(h=>{let u=qt(h,n);return u?.length?u[0]:null});if(l.some(h=>!h))throw new Error(`Failed to select offers for: ${n.wcsOsi}`);let d=l,p=Xa(l);if(a.featureFlags[Ce]||n[Ce]){if(i.displayPerUnit===void 0&&(n.displayPerUnit=p.customerSegment!=="INDIVIDUAL"),i.displayTax===void 0||i.forceTaxExclusive===void 0){let{country:h,language:u}=n,[f=""]=p.marketSegments,x=await yi(h,u,p.customerSegment,f);i.displayTax===void 0&&(n.displayTax=x?.displayTax||n.displayTax),i.forceTaxExclusive===void 0&&(n.forceTaxExclusive=x?.forceTaxExclusive||n.forceTaxExclusive),n.forceTaxExclusive&&(d=c.map(y=>{let A=qt(y,n);return A?.length?A[0]:null}))}}else i.displayOldPrice===void 0&&(n.displayOldPrice=!0);if(a.featureFlags[at]&&n.displayAnnual!==!1&&(n.displayAnnual=!0),n.template==="discount"&&d.length===2){let[h,u]=d,f={...h,priceDetails:{...h.priceDetails,priceWithoutDiscount:u.priceDetails?.price}};return this.renderOffers([f],n,s)}let m=Xa(d);return this.renderOffers([m],n,s)}catch(s){throw this.innerHTML="",s}}renderOffers(t,a,i=void 0){if(!this.isConnected)return;let n=se();if(!n)return!1;if(i??(i=this.masElement.togglePending()),t.length){if(this.masElement.toggleResolved(i,t,a)){this.innerHTML=n.buildPriceHTML(t,this.options);let s=this.closest("p, h3, div");if(!s||!s.querySelector('span[data-template="strikethrough"]')||s.querySelector(".alt-aria-label"))return!0;let o=s?.querySelectorAll('span[is="inline-price"]');return o.length>1&&o.length===s.querySelectorAll('span[data-template="strikethrough"]').length*2&&o.forEach(c=>{c.dataset.template!=="strikethrough"&&c.options&&!c.options.alternativePrice&&!c.isFailed&&(c.options.alternativePrice=!0,c.innerHTML=n.buildPriceHTML(t,c.options))}),!0}}else{let s=new Error(`Not provided: ${this.options?.wcsOsi??"-"}`);if(this.masElement.toggleFailed(i,s,this.options))return this.innerHTML="",!0}return!1}};g(er,"is","inline-price"),g(er,"tag","span");var Le=er;window.customElements.get(Le.is)||window.customElements.define(Le.is,Le,{extends:Le.tag});function us({literals:e,providers:r,settings:t}){function a(s,o=null){let c={country:t.country,language:t.language,locale:t.locale,literals:{...e.price}};if(o&&r?.price)for(let N of r.price)N(o,c);let{displayOldPrice:l,displayPerUnit:d,displayRecurrence:p,displayTax:m,displayPlanType:h,forceTaxExclusive:u,perpetual:f,displayAnnual:x,promotionCode:y,quantity:A,alternativePrice:b,wcsOsi:C,...z}=Object.assign(c,o?.dataset??{},s??{});return c=Sr(Object.assign({...c,...z,displayOldPrice:E(l),displayPerUnit:E(d),displayRecurrence:E(p),displayTax:E(m),displayPlanType:E(h),forceTaxExclusive:E(u),perpetual:E(f),displayAnnual:E(x),promotionCode:Tr(y).effectivePromoCode,quantity:bt(A,R.quantity),alternativePrice:E(b),wcsOsi:Mr(C)})),c}function i(s,o){if(!Array.isArray(s)||!s.length||!o)return"";let{template:c}=o,l;switch(c){case"discount":l=hs;break;case"strikethrough":l=rs;break;case"promo-strikethrough":l=as;break;case"annual":l=is;break;case"legal":l=ls;break;default:o.template==="optical"&&o.alternativePrice?l=ns:o.template==="optical"?l=ts:o.displayAnnual&&s[0].planType==="ABM"?l=o.promotionCode&&s[0].promotion?cs:ss:o.alternativePrice?l=os:l=o.promotionCode&&s[0].promotion?es:Jo}let[d]=s;return d={...d,...d.priceDetails},l({...t,...o},d)}let n=Le.createInlinePrice;return{InlinePrice:Le,buildPriceHTML:i,collectPriceOptions:a,createInlinePrice:n}}function Pd({locale:e=void 0,country:r=void 0,language:t=void 0}={}){return t??(t=e?.split("_")?.[0]||R.language),r??(r=e?.split("_")?.[1]||R.country),e??(e=`${t}_${r}`),{locale:e,country:r,language:t}}function gs(e={},r){let t=r.featureFlags[Ce],{commerce:a={}}=e,i=ve.PRODUCTION,n=ua,s=H("checkoutClientId",a)??R.checkoutClientId,o=Gt(H("checkoutWorkflowStep",a),ie,R.checkoutWorkflowStep),c=E(H("displayOldPrice",a),R.displayOldPrice),l=R.displayPerUnit,d=E(H("displayRecurrence",a),R.displayRecurrence),p=E(H("displayTax",a),R.displayTax),m=E(H("displayPlanType",a),R.displayPlanType),h=E(H("entitlement",a),R.entitlement),u=E(H("modal",a),R.modal),f=E(H("forceTaxExclusive",a),R.forceTaxExclusive),x=H("promotionCode",a)??R.promotionCode,y=bt(H("quantity",a)),A=H("wcsApiKey",a)??R.wcsApiKey,b=a?.env==="stage",C=Oe.PUBLISHED;["true",""].includes(a.allowOverride)&&(b=(H(pa,a,{metadata:!1})?.toLowerCase()??a?.env)==="stage",C=Gt(H(ma,a),Oe,C)),b&&(i=ve.STAGE,n=ga);let N=H(ha)??e.preview,U=typeof N<"u"&&N!=="off"&&N!=="false",V={};U&&(V={preview:U});let J=H("mas-io-url")??e.masIOUrl,Z=zi(J)?J:`https://www${i===ve.STAGE?".stage":""}.adobe.com/mas/io`,F=H("preselect-plan")??void 0,O=H("instant")??e.instant;return{...Pd(e),...V,displayOldPrice:c,checkoutClientId:s,checkoutWorkflowStep:o,displayPerUnit:l,displayRecurrence:d,displayTax:p,displayPlanType:m,entitlement:h,extraOptions:R.extraOptions,modal:u,env:i,forceTaxExclusive:f,promotionCode:x,quantity:y,alternativePrice:R.alternativePrice,wcsApiKey:A,wcsURL:n,landscape:C,masIOUrl:Z,...F&&{preselectPlan:F},...O&&{instant:O}}}async function fs(e,r={},t=2,a=100){let i;for(let n=0;n<=t;n++)try{let s=await fetch(e,r);return s.retryCount=n,s}catch(s){if(i=s,i.retryCount=n,n>t)break;await new Promise(o=>setTimeout(o,a*(n+1)))}throw i}var wi="wcs";function vs({settings:e}){let r=oe.module(wi),{env:t,wcsApiKey:a}=e,i=new Map,n=new Map,s,o=new Map;async function c(u,f,x=!0){let y=se(),A=ca;r.debug("Fetching:",u);let b="",C;if(u.offerSelectorIds.length>1)throw new Error("Multiple OSIs are not supported anymore");let z=new Map(f),[N]=u.offerSelectorIds,U=Date.now()+Math.random().toString(36).substring(2,7),V=`${wi}:${N}:${U}${va}`,J=`${wi}:${N}:${U}${xa}`,Z;try{if(performance.mark(V),b=new URL(e.wcsURL),b.searchParams.set("offer_selector_ids",N),b.searchParams.set("country",u.country),b.searchParams.set("locale",u.locale),b.searchParams.set("landscape",t===ve.STAGE?"ALL":e.landscape),b.searchParams.set("api_key",a),u.language&&b.searchParams.set("language",u.language),u.promotionCode&&b.searchParams.set("promotion_code",u.promotionCode),u.currency&&b.searchParams.set("currency",u.currency),C=await fs(b.toString(),{credentials:"omit"}),C.ok){let F=[];try{let O=await C.json();r.debug("Fetched:",u,O),F=O.resolvedOffers??[]}catch(O){r.error(`Error parsing JSON: ${O.message}`,{...O.context,...y?.duration})}F=F.map(kr),f.forEach(({resolve:O},re)=>{let de=F.filter(({offerSelectorIds:tt})=>tt.includes(re)).flat();de.length&&(z.delete(re),f.delete(re),O(de))})}else A=sa}catch(F){A=`Network error: ${F.message}`}finally{Z=performance.measure(J,V),performance.clearMarks(V),performance.clearMeasures(J)}if(x&&f.size){r.debug("Missing:",{offerSelectorIds:[...f.keys()]});let F=Yn(C);f.forEach(O=>{O.reject(new yt(A,{...u,...F,response:C,measure:dr(Z),...y?.duration}))})}}function l(){clearTimeout(s);let u=[...n.values()];n.clear(),u.forEach(({options:f,promises:x})=>c(f,x))}function d(u){if(!u||typeof u!="object")throw new TypeError("Cache must be a Map or similar object");let f=t===ve.STAGE?"stage":"prod",x=u[f];if(!x||typeof x!="object"){r.warn(`No cache found for environment: ${t}`);return}for(let[y,A]of Object.entries(x))i.set(y,Promise.resolve(A.map(kr)));r.debug(`Prefilled WCS cache with ${x.size} entries`)}function p(){let u=i.size;o=new Map(i),i.clear(),r.debug(`Moved ${u} cache entries to stale cache`)}function m(u,f,x){let y=u!=="GB"&&!x?"MULT":"en",A=ba.includes(u)?u:R.country;return{validCountry:A,validLanguage:y,locale:`${f}_${A}`}}function h({country:u,language:f,perpetual:x=!1,promotionCode:y="",wcsOsi:A=[]}){let{validCountry:b,validLanguage:C,locale:z}=m(u,f,x),N=[b,C,y].filter(U=>U).join("-").toLowerCase();return A.map(U=>{let V=`${U}-${N}`;if(i.has(V))return i.get(V);let J=new Promise((Z,F)=>{let O=n.get(N);O||(O={options:{country:b,locale:z,...C==="MULT"&&{language:C},offerSelectorIds:[]},promises:new Map},n.set(N,O)),y&&(O.options.promotionCode=y),O.options.offerSelectorIds.push(U),O.promises.set(U,{resolve:Z,reject:F}),l()}).catch(Z=>{if(o.has(V))return o.get(V);throw Z});return i.set(V,J),J})}return{Commitment:Ue,PlanType:zn,Term:he,applyPlanType:kr,resolveOfferSelectors:h,flushWcsCacheInternal:p,prefillWcsCache:d,normalizeCountryLanguageAndLocale:m}}var xs="mas-commerce-service",bs="mas-commerce-service:start",ys="mas-commerce-service:ready",tr,Et,Je,ws,Si,Ei=class extends HTMLElement{constructor(){super(...arguments);M(this,Je);M(this,tr);M(this,Et);g(this,"lastLoggingTime",0)}async registerCheckoutAction(t){typeof t=="function"&&(this.buildCheckoutAction=async(a,i,n)=>{let s=await t?.(a,i,this.imsSignedInPromise,n);return s||null})}get featureFlags(){return v(this,Et)||T(this,Et,{[Ce]:j(this,Je,Si).call(this,Ce),[at]:j(this,Je,Si).call(this,at)}),v(this,Et)}activate(){let t=v(this,Je,ws),a=gs(t,this);_r(t.lana);let i=oe.init(t.hostEnv).module("service");i.debug("Activating:",t);let s={price:wo(a)},o={checkout:new Set,price:new Set},c={literals:s,providers:o,settings:a};Object.defineProperties(this,Object.getOwnPropertyDescriptors({...xo(c),...bo(c),...us(c),...vs(c),...ya,Log:oe,resolvePriceTaxFlags:yi,get defaults(){return R},get log(){return oe},get providers(){return{checkout(d){return o.checkout.add(d),()=>o.checkout.delete(d)},price(d){return o.price.add(d),()=>o.price.delete(d)},has:d=>o.price.has(d)||o.checkout.has(d)}},get settings(){return a}})),i.debug("Activated:",{literals:s,settings:a});let l=new CustomEvent(sr,{bubbles:!0,cancelable:!1,detail:this});performance.mark(ys),T(this,tr,performance.measure(ys,bs)),this.dispatchEvent(l),setTimeout(()=>{this.logFailedRequests()},1e4)}connectedCallback(){performance.mark(bs),this.activate()}flushWcsCache(){this.flushWcsCacheInternal(),this.log.debug("Flushed WCS cache")}isPreview(){let t=this.getAttribute("preview");return t!=null&&["true","on",!0].includes(t)}refreshOffers(){this.flushWcsCacheInternal(),document.querySelectorAll(Kr).forEach(t=>t.requestUpdate(!0)),this.log.debug("Refreshed WCS offers"),this.logFailedRequests()}refreshFragments(){this.flushWcsCacheInternal(),customElements.get("aem-fragment")?.cache.clear(),document.querySelectorAll("aem-fragment").forEach(t=>t.refresh(!1)),this.log.debug("Refreshed AEM fragments"),this.logFailedRequests()}get duration(){return{"mas-commerce-service:measure":dr(v(this,tr))}}logFailedRequests(){let t=[...performance.getEntriesByType("resource")].filter(({startTime:i})=>i>this.lastLoggingTime).filter(({transferSize:i,duration:n,responseStatus:s})=>i===0&&n===0&&s<200||s>=400),a=Array.from(new Map(t.map(i=>[i.name,i])).values());if(a.some(({name:i})=>/(\/fragment\?|web_commerce_artifact)/.test(i))){let i=a.map(({name:n})=>n);this.log.error("Failed requests:",{failedUrls:i,...this.duration})}this.lastLoggingTime=performance.now().toFixed(3)}};tr=new WeakMap,Et=new WeakMap,Je=new WeakSet,ws=function(){let t=this.getAttribute("env")??"prod",a={commerce:{env:t},hostEnv:{name:t},lana:{tags:this.getAttribute("lana-tags"),sampleRate:parseInt(this.getAttribute("lana-sample-rate")??1,10),isProdDomain:t==="prod"},masIOUrl:this.getAttribute("mas-io-url")};return["locale","country","language","preview","instant"].forEach(i=>{let n=this.getAttribute(i);n&&(a[i]=n)}),["checkout-workflow-step","force-tax-exclusive","checkout-client-id","allow-override","wcs-api-key"].forEach(i=>{let n=this.getAttribute(i);if(n!=null){let s=i.replace(/-([a-z])/g,o=>o[1].toUpperCase());a.commerce[s]=n}}),a},Si=function(t){return["on","true",!0].includes(this.getAttribute(`data-${t}`)||H(t))};window.customElements.get(xs)||window.customElements.define(xs,Ei);var Cs="merch-card-collection",Ld=3e4,Md={catalog:["four-merch-cards"],plans:["four-merch-cards"],plansTwoColumns:["two-merch-cards"],plansThreeColumns:["three-merch-cards"],product:["four-merch-cards"],productTwoColumns:["two-merch-cards"],productThreeColumns:["three-merch-cards"],segment:["four-merch-cards"],segmentTwoColumns:["two-merch-cards"],segmentThreeColumns:["three-merch-cards"],"special-offers":["three-merch-cards"],image:["three-merch-cards"],"mini-compare-chart":["three-merch-cards"],"mini-compare-chartTwoColumns":["two-merch-cards"],"mini-compare-chart-mweb":["three-merch-cards"],"mini-compare-chart-mwebTwoColumns":["two-merch-cards"]},Rd={plans:!0},Od=(e,{filter:r})=>e.filter(t=>t?.filters&&t?.filters.hasOwnProperty(r)),Nd=(e,{types:r})=>r?(r=r.split(","),e.filter(t=>r.some(a=>t.types.includes(a)))):e,Id=e=>e.sort((r,t)=>(r.title??"").localeCompare(t.title??"","en",{sensitivity:"base"})),Dd=(e,{filter:r})=>e.sort((t,a)=>a.filters[r]?.order==null||isNaN(a.filters[r]?.order)?-1:t.filters[r]?.order==null||isNaN(t.filters[r]?.order)?1:t.filters[r].order-a.filters[r].order),zd=(e,{search:r})=>r?.length?(r=r.toLowerCase(),e.filter(t=>(t.title??"").toLowerCase().includes(r))):e,Be,At,et,ar,qr,Ts,St=class extends Ss{constructor(){super();M(this,qr);M(this,Be,{});M(this,At);M(this,et);M(this,ar);this.id=null,this.filter="all",this.hasMore=!1,this.resultCount=void 0,this.displayResult=!1,this.data=null,this.variant=null,this.hydrating=!1,this.hydrationReady=null,this.literalsHandlerAttached=!1,this.onUnmount=[],this.resizeHandlerDebounced=Di(this.resizeHandler.bind(this),300)}resizeHandler(){this.firstChild?.variantLayout?.resizeHandler?.()}render(){return Me` <slot></slot>
            ${this.footer}`}checkReady(){if(!this.querySelector("aem-fragment"))return Promise.resolve(!0);let a=new Promise(i=>setTimeout(()=>i(!1),Ld));return Promise.race([this.hydrationReady,a])}updated(t){if(!this.querySelector("merch-card"))return;let a=window.scrollY||document.documentElement.scrollTop,i=[...this.children].filter(l=>l.tagName==="MERCH-CARD"&&!l.failed);if(i.length===0)return;t.has("singleApp")&&this.singleApp&&i.forEach(l=>{l.updateFilters(l.name===this.singleApp)});let n=this.sort===ge.alphabetical?Id:Dd,o=[Od,Nd,zd,n].reduce((l,d)=>d(l,this),i).map((l,d)=>[l,d]);if(this.resultCount=o.length,this.page&&this.limit){let l=this.page*this.limit;this.hasMore=o.length>l,o=o.filter(([,d])=>d<l)}let c=new Map(o.reverse());for(let l of c.keys())this.prepend(l);i.forEach(l=>{c.has(l)?(l.size=l.filters[this.filter]?.size,l.style.removeProperty("display"),l.requestUpdate()):(l.style.display="none",l.size=void 0)}),window.scrollTo(0,a),this.updateComplete.then(()=>{this.dispatchLiteralsChanged(),this.sidenav&&!this.literalsHandlerAttached&&(this.sidenav.addEventListener(ea,()=>{this.dispatchLiteralsChanged()}),this.literalsHandlerAttached=!0)})}dispatchLiteralsChanged(){this.dispatchEvent(new CustomEvent(me,{detail:{resultCount:this.resultCount,searchTerm:this.search,filter:this.sidenav?.filters?.selectedText}}))}buildOverrideMap(){T(this,Be,{}),this.overrides?.split(",").forEach(t=>{let[a,i]=t?.split(":");a&&i&&(v(this,Be)[a]=i)})}connectedCallback(){super.connectedCallback(),T(this,At,Mt()),v(this,At)&&T(this,et,v(this,At).Log.module(Cs)),T(this,ar,customElements.get("merch-card")),this.buildOverrideMap(),this.init(),window.addEventListener("resize",this.resizeHandlerDebounced)}async init(){await this.hydrate(),this.sidenav=this.parentElement.querySelector("merch-sidenav"),this.filtered?(this.filter=this.filtered,this.page=1):this.startDeeplink(),this.initializePlaceholders()}disconnectedCallback(){super.disconnectedCallback(),this.stopDeeplink?.();for(let t of this.onUnmount)t();window.removeEventListener("resize",this.resizeHandlerDebounced)}initializeHeader(){let t=document.createElement("merch-card-collection-header");t.collection=this,t.classList.add(this.variant),this.parentElement.insertBefore(t,this),this.header=t,this.querySelectorAll("[placeholder]").forEach(i=>{let n=i.getAttribute("slot");this.header.placeholderKeys.includes(n)&&this.header.append(i)})}initializePlaceholders(){let t=this.data?.placeholders||{};!t.searchText&&this.data?.sidenavSettings?.searchText&&(t.searchText=this.data.sidenavSettings.searchText);for(let a of Object.keys(t)){let i=t[a],n=i.includes("<p>")?"div":"p",s=document.createElement(n);s.setAttribute("slot",a),s.setAttribute("placeholder",""),s.innerHTML=i,this.append(s)}}attachSidenav(t,a=!0){if(!t)return;a&&this.parentElement.prepend(t),this.sidenav=t,this.sidenav.variant=this.variant,this.sidenav.classList.add(this.variant),Rd[this.variant]&&this.sidenav.setAttribute("autoclose",""),this.initializeHeader(),this.dispatchEvent(new CustomEvent(_t));let i=v(this,ar)?.getCollectionOptions(this.variant)?.onSidenavAttached;i&&i(this)}async hydrate(){if(this.hydrating)return!1;let t=this.querySelector("aem-fragment");if(!t)return;this.id=t.getAttribute("fragment"),this.hydrating=!0;let a;this.hydrationReady=new Promise(o=>{a=o});let i=this;function n(o){let c;return o.fields?.checkboxGroups?c=o.fields.checkboxGroups:o.fields?.tagFilters&&(c=[{title:o.fields?.tagFiltersTitle,label:"types",deeplink:"types",checkboxes:o.fields.tagFilters.map(l=>{let d=l.split("/").pop(),p=o.settings?.tagLabels?.[d]||d;return p=p.startsWith("coll-tag-filter")?d.charAt(0).toUpperCase()+d.slice(1):p,{name:d,label:p}})}]),{searchText:o.fields?.searchText,tagFilters:c,linksTitle:o.fields?.linksTitle,link:o.fields?.link,linkText:o.fields?.linkText,linkIcon:o.fields?.linkIcon}}function s(o,c){let l={cards:[],hierarchy:[],placeholders:o.placeholders,sidenavSettings:n(o)};function d(p,m){for(let h of m){if(h.fieldName==="variations")continue;if(h.fieldName==="cards"){if(l.cards.findIndex(b=>b.id===h.identifier)!==-1)continue;if(!o.references[h.identifier]?.value){v(i,et)?.error(`Reference not found for card: ${h.identifier}`);continue}l.cards.push(o.references[h.identifier].value);continue}let u=o.references[h.identifier]?.value,f=h.referencesTree,x=c[h.identifier];if(x){let b=document.querySelector(`aem-fragment[fragment="${x}"]`)?.rawData;if(b?.fields)u=b,f=b.referencesTree,o.references={...o.references,...b.references};else{v(i,et)?.error(`Override fragment ${x} not found or invalid:`);continue}}if(!u?.fields)continue;let{fields:y}=u,A={label:y.label||"",icon:y.icon,iconLight:y.iconLight,queryLabel:y.queryLabel,cards:y.cards?y.cards.map(b=>c[b]||b):[],collections:[]};y.defaultchild&&(A.defaultchild=c[y.defaultchild]||y.defaultchild),p.push(A),d(A.collections,f)}}return d(l.hierarchy,o.referencesTree),l.hierarchy.length===0&&(i.filtered="all"),l}t.addEventListener(ra,o=>{j(this,qr,Ts).call(this,"Error loading AEM fragment",o.detail),this.hydrating=!1,t.remove()}),t.addEventListener(ta,async o=>{this.limit=27,this.data=s(o.detail,v(this,Be)),o.detail.variationId&&this.setAttribute("variation-id",o.detail.variationId);let{cards:c,hierarchy:l}=this.data,d=l.length===0&&o.detail.fields?.defaultchild?v(this,Be)[o.detail.fields.defaultchild]||o.detail.fields.defaultchild:null;t.cache.add(...c);let p=(u,f)=>{for(let x of u)if(x.defaultchild===f||x.collections&&p(x.collections,f))return!0;return!1};for(let u of c){let b=function(z){for(let N of z){let U=N.cards.indexOf(x);if(U===-1)continue;let V=N.queryLabel??N?.label?.toLowerCase()??"";f.filters[V]={order:U+1,size:u.fields.size},b(N.collections)}},f=document.createElement("merch-card"),x=v(this,Be)[u.id]||u.id;f.setAttribute("consonant",""),f.setAttribute("style","");let y=u.fields.tags?.filter(z=>z.startsWith("mas:types/")).map(z=>z.split("/")[1]).join(",");y&&f.setAttribute("types",y),pr(u.fields.variant)?.supportsDefaultChild&&(d?x===d:p(l,x))&&f.setAttribute("data-default-card","true"),b(l);let C=document.createElement("aem-fragment");C.setAttribute("fragment",x),f.append(C),Object.keys(f.filters).length===0&&(f.filters={all:{order:c.indexOf(u)+1,size:u.fields.size}}),this.append(f)}let m="",h=Zn(c[0]?.fields?.variant);this.variant=h,h==="plans"&&(c.length===2||c.length===3)&&!c.some(u=>u.fields?.size?.includes("wide"))||(h==="segment"||h==="product")&&(c.length===2||c.length===3)?m=c.length===2?"TwoColumns":"ThreeColumns":(h==="mini-compare-chart"||h==="mini-compare-chart-mweb")&&c.length<=2&&(m=c.length===1?"":"TwoColumns"),h&&this.classList.add("merch-card-collection",h,...Md[`${h}${m}`]||[]),this.displayResult=!0,this.hydrating=!1,t.remove(),a(!0)}),await this.hydrationReady}get footer(){if(!this.filtered)return Me`<div id="footer">
