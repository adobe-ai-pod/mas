var Ri=Object.defineProperty;var Oi=e=>{throw TypeError(e)};var qs=(e,r,t)=>r in e?Ri(e,r,{enumerable:!0,configurable:!0,writable:!0,value:t}):e[r]=t;var Vs=(e,r)=>{for(var t in r)Ri(e,t,{get:r[t],enumerable:!0})};var m=(e,r,t)=>qs(e,typeof r!="symbol"?r+"":r,t),Zr=(e,r,t)=>r.has(e)||Oi("Cannot "+t);var v=(e,r,t)=>(Zr(e,r,"read from private field"),t?t.call(e):r.get(e)),M=(e,r,t)=>r.has(e)?Oi("Cannot add the same private member more than once"):r instanceof WeakSet?r.add(e):r.set(e,t),T=(e,r,t,a)=>(Zr(e,r,"write to private field"),a?a.call(e,t):r.set(e,t),t),j=(e,r,t)=>(Zr(e,r,"access private method"),t);import{html as Re,LitElement as Os,css as Ns,unsafeCSS as Rs,nothing as ve}from"./lit-all.min.js";var D="(max-width: 767px)",X="(max-width: 1199px)",I="(min-width: 768px)",_="(min-width: 1200px)",ee="(min-width: 1600px)",Ni="(min-width: 1280px)",Ii={matchMobile:window.matchMedia(D),matchDesktop:window.matchMedia(`${_} and (not ${ee})`),matchDesktopOrUp:window.matchMedia(_),matchLargeDesktop:window.matchMedia(ee),get isMobile(){return this.matchMobile.matches},get isDesktop(){return this.matchDesktop.matches},get isDesktopOrUp(){return this.matchDesktopOrUp.matches}},k=Ii;function dr(){return Ii.isDesktop}var Lt=class{constructor(r,t){this.key=Symbol("match-media-key"),this.matches=!1,this.host=r,this.host.addController(this),this.media=window.matchMedia(t),this.matches=this.media.matches,this.onChange=this.onChange.bind(this),r.addController(this)}hostConnected(){var r;(r=this.media)==null||r.addEventListener("change",this.onChange)}hostDisconnected(){var r;(r=this.media)==null||r.removeEventListener("change",this.onChange)}onChange(r){this.matches!==r.matches&&(this.matches=r.matches,this.host.requestUpdate(this.key,!this.matches))}};var Di="hashchange";function js(e=window.location.hash){let r=[],t=e.replace(/^#/,"").split("&");for(let a of t){let[i,n=""]=a.split("=");i&&r.push([i,decodeURIComponent(n.replace(/\+/g," "))])}return Object.fromEntries(r)}function Mt(e){let r=new URLSearchParams(window.location.hash.slice(1));Object.entries(e).forEach(([i,n])=>{n?r.set(i,n):r.delete(i)}),r.sort();let t=r.toString();if(t===window.location.hash)return;let a=window.scrollY||document.documentElement.scrollTop;window.location.hash=t,window.scrollTo(0,a)}function Hi(e){let r=()=>{if(window.location.hash&&!window.location.hash.includes("="))return;let t=js(window.location.hash);e(t)};return r(),window.addEventListener(Di,r),()=>{window.removeEventListener(Di,r)}}var Aa={};Vs(Aa,{CLASS_NAME_FAILED:()=>ca,CLASS_NAME_HIDDEN:()=>Ys,CLASS_NAME_PENDING:()=>la,CLASS_NAME_RESOLVED:()=>da,CheckoutWorkflow:()=>lc,CheckoutWorkflowStep:()=>ie,Commitment:()=>$e,ERROR_MESSAGE_BAD_REQUEST:()=>ha,ERROR_MESSAGE_MISSING_LITERALS_URL:()=>oc,ERROR_MESSAGE_OFFER_NOT_FOUND:()=>pa,EVENT_AEM_ERROR:()=>oa,EVENT_AEM_LOAD:()=>na,EVENT_COMPARE_CHART_REHYDRATE:()=>ic,EVENT_EXPANDED_GROUPS_CHANGE:()=>nc,EVENT_MAS_ERROR:()=>sa,EVENT_MAS_READY:()=>mr,EVENT_MERCH_ADDON_AND_QUANTITY_UPDATE:()=>rc,EVENT_MERCH_CARD_ACTION_MENU_TOGGLE:()=>ta,EVENT_MERCH_CARD_COLLECTION_LITERALS_CHANGED:()=>ue,EVENT_MERCH_CARD_COLLECTION_SHOWMORE:()=>aa,EVENT_MERCH_CARD_COLLECTION_SIDENAV_ATTACHED:()=>Rt,EVENT_MERCH_CARD_COLLECTION_SORT:()=>ra,EVENT_MERCH_CARD_QUANTITY_CHANGE:()=>pr,EVENT_MERCH_OFFER_READY:()=>Qs,EVENT_MERCH_OFFER_SELECT_READY:()=>Zs,EVENT_MERCH_QUANTITY_SELECTOR_CHANGE:()=>ae,EVENT_MERCH_SEARCH_CHANGE:()=>ac,EVENT_MERCH_SIDENAV_SELECT:()=>ia,EVENT_MERCH_STOCK_CHANGE:()=>ec,EVENT_MERCH_STORAGE_CHANGE:()=>tc,EVENT_OFFER_SELECTED:()=>Js,EVENT_TYPE_FAILED:()=>ma,EVENT_TYPE_READY:()=>hr,EVENT_TYPE_RESOLVED:()=>Ae,Env:()=>xe,FF_ANNUAL_PRICE:()=>nt,FF_DEFAULTS:()=>Te,HEADER_X_REQUEST_ID:()=>Ot,LOG_NAMESPACE:()=>ua,Landscape:()=>Ne,MARK_DURATION_SUFFIX:()=>Ea,MARK_START_SUFFIX:()=>wa,MERCH_CARD_LOAD_TIMEOUT:()=>Jr,MODAL_TYPE_3_IN_1:()=>Ge,NAMESPACE:()=>Ws,PARAM_AOS_API_KEY:()=>sc,PARAM_ENV:()=>fa,PARAM_LANDSCAPE:()=>va,PARAM_MAS_PREVIEW:()=>ga,PARAM_WCS_API_KEY:()=>cc,PROVIDER_ENVIRONMENT:()=>ya,SELECTOR_MAS_CHECKOUT_LINK:()=>zi,SELECTOR_MAS_ELEMENT:()=>ea,SELECTOR_MAS_INLINE_PRICE:()=>W,SELECTOR_MAS_SP_BUTTON:()=>Ks,SELECTOR_MAS_UPT_LINK:()=>Fi,SORT_ORDER:()=>fe,STATE_FAILED:()=>ge,STATE_PENDING:()=>Oe,STATE_RESOLVED:()=>Ce,SUPPORTED_COUNTRIES:()=>Sa,TAG_NAME_SERVICE:()=>Xs,TEMPLATE_PRICE:()=>dc,TEMPLATE_PRICE_ANNUAL:()=>pc,TEMPLATE_PRICE_LEGAL:()=>te,TEMPLATE_PRICE_STRIKETHROUGH:()=>hc,Term:()=>he,WCS_PROD_URL:()=>xa,WCS_STAGE_URL:()=>ba});var $e=Object.freeze({MONTH:"MONTH",YEAR:"YEAR",TWO_YEARS:"TWO_YEARS",THREE_YEARS:"THREE_YEARS",PERPETUAL:"PERPETUAL",TERM_LICENSE:"TERM_LICENSE",ACCESS_PASS:"ACCESS_PASS",THREE_MONTHS:"THREE_MONTHS",SIX_MONTHS:"SIX_MONTHS"}),he=Object.freeze({ANNUAL:"ANNUAL",MONTHLY:"MONTHLY",TWO_YEARS:"TWO_YEARS",THREE_YEARS:"THREE_YEARS",P1D:"P1D",P1Y:"P1Y",P3Y:"P3Y",P10Y:"P10Y",P15Y:"P15Y",P3D:"P3D",P7D:"P7D",P30D:"P30D",HALF_YEARLY:"HALF_YEARLY",QUARTERLY:"QUARTERLY"}),Ws="merch",Jr=2e4,Ys="hidden",hr="wcms:commerce:ready",Xs="mas-commerce-service",W='span[is="inline-price"][data-wcs-osi]',zi='a[is="checkout-link"][data-wcs-osi],button[is="checkout-button"][data-wcs-osi]',Ks="sp-button[data-wcs-osi]",Fi='a[is="upt-link"]',ea=`${W},${zi},${Fi}`,Qs="merch-offer:ready",Zs="merch-offer-select:ready",ta="merch-card:action-menu-toggle",Js="merch-offer:selected",ec="merch-stock:change",tc="merch-storage:change",ae="merch-quantity-selector:change",pr="merch-card-quantity:change",rc="merch-modal:addon-and-quantity-update",ac="merch-search:change",ra="merch-card-collection:sort",ue="merch-card-collection:literals-changed",Rt="merch-card-collection:sidenav-attached",aa="merch-card-collection:showmore",ia="merch-sidenav:select",na="aem:load",oa="aem:error",mr="mas:ready",sa="mas:error",ic="mas-compare-chart:rehydrate",nc="expanded-groups-change",ca="placeholder-failed",la="placeholder-pending",da="placeholder-resolved",ha="Bad WCS request",pa="Commerce offer not found",oc="Literals URL not provided",ma="mas:failed",Ae="mas:resolved",ua="mas/commerce",ga="mas.preview",fa="commerce.env",va="commerce.landscape",sc="commerce.aosKey",cc="commerce.wcsKey",xa="https://www.adobe.com/web_commerce_artifact",ba="https://www.stage.adobe.com/web_commerce_artifact_stage",ge="failed",Oe="pending",Ce="resolved",Ne={DRAFT:"DRAFT",PUBLISHED:"PUBLISHED"},Ot="X-Request-Id",ie=Object.freeze({SEGMENTATION:"segmentation",BUNDLE:"bundle",COMMITMENT:"commitment",RECOMMENDATION:"recommendation",EMAIL:"email",PAYMENT:"payment",CHANGE_PLAN_TEAM_PLANS:"change-plan/team-upgrade/plans",CHANGE_PLAN_TEAM_PAYMENT:"change-plan/team-upgrade/payment"}),lc="UCv3",xe=Object.freeze({STAGE:"STAGE",PRODUCTION:"PRODUCTION",LOCAL:"LOCAL"}),ya={PRODUCTION:"PRODUCTION"},Ge={TWP:"twp",D2P:"d2p",CRM:"crm"},wa=":start",Ea=":duration",dc="price",hc="price-strikethrough",pc="annual",te="legal",Te="mas-ff-defaults",nt="mas-ff-annual-price",fe={alphabetical:"alphabetical",authored:"authored"},Sa=["AE","AM","AR","AT","AU","AZ","BB","BD","BE","BG","BH","BO","BR","BS","BY","CA","CH","CL","CN","CO","CR","CY","CZ","DE","DK","DO","DZ","EC","EE","EG","ES","FI","FR","GB","GE","GH","GR","GT","HK","HN","HR","HU","ID","IE","IL","IN","IQ","IS","IT","JM","JO","JP","KE","KG","KR","KW","KZ","LA","LB","LK","LT","LU","LV","MA","MD","MO","MT","MU","MX","MY","NG","NI","NL","NO","NP","NZ","OM","PA","PE","PH","PK","PL","PR","PT","PY","QA","RO","RS","RU","SA","SE","SG","SI","SK","SV","TH","TJ","TM","TN","TR","TT","TW","TZ","UA","US","UY","UZ","VE","VN","YE","ZA"];var mc="mas-commerce-service";function Bi(e,r){let t;return function(){let a=this,i=arguments;clearTimeout(t),t=setTimeout(()=>e.apply(a,i),r)}}var Nt=(e,r)=>e?.querySelector(`[slot="${r}"]`)?.textContent?.trim();function be(e,r={},t=null,a=null){let i=a?document.createElement(e,{is:a}):document.createElement(e);t instanceof HTMLElement?i.appendChild(t):i.innerHTML=t;for(let[n,o]of Object.entries(r))i.setAttribute(n,o);return i}function ur(e){return`startTime:${e.startTime.toFixed(2)}|duration:${e.duration.toFixed(2)}`}function Ca(){return window.matchMedia("(max-width: 1024px)").matches}function It(){return document.getElementsByTagName(mc)?.[0]}function Dt(e){let r=window.getComputedStyle(e);return e.offsetHeight+parseFloat(r.marginTop)+parseFloat(r.marginBottom)}var uc=["adobe.com","adobeioruntime.net","aem.live","aem.page"],gc=["localhost","127.0.0.1"];function Ui(e){try{let r=new URL(e);return gc.includes(r.hostname)?r.protocol==="http:"||r.protocol==="https:":r.protocol!=="https:"?!1:uc.some(t=>r.hostname===t||r.hostname.endsWith(`.${t}`))}catch{return!1}}import{html as gr,nothing as fc}from"./lit-all.min.js";var ot,Ht=class Ht{constructor(r){m(this,"card");M(this,ot);this.card=r,this.insertVariantStyle()}getContainer(){return T(this,ot,v(this,ot)??this.card.closest('merch-card-collection, [class*="-merch-cards"]')??this.card.parentElement),v(this,ot)}insertVariantStyle(){let r=this.constructor.name;if(!Ht.styleMap[r]){Ht.styleMap[r]=!0;let t=document.createElement("style");t.innerHTML=this.getGlobalCSS(),document.head.appendChild(t)}}updateCardElementMinHeight(r,t){if(!r||this.card.heightSync===!1)return;let a=`--consonant-merch-card-${this.card.variant}-${t}-height`,i=Math.max(0,parseInt(window.getComputedStyle(r).height)||0),n=this.getContainer(),o=parseInt(n.style.getPropertyValue(a))||0;i>o&&n.style.setProperty(a,`${i}px`)}syncRowHeights(r){if(this.card.heightSync===!1)return;let t=this.getContainer();if(!t)return;let a=this.card.variant,i=Array.from(t.querySelectorAll(`merch-card[variant="${a}"]`)).filter(o=>o.variantLayout?.card?.heightSync!==!1);if(i.length===0)return;for(let{name:o}of r){let s=`--consonant-merch-card-${a}-${o}-height`;t.style.getPropertyValue(s)&&t.style.removeProperty(s)}let n=new Map;for(let o of i){let s=o.getBoundingClientRect();if(s.width<=2)continue;let c=Math.round(s.top),l=n.get(c);l||(l=[],n.set(c,l)),l.push(o)}for(let o of n.values())for(let{name:s,getElement:c}of r){let l=`--consonant-merch-card-${a}-${s}-height`,d=o.map(u=>u.style.getPropertyValue(l)),p=0;for(let u of o){u.style.removeProperty(l);let h=c(u);if(!h)continue;let g=Math.max(0,parseInt(window.getComputedStyle(h).height)||0);g>p&&(p=g)}o.forEach((u,h)=>{p>0?u.style.setProperty(l,`${p}px`):d[h]&&u.style.setProperty(l,d[h])})}}get legalDisplayDot(){return!0}get badge(){let r;if(!(!this.card.badgeBackgroundColor||!this.card.badgeColor||!this.card.badgeText))return this.evergreen&&(r=`border: 1px solid ${this.card.badgeBackgroundColor}; border-right: none;`),gr`
            <div
                id="badge"
        ...
        `}get cardImage(){return gr` <div class="image">
            <slot name="bg-image"></slot>
            ${this.badge}
        </div>`}getGlobalCSS(){return""}get theme(){return document.querySelector("sp-theme")}get evergreen(){return this.card.classList.contains("intro-pricing")}get promoBottom(){return this.card.classList.contains("promo-bottom")}get headingSelector(){return'[slot="heading-xs"]'}get secureLabel(){return this.card.secureLabel?gr`<span class="secure-transaction-label"
                  >${this.card.secureLabel}</span
              >`:fc}get secureLabelFooter(){return gr`<footer>
            ${this.secureLabel}<slot name="footer"></slot>
        </footer>`}async postCardUpdateHook(){if(this.card.isConnected&&(await this.card.updateComplete,this.card.prices?.length>0)){let r=Promise.allSettled(this.card.prices.map(i=>i.onceSettled?.()||Promise.resolve())),t,a=new Promise(i=>{t=setTimeout(i,Jr)});await Promise.race([r,a]),clearTimeout(t)}}connectedCallbackHook(){}disconnectedCallbackHook(){}syncHeights(){}renderLayout(){}get aemFragmentMapping(){return fr(this.card.variant)}};ot=new WeakMap,m(Ht,"styleMap",{});var w=Ht;import{html as Ta,css as vc}from"./lit-all.min.js";var $i=`
:root {
...
merch-card[variant="catalog"] [slot="footer"] .spectrum-Link--primary {
  ...
  font-weight: 700;
            ...
            <slot></slot>`}getGlobalCSS(){return $i}setAriaExpanded(t,a){t.setAttribute("aria-expanded",a)}connectedCallbackHook(){this.card.addEventListener("mouseenter",this.showActionMenuOnHover),this.card.addEventListener("mouseleave",this.toggleActionMenuFromCard),this.card.addEventListener("focusin",this.showActionMenuOnHover),this.card.addEventListener("focusout",this.handleCardFocusOut),this.card.addEventListener("keydown",this.handleKeyDown)}disconnectedCallbackHook(){this.card.removeEventListener("mouseenter",this.showActionMenuOnHover),this.card.removeEventListener("mouseleave",this.toggleActionMenuFromCard),this.card.removeEventListener("focusin",this.showActionMenuOnHover),this.card.removeEventListener("focusout",this.handleCardFocusOut),this.card.removeEventListener("keydown",this.handleKeyDown)}};m(st,"variantStyle",vc`
    ...
    `);import{html as zt,css as xc}from"./lit-all.min.js";var qi=`
:root {
...
`;var Vi={cardName:{attribute:"name"},badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300-plans"},badgeIcon:!0,borderColor:{attribute:"border-color"},allowedBadgeColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-gray-700-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],allowedBorderColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],ctas:{slot:"footer",size:"m"},description:{tag:"div",slot:"body-xs"},mnemonics:{size:"l"},prices:{tag:"h3",slot:"heading-xs"},promoText:{tag:"p",slot:"promo-text"},size:["wide","super-wide"],title:{tag:"h3",slot:"heading-xs"},subtitle:{tag:"p",slot:"body-xxs"},backgroundImage:{tag:"div",slot:"bg-image"}},qe=class extends w{constructor(r){super(r)}getGlobalCSS(){return qi}renderLayout(){return zt`<div class="image">
                <slot name="bg-image"></slot>
    ...
    `);import{html as Wi}from"./lit-all.min.js";var ji=`
:root {
...
`;var vr=class extends w{constructor(r){super(r)}getGlobalCSS(){return ji}renderLayout(){return Wi` ${this.badge}
            <div class="body">
                <div class="top-section">
                    <slot name="icons"></slot>
                    <slot name="heading-xs"></slot>
            ...
            ${this.card.customHr?"":Wi`<hr />`} ${this.secureLabelFooter}`}};import{html as Ie,css as bc,unsafeCSS as Xi}from"./lit-all.min.js";var Yi=`
  :root {
...
`;var yc=32,Ki={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},subtitle:{tag:"p",slot:"subtitle"},prices:{tag:"p",slot:"heading-m-price"},promoText:{tag:"div",slot:"promo-text"},shortDescription:{tag:"div",slot:"body-xxs"},description:{tag:"div",slot:"body-m"},mnemonics:{size:"l"},quantitySelect:{tag:"div",slot:"quantity-select"},callout:{tag:"div",slot:"callout-content"},addon:!0,secureLabel:!0,planType:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300-plans"},allowedBadgeColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-gray-700-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],allowedBorderColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],whatsIncludedDividerColor:{attribute:"whats-included-divider-color"},allowedWhatsIncludedDividerColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],borderColor:{attribute:"border-color"},size:["wide","super-wide"],whatsIncluded:{tag:"div",slot:"footer-rows"},ctas:{slot:"footer",size:"l"},style:"consonant"},ct=class extends w{constructor(t){super(t);m(this,"getRowMinHeightPropertyName",t=>`--consonant-merch-card-footer-row-${t}-min-height`);m(this,"getMiniCompareFooter",()=>{let t=this.card.secureLabel?Ie`<slot name="secure-transaction-label">
    ...
    `);import{html as xr,css as wc,unsafeCSS as _a,nothing as Ec}from"./lit-all.min.js";var Qi=`
  :root {
...
`;var Sc=32,Zi={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},subtitle:{tag:"p",slot:"subtitle"},prices:{tag:"p",slot:"heading-m-price"},promoText:{tag:"div",slot:"promo-text"},shortDescription:{tag:"div",slot:"body-m"},description:{tag:"div",slot:"body-xs"},mnemonics:{size:"l"},secureLabel:!0,planType:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300-plans"},allowedBadgeColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-gray-700-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],allowedBorderColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],borderColor:{attribute:"border-color"},size:["wide","super-wide"],ctas:{slot:"footer",size:"l"},style:"consonant"},ye,lt=class extends w{constructor(t){super(t);M(this,ye);m(this,"getRowMinHeightPropertyName",t=>`--consonant-merch-card-footer-row-${t}-min-height`);m(this,"getMiniCompareFooter",()=>xr` <footer>
        ...
        </footer>`);m(this,"getMiniCompareFooterRows",()=>xr` <div class="footer-rows-container">
            <slot name="body-xs"></slot>
            <slot name="footer-rows"></slot>
        </div>`);this.updatePriceQuantity=this.updatePriceQuantity.bind(this)}connectedCallbackHook(){this.card.addEventListener(ae,this.updatePriceQuantity)}disconnectedCallbackHook(){this.card.removeEventListener(ae,this.updatePriceQuantity),this._syncObserver?.disconnect(),this._syncObserver=null,v(this,ye)?.disconnect(),T(this,ye,null)}updatePriceQuantity({detail:t}){!this.mainPrice||!t?.option||(this.mainPrice.dataset.quantity=t.option)}syncHeights(){if(this.card.getBoundingClientRect().width<=2){v(this,ye)||(T(this,ye,new ResizeObserver(()=>{this.card.getBoundingClientRect().width>2&&(v(this,ye)?.disconnect(),T(this,ye,null),this.syncHeights())})),v(this,ye).observe(this.card));return}let t=["heading-xs","subtitle","heading-m-price","promo-text","body-m","body-xs"];this.syncRowHeights(t.map(a=>({name:a,getElement:i=>i.querySelector(`[slot="${a}"]`)}))),this.adjustMiniCompareFooterRows()}priceOptionsProvider(t,a){if(t.dataset.template===te){a.displayPlanType=this.card?.settings?.displayPlanType??!1;return}(t.dataset.template==="strikethrough"||t.dataset.template==="price")&&(a.displayPerUnit=!1)}getGlobalCSS(){return Qi}adjustMiniCompareBodySlots(){if(this.card.getBoundingClientRect().width<=2){this._syncObserver||(this._syncObserver=new ResizeObserver(()=>{this.card.getBoundingClientRect().width>2&&(this._syncObserver?.disconnect(),this._syncObserver=null,this.adjustMiniCompareBodySlots(),this.adjustMiniCompareFooterRows())}),this._syncObserver.observe(this.card));return}["heading-xs","subtitle","heading-m-price","price-wrapping","promo-text","body-m","body-xs","footer-rows"].forEach(a=>{let n=this.card.querySelector(`[slot="${a}"]`)??this.card.shadowRoot.querySelector(`slot[name="${a}"]`);this.updateCardElementMinHeight(n,a)}),[['slot[name="promo-text"]',"promo-text"],["footer","footer"]].forEach(([a,i])=>{this.updateCardElementMinHeight(this.card.shadowRoot.querySelector(a),i)})}adjustMiniCompareFooterRows(){if(this.card.getBoundingClientRect().width===0)return;let t=this.card.querySelector('[slot="footer-rows"] ul');!t||!t.children||[...t.children].forEach((a,i)=>{let n=Math.max(Sc,parseFloat(window.getComputedStyle(a).height)||0),o=parseFloat(this.getContainer().style.getPropertyValue(this.getRowMinHeightPropertyName(i+1)))||0;n>o&&this.getContainer().style.setProperty(this.getRowMinHeightPropertyName(i+1),`${n}px`)})}removeEmptyRows(){this.card.querySelectorAll(".footer-row-cell").forEach(a=>{let i=a.querySelector(".footer-row-cell-description");i&&!i.textContent.trim()&&a.remove()})}setupToggle(){if(this.toggleSetupDone)return;let t=this.card.querySelector('[slot="body-xs"]');if(!t)return;let a=t.querySelector("p"),i=t.querySelector("ul");if(!a||!i||t.querySelector(".footer-rows-title"))return;this.toggleSetupDone=!0;let n=a.textContent.trim(),o=this.card.querySelector("h3")?.id,s=o?`${o}-list`:`mweb-list-${Date.now()}`;i.setAttribute("id",s),i.classList.add("checkmark-copy-container");let c=be("h4",{class:"footer-rows-title"},n);if(k.isMobile){let l=be("button",{class:"toggle-icon","aria-label":n,"aria-expanded":"false","aria-controls":s});c.appendChild(l),c.addEventListener("click",()=>{let d=i.classList.toggle("open");l.classList.toggle("expanded",d),l.setAttribute("aria-expanded",String(d))})}else i.classList.add("open");a.replaceWith(c)}get legalDisplayDot(){return!1}get mainPrice(){return this.card.querySelector(`[slot="heading-m-price"] ${W}[data-template="price"]`)}async adjustLegal(){if(!this.legalAdjusted)try{this.legalAdjusted=!0,await this.card.updateComplete,await customElements.whenDefined("inline-price");let t=this.mainPrice;if(!t)return;let a=t.cloneNode(!0);if(await t.onceSettled(),!t?.options)return;t.options.displayPerUnit&&(t.dataset.displayPerUnit="false"),t.options.displayTax&&(t.dataset.displayTax="false"),t.options.displayPlanType&&(t.dataset.displayPlanType="false"),a.setAttribute("data-template","legal"),t.parentNode.insertBefore(a,t.nextSibling),await a.onceSettled()}catch{}}get icons(){return!this.card.querySelector('[slot="icons"]')&&!this.card.getAttribute("id")?Ec:xr`<slot name="icons"></slot>`}renderLayout(){return xr`
            ${this.badge}
            <div class="body">
                <div class="body-main">
                    ${this.icons}
        ...
        `}async postCardUpdateHook(){if(this.legalAdjusted||await this.adjustLegal(),this.setupToggle(),k.isMobile&&this.removeEmptyRows(),await super.postCardUpdateHook(),window.matchMedia("(min-width: 768px)").matches){let t=this.card.parentElement,a=Array.from(t.querySelectorAll(`merch-card[variant="${this.card.variant}"]`));await Promise.all(a.map(i=>i.updateComplete)),await new Promise(i=>setTimeout(i,100)),this.card===t.firstElementChild&&requestAnimationFrame(()=>{this.syncHeights()})}}};ye=new WeakMap,m(lt,"variantStyle",wc`
        ...
        @media screen and ${_a(_)} {
            :host([variant='mini-compare-chart-mweb']) footer {
                padding: 0;
            }
        }

        @media screen and ${_a(I)} {
            :host([variant='mini-compare-chart-mweb'])
                .price-wrapping
                > slot[name='subtitle'] {
                min-height: var(
    ...
    `);import{html as Ft,css as Ac,nothing as br}from"./lit-all.min.js";var Ji=`
:root {
...
`;var yr={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},subtitle:{tag:"p",slot:"subtitle"},prices:{tag:"p",slot:"heading-m"},promoText:{tag:"p",slot:"promo-text"},description:{tag:"div",slot:"body-xs"},mnemonics:{size:"l"},callout:{tag:"div",slot:"callout-content"},quantitySelect:{tag:"div",slot:"quantity-select"},addon:!0,secureLabel:!0,planType:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300-plans"},allowedBadgeColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-gray-700-plans","spectrum-green-900-plans","gradient-purple-blue"],allowedBorderColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-green-900-plans","gradient-purple-blue"],borderColor:{attribute:"border-color"},size:["wide","super-wide"],whatsIncluded:{tag:"div",slot:"whats-included"},ctas:{slot:"footer",size:"m"},style:"consonant",perUnitLabel:{tag:"span",slot:"per-unit-label"}},en={...function(){let{whatsIncluded:e,size:r,...t}=yr;return t}(),title:{tag:"h3",slot:"heading-s"},secureLabel:!1},tn={...function(){let{subtitle:e,whatsIncluded:r,size:t,quantitySelect:a,...i}=yr;return i}()},we,Ee,ne=class extends w{constructor(t){super(t);M(this,we);M(this,Ee);this.adaptForMedia=this.adaptForMedia.bind(this)}priceOptionsProvider(t,a){t.dataset.template===te&&(a.displayPlanType=this.card?.settings?.displayPlanType??!1)}getGlobalCSS(){return Ji}adjustSlotPlacement(t,a,i){let n=this.card.shadowRoot,o=n.querySelector("footer"),s=this.card.getAttribute("size");if(!s)return;let c=n.querySelector(`footer slot[name="${t}"]`),l=n.querySelector(`.body slot[name="${t}"]`),d=n.querySelector(".body");if(s.includes("wide")||(o?.classList.remove("wide-footer"),c&&c.remove()),!!a.includes(s)){if(o?.classList.toggle("wide-footer",k.isDesktopOrUp),!i&&c){if(l)c.remove();else{let p=d.querySelector(`[data-placeholder-for="${t}"]`);p?p.replaceWith(c):d.appendChild(c)}return}if(i&&l){let p=document.createElement("div");if(p.setAttribute("data-placeholder-for",t),p.classList.add("slot-placeholder"),!c){let u=l.cloneNode(!0);o.prepend(u)}l.replaceWith(p)}}}adaptForMedia(){if(!this.card.closest("merch-card-collection,overlay-trigger,.two-merch-cards,.three-merch-cards,.four-merch-cards, .columns")){this.card.removeAttribute("size");return}this.adjustSlotPlacement("addon",["super-wide"],k.isDesktopOrUp),this.adjustSlotPlacement("callout-content",["super-wide"],k.isDesktopOrUp)}adjustCallout(){let t=this.card.querySelector('[slot="callout-content"] .icon-button');t&&t.title&&(t.dataset.tooltip=t.title,t.removeAttribute("title"),t.classList.add("hide-tooltip"),document.addEventListener("touchstart",a=>{a.preventDefault(),a.target!==t?t.classList.add("hide-tooltip"):a.target.classList.toggle("hide-tooltip")}),document.addEventListener("mouseover",a=>{a.preventDefault(),a.target!==t?t.classList.add("hide-tooltip"):a.target.classList.remove("hide-tooltip")}))}syncHeights(){if(this.card.getBoundingClientRect().width<=2){v(this,we)||(T(this,we,new ResizeObserver(()=>{this.card.getBoundingClientRect().width>2&&(v(this,we)?.disconnect(),T(this,we,null),this.syncHeights())})),v(this,we).observe(this.card));return}let t=["heading-xs","subtitle","heading-m","promo-text","body-xs"];this.syncRowHeights(t.map(a=>({name:a,getElement:i=>i.querySelector(`[slot="${a}"]`)})))}async adjustEduLists(){if(this.card.variant!=="plans-education"||this.card.querySelector(".spacer"))return;let a=this.card.querySelector('[slot="body-xs"]');if(!a)return;let i=a.querySelector("ul");if(!i)return;let n=i.previousElementSibling,o=document.createElement("div");o.classList.add("spacer"),a.insertBefore(o,n);let s=new IntersectionObserver(([c])=>{if(c.boundingClientRect.height===0)return;let l=0,d=this.card.querySelector('[slot="heading-s"]');d&&(l+=Dt(d));let p=this.card.querySelector('[slot="subtitle"]');p&&(l+=Dt(p));let u=this.card.querySelector('[slot="heading-m"]');u&&(l+=8+Dt(u));for(let g of a.childNodes){if(g.classList.contains("spacer"))break;l+=Dt(g)}let h=this.card.parentElement.style.getPropertyValue("--merch-card-plans-edu-list-max-offset");l>(parseFloat(h)||0)&&this.card.parentElement.style.setProperty("--merch-card-plans-edu-list-max-offset",`${l}px`),this.card.style.setProperty("--merch-card-plans-edu-list-offset",`${l}px`),s.disconnect()});s.observe(this.card)}async postCardUpdateHook(){this.adaptForMedia(),this.adjustAddon(),this.adjustCallout(),this.legalAdjusted||(await this.adjustLegal(),await this.adjustEduLists()),await super.postCardUpdateHook(),window.matchMedia("(min-width: 768px)").matches&&this.card===this.card.parentElement.firstElementChild&&requestAnimationFrame(()=>{this.syncHeights()})}get headingM(){return this.card.querySelector('[slot="heading-m"]')}get mainPrice(){return this.headingM?.querySelector(`${W}[data-template="price"]`)}get divider(){return this.card.variant==="plans-education"?Ft`<div class="divider"></div>`:br}async adjustLegal(){if(!this.legalAdjusted)try{this.legalAdjusted=!0,await this.card.updateComplete,await customElements.whenDefined("inline-price");let t=[],a=this.card.querySelector(`[slot="heading-m"] ${W}[data-template="price"]`);a&&t.push(a);let i=t.map(async n=>{let o=n.cloneNode(!0);await n.onceSettled(),n?.options&&(n.options.displayPerUnit&&(n.dataset.displayPerUnit="false"),n.options.displayTax&&(n.dataset.displayTax="false"),n.options.displayPlanType&&(n.dataset.displayPlanType="false"),o.setAttribute("data-template","legal"),n.parentNode.insertBefore(o,n.nextSibling),await o.onceSettled())});await Promise.all(i)}catch{}}async adjustAddon(){await this.card.updateComplete;let t=this.card.addon;if(!t)return;t.setAttribute("custom-checkbox","");let a=this.mainPrice;if(!a)return;await a.onceSettled?.();let i=a.value?.[0]?.planType;i&&(t.planType=i)}get stockCheckbox(){return this.card.checkboxLabel?Ft`<label id="stock-checkbox">
            ...
            ${this.secureLabelFooter}
            <slot></slot>`}};we=new WeakMap,Ee=new WeakMap,m(ne,"variantStyle",Ac`
        :host([variant^='plans']) {
            min-height: 273px;
    ...
    `),m(ne,"collectionOptions",{customHeaderArea:t=>t.sidenav?Ft`<slot name="resultsText"></slot>`:br,headerVisibility:{search:!1,sort:!1,result:["mobile","tablet"],custom:["desktop"]},onSidenavAttached:t=>{let a=()=>{let i=t.querySelectorAll("merch-card");for(let o of i)o.hasAttribute("data-size")&&(o.setAttribute("size",o.getAttribute("data-size")),o.removeAttribute("data-size"));if(!k.isDesktop)return;let n=0;for(let o of i){if(o.style.display==="none")continue;let s=o.getAttribute("size"),c=s==="wide"?2:s==="super-wide"?3:1;c===2&&n%3===2&&(o.setAttribute("data-size",s),o.removeAttribute("size"),c=1),n+=c}};k.matchDesktop.addEventListener("change",a),t.addEventListener(ue,a),t.onUnmount.push(()=>{k.matchDesktop.removeEventListener("change",a),t.removeEventListener(ue,a)})}});import{html as _e,css as Cc,unsafeCSS as an,nothing as wr}from"./lit-all.min.js";var rn=`
:root {
...
`)[0].trim()}updateShortDescriptionVisibility(){let r=this.card.querySelector('[slot="short-description"]');if(!r)return;let t=r.querySelector("strong, b, p");t&&(k.isMobile?t.style.display="none":t.style.display="")}toggleShortDescription(){this.shortDescriptionExpanded=!this.shortDescriptionExpanded,this.card.requestUpdate()}get shortDescriptionToggle(){return this.hasShortDescription?k.isMobile?_e`
        ...
        `:_e`
            ...
            `:wr}get icons(){return this.card.querySelector('[slot="icons"]')||this.card.getAttribute("id")?_e`<slot name="icons"></slot>`:wr}get secureLabelFooter(){return _e`<footer>
            ...
            <slot></slot>`}};m(De,"variantStyle",Cc`
    ...
    `),m(De,"collectionOptions",{customHeaderArea:r=>r.sidenav?_e`<slot name="resultsText"></slot>`:wr,headerVisibility:{search:!1,sort:!1,result:["mobile","tablet"],custom:["desktop"]},onSidenavAttached:r=>{let t=()=>{let a=r.querySelectorAll("merch-card");if(a.forEach(n=>{n.hasAttribute("data-size")&&(n.setAttribute("size",n.getAttribute("data-size")),n.removeAttribute("data-size"))}),!k.isDesktop)return;let i=0;a.forEach(n=>{if(n.style.display==="none")return;let o=n.getAttribute("size"),s=o==="wide"?2:o==="super-wide"?3:1;s===2&&i%3===2&&(n.setAttribute("data-size",o),n.removeAttribute("size"),s=1),i+=s})};k.matchDesktop.addEventListener("change",t),r.addEventListener(ue,t),r.onUnmount.push(()=>{k.matchDesktop.removeEventListener("change",t),r.removeEventListener(ue,t)})}});import{html as He,css as Tc,nothing as Bt,unsafeCSS as _c}from"./lit-all.min.js";var on=`
:root {
...
`;var[_p,kp,sn,cn,ln,dn]=["ArrowLeft","ArrowRight","ArrowUp","ArrowDown","Enter","Tab"];var kc="pro",hn=`--consonant-merch-card-${kc}-top-card-height`,pn={cardName:{attribute:"name"},subtitle:{tag:"p",slot:"subtitle"},title:{tag:"h3",slot:"heading-xs"},description:{tag:"div",slot:"body-xs"},mnemonics:{size:"s"},size:["wide","edu"],prices:{tag:"p",slot:"heading-m"},promoText:{tag:"p",slot:"promo-text"},perUnitLabel:{tag:"span",slot:"per-unit-label"},callout:{tag:"div",slot:"callout-content",editorLabel:"License callout"},quantitySelect:{tag:"div",slot:"quantity-select"},shortDescription:{tag:"div",slot:"legal-text"},secureLabel:!0,planType:!0,addon:!0,ctas:{slot:"footer",size:"m"},whatsIncluded:{tag:"div",slot:"whats-included"},backgroundColor:{attribute:"background-color",editorLabel:"Theme",specialValues:{Light:"light",Dark:"dark"}},borderColor:{attribute:"border-color",specialValues:{Black:"black"}},allowedBorderColors:[],style:"consonant"},ke,Ve,qt,Y,mn,Ut,un,$t,ka,Er,Sr=class Sr extends w{constructor(t){super(t);M(this,Y);m(this,"expanded",!1);m(this,"licenseOpen",!1);m(this,"licenseQty",null);m(this,"licenseHighlightedIndex",0);M(this,ke,null);M(this,Ve,null);m(this,"lastSyncKey",null);M(this,qt,({detail:t})=>{let a=t?.quantity==null?null:String(t.quantity);a==null||a===this.licenseQty||this.licenseOptions?.includes(a)&&(this.licenseQty=a,this.card.requestUpdate())});m(this,"toggleExpanded",t=>{t.preventDefault();let a=!this.expanded;for(let i of j(this,Y,mn).call(this)){let n=i.variantLayout;n instanceof Sr&&(n.expanded=a,i._proExpanded=a,i.requestUpdate())}});m(this,"toggleLicensePopover",t=>{t.preventDefault(),t.stopPropagation(),this.licenseOpen?j(this,Y,ka).call(this):j(this,Y,$t).call(this),this.card.requestUpdate()});M(this,Er,t=>{let a=this.licenseOptions;if(!a?.length)return;let i=a.length-1;switch(t.key){case cn:t.preventDefault(),this.licenseOpen?this.licenseHighlightedIndex=(this.licenseHighlightedIndex+1)%a.length:j(this,Y,$t).call(this);break;case sn:t.preventDefault(),this.licenseOpen?this.licenseHighlightedIndex=(this.licenseHighlightedIndex-1+a.length)%a.length:j(this,Y,$t).call(this);break;case"Home":if(!this.licenseOpen)return;t.preventDefault(),this.licenseHighlightedIndex=0;break;case"End":if(!this.licenseOpen)return;t.preventDefault(),this.licenseHighlightedIndex=i;break;case ln:case" ":if(t.preventDefault(),this.licenseOpen){this.selectLicenseQty(a[this.licenseHighlightedIndex]);return}j(this,Y,$t).call(this);break;case"Escape":if(!this.licenseOpen)return;t.preventDefault(),j(this,Y,ka).call(this);break;case dn:this.licenseOpen&&this.selectLicenseQty(a[this.licenseHighlightedIndex]);return;default:return}this.card.requestUpdate()});m(this,"selectLicenseQty",t=>{this.licenseQty=t,this.licenseOpen=!1,j(this,Y,Ut).call(this);let a=this.quantitySelectEl;a&&(a.selectedValue=Number(t),a.dispatchEvent(new CustomEvent(ae,{detail:{option:Number(t)},bubbles:!0}))),this.card.requestUpdate()});this.updatePriceQuantity=this.updatePriceQuantity.bind(this),this.expanded=t._proExpanded??!1}getGlobalCSS(){return on}priceOptionsProvider(t,a){t.dataset.template===te&&(a.displayPlanType=this.card?.settings?.displayPlanType??!1)}async adjustLegal(){if(!this.legalAdjusted)try{this.legalAdjusted=!0,await this.card.updateComplete,await customElements.whenDefined("inline-price");let t=this.mainPrice;if(!t)return;let a=t.cloneNode(!0);if(await t.onceSettled(),!t?.options)return;t.options.displayTax&&(t.dataset.displayTax="false"),t.options.displayPlanType&&(t.dataset.displayPlanType="false"),a.setAttribute("data-template","legal"),a.dataset.displayPerUnit="false",t.parentNode.insertBefore(a,t.nextSibling),await a.onceSettled(),this.legalResolvedHandler||(this.legalResolvedHandler=()=>this.adjustShortDescription(),a.addEventListener(Ae,this.legalResolvedHandler)),this.adjustShortDescription()}catch{}}adjustShortDescription(){let t=this.card.querySelector('[slot="legal-text"]')?.textContent?.trim();if(!t)return;let a=this.card.querySelector('[slot="heading-m"] [data-template="legal"]'),i=a?.querySelector(".price-plan-type");if(!i)return;i.textContent=t;let n=a.querySelector(".price-tax-inclusivity:not(.disabled)");n?.textContent&&!/\s$/.test(n.textContent)&&(n.textContent+=". ")}get hasWhatsIncluded(){return!!this.card.querySelector('[slot="whats-included"]')}get whatsIncludedToggleLabel(){return this.card.querySelector('[slot="whats-included"] .whats-included-label')?.textContent.trim()||"See what's included:"}get hasCallout(){return!!this.card.querySelector('[slot="callout-content"]')}get hasQuantitySelect(){let t=this.quantitySelectEl;return t?!!t.getAttribute("title")||parseInt(t.getAttribute("min"),10)>0||parseInt(t.getAttribute("step"),10)>0:!1}get hasAddOn(){return!!this.card.querySelector('[slot="addon"]')}get mainPrice(){return this.card.querySelector(`[slot="heading-m"] ${W}[data-template="price"]`)}updatePriceQuantity({detail:t}){!this.mainPrice||!t?.option||(this.mainPrice.dataset.quantity=t.option)}async adjustAddon(){await this.card.updateComplete;let t=this.card.addon;if(!t)return;t.setAttribute("custom-checkbox","");let a=this.mainPrice;if(!a)return;await a.onceSettled?.();let i=a.value?.[0]?.planType;i&&(t.planType=i)}async postCardUpdateHook(){await this.adjustAddon(),this.legalAdjusted||await this.adjustLegal(),this.adjustShortDescription(),await super.postCardUpdateHook(),window.matchMedia("(min-width: 768px)").matches&&this.syncHeights()}async waitForContentFonts(){let t=[this.card.querySelector('[slot="heading-xs"]'),this.card.querySelector('[slot="body-xs"]')].filter(Boolean);document.fonts?.load&&await Promise.all(t.map(a=>{let i=window.getComputedStyle(a),n=`${i.fontWeight} ${i.fontSize} ${i.fontFamily}`;return document.fonts.load(n,a.textContent).catch(()=>null)})),await document.fonts?.ready}async syncHeights(){if(this.card.heightSync===!1)return;await this.waitForContentFonts(),await new Promise(s=>requestAnimationFrame(s)),await new Promise(s=>requestAnimationFrame(s));let t=this.getContainer();if(!t||this.card.getBoundingClientRect().width<=2)return;let a=this.card.variant,i=hn,n=[...t.querySelectorAll(`merch-card[variant="${a}"]`)].filter(s=>s.getBoundingClientRect().width>2&&s.variantLayout?.card?.heightSync!==!1),o=new Map;for(let s of n){let c=o.get(s.offsetTop)??[];c.push(s),o.set(s.offsetTop,c)}for(let s of o.values()){let c=0;for(let l of s){l.style.removeProperty(i);let d=l.shadowRoot?.querySelector(".top-card");d&&(c=Math.max(c,parseInt(getComputedStyle(d).height)||0))}c>0&&s.length>1&&s.forEach(l=>l.style.setProperty(i,`${c}px`))}}resyncOnReflow(){let t=this.card.getBoundingClientRect().width;if(t<=2)return;let a=this.card.querySelector('[slot="body-xs"]'),i=a?Math.round(a.getBoundingClientRect().height):0,n=`${Math.round(t)}:${i}`;n!==this.lastSyncKey&&(this.lastSyncKey=n,this.syncHeights())}connectedCallbackHook(){if(!this.card||(this.card.addEventListener(pr,v(this,qt)),this.card.addEventListener(ae,this.updatePriceQuantity),typeof ResizeObserver>"u"))return;T(this,Ve,new ResizeObserver(()=>this.resyncOnReflow())),v(this,Ve).observe(this.card);let t=this.card.querySelector('[slot="body-xs"]');t&&v(this,Ve).observe(t)}disconnectedCallbackHook(){this.card?.removeEventListener(ae,this.updatePriceQuantity),j(this,Y,Ut).call(this),v(this,Ve)?.disconnect(),this.card?.removeEventListener(pr,v(this,qt))}get quantitySelectEl(){return this.card.querySelector("merch-quantity-select")}get licenseOptions(){let t=this.quantitySelectEl;if(!t)return null;let a=parseInt(t.getAttribute("min"),10),i=parseInt(t.getAttribute("max"),10),n=parseInt(t.getAttribute("step"),10)||1;if(Number.isNaN(a)||Number.isNaN(i)||i<a)return null;let o=[];for(let s=a;s<=i;s+=n)o.push(String(s));return o.length?o:null}licenseLabel(t){let a=this.quantitySelectEl?.getAttribute("title")||"License",[i,n]=a.split("|").map(o=>o.trim());return Number(t)===1?i:n||i}get hasLicenseSelector(){return(this.licenseOptions?.length??0)>0}get currentLicenseValue(){let t=this.licenseOptions;if(!t?.length)return null;if(this.licenseQty!=null)return this.licenseQty;let a=this.quantitySelectEl?.getAttribute("default-value");return a!=null&&t.includes(a)?a:t[0]}renderLicenseSelector(){if(!this.hasLicenseSelector)return He`<slot name="quantity-select"></slot>`;let t=this.licenseOptions,a=this.currentLicenseValue,i=!!this.licenseOpen,n=this.licenseLabel(Number(a));return He`
            <div class="license-select" ?data-open=${i}>
                <div
                    ...
                    aria-activedescendant=${i?`license-option-${this.licenseHighlightedIndex}`:Bt}
        ...
        `}renderLayout(){let t=!!this.expanded;return He`
            <div class="top-card">
                <div class="mnemonic">
                    <slot name="icons"></slot>
                    <slot name="subtitle"></slot>
                ...
                ${this.hasLicenseSelector||this.hasCallout||this.hasQuantitySelect?He`<div class="license-zone">
                          ${this.renderLicenseSelector()}
                          ${this.hasCallout?He`<div class="callout">
                                    <slot name="callout-content"></slot>
                                </div>`:Bt}
                      </div>`:Bt}
                ${this.hasAddOn?He`<div class="add-on">
                          <slot name="addon"></slot>
                      </div>`:Bt}
                <footer>
                    <slot name="footer"></slot>
            ...
            ${this.hasWhatsIncluded?He`
                  ...
                  `:Bt}
            <slot></slot>
        `}};ke=new WeakMap,Ve=new WeakMap,qt=new WeakMap,Y=new WeakSet,mn=function(){let t=this.card.offsetTop,a=Array.from(this.getContainer()?.querySelectorAll(`merch-card[variant="${this.card.variant}"]`)??[]).filter(i=>i.getBoundingClientRect().width>2&&i.offsetTop===t);return a.length?a:[this.card]},Ut=function(){v(this,ke)&&(document.removeEventListener("mousedown",v(this,ke)),T(this,ke,null))},un=function(){let t=this.licenseOptions?.indexOf(this.currentLicenseValue);return t>0?t:0},$t=function(){this.licenseOpen=!0,this.licenseHighlightedIndex=j(this,Y,un).call(this),v(this,ke)||(T(this,ke,t=>{t.composedPath().includes(this.card)||(this.licenseOpen=!1,this.card.requestUpdate(),j(this,Y,Ut).call(this))}),document.addEventListener("mousedown",v(this,ke)))},ka=function(){this.licenseOpen=!1,j(this,Y,Ut).call(this)},Er=new WeakMap,m(Sr,"variantStyle",Tc`
        :host([variant='pro']) {
            display: flex;
            flex-direction: column;
            background: var(
    ...
    `);var Gt=Sr;import{html as Pa,css as Pc}from"./lit-all.min.js";var gn=`
:root {
...
`;var fn={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},prices:{tag:"p",slot:"heading-xs"},promoText:{tag:"p",slot:"promo-text"},description:{tag:"div",slot:"body-xs"},shortDescription:{tag:"div",slot:"short-description"},mnemonics:{size:"l"},callout:{tag:"div",slot:"callout-content"},quantitySelect:{tag:"div",slot:"quantity-select"},secureLabel:!0,planType:!0,addon:!0,addonBackground:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"color-yellow-300-variation"},allowedBadgeColors:["color-yellow-300-variation","color-gray-300-variation","color-gray-700-variation","color-green-900-variation","gradient-purple-blue"],allowedBorderColors:["color-yellow-300-variation","color-gray-300-variation","color-green-900-variation","gradient-purple-blue"],borderColor:{attribute:"border-color"},whatsIncluded:{tag:"div",slot:"whats-included"},ctas:{slot:"footer",size:"m"},style:"consonant",perUnitLabel:{tag:"span",slot:"per-unit-label"}},Se,dt=class extends w{constructor(t){super(t);M(this,Se);this.postCardUpdateHook=this.postCardUpdateHook.bind(this),this.updatePriceQuantity=this.updatePriceQuantity.bind(this)}getGlobalCSS(){return gn}priceOptionsProvider(t,a){t.dataset.template===te&&(a.displayPlanType=this.card?.settings?.displayPlanType??!1,(t.dataset.template==="strikethrough"||t.dataset.template==="price")&&(a.displayPerUnit=!1))}adjustProductBodySlots(){if(this.card.getBoundingClientRect().width===0)return;["heading-xs","body-xxs","body-xs","promo-text","callout-content","addon","body-lower"].forEach(a=>this.updateCardElementMinHeight(this.card.shadowRoot.querySelector(`slot[name="${a}"]`),a))}renderLayout(){return Pa` ${this.badge}
            ...
            <hr />
            ${this.secureLabelFooter}`}connectedCallbackHook(){this.handleResize=()=>{v(this,Se)&&cancelAnimationFrame(v(this,Se)),T(this,Se,requestAnimationFrame(()=>{T(this,Se,null),this.postCardUpdateHook()}))},this.adjustShortDescriptionBound=this.adjustShortDescription.bind(this),window.addEventListener("resize",this.handleResize),this.card.addEventListener(ae,this.updatePriceQuantity),this.card.addEventListener(mr,this.adjustShortDescriptionBound)}disconnectedCallbackHook(){this.handleResize&&(window.removeEventListener("resize",this.handleResize),this.handleResize=null),v(this,Se)&&(cancelAnimationFrame(v(this,Se)),T(this,Se,null)),this.card.removeEventListener(ae,this.updatePriceQuantity),this.card.removeEventListener(mr,this.adjustShortDescriptionBound)}adjustShortDescription(){let t=this.card.querySelector('[slot="short-description"]');if(!t?.textContent?.trim())return;let a=this.card.querySelector('span[data-template="legal"]');if(!a)return;this.card.querySelector(".merch-short-description")?.remove();let i=document.createElement("span");i.className="merch-short-description";let n=t.querySelector("p")??t;i.innerHTML=n.innerHTML,i.querySelectorAll(".icon-button").forEach(o=>{o.dataset.eventsWired||(o.dataset.eventsWired="1",["mouseenter","focus"].forEach(s=>o.addEventListener(s,()=>o.classList.add("tooltip-visible"))),["mouseleave","blur"].forEach(s=>o.addEventListener(s,()=>o.classList.remove("tooltip-visible"))),o.addEventListener("keydown",s=>{s.key==="Escape"&&o.classList.remove("tooltip-visible")}))}),a.after(i),t.hidden=!0}async postCardUpdateHook(){this.card.isConnected&&(this.adjustAddon(),k.isMobile||this.adjustProductBodySlots(),this.legalAdjusted||await this.adjustLegal(),await super.postCardUpdateHook())}async adjustLegal(){if(!(this.legalAdjusted||!this.card.id))try{this.legalAdjusted=!0,await this.card.updateComplete,await customElements.whenDefined("inline-price");let t=this.mainPrice;if(!t)return;let a=t.cloneNode(!0);if(await t.onceSettled(),!t?.options)return;t.options.displayTax&&(t.dataset.displayTax="false"),t.options.displayPlanType&&(t.dataset.displayPlanType="false"),a.setAttribute("data-template","legal"),t.closest('[slot="heading-xs"]').appendChild(a),await a.onceSettled(),a.querySelector(".price-unit-type")?.remove()}catch{}}get headingXSSlot(){return this.card.shadowRoot.querySelector('slot[name="heading-xs"]').assignedElements()[0]}get mainPrice(){return this.card.querySelector(`[slot="heading-xs"] ${W}[data-template="price"]`)}updatePriceQuantity({detail:t}){!this.mainPrice||!t?.option||(this.mainPrice.dataset.quantity=t.option)}toggleAddon(t){let a=this.mainPrice,i=this.headingXSSlot;if(!a&&i){let n=t?.getAttribute("plan-type"),o=null;if(t&&n&&(o=t.querySelector(`p[data-plan-type="${n}"]`)?.querySelector('span[is="inline-price"]')),this.card.querySelectorAll('p[slot="heading-xs"]').forEach(s=>s.remove()),t.checked){if(o){let s=be("p",{class:"addon-heading-xs-price-addon",slot:"heading-xs"},o.innerHTML);this.card.appendChild(s)}}else{let s=be("p",{class:"card-heading",id:"free",slot:"heading-xs"},"Free");this.card.appendChild(s)}}}async adjustAddon(){await this.card.updateComplete;let t=this.card.addon;if(!t)return;let a=this.mainPrice,i=this.card.planType;a&&(await a.onceSettled?.(),i=a.value?.[0]?.planType),i&&(t.planType=i)}};Se=new WeakMap,m(dt,"variantStyle",Pc`
    ...
    `);import{html as La,css as Lc}from"./lit-all.min.js";var vn=`
:root {
...
`;var xn={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},prices:{tag:"p",slot:"heading-xs"},promoText:{tag:"p",slot:"promo-text"},description:{tag:"div",slot:"body-xs"},callout:{tag:"div",slot:"callout-content"},planType:!0,secureLabel:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"color-red-700-variation"},allowedBadgeColors:["color-yellow-300-variation","color-gray-300-variation","color-gray-700-variation","color-green-900-variation","color-red-700-variation","gradient-purple-blue"],allowedBorderColors:["color-yellow-300-variation","color-gray-300-variation","color-green-900-variation","color-red-700-variation","gradient-purple-blue"],borderColor:{attribute:"border-color"},ctas:{slot:"footer",size:"m"},style:"consonant",perUnitLabel:{tag:"span",slot:"per-unit-label"}},ht=class extends w{constructor(r){super(r)}priceOptionsProvider(r,t){r.dataset.template===te&&(t.displayPlanType=this.card?.settings?.displayPlanType??!1,(r.dataset.template==="strikethrough"||r.dataset.template==="price")&&(t.displayPerUnit=!1))}getGlobalCSS(){return vn}get badgeElement(){return this.card.querySelector('[slot="badge"]')}get mainPrice(){return this.card.querySelector(`[slot="heading-xs"] ${W}[data-template="price"]`)}async postCardUpdateHook(){this.legalAdjusted||await this.adjustLegal(),await super.postCardUpdateHook()}async adjustLegal(){if(!(this.legalAdjusted||!this.card.id))try{this.legalAdjusted=!0,await this.card.updateComplete,await customElements.whenDefined("inline-price");let r=this.mainPrice;if(!r)return;let t=r.cloneNode(!0);if(await r.onceSettled(),!r?.options)return;r.options.displayPerUnit&&(r.dataset.displayPerUnit="false"),r.options.displayTax&&(r.dataset.displayTax="false"),r.options.displayPlanType&&(r.dataset.displayPlanType="false"),t.setAttribute("data-template","legal"),r.parentNode.insertBefore(t,r.nextSibling),await t.onceSettled()}catch{}}renderLayout(){return La`
            ${this.badge}
            <div class="body">
                <slot name="heading-xs"></slot>
                <slot name="body-xxs"></slot>
                ${this.promoBottom?"":La`<slot name="promo-text"></slot
                          ><slot name="callout-content"></slot>`}
                <slot name="body-xs"></slot>
                ${this.promoBottom?La`<slot name="promo-text"></slot
                          ><slot name="callout-content"></slot>`:""}
    ...
    `);import{html as Mc,css as Rc}from"./lit-all.min.js";var bn=`
...
`;var yn={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},subtitle:{tag:"p",slot:"body-xxs"},description:{tag:"div",slot:"body-xs"},ctas:{slot:"footer",size:"m"},backgroundImage:{tag:"div",slot:"bg-image"},style:"consonant"},pt=class extends w{constructor(r){super(r)}getGlobalCSS(){return bn}removeFocusFromModalClose(){let r=this.card.closest(".dialog-modal");r&&r.querySelector(".dialog-close")?.blur()}async postCardUpdateHook(){this.removeFocusFromModalClose(),await super.postCardUpdateHook()}renderLayout(){return Mc`
            <div class="media-row">
                <div class="text">
                    <slot name="body-xxs"></slot>
                    <slot name="heading-xs"></slot>
    ...
    `);import{html as Ma,css as Oc}from"./lit-all.min.js";var wn=`
:root {
...
`;var En={cardName:{attribute:"name"},backgroundImage:{tag:"div",slot:"bg-image"},subtitle:{tag:"p",slot:"detail-m"},title:{tag:"h3",slot:"heading-xs"},prices:{tag:"p",slot:"heading-xs-price"},description:{tag:"div",slot:"body-xs"},ctas:{slot:"footer",size:"l"},badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300-special-offers"},allowedBadgeColors:["spectrum-yellow-300-special-offers","spectrum-gray-300-special-offers","spectrum-green-900-special-offers"],allowedBorderColors:["spectrum-yellow-300-special-offers","spectrum-gray-300-special-offers","spectrum-green-900-special-offers"],borderColor:{attribute:"border-color"}},mt=class extends w{constructor(r){super(r)}get headingSelector(){return'[slot="detail-m"]'}getGlobalCSS(){return wn}renderLayout(){return Ma`${this.cardImage}
            ...
            ${this.evergreen?Ma`
                  ...
                  `:Ma`
                      ...
                      ${this.secureLabelFooter}
                  `}
            <slot></slot>`}};m(mt,"variantStyle",Oc`
    ...
    `);import{html as Nc,css as Ic}from"./lit-all.min.js";var Sn=`
:root {
...
`;var Ra={title:{tag:"h3",slot:"heading-xs",maxCount:250,withSuffix:!0},badge:{tag:"div",slot:"badge",default:"spectrum-blue-400"},allowedBadgeColors:["spectrum-blue-400","spectrum-gray-300","spectrum-yellow-300","gradient-purple-blue","gradient-firefly-spectrum"],description:{tag:"div",slot:"body-xs",maxCount:2e3,withSuffix:!1},prices:{tag:"div",slot:"price"},callout:{tag:"div",slot:"callout-content",editorLabel:"Price description"},ctas:{slot:"cta",size:"XL"},borderColor:{attribute:"border-color",specialValues:{gray:"var(--spectrum-gray-300)",blue:"var(--spectrum-blue-400)","gradient-purple-blue":"linear-gradient(96deg, #B539C8 0%, #7155FA 66%, #3B63FB 100%)","gradient-firefly-spectrum":"linear-gradient(96deg, #D73220 0%, #D92361 33%, #7155FA 100%)"}},disabledAttributes:["badgeColor","badgeBorderColor","trialBadgeColor","trialBadgeBorderColor"],supportsDefaultChild:!0},ut=class extends w{getGlobalCSS(){return Sn}get aemFragmentMapping(){return Ra}get headingSelector(){return'[slot="heading-xs"]'}get badge(){return this.card.querySelector('[slot="badge"]')}syncHeights(){if(this.card.getBoundingClientRect().width===0)return;let r=this.card.shadowRoot;if(!r)return;["header","price-container","cta"].forEach(i=>this.updateCardElementMinHeight(r.querySelector(`.${i}`),i));let t=this.card.querySelector('[slot="body-xs"]');t&&this.updateCardElementMinHeight(t,"description");let a=this.card.querySelector('[slot="body-xs"] p:has(mas-mnemonic)');a&&this.updateCardElementMinHeight(a,"icons")}async postCardUpdateHook(){if(!this.card.isConnected)return;await super.postCardUpdateHook();let r=this.getContainer();if(!r)return;let t=r.querySelectorAll(`merch-card[variant="${this.card.variant}"]`),a=34;t.forEach(i=>{i.classList.remove("small-font-size-button"),i.querySelectorAll('[slot="cta"] sp-button, [slot="cta"] button, [slot="cta"] a.con-button, [slot="cta"] a.spectrum-Button, a[slot="cta"]').forEach(o=>{let s=o.textContent.trim().length>a;o.classList.toggle("small-font-size-button",s)})}),k.isDesktopOrUp&&t.forEach(i=>i.variantLayout?.syncHeights?.())}connectedCallbackHook(){!this.card||this.card.failed||(this.setupAccordion(),this.card?.hasAttribute("data-default-card")&&!dr()&&this.card.setAttribute("data-expanded","true"),this.observeVisibility())}resyncSiblings(){let r=this.getContainer();r&&r.querySelectorAll(`merch-card[variant="${this.card.variant}"]`).forEach(t=>t.variantLayout?.syncHeights?.())}observeVisibility(){typeof ResizeObserver>"u"||(this.lastSyncedWidth=0,this.sizeObserver=new ResizeObserver(()=>{let r=this.card.getBoundingClientRect().width;r<=2||r===this.lastSyncedWidth||(this.lastSyncedWidth=r,this.resyncSiblings())}),this.sizeObserver.observe(this.card))}setupAccordion(){let r=this.card;if(!r)return;let t=()=>{if(dr())r.removeAttribute("data-expanded");else{let i=r.hasAttribute("data-default-card");r.setAttribute("data-expanded",i?"true":"false")}};t();let a=window.matchMedia(D);this.mediaQueryListener=()=>{t()},a.addEventListener("change",this.mediaQueryListener)}disconnectedCallbackHook(){this.mediaQueryListener&&window.matchMedia(D).removeEventListener("change",this.mediaQueryListener),this.sizeObserver?.disconnect(),this.sizeObserver=null}handleChevronClick(r){r.preventDefault(),r.stopPropagation(),this.toggleExpanded()}handleCardClick(r){r.target.closest('.chevron-button, mas-mnemonic, button, a, [role="button"]')||(r.preventDefault(),this.toggleExpanded())}toggleExpanded(){let r=this.card;if(!r||dr())return;let i=r.getAttribute("data-expanded")==="true"?"false":"true";r.setAttribute("data-expanded",i)}renderLayout(){return Nc`
    ...
    `);import{html as Cn,css as Dc}from"./lit-all.min.js";var An=`
:root {
...
`;var Oa={title:{tag:"h3",slot:"heading-xs",maxCount:250,withSuffix:!0},badge:{tag:"div",slot:"badge",default:"spectrum-blue-400"},allowedBadgeColors:["spectrum-blue-400","spectrum-gray-300","spectrum-yellow-300","gradient-purple-blue","gradient-firefly-spectrum"],description:{tag:"div",slot:"body-s",maxCount:2e3,withSuffix:!1},shortDescription:{tag:"div",slot:"short-description",maxCount:3e3,withSuffix:!1},callout:{tag:"div",slot:"callout-content",editorLabel:"Price description"},prices:{tag:"div",slot:"price"},trialBadge:{tag:"div",slot:"trial-badge"},ctas:{slot:"cta",size:"XL"},mnemonics:{size:"xs"},borderColor:{attribute:"border-color",specialValues:{gray:"var(--spectrum-gray-300)",blue:"var(--spectrum-blue-400)","gradient-purple-blue":"linear-gradient(96deg, #B539C8 0%, #7155FA 66%, #3B63FB 100%)","gradient-firefly-spectrum":"linear-gradient(96deg, #D73220 0%, #D92361 33%, #7155FA 100%)"}},showAllSpectrumColors:!0,multiWhatsIncluded:"true",disabledAttributes:[]},Vt=class Vt extends w{getGlobalCSS(){return An}get aemFragmentMapping(){return Oa}get headingSelector(){return'[slot="heading-xs"]'}get badgeElement(){return this.card.querySelector('[slot="badge"]')}get badge(){return Cn`
        ...
        `}async waitForTitleFont(){let r=this.card.querySelector(this.headingSelector);if(r&&document.fonts?.load){let t=window.getComputedStyle(r),a=`${t.fontWeight} ${t.fontSize} ${t.fontFamily}`;await document.fonts.load(a,r.textContent).catch(()=>null)}await document.fonts.ready}async syncHeights(){if(await this.waitForTitleFont(),await new Promise(s=>requestAnimationFrame(s)),await new Promise(s=>requestAnimationFrame(s)),this.card.getBoundingClientRect().width<=2)return;let r=Vt.SYNCED_SECTIONS.map(s=>({name:s,getElement:c=>c.shadowRoot?.querySelector(`.${s}`)})),t=this.getContainer(),a=t?t.querySelectorAll(`merch-card[variant="${this.card.variant}"]`):[this.card],i='[slot="body-s"] > *',n=Math.max(0,...Array.from(a,s=>s.querySelectorAll(i).length)),o=Array.from({length:n},(s,c)=>({name:`description-row-${c}`,getElement:l=>l.querySelectorAll(i)[c]}));this.syncRowHeights([...r,...o])}async postCardUpdateHook(){if(!this.card.isConnected)return;await super.postCardUpdateHook();let r=this.getContainer();if(r){let t=r.querySelectorAll(`merch-card[variant="${this.card.variant}"]`),a=49;t.forEach(i=>{i.classList.remove("small-font-size-button"),i.querySelectorAll('[slot="cta"] sp-button, [slot="cta"] button, [slot="cta"] a.con-button, [slot="cta"] a.spectrum-Button, a[slot="cta"]').forEach(o=>{let s=o.textContent.trim().length>a;o.classList.toggle("small-font-size-button",s)})})}window.matchMedia("(min-width: 768px)").matches&&this.syncHeights()}resyncOnReflow(){let r=this.card.getBoundingClientRect().width;if(r<=2)return;let t=this.card.querySelector(this.headingSelector),a=t?Math.round(t.getBoundingClientRect().height):0,i=`${Math.round(r)}:${a}`;i!==this.lastSyncedKey&&(this.lastSyncedKey=i,this.syncHeights())}connectedCallbackHook(){if(!this.card||typeof ResizeObserver>"u")return;this.lastSyncedKey="",this.sizeObserver=new ResizeObserver(()=>this.resyncOnReflow()),this.sizeObserver.observe(this.card);let r=this.card.querySelector(this.headingSelector);r&&this.sizeObserver.observe(r)}disconnectedCallbackHook(){this.sizeObserver?.disconnect(),this.sizeObserver=null}renderLayout(){return Cn`
            ...
            <slot></slot>
        `}};m(Vt,"SYNCED_SECTIONS",["header","short-description","price-container","cta"]),m(Vt,"variantStyle",Dc`
    ...
    `);var jt=Vt;import{html as Na,css as Hc,nothing as zc}from"./lit-all.min.js";var Tn=`
...
`;var _n={cardName:{attribute:"name"},title:{tag:"p",slot:"heading-xs"},cardTitle:{tag:"p",slot:"heading-xs"},subtitle:{tag:"p",slot:"body-xxs"},description:{tag:"div",slot:"body-xs"},promoText:{tag:"p",slot:"promo-text"},shortDescription:{tag:"p",slot:"short-description"},callout:{tag:"div",slot:"callout-content"},quantitySelect:{tag:"div",slot:"quantity-select"},whatsIncluded:{tag:"div",slot:"whats-included"},addonConfirmation:{tag:"div",slot:"addon-confirmation"},badge:{tag:"div",slot:"badge"},trialBadge:{tag:"div",slot:"trial-badge"},prices:{tag:"p",slot:"prices"},backgroundImage:{tag:"div",slot:"bg-image"},ctas:{slot:"footer",size:"m"},addon:!0,secureLabel:!0,borderColor:{attribute:"border-color"},backgroundColor:{attribute:"background-color"},size:[],mnemonics:{size:"m"}},Fc=[{slot:"bg-image",label:"Background Image"},{slot:"badge",label:"Badge"},{slot:"icons",label:"Mnemonic icon"},{slot:"heading-xs",label:"Title"},{slot:"body-xxs",label:"Subtitle"},{slot:"body-xs",label:"Product description"},{slot:"promo-text",label:"Promo Text"},{slot:"callout-content",label:"Callout text"},{slot:"short-description",label:"Short Description"},{slot:"trial-badge",label:"Trial Badge"},{slot:"prices",label:"Product price"},{slot:"quantity-select",label:"Quantity select"},{slot:"addon",label:"Addon"},{slot:"whats-included",label:"What's included"},{slot:"addon-confirmation",label:"Addon confirmation"},{slot:"footer",label:"CTAs"}];function je(e){return e.map(({slot:r,label:t})=>Na`
        ...
        `)}var pe=class extends w{constructor(r){super(r)}getGlobalCSS(){return Tn}renderLayout(){return Na`
            <div class="headless">
                ${je(Fc)}
    ...
    `);import{css as Bc,html as kn,nothing as Uc}from"./lit-all.min.js";var $c=[{slot:"heading-xs",label:"Title"},{slot:"body-xs",label:"Description"},{slot:"short-description",label:"Short Description"},{slot:"prices",label:"Price"},{slot:"footer",label:"CTAs"}],Pn={cardName:{attribute:"name"},title:{tag:"p",slot:"heading-xs"},description:{tag:"div",slot:"body-xs"},shortDescription:{tag:"p",slot:"short-description"},prices:{tag:"p",slot:"prices"},ctas:{slot:"footer",size:"m"},size:[]},gt=class extends pe{constructor(r){super(r)}renderLayout(){return kn`
            <div class="headless">
                ${je($c)}
                ${this.card.secureLabel?kn`
                          <div class="headless-row">
                              <span class="headless-label">Secure label</span>
                              <span class="headless-value">
                                  ${this.secureLabel}
    ...
    `);import{css as Gc,html as Ln,nothing as qc}from"./lit-all.min.js";var Vc=[{slot:"prices",label:"Price"},{slot:"body-xs",label:"FAQ answer 1"},{slot:"short-description",label:"FAQ answer 2"},{slot:"callout-content",label:"FAQ answer 3"}],Mn={cardName:{attribute:"name"},prices:{tag:"p",slot:"prices"},description:{tag:"div",slot:"body-xs"},shortDescription:{tag:"p",slot:"short-description"},callout:{tag:"div",slot:"callout-content"},size:[]},ft=class extends pe{constructor(r){super(r)}renderLayout(){return Ln`
            <div class="headless">
                ${je(Vc)}
                ${this.card.secureLabel?Ln`
                          <div class="headless-row">
                              <span class="headless-label">Secure label</span>
                              <span class="headless-value">
                                  ${this.secureLabel}
    ...
    `);import{css as jc,html as Rn,nothing as Wc}from"./lit-all.min.js";var Yc=[{slot:"body-xs",label:"Description"},{slot:"footer",label:"CTAs"}],On={cardName:{attribute:"name"},description:{tag:"div",slot:"body-xs"},ctas:{slot:"footer",size:"m"},size:[]},vt=class extends pe{constructor(r){super(r)}renderLayout(){return Rn`
            <div class="headless">
                ${je(Yc)}
                ${this.card.secureLabel?Rn`
                          <div class="headless-row">
                              <span class="headless-label">Secure label</span>
                              <span class="headless-value">
                                  ${this.secureLabel}
    ...
    `);import{css as Xc,html as Kc}from"./lit-all.min.js";var Nn=`
...
`;var In={title:{tag:"p",slot:"title"},prices:{tag:"p",slot:"prices"},description:{tag:"p",slot:"description"},planType:!0,ctas:{slot:"ctas",size:"S"}},xt=class extends w{constructor(){super(...arguments);m(this,"legal")}async postCardUpdateHook(){await super.postCardUpdateHook(),this.adjustLegal()}getGlobalCSS(){return Nn}get headingSelector(){return'[slot="title"]'}priceOptionsProvider(t,a){a.literals={...a.literals,strikethroughAriaLabel:"",alternativePriceAriaLabel:""},a.space=!0,a.displayAnnual=this.card.settings?.displayAnnual??!1}adjustLegal(){if(this.legal!==void 0)return;let t=this.card.querySelector(`${W}[data-template="price"]`);if(!t)return;let a=t.cloneNode(!0);this.legal=a,t.dataset.displayTax="false",t.dataset.displayPerUnit="false",a.dataset.template="legal",a.dataset.displayPlanType=this.card?.settings?.displayPlanType??!0,a.setAttribute("slot","legal"),this.card.appendChild(a)}renderLayout(){return Kc`
            ${this.badge}
            <div class="body">
    ...
    `);import{html as Qc,css as Zc}from"./lit-all.min.js";var Dn=`
...
`;var Ia={mnemonics:{size:"l"},title:{tag:"h3",slot:"header",maxCount:100},prices:{tag:"p",slot:"price"},description:{tag:"div",slot:"detail",maxCount:1e3},ctas:{slot:"cta",size:"M"},features:{tag:"div",slot:"features",unwrap:!0}},Jc=[{key:"header",selector:".seg-header"},{key:"price",selector:".seg-price"},{key:"detail",selector:".seg-detail"},{key:"cta",selector:".seg-cta"}],Ar,Hn,bt=class extends w{constructor(t){super(t);M(this,Ar);this.postCardUpdateHook=this.postCardUpdateHook.bind(this)}getGlobalCSS(){return Dn}get aemFragmentMapping(){return Ia}getContainer(){return this.card.closest("mas-compare-chart")??this.card.parentElement}connectedCallbackHook(){window.addEventListener("resize",this.postCardUpdateHook)}disconnectedCallbackHook(){window.removeEventListener("resize",this.postCardUpdateHook)}async postCardUpdateHook(){this.card.isConnected&&(await this.card.updateComplete,j(this,Ar,Hn).call(this))}renderLayout(){return Qc`
            <div class="card">
            ...
            <slot></slot>
        `}};Ar=new WeakSet,Hn=function(){if(this.card.getBoundingClientRect().width===0)return;let t=this.card.shadowRoot;Jc.forEach(({key:a,selector:i})=>this.updateCardElementMinHeight(t.querySelector(i),a))},m(bt,"variantStyle",Zc`
...
`;var Da={mnemonics:{size:"s"},title:{tag:"h3",slot:"heading-xxs",maxCount:250,withSuffix:!0},description:{tag:"div",slot:"body-s",maxCount:2e3,withSuffix:!1},whatsIncluded:{tag:"div",slot:"whats-included"},badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300"},trialBadge:{tag:"div",slot:"trial-badge",default:"spectrum-green-800"},prices:{tag:"p",slot:"price"},ctas:{slot:"cta",size:"M"},addonConfirmation:{tag:"div",slot:"addon-confirmation"},borderColor:{attribute:"border-color",specialValues:{gray:"--spectrum-gray-300","gradient-purple-blue":"var(--gradient-purple-blue)","gradient-firefly-spectrum":"var(--gradient-firefly-spectrum)"}}},yt=class extends w{getGlobalCSS(){return zn}get aemFragmentMapping(){return Da}renderLayout(){return el`
    ...
    `);var Fn=new Map;var U=(e,r,t=null,a=null,i)=>{Fn.set(e,{class:r,fragmentMapping:t,style:a,collectionOptions:i})};U("catalog",st,Gi,st.variantStyle);U("image",qe);U("inline-heading",vr);U("mini-compare-chart",ct,Ki,ct.variantStyle);U("mini-compare-chart-mweb",lt,Zi,lt.variantStyle);U("plans",ne,yr,ne.variantStyle,ne.collectionOptions);U("plans-students",ne,tn,ne.variantStyle,ne.collectionOptions);U("plans-education",ne,en,ne.variantStyle,ne.collectionOptions);U("plans-v2",De,nn,De.variantStyle,De.collectionOptions);U("pro",Gt,pn,Gt.variantStyle);U("product",dt,fn,dt.variantStyle);U("segment",ht,xn,ht.variantStyle);U("media",pt,yn,pt.variantStyle);U("headless",pe,_n,pe.variantStyle);U("headless-marquee",gt,Pn,gt.variantStyle);U("headless-faq",ft,Mn,ft.variantStyle);U("headless-promo-bar",vt,On,vt.variantStyle);U("special-offers",mt,En,mt.variantStyle);U("simplified-pricing-express",ut,Ra,ut.variantStyle);U("full-pricing-express",jt,Oa,jt.variantStyle);U("mini",xt,In,xt.variantStyle);U("image",qe,Vi,qe.variantStyle);U("compare-chart-column",bt,Ia,bt.variantStyle);U("fries",yt,Da,yt.variantStyle);function fr(e){return Fn.get(e)?.fragmentMapping}var Bn="tacocat.js";var Ha=(e,r)=>String(e??"").toLowerCase()==String(r??"").toLowerCase(),Un=e=>`${e??""}`.replace(/[&<>'"]/g,r=>({"&":"&amp;","<":"&lt;",">":"&gt;","'":"&#39;",'"':"&quot;"})[r]??r)??"";function z(e,r={},{metadata:t=!0,search:a=!0,storage:i=!0}={}){let n;if(a&&n==null){let o=new URLSearchParams(window.location.search),s=wt(a)?a:e;n=o.get(s)}if(i&&n==null){let o=wt(i)?i:e;n=window.sessionStorage.getItem(o)??window.localStorage.getItem(o)}if(t&&n==null){let o=al(wt(t)?t:e);n=document.documentElement.querySelector(`meta[name="${o}"]`)?.content}return n??r[e]}var rl=e=>typeof e=="boolean",Cr=e=>typeof e=="function",Tr=e=>typeof e=="number",$n=e=>e!=null&&typeof e=="object";var wt=e=>typeof e=="string",Gn=e=>wt(e)&&e,Et=e=>Tr(e)&&Number.isFinite(e)&&e>0;function _r(e,r=t=>t==null||t===""){return e!=null&&Object.entries(e).forEach(([t,a])=>{r(a)&&delete e[t]}),e}function E(e,r){if(rl(e))return e;let t=String(e);return t==="1"||t==="true"?!0:t==="0"||t==="false"?!1:r}function Wt(e,r,t){let a=Object.values(r);return a.find(i=>Ha(i,e))??t??a[0]}function al(e=""){return String(e).replace(/(\p{Lowercase_Letter})(\p{Uppercase_Letter})/gu,(r,t,a)=>`${t}-${a}`).replace(/\W+/gu,"-").toLowerCase()}function qn(e,r=1){return Tr(e)||(e=Number.parseInt(e,10)),!Number.isNaN(e)&&e>0&&Number.isFinite(e)?e:r}var il=Date.now(),za=()=>`(+${Date.now()-il}ms)`,kr=new Set,nl=E(z("tacocat.debug",{},{metadata:!1}),!1);function Vn(e){let r=`[${Bn}/${e}]`,t=(o,s,...c)=>o?!0:(i(s,...c),!1),a=nl?(o,...s)=>{console.debug(`${r} ${o}`,...s,za())}:()=>{},i=(o,...s)=>{let c=`${r} ${o}`;kr.forEach(([l])=>l(c,...s))};return{assert:t,debug:a,error:i,warn:(o,...s)=>{let c=`${r} ${o}`;kr.forEach(([,l])=>l(c,...s))}}}function ol(e,r){let t=[e,r];return kr.add(t),()=>{kr.delete(t)}}ol((e,...r)=>{console.error(e,...r,za())},(e,...r)=>{console.warn(e,...r,za())});var sl="no promo",jn="promo-tag",cl="yellow",ll="neutral",dl=(e,r,t)=>{let a=n=>n||sl,i=t?` (was "${a(r)}")`:"";return`${a(e)}${i}`},Pr="cancel-context",Lr=(e,r)=>{let t=e===Pr,a=!t&&e?.length>0,i=(a||t)&&(r&&r!=e||!r&&!t),n=i&&a||!i&&!!r,o=n?e||r:void 0;return{effectivePromoCode:o,overridenPromoCode:e,className:n?jn:`${jn} no-promo`,text:dl(o,r,i),variant:n?cl:ll,isOverriden:i}};var Fa;(function(e){e.BASE="BASE",e.TRIAL="TRIAL",e.PROMOTION="PROMOTION"})(Fa||(Fa={}));var le;(function(e){e.MONTH="MONTH",e.YEAR="YEAR",e.TWO_YEARS="TWO_YEARS",e.THREE_YEARS="THREE_YEARS",e.PERPETUAL="PERPETUAL",e.TERM_LICENSE="TERM_LICENSE",e.ACCESS_PASS="ACCESS_PASS",e.THREE_MONTHS="THREE_MONTHS",e.SIX_MONTHS="SIX_MONTHS"})(le||(le={}));var me;(function(e){e.ANNUAL="ANNUAL",e.MONTHLY="MONTHLY",e.TWO_YEARS="TWO_YEARS",e.THREE_YEARS="THREE_YEARS",e.P1D="P1D",e.P1Y="P1Y",e.P3Y="P3Y",e.P10Y="P10Y",e.P15Y="P15Y",e.P3D="P3D",e.P7D="P7D",e.P30D="P30D",e.HALF_YEARLY="HALF_YEARLY",e.QUARTERLY="QUARTERLY"})(me||(me={}));var Ba;(function(e){e.INDIVIDUAL="INDIVIDUAL",e.TEAM="TEAM",e.ENTERPRISE="ENTERPRISE"})(Ba||(Ba={}));var Ua;(function(e){e.COM="COM",e.EDU="EDU",e.GOV="GOV"})(Ua||(Ua={}));var $a;(function(e){e.DIRECT="DIRECT",e.INDIRECT="INDIRECT"})($a||($a={}));var Ga;(function(e){e.ENTERPRISE_PRODUCT="ENTERPRISE_PRODUCT",e.ETLA="ETLA",e.RETAIL="RETAIL",e.VIP="VIP",e.VIPMP="VIPMP",e.FREE="FREE"})(Ga||(Ga={}));var qa="ABM",Va="PUF",ja="M2M",Wa="PERPETUAL",Ya="P3Y",hl="TAX_INCLUSIVE_DETAILS",pl="TAX_EXCLUSIVE",Wn={ABM:qa,PUF:Va,M2M:ja,PERPETUAL:Wa,P3Y:Ya},$u={[qa]:{commitment:le.YEAR,term:me.MONTHLY},[Va]:{commitment:le.YEAR,term:me.ANNUAL},[ja]:{commitment:le.MONTH,term:me.MONTHLY},[Wa]:{commitment:le.PERPETUAL,term:void 0},[Ya]:{commitment:le.THREE_MONTHS,term:me.P3Y}},Yn="Value is not an offer",Mr=e=>{if(typeof e!="object")return Yn;let{commitment:r,term:t}=e,a=ml(r,t);return{...e,planType:a}};var ml=(e,r)=>{switch(e){case void 0:return Yn;case"":return"";case le.YEAR:return r===me.MONTHLY?qa:r===me.ANNUAL?Va:"";case le.MONTH:return r===me.MONTHLY?ja:"";case le.PERPETUAL:return Wa;case le.TERM_LICENSE:return r===me.P3Y?Ya:"";default:return""}};function Xn(e){let{priceDetails:r}=e,{price:t,priceWithoutDiscount:a,priceWithoutTax:i,priceWithoutDiscountAndTax:n,taxDisplay:o}=r;if(o!==hl)return e;let s={...e,priceDetails:{...r,price:i??t,priceWithoutDiscount:n??a,taxDisplay:pl}};return s.offerType==="TRIAL"&&s.priceDetails.price===0&&(s.priceDetails.price=s.priceDetails.priceWithoutDiscount),s}var We={clientId:"merch-at-scale",delimiter:"\xB6",ignoredProperties:["analytics","literals","element"],serializableTypes:["Array","Object"],sampleRate:1,severity:"e",tags:"acom",isProdDomain:!1},Kn=1e3;function ul(e){return e instanceof Error||typeof e?.originatingRequest=="string"}function Qn(e){if(e==null)return;let r=typeof e;if(r==="function")return e.name?`function ${e.name}`:"function";if(r==="object"){if(e instanceof Error)return e.message;if(typeof e.originatingRequest=="string"){let{message:a,originatingRequest:i,status:n}=e;return[a,n,i].filter(Boolean).join(" ")}let t=e[Symbol.toStringTag]??Object.getPrototypeOf(e).constructor.name;if(!We.serializableTypes.includes(t))return t}return e}function gl(e,r){if(!We.ignoredProperties.includes(e))return Qn(r)}var Xa={append(e){if(e.level!=="error")return;let{message:r,params:t}=e,a=[],i=[],n=r;t.forEach(l=>{l!=null&&(ul(l)?a:i).push(l)}),a.length&&(n+=` ${a.map(Qn).join(" ")}`);let{pathname:o,search:s}=window.location,c=`${We.delimiter}page=${o}${s}`;c.length>Kn&&(c=`${c.slice(0,Kn)}<trunc>`),n+=c,i.length&&(n+=`${We.delimiter}facts=`,n+=JSON.stringify(i,gl)),window.lana?.log(n,We)}};function Rr(e){Object.assign(We,Object.fromEntries(Object.entries(e).filter(([r,t])=>r in We&&t!==""&&t!==null&&t!==void 0&&!Number.isNaN(t))))}var Zn={LOCAL:"local",PROD:"prod",STAGE:"stage"},Ka={DEBUG:"debug",ERROR:"error",INFO:"info",WARN:"warn"},Qa=new Set,Za=new Set,Jn=new Map,eo={append({level:e,message:r,params:t,timestamp:a,source:i}){console[e](`${a}ms [${i}] %c${r}`,"font-weight: bold;",...t)}},to={filter:({level:e})=>e!==Ka.DEBUG},fl={filter:()=>!1};function vl(e,r,t,a,i){return{level:e,message:r,namespace:t,get params(){return a.length===1&&Cr(a[0])&&(a=a[0](),Array.isArray(a)||(a=[a])),a},source:i,timestamp:performance.now().toFixed(3)}}function xl(e){[...Za].every(r=>r(e))&&Qa.forEach(r=>r(e))}function ro(e){let r=(Jn.get(e)??0)+1;Jn.set(e,r);let t=`${e} #${r}`,a={id:t,namespace:e,module:i=>ro(`${a.namespace}/${i}`),updateConfig:Rr};return Object.values(Ka).forEach(i=>{a[i]=(n,...o)=>xl(vl(i,n,e,o,t))}),Object.seal(a)}function Or(...e){e.forEach(r=>{let{append:t,filter:a}=r;Cr(a)&&Za.add(a),Cr(t)&&Qa.add(t)})}function bl(e={}){let{name:r}=e,t=E(z("commerce.debug",{search:!0,storage:!0}),r===Zn.LOCAL);return Or(t?eo:to),r===Zn.PROD&&Or(Xa),oe}function yl(){Qa.clear(),Za.clear()}var oe={...ro(ua),Level:Ka,Plugins:{consoleAppender:eo,debugFilter:to,quietFilter:fl,lanaAppender:Xa},init:bl,reset:yl,use:Or};var wl="mas-commerce-service",El=oe.module("utilities"),Sl={requestId:Ot,etag:"Etag",lastModified:"Last-Modified",serverTiming:"server-timing"};function Yt(e,{country:r,forceTaxExclusive:t}){let a;if(e.length<2)a=e;else{let i=r==="GB"?"EN":"MULT";e.sort((n,o)=>n.language===i?-1:o.language===i?1:0),e.sort((n,o)=>!n.term&&o.term?-1:n.term&&!o.term?1:0),a=[e[0]]}return t&&(a=a.map(Xn)),a}var ao=(e,r)=>{let t=e.reduce((a,i)=>a+(r(i)||0),0);return t>0?Math.round(t*100)/100:void 0};function Ja(e){if(!e||e.length===0)return null;if(e.length===1)return e[0];let[r,...t]=e;for(let s of t){let c=[["commitment","commitment types"],["term","terms"],["priceDetails.formatString","currency formats"]];for(let[l,d]of c){let p=l.includes(".")?r.priceDetails?.formatString:r[l],u=l.includes(".")?s.priceDetails?.formatString:s[l];u!==p&&El.warn(`Offers have different ${d}, summing may produce unexpected results`,{expected:p,actual:u})}}let a=[["price",s=>s.priceDetails?.price],["priceWithoutDiscount",s=>s.priceDetails?.priceWithoutDiscount],["priceWithoutTax",s=>s.priceDetails?.priceWithoutTax],["priceWithoutDiscountAndTax",s=>s.priceDetails?.priceWithoutDiscountAndTax]],i={};for(let[s,c]of a){let l=ao(e,c);l!==void 0&&(i[s]=l)}let n=e.some(s=>s.priceDetails?.annualized),o;if(n){let s=[["annualizedPrice",c=>c.priceDetails?.annualized?.annualizedPrice],["annualizedPriceWithoutTax",c=>c.priceDetails?.annualized?.annualizedPriceWithoutTax],["annualizedPriceWithoutDiscount",c=>c.priceDetails?.annualized?.annualizedPriceWithoutDiscount],["annualizedPriceWithoutDiscountAndTax",c=>c.priceDetails?.annualized?.annualizedPriceWithoutDiscountAndTax]];o={};for(let[c,l]of s){let d=ao(e,l);d!==void 0&&(o[c]=d)}}return{...r,offerSelectorIds:e.flatMap(s=>s.offerSelectorIds||[]),priceDetails:{...r.priceDetails,...i,...o&&{annualized:o}}}}var Nr=e=>window.setTimeout(e);function St(e,r=1){if(e==null)return[r];let t=(Array.isArray(e)?e:String(e).split(",")).map(qn).filter(Et);return t.length||(t=[r]),t}function Ir(e){return e==null?[]:(Array.isArray(e)?e:String(e).split(",")).filter(Gn)}function se(){return document.getElementsByTagName(wl)?.[0]}function io(e){let r={};if(!e?.headers)return r;let t=e.headers;for(let[a,i]of Object.entries(Sl)){let n=t.get(i);n&&(n=n.replace(/[,;]/g,"|"),n=n.replace(/[| ]+/g,"|"),r[a]=n)}return r}var At=class e extends Error{constructor(r,t,a){if(super(r,{cause:a}),this.name="MasError",t.response){let i=t.response.headers?.get(Ot);i&&(t.requestId=i),t.response.status&&(t.status=t.response.status,t.statusText=t.response.statusText),t.response.url&&(t.url=t.response.url)}delete t.response,this.context=t,Error.captureStackTrace&&Error.captureStackTrace(this,e)}toString(){let r=Object.entries(this.context||{}).map(([a,i])=>`${a}: ${JSON.stringify(i)}`).join(", "),t=`${this.name}: ${this.message}`;return r&&(t+=` (${r})`),this.cause&&(t+=`
Caused by: ${this.cause}`),t}};var Al={[ge]:ca,[Oe]:la,[Ce]:da},Cl={[ge]:ma,[Ce]:Ae},Xt,ze=class{constructor(r){M(this,Xt);m(this,"changes",new Map);m(this,"connected",!1);m(this,"error");m(this,"log");m(this,"options");m(this,"promises",[]);m(this,"state",Oe);m(this,"timer",null);m(this,"value");m(this,"version",0);m(this,"wrapperElement");this.wrapperElement=r,this.log=oe.module("mas-element")}update(){[ge,Oe,Ce].forEach(r=>{this.wrapperElement.classList.toggle(Al[r],r===this.state)})}notify(){(this.state===Ce||this.state===ge)&&(this.state===Ce?this.promises.forEach(({resolve:t})=>t(this.wrapperElement)):this.state===ge&&this.promises.forEach(({reject:t})=>t(this.error)),this.promises=[]);let r=this.error;this.error instanceof At&&(r={message:this.error.message,...this.error.context}),this.wrapperElement.dispatchEvent(new CustomEvent(Cl[this.state],{bubbles:!0,composed:!0,detail:r}))}attributeChangedCallback(r,t,a){this.changes.set(r,a),this.requestUpdate()}connectedCallback(){T(this,Xt,se()),this.requestUpdate(!0)}disconnectedCallback(){this.connected&&(this.connected=!1,this.log?.debug("Disconnected:",{element:this.wrapperElement}))}onceSettled(){let{error:r,promises:t,state:a}=this;return Ce===a?Promise.resolve(this.wrapperElement):ge===a?Promise.reject(r):new Promise((i,n)=>{t.push({resolve:i,reject:n})})}toggleResolved(r,t,a){return r!==this.version?!1:(a!==void 0&&(this.options=a),this.state=Ce,this.value=t,this.update(),this.log?.debug("Resolved:",{element:this.wrapperElement,value:t}),Nr(()=>this.notify()),!0)}toggleFailed(r,t,a){if(r!==this.version)return!1;a!==void 0&&(this.options=a),this.error=t,this.state=ge,this.update();let i=this.wrapperElement.getAttribute("is");return this.log?.error(`${i}: Failed to render: ${t.message}`,{element:this.wrapperElement,...t.context,...v(this,Xt)?.duration}),Nr(()=>this.notify()),!0}togglePending(r){return this.version++,r&&(this.options=r),this.state=Oe,this.update(),this.log?.debug("Pending:",{osi:this.wrapperElement?.options?.wcsOsi}),this.version}requestUpdate(r=!1){if(!this.wrapperElement.isConnected||!se()||this.timer)return;let{error:t,options:a,state:i,value:n,version:o}=this;this.state=Oe,this.timer=Nr(async()=>{this.timer=null;let s=null;if(this.changes.size&&(s=Object.fromEntries(this.changes.entries()),this.changes.clear()),this.connected?this.log?.debug("Updated:",{element:this.wrapperElement,changes:s}):(this.connected=!0,this.log?.debug("Connected:",{element:this.wrapperElement,changes:s})),s||r)try{await this.wrapperElement.render?.()===!1&&this.state===Oe&&this.version===o&&(this.state=i,this.error=t,this.value=n,this.update(),this.notify())}catch(c){this.toggleFailed(this.version,c,a)}})}};Xt=new WeakMap;function no(e={}){return Object.entries(e).forEach(([r,t])=>{(t==null||t===""||t?.length===0)&&delete e[r]}),e}function Dr(e,r={}){let{tag:t,is:a}=e,i=document.createElement(t,{is:a});return i.setAttribute("is",a),Object.assign(i.dataset,no(r)),i}function oo(e,r={}){return e instanceof HTMLElement?(Object.assign(e.dataset,no(r)),e):null}function Tl(e){return`https://${e==="PRODUCTION"?"www.adobe.com":"www.stage.adobe.com"}/offers/promo-terms.html`}var Ke,Ye=class Ye extends HTMLAnchorElement{constructor(){super();m(this,"masElement",new ze(this));M(this,Ke);this.setAttribute("is",Ye.is)}get isUptLink(){return!0}initializeWcsData(t,a){this.setAttribute("data-wcs-osi",t),a&&this.setAttribute("data-promotion-code",a)}attributeChangedCallback(t,a,i){this.masElement.attributeChangedCallback(t,a,i)}connectedCallback(){this.masElement.connectedCallback(),T(this,Ke,It()),v(this,Ke)&&(this.log=v(this,Ke).log.module("upt-link"))}disconnectedCallback(){this.masElement.disconnectedCallback(),T(this,Ke,void 0)}requestUpdate(t=!1){this.masElement.requestUpdate(t)}onceSettled(){return this.masElement.onceSettled()}async render(){let t=It();if(!t)return!1;this.dataset.imsCountry||t.imsCountryPromise.then(o=>{o&&(this.dataset.imsCountry=o)});let a=t.collectCheckoutOptions({},this);if(!a.wcsOsi)return this.log.error("Missing 'data-wcs-osi' attribute on upt-link."),!1;let i=this.masElement.togglePending(a),n=t.resolveOfferSelectors(a);try{let[[o]]=await Promise.all(n),{country:s,language:c,env:l}=a,d=`locale=${c}_${s}&country=${s}&offer_id=${o.offerId}`,p=this.getAttribute("data-promotion-code");p&&(d+=`&promotion_code=${encodeURIComponent(p)}`),this.href=`${Tl(l)}?${d}`,this.masElement.toggleResolved(i,o,a)}catch(o){let s=new Error(`Could not resolve offer selectors for id: ${a.wcsOsi}.`,o.message);return this.masElement.toggleFailed(i,s,a),!1}}static createFrom(t){let a=new Ye;for(let i of t.attributes)i.name!=="is"&&(i.name==="class"&&i.value.includes("upt-link")?a.setAttribute("class",i.value.replace("upt-link","").trim()):a.setAttribute(i.name,i.value));return a.innerHTML=t.innerHTML,a.setAttribute("tabindex",0),a}};Ke=new WeakMap,m(Ye,"is","upt-link"),m(Ye,"tag","a"),m(Ye,"observedAttributes",["data-wcs-osi","data-promotion-code","data-ims-country"]);var Xe=Ye;window.customElements.get(Xe.is)||window.customElements.define(Xe.is,Xe,{extends:Xe.tag});function so(e){return e&&(e==="bizpro"&&(e="pro"),e==="pro"||e.startsWith("plans")?"plans":e)}var _l="p_draft_landscape",kl="/store/",Pl=new Map([["countrySpecific","cs"],["customerSegment","cs"],["quantity","q"],["authCode","code"],["checkoutPromoCode","apc"],["rurl","rUrl"],["curl","cUrl"],["ctxrturl","ctxRtUrl"],["country","co"],["language","lang"],["clientId","cli"],["context","ctx"],["productArrangementCode","pa"],["addonProductArrangementCode","ao"],["offerType","ot"],["marketSegment","ms"]]),ei=new Set(["af","ai","ao","apc","appctxid","cli","co","cs","csm","ctx","ctxRtUrl","DCWATC","dp","fr","gsp","ijt","lang","lo","mal","ms","mv","mv2","nglwfdata","ot","otac","pa","pcid","promoid","q","rf","sc","scl","sdid","sid","spint","svar","th","thm","trackingid","usid","workflowid","context.guid","so.ca","so.su","so.tr","so.va"]),Ll=["env","workflowStep","clientId","country"],Ml=["/tw/","/hk_zh/"];function Rl(e){let r=e??"";return Ml.some(t=>r.startsWith(t))}function Ol(){if(typeof window>"u")return!1;let e=[window.location.pathname];try{window.parent!==window&&e.push(window.parent.location.pathname)}catch{}return e.some(Rl)}function ti(e){if(!Ol())return e instanceof URL?e.toString():String(e);let r;try{r=e instanceof URL?e:new URL(e)}catch{return String(e)}r.searchParams.set("lang","zh-Hant");for(let t of[...r.searchParams.keys()])/^items\[\d+]\[lang]$/.test(t)&&r.searchParams.set(t,"zh-Hant");return r.toString()}var co=new Set(["gid","gtoken","notifauditid","cohortid","productname","sdid","attimer","gcsrc","gcprog","gcprogcat","gcpagetype","mv","mv2"]),lo=e=>Pl.get(e)??e;function Hr(e,r,t){for(let[a,i]of Object.entries(e)){let n=lo(a);i!=null&&t.has(n)&&r.set(n,i)}}function Nl(e){switch(e){case ya.PRODUCTION:return"https://commerce.adobe.com";default:return"https://commerce-stg.adobe.com"}}function Il(e,r){for(let t in e){let a=e[t];for(let[i,n]of Object.entries(a)){if(n==null)continue;let o=lo(i);r.set(`items[${t}][${o}]`,n)}}}function Dl({url:e,modal:r,is3in1:t}){if(!t||!e?.searchParams)return e;e.searchParams.set("rtc","t"),e.searchParams.set("lo","sl");let a=e.searchParams.get("af");return e.searchParams.set("af",[a,"uc_new_user_iframe","uc_new_system_close"].filter(Boolean).join(",")),e.searchParams.get("cli")!=="doc_cloud"&&e.searchParams.set("cli",r===Ge.CRM?"creative":"mini_plans"),e}function Hl(e){let r=new URLSearchParams(window.location.search),t={};co.forEach(a=>{let i=r.get(a);i!==null&&(t[a]=i)}),Object.keys(t).length>0&&Hr(t,e.searchParams,co)}function ho(e){zl(e);let{env:r,items:t,workflowStep:a,marketSegment:i,customerSegment:n,offerType:o,productArrangementCode:s,landscape:c,modal:l,is3in1:d,preselectPlan:p,...u}=e,h=new URL(Nl(r));if(h.pathname=`${kl}${a}`,a!==ie.SEGMENTATION&&a!==ie.CHANGE_PLAN_TEAM_PLANS&&Il(t,h.searchParams),Hr({...u},h.searchParams,ei),Hl(h),c===Ne.DRAFT&&Hr({af:_l},h.searchParams,ei),a===ie.SEGMENTATION){let g={marketSegment:i,offerType:o,customerSegment:n,productArrangementCode:s,quantity:t?.[0]?.quantity,addonProductArrangementCode:s?t?.find(f=>f.productArrangementCode!==s)?.productArrangementCode:t?.[1]?.productArrangementCode};p?.toLowerCase()==="edu"?h.searchParams.set("ms","EDU"):p?.toLowerCase()==="team"&&h.searchParams.set("cs","TEAM"),Hr(g,h.searchParams,ei),h.searchParams.get("ot")==="PROMOTION"&&h.searchParams.delete("ot"),h=Dl({url:h,modal:l,is3in1:d})}return ti(h)}function zl(e){for(let r of Ll)if(!e[r])throw new Error(`Argument "checkoutData" is not valid, missing: ${r}`);if(e.workflowStep!==ie.SEGMENTATION&&e.workflowStep!==ie.CHANGE_PLAN_TEAM_PLANS&&!e.items)throw new Error('Argument "checkoutData" is not valid, missing: items');return!0}var Fl=/[0-9\-+#]/,Bl=/[^\d\-+#]/g;function po(e){return e.search(Fl)}function Ul(e="#.##"){let r={},t=e.length,a=po(e);r.prefix=a>0?e.substring(0,a):"";let i=po(e.split("").reverse().join("")),n=t-i,o=e.substring(n,n+1),s=n+(o==="."||o===","?1:0);r.suffix=i>0?e.substring(s,t):"",r.mask=e.substring(a,s),r.maskHasNegativeSign=r.mask.charAt(0)==="-",r.maskHasPositiveSign=r.mask.charAt(0)==="+";let c=r.mask.match(Bl);return r.decimal=c&&c[c.length-1]||".",r.separator=c&&c[1]&&c[0]||",",c=r.mask.split(r.decimal),r.integer=c[0],r.fraction=c[1],r}function $l(e,r,t){let a=!1,i={value:e};e<0&&(a=!0,i.value=-i.value),i.sign=a?"-":"",i.value=Number(i.value).toFixed(r.fraction&&r.fraction.length),i.value=Number(i.value).toString();let n=r.fraction&&r.fraction.lastIndexOf("0"),[o="0",s=""]=i.value.split(".");return(!s||s&&s.length<=n)&&(s=n<0?"":(+`0.${s}`).toFixed(n+1).replace("0.","")),i.integer=o,i.fraction=s,Gl(i,r),(i.result==="0"||i.result==="")&&(a=!1,i.sign=""),!a&&r.maskHasPositiveSign?i.sign="+":a&&r.maskHasPositiveSign?i.sign="-":a&&(i.sign=t&&t.enforceMaskSign&&!r.maskHasNegativeSign?"":"-"),i}function Gl(e,r){e.result="";let t=r.integer.split(r.separator),a=t.join(""),i=a&&a.indexOf("0");if(i>-1)for(;e.integer.length<a.length-i;)e.integer=`0${e.integer}`;else Number(e.integer)===0&&(e.integer="");let n=t[1]&&t[t.length-1].length;if(n){let o=e.integer.length,s=o%n;for(let c=0;c<o;c++)e.result+=e.integer.charAt(c),!((c-s+1)%n)&&c<o-n&&(e.result+=r.separator)}else e.result=e.integer;return e.result+=r.fraction&&e.fraction?r.decimal+e.fraction:"",e}function ql(e,r,t={}){if(!e||isNaN(Number(r)))return r;let a=Ul(e),i=$l(r,a,t);return a.prefix+i.sign+i.result+a.suffix}var mo=ql;var uo=".",Vl=",",fo=/^\s+/,vo=/\s+$/,go="&nbsp;",ri=e=>e*12,Ze=(e,r,t=1)=>{if(!e)return!1;let{start:a,end:i,displaySummary:{amount:n,duration:o,minProductQuantity:s=1,outcomeType:c}={}}=e;if(!(n&&o&&c)||t<s)return!1;let l=r?new Date(r):new Date;if(!a||!i)return!1;let d=new Date(a),p=new Date(i);return l>=d&&l<=p},Qe={MONTH:"MONTH",YEAR:"YEAR"},jl={[he.ANNUAL]:12,[he.MONTHLY]:1,[he.THREE_YEARS]:36,[he.TWO_YEARS]:24},ai=(e,r)=>({accept:e,round:r}),Wl=[ai(({divisor:e,price:r})=>r%e==0,({divisor:e,price:r})=>r/e),ai(({usePrecision:e})=>e,({divisor:e,price:r})=>Math.round(r/e*100)/100),ai(()=>!0,({divisor:e,price:r})=>Math.ceil(Math.floor(r*100/e)/100))],ii={[$e.YEAR]:{[he.MONTHLY]:Qe.MONTH,[he.ANNUAL]:Qe.YEAR},[$e.MONTH]:{[he.MONTHLY]:Qe.MONTH}},Yl=(e,r)=>e.indexOf(`'${r}'`)===0,Xl=(e,r=!0)=>{let t=e.replace(/'.*?'/,"").trim(),a=bo(t);return!!a?r||(t=t.replace(/[,\.]0+/,a)):t=t.replace(/\s?(#.*0)(?!\s)?/,`$&${Ql(e)}`),t},Kl=e=>{let r=Zl(e),t=Yl(e,r),a=e.replace(/'.*?'/,""),i=fo.test(a)||vo.test(a);return{currencySymbol:r,isCurrencyFirst:t,hasCurrencySpace:i}},xo=e=>e.replace(fo,go).replace(vo,go),Ql=e=>e.match(/#(.?)#/)?.[1]===uo?Vl:uo,Zl=e=>e.match(/'(.*?)'/)?.[1]??"",bo=e=>e.match(/0(.?)0/)?.[1]??"";function Ct({formatString:e,price:r,usePrecision:t,isIndianPrice:a=!1},i,n=o=>o){let{currencySymbol:o,isCurrencyFirst:s,hasCurrencySpace:c}=Kl(e),l=t?bo(e):"",d=Xl(e,t),p=t?2:0,u=n(r,{currencySymbol:o}),h=a?u.toLocaleString("hi-IN",{minimumFractionDigits:p,maximumFractionDigits:p}):mo(d,u),g=t?h.lastIndexOf(l):h.length,f=h.substring(0,g),x=h.substring(g+1);return{accessiblePrice:e.replace(/'.*?'/,"SYMBOL").replace(/#.*0/,h).replace(/SYMBOL/,o),currencySymbol:o,decimals:x,decimalsDelimiter:l,hasCurrencySpace:c,integer:f,isCurrencyFirst:s,recurrenceTerm:i}}var yo=e=>{let{commitment:r,term:t,usePrecision:a}=e,i=jl[t]??1;return Ct(e,i>1?Qe.MONTH:ii[r]?.[t],n=>{let o={divisor:i,price:n,usePrecision:a},{round:s}=Wl.find(({accept:c})=>c(o));if(!s)throw new Error(`Missing rounding rule for: ${JSON.stringify(o)}`);return s(o)})},wo=({commitment:e,term:r,...t})=>Ct(t,ii[e]?.[r]),Eo=e=>{let{commitment:r,instant:t,price:a,originalPrice:i,priceWithoutDiscount:n,promotion:o,quantity:s=1,term:c}=e;if(r===$e.YEAR&&c===he.MONTHLY){if(!o)return Ct(e,Qe.YEAR,ri);let{displaySummary:{outcomeType:l,duration:d}={}}=o;switch(l){case"PERCENTAGE_DISCOUNT":if(Ze(o,t,s)){let p=parseInt(d.replace("P","").replace("M",""));if(isNaN(p))return ri(a);let u=i*p,h=n*(12-p),g=Math.round((u+h)*100)/100;return Ct({...e,price:g},Qe.YEAR)}default:return Ct(e,Qe.YEAR,()=>ri(n??a))}}return Ct(e,ii[r]?.[c])};var So="download",Ao="upgrade",Co={e:"EDU",t:"TEAM"};function To(e,r={},t=""){let a=se();if(!a)return null;let{checkoutMarketSegment:i,checkoutWorkflow:n,checkoutWorkflowStep:o,entitlement:s,upgrade:c,modal:l,perpetual:d,promotionCode:p,quantity:u,wcsOsi:h,extraOptions:g,analyticsId:f}=a.collectCheckoutOptions(r),x=Dr(e,{checkoutMarketSegment:i,checkoutWorkflow:n,checkoutWorkflowStep:o,entitlement:s,upgrade:c,modal:l,perpetual:d,promotionCode:r.promotionCode===Pr?Pr:p,quantity:u,wcsOsi:h,extraOptions:g,analyticsId:f});return t&&(x.innerHTML=`<span style="pointer-events: none;">${t}</span>`),x}function _o(e){return class extends e{constructor(){super(...arguments);m(this,"checkoutActionHandler");m(this,"masElement",new ze(this))}attributeChangedCallback(a,i,n){this.masElement.attributeChangedCallback(a,i,n)}connectedCallback(){this.masElement.connectedCallback(),this.addEventListener("click",this.clickHandler)}disconnectedCallback(){this.masElement.disconnectedCallback(),this.removeEventListener("click",this.clickHandler)}onceSettled(){return this.masElement.onceSettled()}get value(){return this.masElement.value}get options(){return this.masElement.options}get marketSegment(){let a=this.options?.ms??this.value?.[0].marketSegments?.[0];return Co[a]??a}get customerSegment(){let a=this.options?.cs??this.value?.[0]?.customerSegment;return Co[a]??a}get is3in1Modal(){return Object.values(Ge).includes(this.getAttribute("data-modal"))}get isOpen3in1Modal(){let a=document.querySelector("meta[name=mas-ff-3in1]");return this.is3in1Modal&&(!a||a.content!=="off")}requestUpdate(a=!1){return this.masElement.requestUpdate(a)}static get observedAttributes(){return["data-checkout-workflow","data-checkout-workflow-step","data-extra-options","data-ims-country","data-perpetual","data-promotion-code","data-quantity","data-template","data-wcs-osi","data-entitlement","data-upgrade","data-modal"]}async render(a={}){let i=se();if(!i)return!1;this.dataset.imsCountry||i.imsCountryPromise.then(h=>{h&&(this.dataset.imsCountry=h)}),a.imsCountry=null;let n=i.collectCheckoutOptions(a,this);if(!n.wcsOsi.length)return!1;let o;try{o=JSON.parse(n.extraOptions??"{}")}catch(h){this.masElement.log?.error("cannot parse exta checkout options",h)}let s=this.masElement.togglePending(n);this.setCheckoutUrl("");let c=i.resolveOfferSelectors(n),l=await Promise.all(c);l=l.map(h=>Yt(h,n));let d=l.flat().find(h=>h.promotion);!Ze(d?.promotion,d?.promotion?.displaySummary?.instant,n.quantity[0])&&n.promotionCode&&delete n.promotionCode,n.country=this.dataset.imsCountry||n.country;let u=await i.buildCheckoutAction?.(l.flat(),{...o,...n},this);return this.renderOffers(l.flat(),n,{},u,s)}renderOffers(a,i,n={},o=void 0,s=void 0){let c=se();if(!c)return!1;if(i={...JSON.parse(this.dataset.extraOptions??"{}"),...i,...n},s??(s=this.masElement.togglePending(i)),this.checkoutActionHandler&&(this.checkoutActionHandler=void 0),o){this.classList.remove(So,Ao),this.masElement.toggleResolved(s,a,i);let{url:d,text:p,className:u,handler:h}=o;d&&this.setCheckoutUrl(ti(d)),p&&(this.firstElementChild.innerHTML=p),u&&this.classList.add(...u.split(" ")),h&&(this.setCheckoutUrl("#"),this.checkoutActionHandler=h.bind(this))}if(a.length){if(this.masElement.toggleResolved(s,a,i)){if(!this.classList.contains(So)&&!this.classList.contains(Ao)){let d=c.buildCheckoutURL(a,i);this.setCheckoutUrl(i.modal==="true"?"#":d)}return!0}}else{let d=new Error(`Not provided: ${i?.wcsOsi??"-"}`);if(this.masElement.toggleFailed(s,d,i))return this.setCheckoutUrl("#"),!0}}setCheckoutUrl(){}clickHandler(a){}updateOptions(a={}){let i=se();if(!i)return!1;let{checkoutMarketSegment:n,checkoutWorkflow:o,checkoutWorkflowStep:s,entitlement:c,upgrade:l,modal:d,perpetual:p,promotionCode:u,quantity:h,wcsOsi:g}=i.collectCheckoutOptions(a);return oo(this,{checkoutMarketSegment:n,checkoutWorkflow:o,checkoutWorkflowStep:s,entitlement:c,upgrade:l,modal:d,perpetual:p,promotionCode:u,quantity:h,wcsOsi:g}),!0}}}var Kt=class Kt extends _o(HTMLAnchorElement){static createCheckoutLink(r={},t=""){return To(Kt,r,t)}setCheckoutUrl(r){this.setAttribute("href",r)}get isCheckoutLink(){return!0}clickHandler(r){if(this.checkoutActionHandler){this.checkoutActionHandler?.(r);return}}};m(Kt,"is","checkout-link"),m(Kt,"tag","a");var Pe=Kt;window.customElements.get(Pe.is)||window.customElements.define(Pe.is,Pe,{extends:Pe.tag});var R=Object.freeze({checkoutClientId:"adobe_com",checkoutWorkflowStep:ie.EMAIL,country:"US",displayOldPrice:!0,displayPerUnit:!1,displayRecurrence:!0,displayTax:!1,displayPlanType:!1,env:xe.PRODUCTION,forceTaxExclusive:!1,language:"en",entitlement:!1,extraOptions:{},modal:!1,promotionCode:"",quantity:1,alternativePrice:!1,wcsApiKey:"wcms-commerce-ims-ro-user-milo",wcsURL:"https://www.adobe.com/web_commerce_artifact",landscape:Ne.PUBLISHED});function ko({settings:e,providers:r}){function t(n,o){let{checkoutClientId:s,checkoutWorkflowStep:c,country:l,language:d,promotionCode:p,quantity:u,preselectPlan:h,env:g}=e,f={checkoutClientId:s,checkoutWorkflowStep:c,country:l,language:d,promotionCode:p,quantity:u,preselectPlan:h,env:g};if(o)for(let at of r.checkout)at(o,f);let{checkoutMarketSegment:x,checkoutWorkflowStep:y=c,imsCountry:A,country:b=A??l,language:C=d,quantity:H=u,entitlement:N,upgrade:$,modal:V,perpetual:J,promotionCode:Q=p,wcsOsi:B,extraOptions:O,...re}=Object.assign(f,o?.dataset??{},n??{}),de=Wt(y,ie,R.checkoutWorkflowStep);return f=_r({...re,extraOptions:O,checkoutClientId:s,checkoutMarketSegment:x,country:b,quantity:St(H,R.quantity),checkoutWorkflowStep:de,language:C,entitlement:E(N),upgrade:E($),modal:V,perpetual:E(J),promotionCode:Lr(Q).effectivePromoCode,wcsOsi:Ir(B),preselectPlan:h}),f}function a(n,o){if(!Array.isArray(n)||!n.length||!o)return"";let{env:s,landscape:c}=e,{checkoutClientId:l,checkoutMarketSegment:d,checkoutWorkflowStep:p,country:u,promotionCode:h,quantity:g,preselectPlan:f,ms:x,cs:y,...A}=t(o),b=document.querySelector("meta[name=mas-ff-3in1]"),C=Object.values(Ge).includes(o.modal)&&(!b||b.content!=="off"),H=window.frameElement||C?"if":"fp",[{productArrangementCode:N,marketSegments:[$],customerSegment:V,offerType:J}]=n,Q=x??$??d,B=y??V;f?.toLowerCase()==="edu"?Q="EDU":f?.toLowerCase()==="team"&&(B="TEAM");let O={is3in1:C,checkoutPromoCode:h,clientId:l,context:H,country:u,env:s,items:[],marketSegment:Q,customerSegment:B,offerType:J,productArrangementCode:N,workflowStep:p,landscape:c,...A},re=g[0]>1?g[0]:void 0;if(n.length===1){let{offerId:de}=n[0];O.items.push({id:de,quantity:re})}else O.items.push(...n.map(({offerId:de,productArrangementCode:at})=>({id:de,quantity:re,...C?{productArrangementCode:at}:{}})));return ho(O)}let{createCheckoutLink:i}=Pe;return{CheckoutLink:Pe,CheckoutWorkflowStep:ie,buildCheckoutURL:a,collectCheckoutOptions:t,createCheckoutLink:i}}function Jl({interval:e=200,maxAttempts:r=25}={}){let t=oe.module("ims");return new Promise(a=>{t.debug("Waing for IMS to be ready");let i=0;function n(){window.adobeIMS?.initialized?a():++i>r?(t.debug("Timeout"),a()):setTimeout(n,e)}n()})}function ed(e){return e.then(()=>window.adobeIMS?.isSignedInUser()??!1)}function td(e){let r=oe.module("ims");return e.then(t=>t?window.adobeIMS.getProfile().then(({countryCode:a})=>(r.debug("Got user country:",a),a),a=>{r.error("Unable to get user country:",a)}):null)}function Po({}){let e=Jl(),r=ed(e),t=td(r);return{imsReadyPromise:e,imsSignedInPromise:r,imsCountryPromise:t}}var Lo=window.masPriceLiterals;function Mo(e){if(Array.isArray(Lo)){let r;switch(e.locale){case"id_ID":r="in";break;case"zh_TW":r="zh-hant";break;case"zh_HK":r="zh-hant";break;default:r=e.language}let t=i=>Lo.find(n=>Ha(n.lang,i)),a=t(r)??t(R.language);if(a)return Object.freeze(a)}return{}}var ni=function(e,r){return ni=Object.setPrototypeOf||{__proto__:[]}instanceof Array&&function(t,a){t.__proto__=a}||function(t,a){for(var i in a)Object.prototype.hasOwnProperty.call(a,i)&&(t[i]=a[i])},ni(e,r)};function Qt(e,r){if(typeof r!="function"&&r!==null)throw new TypeError("Class extends value "+String(r)+" is not a constructor or null");ni(e,r);function t(){this.constructor=e}e.prototype=r===null?Object.create(r):(t.prototype=r.prototype,new t)}var P=function(){return P=Object.assign||function(r){for(var t,a=1,i=arguments.length;a<i;a++){t=arguments[a];for(var n in t)Object.prototype.hasOwnProperty.call(t,n)&&(r[n]=t[n])}return r},P.apply(this,arguments)};function zr(e,r,t){if(t||arguments.length===2)for(var a=0,i=r.length,n;a<i;a++)(n||!(a in r))&&(n||(n=Array.prototype.slice.call(r,0,a)),n[a]=r[a]);return e.concat(n||Array.prototype.slice.call(r))}var S;(function(e){e[e.EXPECT_ARGUMENT_CLOSING_BRACE=1]="EXPECT_ARGUMENT_CLOSING_BRACE",e[e.EMPTY_ARGUMENT=2]="EMPTY_ARGUMENT",e[e.MALFORMED_ARGUMENT=3]="MALFORMED_ARGUMENT",e[e.EXPECT_ARGUMENT_TYPE=4]="EXPECT_ARGUMENT_TYPE",e[e.INVALID_ARGUMENT_TYPE=5]="INVALID_ARGUMENT_TYPE",e[e.EXPECT_ARGUMENT_STYLE=6]="EXPECT_ARGUMENT_STYLE",e[e.INVALID_NUMBER_SKELETON=7]="INVALID_NUMBER_SKELETON",e[e.INVALID_DATE_TIME_SKELETON=8]="INVALID_DATE_TIME_SKELETON",e[e.EXPECT_NUMBER_SKELETON=9]="EXPECT_NUMBER_SKELETON",e[e.EXPECT_DATE_TIME_SKELETON=10]="EXPECT_DATE_TIME_SKELETON",e[e.UNCLOSED_QUOTE_IN_ARGUMENT_STYLE=11]="UNCLOSED_QUOTE_IN_ARGUMENT_STYLE",e[e.EXPECT_SELECT_ARGUMENT_OPTIONS=12]="EXPECT_SELECT_ARGUMENT_OPTIONS",e[e.EXPECT_PLURAL_ARGUMENT_OFFSET_VALUE=13]="EXPECT_PLURAL_ARGUMENT_OFFSET_VALUE",e[e.INVALID_PLURAL_ARGUMENT_OFFSET_VALUE=14]="INVALID_PLURAL_ARGUMENT_OFFSET_VALUE",e[e.EXPECT_SELECT_ARGUMENT_SELECTOR=15]="EXPECT_SELECT_ARGUMENT_SELECTOR",e[e.EXPECT_PLURAL_ARGUMENT_SELECTOR=16]="EXPECT_PLURAL_ARGUMENT_SELECTOR",e[e.EXPECT_SELECT_ARGUMENT_SELECTOR_FRAGMENT=17]="EXPECT_SELECT_ARGUMENT_SELECTOR_FRAGMENT",e[e.EXPECT_PLURAL_ARGUMENT_SELECTOR_FRAGMENT=18]="EXPECT_PLURAL_ARGUMENT_SELECTOR_FRAGMENT",e[e.INVALID_PLURAL_ARGUMENT_SELECTOR=19]="INVALID_PLURAL_ARGUMENT_SELECTOR",e[e.DUPLICATE_PLURAL_ARGUMENT_SELECTOR=20]="DUPLICATE_PLURAL_ARGUMENT_SELECTOR",e[e.DUPLICATE_SELECT_ARGUMENT_SELECTOR=21]="DUPLICATE_SELECT_ARGUMENT_SELECTOR",e[e.MISSING_OTHER_CLAUSE=22]="MISSING_OTHER_CLAUSE",e[e.INVALID_TAG=23]="INVALID_TAG",e[e.INVALID_TAG_NAME=25]="INVALID_TAG_NAME",e[e.UNMATCHED_CLOSING_TAG=26]="UNMATCHED_CLOSING_TAG",e[e.UNCLOSED_TAG=27]="UNCLOSED_TAG"})(S||(S={}));var F;(function(e){e[e.literal=0]="literal",e[e.argument=1]="argument",e[e.number=2]="number",e[e.date=3]="date",e[e.time=4]="time",e[e.select=5]="select",e[e.plural=6]="plural",e[e.pound=7]="pound",e[e.tag=8]="tag"})(F||(F={}));var Je;(function(e){e[e.number=0]="number",e[e.dateTime=1]="dateTime"})(Je||(Je={}));function oi(e){return e.type===F.literal}function Ro(e){return e.type===F.argument}function Fr(e){return e.type===F.number}function Br(e){return e.type===F.date}function Ur(e){return e.type===F.time}function $r(e){return e.type===F.select}function Gr(e){return e.type===F.plural}function Oo(e){return e.type===F.pound}function qr(e){return e.type===F.tag}function Vr(e){return!!(e&&typeof e=="object"&&e.type===Je.number)}function Zt(e){return!!(e&&typeof e=="object"&&e.type===Je.dateTime)}var si=/[ \xA0\u1680\u2000-\u200A\u202F\u205F\u3000]/;var rd=/(?:[Eec]{1,6}|G{1,5}|[Qq]{1,5}|(?:[yYur]+|U{1,5})|[ML]{1,5}|d{1,2}|D{1,3}|F{1}|[abB]{1,5}|[hkHK]{1,2}|w{1,2}|W{1}|m{1,2}|s{1,2}|[zZOvVxX]{1,4})(?=([^']*'[^']*')*[^']*$)/g;function No(e){var r={};return e.replace(rd,function(t){var a=t.length;switch(t[0]){case"G":r.era=a===4?"long":a===5?"narrow":"short";break;case"y":r.year=a===2?"2-digit":"numeric";break;case"Y":case"u":case"U":case"r":throw new RangeError("`Y/u/U/r` (year) patterns are not supported, use `y` instead");case"q":case"Q":throw new RangeError("`q/Q` (quarter) patterns are not supported");case"M":case"L":r.month=["numeric","2-digit","short","long","narrow"][a-1];break;case"w":case"W":throw new RangeError("`w/W` (week) patterns are not supported");case"d":r.day=["numeric","2-digit"][a-1];break;case"D":case"F":case"g":throw new RangeError("`D/F/g` (day) patterns are not supported, use `d` instead");case"E":r.weekday=a===4?"short":a===5?"narrow":"short";break;case"e":if(a<4)throw new RangeError("`e..eee` (weekday) patterns are not supported");r.weekday=["short","long","narrow","short"][a-4];break;case"c":if(a<4)throw new RangeError("`c..ccc` (weekday) patterns are not supported");r.weekday=["short","long","narrow","short"][a-4];break;case"a":r.hour12=!0;break;case"b":case"B":throw new RangeError("`b/B` (period) patterns are not supported, use `a` instead");case"h":r.hourCycle="h12",r.hour=["numeric","2-digit"][a-1];break;case"H":r.hourCycle="h23",r.hour=["numeric","2-digit"][a-1];break;case"K":r.hourCycle="h11",r.hour=["numeric","2-digit"][a-1];break;case"k":r.hourCycle="h24",r.hour=["numeric","2-digit"][a-1];break;case"j":case"J":case"C":throw new RangeError("`j/J/C` (hour) patterns are not supported, use `h/H/K/k` instead");case"m":r.minute=["numeric","2-digit"][a-1];break;case"s":r.second=["numeric","2-digit"][a-1];break;case"S":case"A":throw new RangeError("`S/A` (second) patterns are not supported, use `s` instead");case"z":r.timeZoneName=a<4?"short":"long";break;case"Z":case"O":case"v":case"V":case"X":case"x":throw new RangeError("`Z/O/v/V/X/x` (timeZone) patterns are not supported, use `z` instead")}return""}),r}var Io=/[\t-\r \x85\u200E\u200F\u2028\u2029]/i;function Fo(e){if(e.length===0)throw new Error("Number skeleton cannot be empty");for(var r=e.split(Io).filter(function(u){return u.length>0}),t=[],a=0,i=r;a<i.length;a++){var n=i[a],o=n.split("/");if(o.length===0)throw new Error("Invalid number skeleton");for(var s=o[0],c=o.slice(1),l=0,d=c;l<d.length;l++){var p=d[l];if(p.length===0)throw new Error("Invalid number skeleton")}t.push({stem:s,options:c})}return t}function ad(e){return e.replace(/^(.*?)-/,"")}var Do=/^\.(?:(0+)(\*)?|(#+)|(0+)(#+))$/g,Bo=/^(@+)?(\+|#+)?[rs]?$/g,id=/(\*)(0+)|(#+)(0+)|(0+)/g,Uo=/^(0+)$/;function Ho(e){var r={};return e[e.length-1]==="r"?r.roundingPriority="morePrecision":e[e.length-1]==="s"&&(r.roundingPriority="lessPrecision"),e.replace(Bo,function(t,a,i){return typeof i!="string"?(r.minimumSignificantDigits=a.length,r.maximumSignificantDigits=a.length):i==="+"?r.minimumSignificantDigits=a.length:a[0]==="#"?r.maximumSignificantDigits=a.length:(r.minimumSignificantDigits=a.length,r.maximumSignificantDigits=a.length+(typeof i=="string"?i.length:0)),""}),r}function $o(e){switch(e){case"sign-auto":return{signDisplay:"auto"};case"sign-accounting":case"()":return{currencySign:"accounting"};case"sign-always":case"+!":return{signDisplay:"always"};case"sign-accounting-always":case"()!":return{signDisplay:"always",currencySign:"accounting"};case"sign-except-zero":case"+?":return{signDisplay:"exceptZero"};case"sign-accounting-except-zero":case"()?":return{signDisplay:"exceptZero",currencySign:"accounting"};case"sign-never":case"+_":return{signDisplay:"never"}}}function nd(e){var r;if(e[0]==="E"&&e[1]==="E"?(r={notation:"engineering"},e=e.slice(2)):e[0]==="E"&&(r={notation:"scientific"},e=e.slice(1)),r){var t=e.slice(0,2);if(t==="+!"?(r.signDisplay="always",e=e.slice(2)):t==="+?"&&(r.signDisplay="exceptZero",e=e.slice(2)),!Uo.test(e))throw new Error("Malformed concise eng/scientific notation");r.minimumIntegerDigits=e.length}return r}function zo(e){var r={},t=$o(e);return t||r}function Go(e){for(var r={},t=0,a=e;t<a.length;t++){var i=a[t];switch(i.stem){case"percent":case"%":r.style="percent";continue;case"%x100":r.style="percent",r.scale=100;continue;case"currency":r.style="currency",r.currency=i.options[0];continue;case"group-off":case",_":r.useGrouping=!1;continue;case"precision-integer":case".":r.maximumFractionDigits=0;continue;case"measure-unit":case"unit":r.style="unit",r.unit=ad(i.options[0]);continue;case"compact-short":case"K":r.notation="compact",r.compactDisplay="short";continue;case"compact-long":case"KK":r.notation="compact",r.compactDisplay="long";continue;case"scientific":r=P(P(P({},r),{notation:"scientific"}),i.options.reduce(function(c,l){return P(P({},c),zo(l))},{}));continue;case"engineering":r=P(P(P({},r),{notation:"engineering"}),i.options.reduce(function(c,l){return P(P({},c),zo(l))},{}));continue;case"notation-simple":r.notation="standard";continue;case"unit-width-narrow":r.currencyDisplay="narrowSymbol",r.unitDisplay="narrow";continue;case"unit-width-short":r.currencyDisplay="code",r.unitDisplay="short";continue;case"unit-width-full-name":r.currencyDisplay="name",r.unitDisplay="long";continue;case"unit-width-iso-code":r.currencyDisplay="symbol";continue;case"scale":r.scale=parseFloat(i.options[0]);continue;case"integer-width":if(i.options.length>1)throw new RangeError("integer-width stems only accept a single optional option");i.options[0].replace(id,function(c,l,d,p,u,h){if(l)r.minimumIntegerDigits=d.length;else{if(p&&u)throw new Error("We currently do not support maximum integer digits");if(h)throw new Error("We currently do not support exact integer digits")}return""});continue}if(Uo.test(i.stem)){r.minimumIntegerDigits=i.stem.length;continue}if(Do.test(i.stem)){if(i.options.length>1)throw new RangeError("Fraction-precision stems only accept a single optional option");i.stem.replace(Do,function(c,l,d,p,u,h){return d==="*"?r.minimumFractionDigits=l.length:p&&p[0]==="#"?r.maximumFractionDigits=p.length:u&&h?(r.minimumFractionDigits=u.length,r.maximumFractionDigits=u.length+h.length):(r.minimumFractionDigits=l.length,r.maximumFractionDigits=l.length),""});var n=i.options[0];n==="w"?r=P(P({},r),{trailingZeroDisplay:"stripIfInteger"}):n&&(r=P(P({},r),Ho(n)));continue}if(Bo.test(i.stem)){r=P(P({},r),Ho(i.stem));continue}var o=$o(i.stem);o&&(r=P(P({},r),o));var s=nd(i.stem);s&&(r=P(P({},r),s))}return r}var Jt={AX:["H"],BQ:["H"],CP:["H"],CZ:["H"],DK:["H"],FI:["H"],ID:["H"],IS:["H"],ML:["H"],NE:["H"],RU:["H"],SE:["H"],SJ:["H"],SK:["H"],AS:["h","H"],BT:["h","H"],DJ:["h","H"],ER:["h","H"],GH:["h","H"],IN:["h","H"],LS:["h","H"],PG:["h","H"],PW:["h","H"],SO:["h","H"],TO:["h","H"],VU:["h","H"],WS:["h","H"],"001":["H","h"],AL:["h","H","hB"],TD:["h","H","hB"],"ca-ES":["H","h","hB"],CF:["H","h","hB"],CM:["H","h","hB"],"fr-CA":["H","h","hB"],"gl-ES":["H","h","hB"],"it-CH":["H","h","hB"],"it-IT":["H","h","hB"],LU:["H","h","hB"],NP:["H","h","hB"],PF:["H","h","hB"],SC:["H","h","hB"],SM:["H","h","hB"],SN:["H","h","hB"],TF:["H","h","hB"],VA:["H","h","hB"],CY:["h","H","hb","hB"],GR:["h","H","hb","hB"],CO:["h","H","hB","hb"],DO:["h","H","hB","hb"],KP:["h","H","hB","hb"],KR:["h","H","hB","hb"],NA:["h","H","hB","hb"],PA:["h","H","hB","hb"],PR:["h","H","hB","hb"],VE:["h","H","hB","hb"],AC:["H","h","hb","hB"],AI:["H","h","hb","hB"],BW:["H","h","hb","hB"],BZ:["H","h","hb","hB"],CC:["H","h","hb","hB"],CK:["H","h","hb","hB"],CX:["H","h","hb","hB"],DG:["H","h","hb","hB"],FK:["H","h","hb","hB"],GB:["H","h","hb","hB"],GG:["H","h","hb","hB"],GI:["H","h","hb","hB"],IE:["H","h","hb","hB"],IM:["H","h","hb","hB"],IO:["H","h","hb","hB"],JE:["H","h","hb","hB"],LT:["H","h","hb","hB"],MK:["H","h","hb","hB"],MN:["H","h","hb","hB"],MS:["H","h","hb","hB"],NF:["H","h","hb","hB"],NG:["H","h","hb","hB"],NR:["H","h","hb","hB"],NU:["H","h","hb","hB"],PN:["H","h","hb","hB"],SH:["H","h","hb","hB"],SX:["H","h","hb","hB"],TA:["H","h","hb","hB"],ZA:["H","h","hb","hB"],"af-ZA":["H","h","hB","hb"],AR:["H","h","hB","hb"],CL:["H","h","hB","hb"],CR:["H","h","hB","hb"],CU:["H","h","hB","hb"],EA:["H","h","hB","hb"],"es-BO":["H","h","hB","hb"],"es-BR":["H","h","hB","hb"],"es-EC":["H","h","hB","hb"],"es-ES":["H","h","hB","hb"],"es-GQ":["H","h","hB","hb"],"es-PE":["H","h","hB","hb"],GT:["H","h","hB","hb"],HN:["H","h","hB","hb"],IC:["H","h","hB","hb"],KG:["H","h","hB","hb"],KM:["H","h","hB","hb"],LK:["H","h","hB","hb"],MA:["H","h","hB","hb"],MX:["H","h","hB","hb"],NI:["H","h","hB","hb"],PY:["H","h","hB","hb"],SV:["H","h","hB","hb"],UY:["H","h","hB","hb"],JP:["H","h","K"],AD:["H","hB"],AM:["H","hB"],AO:["H","hB"],AT:["H","hB"],AW:["H","hB"],BE:["H","hB"],BF:["H","hB"],BJ:["H","hB"],BL:["H","hB"],BR:["H","hB"],CG:["H","hB"],CI:["H","hB"],CV:["H","hB"],DE:["H","hB"],EE:["H","hB"],FR:["H","hB"],GA:["H","hB"],GF:["H","hB"],GN:["H","hB"],GP:["H","hB"],GW:["H","hB"],HR:["H","hB"],IL:["H","hB"],IT:["H","hB"],KZ:["H","hB"],MC:["H","hB"],MD:["H","hB"],MF:["H","hB"],MQ:["H","hB"],MZ:["H","hB"],NC:["H","hB"],NL:["H","hB"],PM:["H","hB"],PT:["H","hB"],RE:["H","hB"],RO:["H","hB"],SI:["H","hB"],SR:["H","hB"],ST:["H","hB"],TG:["H","hB"],TR:["H","hB"],WF:["H","hB"],YT:["H","hB"],BD:["h","hB","H"],PK:["h","hB","H"],AZ:["H","hB","h"],BA:["H","hB","h"],BG:["H","hB","h"],CH:["H","hB","h"],GE:["H","hB","h"],LI:["H","hB","h"],ME:["H","hB","h"],RS:["H","hB","h"],UA:["H","hB","h"],UZ:["H","hB","h"],XK:["H","hB","h"],AG:["h","hb","H","hB"],AU:["h","hb","H","hB"],BB:["h","hb","H","hB"],BM:["h","hb","H","hB"],BS:["h","hb","H","hB"],CA:["h","hb","H","hB"],DM:["h","hb","H","hB"],"en-001":["h","hb","H","hB"],FJ:["h","hb","H","hB"],FM:["h","hb","H","hB"],GD:["h","hb","H","hB"],GM:["h","hb","H","hB"],GU:["h","hb","H","hB"],GY:["h","hb","H","hB"],JM:["h","hb","H","hB"],KI:["h","hb","H","hB"],KN:["h","hb","H","hB"],KY:["h","hb","H","hB"],LC:["h","hb","H","hB"],LR:["h","hb","H","hB"],MH:["h","hb","H","hB"],MP:["h","hb","H","hB"],MW:["h","hb","H","hB"],NZ:["h","hb","H","hB"],SB:["h","hb","H","hB"],SG:["h","hb","H","hB"],SL:["h","hb","H","hB"],SS:["h","hb","H","hB"],SZ:["h","hb","H","hB"],TC:["h","hb","H","hB"],TT:["h","hb","H","hB"],UM:["h","hb","H","hB"],US:["h","hb","H","hB"],VC:["h","hb","H","hB"],VG:["h","hb","H","hB"],VI:["h","hb","H","hB"],ZM:["h","hb","H","hB"],BO:["H","hB","h","hb"],EC:["H","hB","h","hb"],ES:["H","hB","h","hb"],GQ:["H","hB","h","hb"],PE:["H","hB","h","hb"],AE:["h","hB","hb","H"],"ar-001":["h","hB","hb","H"],BH:["h","hB","hb","H"],DZ:["h","hB","hb","H"],EG:["h","hB","hb","H"],EH:["h","hB","hb","H"],HK:["h","hB","hb","H"],IQ:["h","hB","hb","H"],JO:["h","hB","hb","H"],KW:["h","hB","hb","H"],LB:["h","hB","hb","H"],LY:["h","hB","hb","H"],MO:["h","hB","hb","H"],MR:["h","hB","hb","H"],OM:["h","hB","hb","H"],PH:["h","hB","hb","H"],PS:["h","hB","hb","H"],QA:["h","hB","hb","H"],SA:["h","hB","hb","H"],SD:["h","hB","hb","H"],SY:["h","hB","hb","H"],TN:["h","hB","hb","H"],YE:["h","hB","hb","H"],AF:["H","hb","hB","h"],LA:["H","hb","hB","h"],CN:["H","hB","hb","h"],LV:["H","hB","hb","h"],TL:["H","hB","hb","h"],"zu-ZA":["H","hB","hb","h"],CD:["hB","H"],IR:["hB","H"],"hi-IN":["hB","h","H"],"kn-IN":["hB","h","H"],"ml-IN":["hB","h","H"],"te-IN":["hB","h","H"],KH:["hB","h","H","hb"],"ta-IN":["hB","h","hb","H"],BN:["hb","hB","h","H"],MY:["hb","hB","h","H"],ET:["hB","hb","h","H"],"gu-IN":["hB","hb","h","H"],"mr-IN":["hB","hb","h","H"],"pa-IN":["hB","hb","h","H"],TW:["hB","hb","h","H"],KE:["hB","hb","H","h"],MM:["hB","hb","H","h"],TZ:["hB","hb","H","h"],UG:["hB","hb","H","h"]};function qo(e,r){for(var t="",a=0;a<e.length;a++){var i=e.charAt(a);if(i==="j"){for(var n=0;a+1<e.length&&e.charAt(a+1)===i;)n++,a++;var o=1+(n&1),s=n<2?1:3+(n>>1),c="a",l=od(r);for((l=="H"||l=="k")&&(s=0);s-- >0;)t+=c;for(;o-- >0;)t=l+t}else i==="J"?t+="H":t+=i}return t}function od(e){var r=e.hourCycle;if(r===void 0&&e.hourCycles&&e.hourCycles.length&&(r=e.hourCycles[0]),r)switch(r){case"h24":return"k";case"h23":return"H";case"h12":return"h";case"h11":return"K";default:throw new Error("Invalid hourCycle")}var t=e.language,a;t!=="root"&&(a=e.maximize().region);var i=Jt[a||""]||Jt[t||""]||Jt["".concat(t,"-001")]||Jt["001"];return i[0]}var ci,sd=new RegExp("^".concat(si.source,"*")),cd=new RegExp("".concat(si.source,"*$"));function L(e,r){return{start:e,end:r}}var ld=!!String.prototype.startsWith,dd=!!String.fromCodePoint,hd=!!Object.fromEntries,pd=!!String.prototype.codePointAt,md=!!String.prototype.trimStart,ud=!!String.prototype.trimEnd,gd=!!Number.isSafeInteger,fd=gd?Number.isSafeInteger:function(e){return typeof e=="number"&&isFinite(e)&&Math.floor(e)===e&&Math.abs(e)<=9007199254740991},di=!0;try{Vo=Xo("([^\\p{White_Space}\\p{Pattern_Syntax}]*)","yu"),di=((ci=Vo.exec("a"))===null||ci===void 0?void 0:ci[0])==="a"}catch{di=!1}var Vo,jo=ld?function(r,t,a){return r.startsWith(t,a)}:function(r,t,a){return r.slice(a,a+t.length)===t},hi=dd?String.fromCodePoint:function(){for(var r=[],t=0;t<arguments.length;t++)r[t]=arguments[t];for(var a="",i=r.length,n=0,o;i>n;){if(o=r[n++],o>1114111)throw RangeError(o+" is not a valid code point");a+=o<65536?String.fromCharCode(o):String.fromCharCode(((o-=65536)>>10)+55296,o%1024+56320)}return a},Wo=hd?Object.fromEntries:function(r){for(var t={},a=0,i=r;a<i.length;a++){var n=i[a],o=n[0],s=n[1];t[o]=s}return t},Yo=pd?function(r,t){return r.codePointAt(t)}:function(r,t){var a=r.length;if(!(t<0||t>=a)){var i=r.charCodeAt(t),n;return i<55296||i>56319||t+1===a||(n=r.charCodeAt(t+1))<56320||n>57343?i:(i-55296<<10)+(n-56320)+65536}},vd=md?function(r){return r.trimStart()}:function(r){return r.replace(sd,"")},xd=ud?function(r){return r.trimEnd()}:function(r){return r.replace(cd,"")};function Xo(e,r){return new RegExp(e,r)}var pi;di?(li=Xo("([^\\p{White_Space}\\p{Pattern_Syntax}]*)","yu"),pi=function(r,t){var a;li.lastIndex=t;var i=li.exec(r);return(a=i[1])!==null&&a!==void 0?a:""}):pi=function(r,t){for(var a=[];;){var i=Yo(r,t);if(i===void 0||Qo(i)||wd(i))break;a.push(i),t+=i>=65536?2:1}return hi.apply(void 0,a)};var li,Ko=function(){function e(r,t){t===void 0&&(t={}),this.message=r,this.position={offset:0,line:1,column:1},this.ignoreTag=!!t.ignoreTag,this.locale=t.locale,this.requiresOtherClause=!!t.requiresOtherClause,this.shouldParseSkeletons=!!t.shouldParseSkeletons}return e.prototype.parse=function(){if(this.offset()!==0)throw Error("parser can only be used once");return this.parseMessage(0,"",!1)},e.prototype.parseMessage=function(r,t,a){for(var i=[];!this.isEOF();){var n=this.char();if(n===123){var o=this.parseArgument(r,a);if(o.err)return o;i.push(o.val)}else{if(n===125&&r>0)break;if(n===35&&(t==="plural"||t==="selectordinal")){var s=this.clonePosition();this.bump(),i.push({type:F.pound,location:L(s,this.clonePosition())})}else if(n===60&&!this.ignoreTag&&this.peek()===47){if(a)break;return this.error(S.UNMATCHED_CLOSING_TAG,L(this.clonePosition(),this.clonePosition()))}else if(n===60&&!this.ignoreTag&&mi(this.peek()||0)){var o=this.parseTag(r,t);if(o.err)return o;i.push(o.val)}else{var o=this.parseLiteral(r,t);if(o.err)return o;i.push(o.val)}}}return{val:i,err:null}},e.prototype.parseTag=function(r,t){var a=this.clonePosition();this.bump();var i=this.parseTagName();if(this.bumpSpace(),this.bumpIf("/>"))return{val:{type:F.literal,value:"<".concat(i,"/>"),location:L(a,this.clonePosition())},err:null};if(this.bumpIf(">")){var n=this.parseMessage(r+1,t,!0);if(n.err)return n;var o=n.val,s=this.clonePosition();if(this.bumpIf("</")){if(this.isEOF()||!mi(this.char()))return this.error(S.INVALID_TAG,L(s,this.clonePosition()));var c=this.clonePosition(),l=this.parseTagName();return i!==l?this.error(S.UNMATCHED_CLOSING_TAG,L(c,this.clonePosition())):(this.bumpSpace(),this.bumpIf(">")?{val:{type:F.tag,value:i,children:o,location:L(a,this.clonePosition())},err:null}:this.error(S.INVALID_TAG,L(s,this.clonePosition())))}else return this.error(S.UNCLOSED_TAG,L(a,this.clonePosition()))}else return this.error(S.INVALID_TAG,L(a,this.clonePosition()))},e.prototype.parseTagName=function(){var r=this.offset();for(this.bump();!this.isEOF()&&yd(this.char());)this.bump();return this.message.slice(r,this.offset())},e.prototype.parseLiteral=function(r,t){for(var a=this.clonePosition(),i="";;){var n=this.tryParseQuote(t);if(n){i+=n;continue}var o=this.tryParseUnquoted(r,t);if(o){i+=o;continue}var s=this.tryParseLeftAngleBracket();if(s){i+=s;continue}break}var c=L(a,this.clonePosition());return{val:{type:F.literal,value:i,location:c},err:null}},e.prototype.tryParseLeftAngleBracket=function(){return!this.isEOF()&&this.char()===60&&(this.ignoreTag||!bd(this.peek()||0))?(this.bump(),"<"):null},e.prototype.tryParseQuote=function(r){if(this.isEOF()||this.char()!==39)return null;switch(this.peek()){case 39:return this.bump(),this.bump(),"'";case 123:case 60:case 62:case 125:break;case 35:if(r==="plural"||r==="selectordinal")break;return null;default:return null}this.bump();var t=[this.char()];for(this.bump();!this.isEOF();){var a=this.char();if(a===39)if(this.peek()===39)t.push(39),this.bump();else{this.bump();break}else t.push(a);this.bump()}return hi.apply(void 0,t)},e.prototype.tryParseUnquoted=function(r,t){if(this.isEOF())return null;var a=this.char();return a===60||a===123||a===35&&(t==="plural"||t==="selectordinal")||a===125&&r>0?null:(this.bump(),hi(a))},e.prototype.parseArgument=function(r,t){var a=this.clonePosition();if(this.bump(),this.bumpSpace(),this.isEOF())return this.error(S.EXPECT_ARGUMENT_CLOSING_BRACE,L(a,this.clonePosition()));if(this.char()===125)return this.bump(),this.error(S.EMPTY_ARGUMENT,L(a,this.clonePosition()));var i=this.parseIdentifierIfPossible().value;if(!i)return this.error(S.MALFORMED_ARGUMENT,L(a,this.clonePosition()));if(this.bumpSpace(),this.isEOF())return this.error(S.EXPECT_ARGUMENT_CLOSING_BRACE,L(a,this.clonePosition()));switch(this.char()){case 125:return this.bump(),{val:{type:F.argument,value:i,location:L(a,this.clonePosition())},err:null};case 44:return this.bump(),this.bumpSpace(),this.isEOF()?this.error(S.EXPECT_ARGUMENT_CLOSING_BRACE,L(a,this.clonePosition())):this.parseArgumentOptions(r,t,i,a);default:return this.error(S.MALFORMED_ARGUMENT,L(a,this.clonePosition()))}},e.prototype.parseIdentifierIfPossible=function(){var r=this.clonePosition(),t=this.offset(),a=pi(this.message,t),i=t+a.length;this.bumpTo(i);var n=this.clonePosition(),o=L(r,n);return{value:a,location:o}},e.prototype.parseArgumentOptions=function(r,t,a,i){var n,o=this.clonePosition(),s=this.parseIdentifierIfPossible().value,c=this.clonePosition();switch(s){case"":return this.error(S.EXPECT_ARGUMENT_TYPE,L(o,c));case"number":case"date":case"time":{this.bumpSpace();var l=null;if(this.bumpIf(",")){this.bumpSpace();var d=this.clonePosition(),p=this.parseSimpleArgStyleIfPossible();if(p.err)return p;var u=xd(p.val);if(u.length===0)return this.error(S.EXPECT_ARGUMENT_STYLE,L(this.clonePosition(),this.clonePosition()));var h=L(d,this.clonePosition());l={style:u,styleLocation:h}}var g=this.tryParseArgumentClose(i);if(g.err)return g;var f=L(i,this.clonePosition());if(l&&jo(l?.style,"::",0)){var x=vd(l.style.slice(2));if(s==="number"){var p=this.parseNumberSkeletonFromString(x,l.styleLocation);return p.err?p:{val:{type:F.number,value:a,location:f,style:p.val},err:null}}else{if(x.length===0)return this.error(S.EXPECT_DATE_TIME_SKELETON,f);var y=x;this.locale&&(y=qo(x,this.locale));var u={type:Je.dateTime,pattern:y,location:l.styleLocation,parsedOptions:this.shouldParseSkeletons?No(y):{}},A=s==="date"?F.date:F.time;return{val:{type:A,value:a,location:f,style:u},err:null}}}return{val:{type:s==="number"?F.number:s==="date"?F.date:F.time,value:a,location:f,style:(n=l?.style)!==null&&n!==void 0?n:null},err:null}}case"plural":case"selectordinal":case"select":{var b=this.clonePosition();if(this.bumpSpace(),!this.bumpIf(","))return this.error(S.EXPECT_SELECT_ARGUMENT_OPTIONS,L(b,P({},b)));this.bumpSpace();var C=this.parseIdentifierIfPossible(),H=0;if(s!=="select"&&C.value==="offset"){if(!this.bumpIf(":"))return this.error(S.EXPECT_PLURAL_ARGUMENT_OFFSET_VALUE,L(this.clonePosition(),this.clonePosition()));this.bumpSpace();var p=this.tryParseDecimalInteger(S.EXPECT_PLURAL_ARGUMENT_OFFSET_VALUE,S.INVALID_PLURAL_ARGUMENT_OFFSET_VALUE);if(p.err)return p;this.bumpSpace(),C=this.parseIdentifierIfPossible(),H=p.val}var N=this.tryParsePluralOrSelectOptions(r,s,t,C);if(N.err)return N;var g=this.tryParseArgumentClose(i);if(g.err)return g;var $=L(i,this.clonePosition());return s==="select"?{val:{type:F.select,value:a,options:Wo(N.val),location:$},err:null}:{val:{type:F.plural,value:a,options:Wo(N.val),offset:H,pluralType:s==="plural"?"cardinal":"ordinal",location:$},err:null}}default:return this.error(S.INVALID_ARGUMENT_TYPE,L(o,c))}},e.prototype.tryParseArgumentClose=function(r){return this.isEOF()||this.char()!==125?this.error(S.EXPECT_ARGUMENT_CLOSING_BRACE,L(r,this.clonePosition())):(this.bump(),{val:!0,err:null})},e.prototype.parseSimpleArgStyleIfPossible=function(){for(var r=0,t=this.clonePosition();!this.isEOF();){var a=this.char();switch(a){case 39:{this.bump();var i=this.clonePosition();if(!this.bumpUntil("'"))return this.error(S.UNCLOSED_QUOTE_IN_ARGUMENT_STYLE,L(i,this.clonePosition()));this.bump();break}case 123:{r+=1,this.bump();break}case 125:{if(r>0)r-=1;else return{val:this.message.slice(t.offset,this.offset()),err:null};break}default:this.bump();break}}return{val:this.message.slice(t.offset,this.offset()),err:null}},e.prototype.parseNumberSkeletonFromString=function(r,t){var a=[];try{a=Fo(r)}catch{return this.error(S.INVALID_NUMBER_SKELETON,t)}return{val:{type:Je.number,tokens:a,location:t,parsedOptions:this.shouldParseSkeletons?Go(a):{}},err:null}},e.prototype.tryParsePluralOrSelectOptions=function(r,t,a,i){for(var n,o=!1,s=[],c=new Set,l=i.value,d=i.location;;){if(l.length===0){var p=this.clonePosition();if(t!=="select"&&this.bumpIf("=")){var u=this.tryParseDecimalInteger(S.EXPECT_PLURAL_ARGUMENT_SELECTOR,S.INVALID_PLURAL_ARGUMENT_SELECTOR);if(u.err)return u;d=L(p,this.clonePosition()),l=this.message.slice(p.offset,this.offset())}else break}if(c.has(l))return this.error(t==="select"?S.DUPLICATE_SELECT_ARGUMENT_SELECTOR:S.DUPLICATE_PLURAL_ARGUMENT_SELECTOR,d);l==="other"&&(o=!0),this.bumpSpace();var h=this.clonePosition();if(!this.bumpIf("{"))return this.error(t==="select"?S.EXPECT_SELECT_ARGUMENT_SELECTOR_FRAGMENT:S.EXPECT_PLURAL_ARGUMENT_SELECTOR_FRAGMENT,L(this.clonePosition(),this.clonePosition()));var g=this.parseMessage(r+1,t,a);if(g.err)return g;var f=this.tryParseArgumentClose(h);if(f.err)return f;s.push([l,{value:g.val,location:L(h,this.clonePosition())}]),c.add(l),this.bumpSpace(),n=this.parseIdentifierIfPossible(),l=n.value,d=n.location}return s.length===0?this.error(t==="select"?S.EXPECT_SELECT_ARGUMENT_SELECTOR:S.EXPECT_PLURAL_ARGUMENT_SELECTOR,L(this.clonePosition(),this.clonePosition())):this.requiresOtherClause&&!o?this.error(S.MISSING_OTHER_CLAUSE,L(this.clonePosition(),this.clonePosition())):{val:s,err:null}},e.prototype.tryParseDecimalInteger=function(r,t){var a=1,i=this.clonePosition();this.bumpIf("+")||this.bumpIf("-")&&(a=-1);for(var n=!1,o=0;!this.isEOF();){var s=this.char();if(s>=48&&s<=57)n=!0,o=o*10+(s-48),this.bump();else break}var c=L(i,this.clonePosition());return n?(o*=a,fd(o)?{val:o,err:null}:this.error(t,c)):this.error(r,c)},e.prototype.offset=function(){return this.position.offset},e.prototype.isEOF=function(){return this.offset()===this.message.length},e.prototype.clonePosition=function(){return{offset:this.position.offset,line:this.position.line,column:this.position.column}},e.prototype.char=function(){var r=this.position.offset;if(r>=this.message.length)throw Error("out of bound");var t=Yo(this.message,r);if(t===void 0)throw Error("Offset ".concat(r," is at invalid UTF-16 code unit boundary"));return t},e.prototype.error=function(r,t){return{val:null,err:{kind:r,message:this.message,location:t}}},e.prototype.bump=function(){if(!this.isEOF()){var r=this.char();r===10?(this.position.line+=1,this.position.column=1,this.position.offset+=1):(this.position.column+=1,this.position.offset+=r<65536?1:2)}},e.prototype.bumpIf=function(r){if(jo(this.message,r,this.offset())){for(var t=0;t<r.length;t++)this.bump();return!0}return!1},e.prototype.bumpUntil=function(r){var t=this.offset(),a=this.message.indexOf(r,t);return a>=0?(this.bumpTo(a),!0):(this.bumpTo(this.message.length),!1)},e.prototype.bumpTo=function(r){if(this.offset()>r)throw Error("targetOffset ".concat(r," must be greater than or equal to the current offset ").concat(this.offset()));for(r=Math.min(r,this.message.length);;){var t=this.offset();if(t===r)break;if(t>r)throw Error("targetOffset ".concat(r," is at invalid UTF-16 code unit boundary"));if(this.bump(),this.isEOF())break}},e.prototype.bumpSpace=function(){for(;!this.isEOF()&&Qo(this.char());)this.bump()},e.prototype.peek=function(){if(this.isEOF())return null;var r=this.char(),t=this.offset(),a=this.message.charCodeAt(t+(r>=65536?2:1));return a??null},e}();function mi(e){return e>=97&&e<=122||e>=65&&e<=90}function bd(e){return mi(e)||e===47}function yd(e){return e===45||e===46||e>=48&&e<=57||e===95||e>=97&&e<=122||e>=65&&e<=90||e==183||e>=192&&e<=214||e>=216&&e<=246||e>=248&&e<=893||e>=895&&e<=8191||e>=8204&&e<=8205||e>=8255&&e<=8256||e>=8304&&e<=8591||e>=11264&&e<=12271||e>=12289&&e<=55295||e>=63744&&e<=64975||e>=65008&&e<=65533||e>=65536&&e<=983039}function Qo(e){return e>=9&&e<=13||e===32||e===133||e>=8206&&e<=8207||e===8232||e===8233}function wd(e){return e>=33&&e<=35||e===36||e>=37&&e<=39||e===40||e===41||e===42||e===43||e===44||e===45||e>=46&&e<=47||e>=58&&e<=59||e>=60&&e<=62||e>=63&&e<=64||e===91||e===92||e===93||e===94||e===96||e===123||e===124||e===125||e===126||e===161||e>=162&&e<=165||e===166||e===167||e===169||e===171||e===172||e===174||e===176||e===177||e===182||e===187||e===191||e===215||e===247||e>=8208&&e<=8213||e>=8214&&e<=8215||e===8216||e===8217||e===8218||e>=8219&&e<=8220||e===8221||e===8222||e===8223||e>=8224&&e<=8231||e>=8240&&e<=8248||e===8249||e===8250||e>=8251&&e<=8254||e>=8257&&e<=8259||e===8260||e===8261||e===8262||e>=8263&&e<=8273||e===8274||e===8275||e>=8277&&e<=8286||e>=8592&&e<=8596||e>=8597&&e<=8601||e>=8602&&e<=8603||e>=8604&&e<=8607||e===8608||e>=8609&&e<=8610||e===8611||e>=8612&&e<=8613||e===8614||e>=8615&&e<=8621||e===8622||e>=8623&&e<=8653||e>=8654&&e<=8655||e>=8656&&e<=8657||e===8658||e===8659||e===8660||e>=8661&&e<=8691||e>=8692&&e<=8959||e>=8960&&e<=8967||e===8968||e===8969||e===8970||e===8971||e>=8972&&e<=8991||e>=8992&&e<=8993||e>=8994&&e<=9e3||e===9001||e===9002||e>=9003&&e<=9083||e===9084||e>=9085&&e<=9114||e>=9115&&e<=9139||e>=9140&&e<=9179||e>=9180&&e<=9185||e>=9186&&e<=9254||e>=9255&&e<=9279||e>=9280&&e<=9290||e>=9291&&e<=9311||e>=9472&&e<=9654||e===9655||e>=9656&&e<=9664||e===9665||e>=9666&&e<=9719||e>=9720&&e<=9727||e>=9728&&e<=9838||e===9839||e>=9840&&e<=10087||e===10088||e===10089||e===10090||e===10091||e===10092||e===10093||e===10094||e===10095||e===10096||e===10097||e===10098||e===10099||e===10100||e===10101||e>=10132&&e<=10175||e>=10176&&e<=10180||e===10181||e===10182||e>=10183&&e<=10213||e===10214||e===10215||e===10216||e===10217||e===10218||e===10219||e===10220||e===10221||e===10222||e===10223||e>=10224&&e<=10239||e>=10240&&e<=10495||e>=10496&&e<=10626||e===10627||e===10628||e===10629||e===10630||e===10631||e===10632||e===10633||e===10634||e===10635||e===10636||e===10637||e===10638||e===10639||e===10640||e===10641||e===10642||e===10643||e===10644||e===10645||e===10646||e===10647||e===10648||e>=10649&&e<=10711||e===10712||e===10713||e===10714||e===10715||e>=10716&&e<=10747||e===10748||e===10749||e>=10750&&e<=11007||e>=11008&&e<=11055||e>=11056&&e<=11076||e>=11077&&e<=11078||e>=11079&&e<=11084||e>=11085&&e<=11123||e>=11124&&e<=11125||e>=11126&&e<=11157||e===11158||e>=11159&&e<=11263||e>=11776&&e<=11777||e===11778||e===11779||e===11780||e===11781||e>=11782&&e<=11784||e===11785||e===11786||e===11787||e===11788||e===11789||e>=11790&&e<=11798||e===11799||e>=11800&&e<=11801||e===11802||e===11803||e===11804||e===11805||e>=11806&&e<=11807||e===11808||e===11809||e===11810||e===11811||e===11812||e===11813||e===11814||e===11815||e===11816||e===11817||e>=11818&&e<=11822||e===11823||e>=11824&&e<=11833||e>=11834&&e<=11835||e>=11836&&e<=11839||e===11840||e===11841||e===11842||e>=11843&&e<=11855||e>=11856&&e<=11857||e===11858||e>=11859&&e<=11903||e>=12289&&e<=12291||e===12296||e===12297||e===12298||e===12299||e===12300||e===12301||e===12302||e===12303||e===12304||e===12305||e>=12306&&e<=12307||e===12308||e===12309||e===12310||e===12311||e===12312||e===12313||e===12314||e===12315||e===12316||e===12317||e>=12318&&e<=12319||e===12320||e===12336||e===64830||e===64831||e>=65093&&e<=65094}function ui(e){e.forEach(function(r){if(delete r.location,$r(r)||Gr(r))for(var t in r.options)delete r.options[t].location,ui(r.options[t].value);else Fr(r)&&Vr(r.style)||(Br(r)||Ur(r))&&Zt(r.style)?delete r.style.location:qr(r)&&ui(r.children)})}function Zo(e,r){r===void 0&&(r={}),r=P({shouldParseSkeletons:!0,requiresOtherClause:!0},r);var t=new Ko(e,r).parse();if(t.err){var a=SyntaxError(S[t.err.kind]);throw a.location=t.err.location,a.originalMessage=t.err.message,a}return r?.captureLocation||ui(t.val),t.val}function er(e,r){var t=r&&r.cache?r.cache:_d,a=r&&r.serializer?r.serializer:Td,i=r&&r.strategy?r.strategy:Sd;return i(e,{cache:t,serializer:a})}function Ed(e){return e==null||typeof e=="number"||typeof e=="boolean"}function Jo(e,r,t,a){var i=Ed(a)?a:t(a),n=r.get(i);return typeof n>"u"&&(n=e.call(this,a),r.set(i,n)),n}function es(e,r,t){var a=Array.prototype.slice.call(arguments,3),i=t(a),n=r.get(i);return typeof n>"u"&&(n=e.apply(this,a),r.set(i,n)),n}function gi(e,r,t,a,i){return t.bind(r,e,a,i)}function Sd(e,r){var t=e.length===1?Jo:es;return gi(e,this,t,r.cache.create(),r.serializer)}function Ad(e,r){return gi(e,this,es,r.cache.create(),r.serializer)}function Cd(e,r){return gi(e,this,Jo,r.cache.create(),r.serializer)}var Td=function(){return JSON.stringify(arguments)};function fi(){this.cache=Object.create(null)}fi.prototype.get=function(e){return this.cache[e]};fi.prototype.set=function(e,r){this.cache[e]=r};var _d={create:function(){return new fi}},jr={variadic:Ad,monadic:Cd};var et;(function(e){e.MISSING_VALUE="MISSING_VALUE",e.INVALID_VALUE="INVALID_VALUE",e.MISSING_INTL_API="MISSING_INTL_API"})(et||(et={}));var tr=function(e){Qt(r,e);function r(t,a,i){var n=e.call(this,t)||this;return n.code=a,n.originalMessage=i,n}return r.prototype.toString=function(){return"[formatjs Error: ".concat(this.code,"] ").concat(this.message)},r}(Error);var vi=function(e){Qt(r,e);function r(t,a,i,n){return e.call(this,'Invalid values for "'.concat(t,'": "').concat(a,'". Options are "').concat(Object.keys(i).join('", "'),'"'),et.INVALID_VALUE,n)||this}return r}(tr);var ts=function(e){Qt(r,e);function r(t,a,i){return e.call(this,'Value for "'.concat(t,'" must be of type ').concat(a),et.INVALID_VALUE,i)||this}return r}(tr);var rs=function(e){Qt(r,e);function r(t,a){return e.call(this,'The intl string context variable "'.concat(t,'" was not provided to the string "').concat(a,'"'),et.MISSING_VALUE,a)||this}return r}(tr);var Z;(function(e){e[e.literal=0]="literal",e[e.object=1]="object"})(Z||(Z={}));function kd(e){return e.length<2?e:e.reduce(function(r,t){var a=r[r.length-1];return!a||a.type!==Z.literal||t.type!==Z.literal?r.push(t):a.value+=t.value,r},[])}function Pd(e){return typeof e=="function"}function rr(e,r,t,a,i,n,o){if(e.length===1&&oi(e[0]))return[{type:Z.literal,value:e[0].value}];for(var s=[],c=0,l=e;c<l.length;c++){var d=l[c];if(oi(d)){s.push({type:Z.literal,value:d.value});continue}if(Oo(d)){typeof n=="number"&&s.push({type:Z.literal,value:t.getNumberFormat(r).format(n)});continue}var p=d.value;if(!(i&&p in i))throw new rs(p,o);var u=i[p];if(Ro(d)){(!u||typeof u=="string"||typeof u=="number")&&(u=typeof u=="string"||typeof u=="number"?String(u):""),s.push({type:typeof u=="string"?Z.literal:Z.object,value:u});continue}if(Br(d)){var h=typeof d.style=="string"?a.date[d.style]:Zt(d.style)?d.style.parsedOptions:void 0;s.push({type:Z.literal,value:t.getDateTimeFormat(r,h).format(u)});continue}if(Ur(d)){var h=typeof d.style=="string"?a.time[d.style]:Zt(d.style)?d.style.parsedOptions:a.time.medium;s.push({type:Z.literal,value:t.getDateTimeFormat(r,h).format(u)});continue}if(Fr(d)){var h=typeof d.style=="string"?a.number[d.style]:Vr(d.style)?d.style.parsedOptions:void 0;h&&h.scale&&(u=u*(h.scale||1)),s.push({type:Z.literal,value:t.getNumberFormat(r,h).format(u)});continue}if(qr(d)){var g=d.children,f=d.value,x=i[f];if(!Pd(x))throw new ts(f,"function",o);var y=rr(g,r,t,a,i,n),A=x(y.map(function(H){return H.value}));Array.isArray(A)||(A=[A]),s.push.apply(s,A.map(function(H){return{type:typeof H=="string"?Z.literal:Z.object,value:H}}))}if($r(d)){var b=d.options[u]||d.options.other;if(!b)throw new vi(d.value,u,Object.keys(d.options),o);s.push.apply(s,rr(b.value,r,t,a,i));continue}if(Gr(d)){var b=d.options["=".concat(u)];if(!b){if(!Intl.PluralRules)throw new tr(`Intl.PluralRules is not available in this environment.
Try polyfilling it using "@formatjs/intl-pluralrules"
`,et.MISSING_INTL_API,o);var C=t.getPluralRules(r,{type:d.pluralType}).select(u-(d.offset||0));b=d.options[C]||d.options.other}if(!b)throw new vi(d.value,u,Object.keys(d.options),o);s.push.apply(s,rr(b.value,r,t,a,i,u-(d.offset||0)));continue}}return kd(s)}function Ld(e,r){return r?P(P(P({},e||{}),r||{}),Object.keys(e).reduce(function(t,a){return t[a]=P(P({},e[a]),r[a]||{}),t},{})):e}function Md(e,r){return r?Object.keys(e).reduce(function(t,a){return t[a]=Ld(e[a],r[a]),t},P({},e)):e}function xi(e){return{create:function(){return{get:function(r){return e[r]},set:function(r,t){e[r]=t}}}}}function Rd(e){return e===void 0&&(e={number:{},dateTime:{},pluralRules:{}}),{getNumberFormat:er(function(){for(var r,t=[],a=0;a<arguments.length;a++)t[a]=arguments[a];return new((r=Intl.NumberFormat).bind.apply(r,zr([void 0],t,!1)))},{cache:xi(e.number),strategy:jr.variadic}),getDateTimeFormat:er(function(){for(var r,t=[],a=0;a<arguments.length;a++)t[a]=arguments[a];return new((r=Intl.DateTimeFormat).bind.apply(r,zr([void 0],t,!1)))},{cache:xi(e.dateTime),strategy:jr.variadic}),getPluralRules:er(function(){for(var r,t=[],a=0;a<arguments.length;a++)t[a]=arguments[a];return new((r=Intl.PluralRules).bind.apply(r,zr([void 0],t,!1)))},{cache:xi(e.pluralRules),strategy:jr.variadic})}}var as=function(){function e(r,t,a,i){var n=this;if(t===void 0&&(t=e.defaultLocale),this.formatterCache={number:{},dateTime:{},pluralRules:{}},this.format=function(o){var s=n.formatToParts(o);if(s.length===1)return s[0].value;var c=s.reduce(function(l,d){return!l.length||d.type!==Z.literal||typeof l[l.length-1]!="string"?l.push(d.value):l[l.length-1]+=d.value,l},[]);return c.length<=1?c[0]||"":c},this.formatToParts=function(o){return rr(n.ast,n.locales,n.formatters,n.formats,o,void 0,n.message)},this.resolvedOptions=function(){return{locale:n.resolvedLocale.toString()}},this.getAst=function(){return n.ast},this.locales=t,this.resolvedLocale=e.resolveLocale(t),typeof r=="string"){if(this.message=r,!e.__parse)throw new TypeError("IntlMessageFormat.__parse must be set to process `message` of type `string`");this.ast=e.__parse(r,{ignoreTag:i?.ignoreTag,locale:this.resolvedLocale})}else this.ast=r;if(!Array.isArray(this.ast))throw new TypeError("A message must be provided as a String or AST.");this.formats=Md(e.formats,a),this.formatters=i&&i.formatters||Rd(this.formatterCache)}return Object.defineProperty(e,"defaultLocale",{get:function(){return e.memoizedDefaultLocale||(e.memoizedDefaultLocale=new Intl.NumberFormat().resolvedOptions().locale),e.memoizedDefaultLocale},enumerable:!1,configurable:!0}),e.memoizedDefaultLocale=null,e.resolveLocale=function(r){var t=Intl.NumberFormat.supportedLocalesOf(r);return t.length>0?new Intl.Locale(t[0]):new Intl.Locale(typeof r=="string"?r:r[0])},e.__parse=Zo,e.formats={number:{integer:{maximumFractionDigits:0},currency:{style:"currency"},percent:{style:"percent"}},date:{short:{month:"numeric",day:"numeric",year:"2-digit"},medium:{month:"short",day:"numeric",year:"numeric"},long:{month:"long",day:"numeric",year:"numeric"},full:{weekday:"long",month:"long",day:"numeric",year:"numeric"}},time:{short:{hour:"numeric",minute:"numeric"},medium:{hour:"numeric",minute:"numeric",second:"numeric"},long:{hour:"numeric",minute:"numeric",second:"numeric",timeZoneName:"short"},full:{hour:"numeric",minute:"numeric",second:"numeric",timeZoneName:"short"}}},e}();var is=as;var bi={recurrenceLabel:"{recurrenceTerm, select, MONTH {/mo} YEAR {/yr} other {}}",recurrenceAriaLabel:"{recurrenceTerm, select, MONTH {per month} YEAR {per year} other {}}",perUnitLabel:"{perUnit, select, LICENSE {per license} other {}}",perUnitAriaLabel:"{perUnit, select, LICENSE {per license} other {}}",freeLabel:"Free",freeAriaLabel:"Free",taxExclusiveLabel:"{taxTerm, select, GST {excl. GST} VAT {excl. VAT} TAX {excl. tax} IVA {excl. IVA} SST {excl. SST} KDV {excl. KDV} other {}}",taxInclusiveLabel:"{taxTerm, select, GST {incl. GST} VAT {incl. VAT} TAX {incl. tax} IVA {incl. IVA} SST {incl. SST} KDV {incl. KDV} other {}}",alternativePriceAriaLabel:"Alternatively at",strikethroughAriaLabel:"Regularly at",planTypeLabel:"{planType, select, ABM {Annual, billed monthly} other {}}"},Od=Vn("ConsonantTemplates/price"),Nd=/<\/?[^>]+(>|$)/g,G={container:"price",containerOptical:"price-optical",containerStrikethrough:"price-strikethrough",containerPromoStrikethrough:"price-promo-strikethrough",containerAlternative:"price-alternative",containerAnnual:"price-annual",containerAnnualPrefix:"price-annual-prefix",containerAnnualSuffix:"price-annual-suffix",disabled:"disabled",currencySpace:"price-currency-space",currencySymbol:"price-currency-symbol",decimals:"price-decimals",decimalsDelimiter:"price-decimals-delimiter",integer:"price-integer",recurrence:"price-recurrence",taxInclusivity:"price-tax-inclusivity",unitType:"price-unit-type"},Fe={perUnitLabel:"perUnitLabel",perUnitAriaLabel:"perUnitAriaLabel",recurrenceLabel:"recurrenceLabel",recurrenceAriaLabel:"recurrenceAriaLabel",taxExclusiveLabel:"taxExclusiveLabel",taxInclusiveLabel:"taxInclusiveLabel",strikethroughAriaLabel:"strikethroughAriaLabel",alternativePriceAriaLabel:"alternativePriceAriaLabel"},yi="TAX_EXCLUSIVE",Id=e=>$n(e)?Object.entries(e).filter(([,r])=>wt(r)||Tr(r)||r===!0).reduce((r,[t,a])=>`${r} ${t}${a===!0?"":`="${Un(a)}"`}`,""):"",q=(e,r,t,a=!1)=>`<span class="${e}${r?"":` ${G.disabled}`}"${Id(t)}>${a?xo(r):r??""}</span>`;function Dd(e){e=e.replaceAll("</a>","&lt;/a&gt;");let r=/<a [^>]+(>|$)/g;return e.match(r)?.forEach(a=>{let i=a.replace("<a ","&lt;a ").replace(">","&gt;");e=e.replaceAll(a,i)}),e}function Hd(e){e=e.replaceAll("&lt;/a&gt;","</a>");let r=/&lt;a (?!&gt;)(.*?)(&gt;|$)/g;return e.match(r)?.forEach(a=>{let i=a.replace("&lt;a ","<a ").replace("&gt;",">");e=e.replaceAll(a,i)}),e}function Le(e,r,t,a){let i=e[t];if(i==null)return"";let n=i.includes("<"),o=i.includes("<a ");try{i=o?Dd(i):i,i=n?i.replace(Nd,""):i;let s=new is(i,r).format(a);return o?Hd(s):s}catch{return Od.error("Failed to format literal:",i),""}}function zd(e,{accessibleLabel:r,altAccessibleLabel:t,currencySymbol:a,decimals:i,decimalsDelimiter:n,hasCurrencySpace:o,integer:s,isCurrencyFirst:c,recurrenceLabel:l,perUnitLabel:d,taxInclusivityLabel:p},u={}){let h=q(G.currencySymbol,a),g=q(G.currencySpace,o?"&nbsp;":""),f="";return r?f=`<sr-only class="strikethrough-aria-label">${r}</sr-only>`:t&&(f=`<sr-only class="alt-aria-label">${t}</sr-only>`),c&&(f+=h+g),f+=q(G.integer,s),f+=q(G.decimalsDelimiter,n),f+=q(G.decimals,i),c||(f+=g+h),f+=q(G.recurrence,l,null,!0),f+=q(G.unitType,d,null,!0),f+=q(G.taxInclusivity,p,!0),q(e,f,{...u})}var K=({isAlternativePrice:e=!1,displayOptical:r=!1,displayStrikethrough:t=!1,displayPromoStrikethrough:a=!1,displayAnnual:i=!1,instant:n=void 0}={})=>({country:o,displayFormatted:s=!0,displayRecurrence:c=!0,displayPerUnit:l=!1,displayTax:d=!1,language:p,literals:u={},quantity:h=1,space:g=!1,isPromoApplied:f=!1}={},{commitment:x,offerSelectorIds:y,formatString:A,price:b,priceWithoutDiscount:C,taxDisplay:H,taxTerm:N,term:$,usePrecision:V,promotion:J}={},Q={})=>{Object.entries({country:o,formatString:A,language:p,price:b}).forEach(([$s,Gs])=>{if(Gs==null)throw new Error(`Argument "${$s}" is missing for osi ${y?.toString()}, country ${o}, language ${p}`)});let B={...bi,...u},O=`${p.toLowerCase()}-${o.toUpperCase()}`,re;J&&!f&&C?re=e||a?b:C:t&&C?re=C:re=b;let de=r?yo:wo;i&&(de=Eo);let{accessiblePrice:at,recurrenceTerm:ki,...Pi}=de({commitment:x,formatString:A,instant:n,isIndianPrice:o==="IN",originalPrice:b,priceWithoutDiscount:C,price:r?b:re,promotion:J,quantity:h,term:$,usePrecision:V}),Xr="",Kr="",Qr="";E(c)&&ki&&(Qr=Le(B,O,Fe.recurrenceLabel,{recurrenceTerm:ki}));let cr="";E(l)&&(g&&(cr+=" "),cr+=Le(B,O,Fe.perUnitLabel,{perUnit:"LICENSE"}));let lr="";E(d)&&N&&(g&&(lr+=" "),lr+=Le(B,O,H===yi?Fe.taxExclusiveLabel:Fe.taxInclusiveLabel,{taxTerm:N})),t&&(Xr=Le(B,O,Fe.strikethroughAriaLabel,{strikethroughPrice:Xr})),e&&(Kr=Le(B,O,Fe.alternativePriceAriaLabel,{alternativePrice:Kr}));let Ue=G.container;if(r&&(Ue+=` ${G.containerOptical}`),t&&(Ue+=` ${G.containerStrikethrough}`),a&&(Ue+=` ${G.containerPromoStrikethrough}`),e&&(Ue+=` ${G.containerAlternative}`),i&&(Ue+=` ${G.containerAnnual}`),E(s))return zd(Ue,{...Pi,accessibleLabel:Xr,altAccessibleLabel:Kr,recurrenceLabel:Qr,perUnitLabel:cr,taxInclusivityLabel:lr},Q);let{currencySymbol:Li,decimals:Hs,decimalsDelimiter:zs,hasCurrencySpace:Mi,integer:Fs,isCurrencyFirst:Bs}=Pi,it=[Fs,zs,Hs];Bs?(it.unshift(Mi?"\xA0":""),it.unshift(Li)):(it.push(Mi?"\xA0":""),it.push(Li)),it.push(Qr,cr,lr);let Us=it.join("");return q(Ue,Us,Q)},ns=()=>(e,r,t)=>{let a=Ze(r.promotion,r.promotion?.displaySummary?.instant,Array.isArray(e.quantity)?e.quantity[0]:e.quantity),n=(e.displayOldPrice===void 0||E(e.displayOldPrice))&&r.priceWithoutDiscount&&r.priceWithoutDiscount!=r.price&&(!r.promotion||a);return`${n?`${K({displayStrikethrough:!0})({isPromoApplied:a,...e,displayPerUnit:!1,displayTax:!1},r,t)}&nbsp;`:""}${K({isAlternativePrice:n})({isPromoApplied:a,...e},r,t)}`},os=()=>(e,r,t)=>{let{instant:a}=e;try{a||(a=new URLSearchParams(document.location.search).get("instant")),a&&(a=new Date(a))}catch{a=void 0}let i=Ze(r.promotion,a,Array.isArray(e.quantity)?e.quantity[0]:e.quantity),n={...e,displayTax:!1,displayPerUnit:!1,isPromoApplied:i};if(!i)return K()(e,{...r,price:r.priceWithoutDiscount},t)+q(G.containerAnnualPrefix," (")+K({displayAnnual:!0,instant:a})(n,{...r,price:r.priceWithoutDiscount},t)+q(G.containerAnnualSuffix,")");let s=(e.displayOldPrice===void 0||E(e.displayOldPrice))&&r.priceWithoutDiscount&&r.priceWithoutDiscount!=r.price;return`${s?`${K({displayStrikethrough:!0})(n,r,t)}&nbsp;`:""}${K({isAlternativePrice:s})({isPromoApplied:i,...e},r,t)}${q(G.containerAnnualPrefix," (")}${K({displayAnnual:!0,instant:a})(n,r,t)}${q(G.containerAnnualSuffix,")")}`},ss=()=>(e,r,t)=>{let a={...e,displayTax:!1,displayPerUnit:!1};return`${K({isAlternativePrice:e.displayOldPrice})(e,r,t)}${q(G.containerAnnualPrefix," (")}${K({displayAnnual:!0})(a,r,t)}${q(G.containerAnnualSuffix,")")}`};var ar={...G,containerLegal:"price-legal",planType:"price-plan-type"},Wr={...Fe,planTypeLabel:"planTypeLabel"};function Fd(e,{perUnitLabel:r,taxInclusivityLabel:t,planTypeLabel:a},i={},n=!0){let o="";return o+=q(ar.unitType,r,null,!0),t&&a&&n&&(t+=t.endsWith(".")?" ":". "),o+=q(ar.taxInclusivity,t,!0),o+=q(ar.planType,a,null),q(e,o,{...i})}var cs=({country:e,displayPerUnit:r=!1,displayTax:t=!1,displayPlanType:a=!1,displayDot:i=!0,language:n,literals:o={}}={},{taxDisplay:s,taxTerm:c,planType:l}={},d={})=>{let p={...bi,...o},u=`${n.toLowerCase()}-${e.toUpperCase()}`,h="";E(r)&&(h=Le(p,u,Wr.perUnitLabel,{perUnit:"LICENSE"}));let g="";e==="US"&&n==="en"&&(t=!1),E(t)&&c&&(g=Le(p,u,s===yi?Wr.taxExclusiveLabel:Wr.taxInclusiveLabel,{taxTerm:c}));let f="";E(a)&&l&&(f=Le(p,u,Wr.planTypeLabel,{planType:l}));let x=ar.container;return x+=` ${ar.containerLegal}`,Fd(x,{perUnitLabel:h,taxInclusivityLabel:g,planTypeLabel:f},d,i)};var ls=K(),ds=ns(),hs=K({displayOptical:!0}),ps=K({displayStrikethrough:!0}),ms=K({displayPromoStrikethrough:!0}),us=K({displayAnnual:!0}),gs=K({displayOptical:!0,isAlternativePrice:!0}),fs=K({isAlternativePrice:!0}),vs=ss(),xs=os(),bs=cs;var Bd=(e,r)=>{if(!r&&Et(e))return 0;if(!(!Et(e)||!Et(r)))return Math.floor((r-e)/r*100)},ys=()=>(e,r)=>{let{price:t,priceWithoutDiscount:a}=r,i=Bd(t,a);return i===void 0?'<span class="no-discount"></span>':`<span class="discount">${i}%</span>`};var ws=ys();var Es="INDIVIDUAL_COM",Ei="TEAM_COM",Ss="INDIVIDUAL_EDU",Si="TEAM_EDU",Ud=["AT_de","AU_en","BE_en","BE_fr","BE_nl","BG_bg","CH_de","CH_fr","CH_it","CZ_cs","CO_es","DE_de","DK_da","EE_et","EG_ar","EG_en","ES_es","FI_fi","FR_fr","GB_en","GR_el","GR_en","HU_hu","ID_en","ID_id","ID_in","IE_en","IN_en","IN_hi","IT_it","JP_ja","KR_ko","LU_de","LU_en","LU_fr","LT_lt","LV_lv","MY_en","MY_ms","MU_en","NL_nl","NG_en","NO_nb","NZ_en","PE_es","PL_pl","PT_pt","RO_ro","SE_sv","SI_sl","SK_sk","SG_en","TH_en","TH_th","TR_tr","UA_uk","ZA_en","SA_ar","SA_en","MX_es","CL_es","PE_es","PH_en","PH_fil","VN_vi","VN_en","TW_zh"],$d={[Es]:[],[Ei]:[],[Ss]:[],[Si]:[]},Gd={MU_en:[!0,!0,!0,!0],NG_en:[!1,!1,!1,!1],AU_en:[!1,!1,!1,!1],JP_ja:[!1,!1,!1,!1],NZ_en:[!1,!1,!1,!1],TH_en:[!1,!1,!1,!1],TH_th:[!1,!1,!1,!1],ZA_en:[!1,!1,!1,!1],PE_es:[!1,!1,!1,!1]},qd=[Es,Ei,Ss,Si],Vd=e=>[Ei,Si].includes(e);function wi(e,r,t,a){if(e[r])return e[r];let i=`${r}_${t}`;if(e[i])return e[i];let n;if(a)n=e.find(o=>o.startsWith(`${r}_`));else{let o=Object.keys(e).find(s=>s.startsWith(`${r}_`));n=o?e[o]:null}return n}var jd=(e,r,t,a)=>{let i=`${t}_${a}`,n=wi(Gd,e,r,!1);if(n){let o=qd.indexOf(i);return n[o]}return Vd(i)},Wd=(e,r,t,a)=>{if(wi(Ud,e,r,!0))return!0;let i=$d[`${t}_${a}`];return i?wi(i,e,r,!0)?!0:R.displayTax:R.displayTax},Ai=async(e,r,t,a)=>{let i=Wd(e,r,t,a);return{displayTax:i,forceTaxExclusive:i?jd(e,r,t,a):R.forceTaxExclusive}},ir=class ir extends HTMLSpanElement{constructor(){super();m(this,"masElement",new ze(this));this.handleClick=this.handleClick.bind(this)}static get observedAttributes(){return["data-display-old-price","data-display-per-unit","data-display-recurrence","data-display-tax","data-display-plan-type","data-display-annual","data-perpetual","data-promotion-code","data-force-tax-exclusive","data-template","data-wcs-osi","data-quantity"]}static createInlinePrice(t){let a=se();if(!a)return null;let{displayOldPrice:i,displayPerUnit:n,displayRecurrence:o,displayTax:s,displayPlanType:c,displayAnnual:l,forceTaxExclusive:d,perpetual:p,promotionCode:u,quantity:h,alternativePrice:g,template:f,wcsOsi:x}=a.collectPriceOptions(t);return Dr(ir,{displayOldPrice:i,displayPerUnit:n,displayRecurrence:o,displayTax:s,displayPlanType:c,displayAnnual:l,forceTaxExclusive:d,perpetual:p,promotionCode:u,quantity:h,alternativePrice:g,template:f,wcsOsi:x})}get isInlinePrice(){return!0}attributeChangedCallback(t,a,i){this.masElement.attributeChangedCallback(t,a,i)}connectedCallback(){this.masElement.connectedCallback(),this.addEventListener("click",this.handleClick)}disconnectedCallback(){this.masElement.disconnectedCallback(),this.removeEventListener("click",this.handleClick)}handleClick(t){t.target!==this&&(t.stopImmediatePropagation(),this.dispatchEvent(new MouseEvent("click",{bubbles:!0,cancelable:!0,view:window})))}onceSettled(){return this.masElement.onceSettled()}get value(){return this.masElement.value}get options(){return this.masElement.options}get isFailed(){return this.masElement.state===ge}requestUpdate(t=!1){return this.masElement.requestUpdate(t)}async render(t={}){if(!this.isConnected)return!1;let a=se();if(!a)return!1;let i=a.collectPriceOptions(t,this),n={...a.settings,...i};if(!n.wcsOsi.length)return!1;try{let o=this.masElement.togglePending({});this.innerHTML="";let s=a.resolveOfferSelectors(n),c=await Promise.all(s),l=c.map(h=>{let g=Yt(h,n);return g?.length?g[0]:null});if(l.some(h=>!h))throw new Error(`Failed to select offers for: ${n.wcsOsi}`);let d=l,p=Ja(l);if(a.featureFlags[Te]||n[Te]){if(i.displayPerUnit===void 0&&(n.displayPerUnit=p.customerSegment!=="INDIVIDUAL"),i.displayTax===void 0||i.forceTaxExclusive===void 0){let{country:h,language:g}=n,[f=""]=p.marketSegments,x=await Ai(h,g,p.customerSegment,f);i.displayTax===void 0&&(n.displayTax=x?.displayTax||n.displayTax),i.forceTaxExclusive===void 0&&(n.forceTaxExclusive=x?.forceTaxExclusive||n.forceTaxExclusive),n.forceTaxExclusive&&(d=c.map(y=>{let A=Yt(y,n);return A?.length?A[0]:null}))}}else i.displayOldPrice===void 0&&(n.displayOldPrice=!0);if(a.featureFlags[nt]&&n.displayAnnual!==!1&&(n.displayAnnual=!0),n.template==="discount"&&d.length===2){let[h,g]=d,f={...h,priceDetails:{...h.priceDetails,priceWithoutDiscount:g.priceDetails?.price}};return this.renderOffers([f],n,o)}let u=Ja(d);return this.renderOffers([u],n,o)}catch(o){throw this.innerHTML="",o}}renderOffers(t,a,i=void 0){if(!this.isConnected)return;let n=se();if(!n)return!1;if(i??(i=this.masElement.togglePending()),t.length){if(this.masElement.toggleResolved(i,t,a)){this.innerHTML=n.buildPriceHTML(t,this.options);let o=this.closest("p, h3, div");if(!o||!o.querySelector('span[data-template="strikethrough"]')||o.querySelector(".alt-aria-label"))return!0;let s=o?.querySelectorAll('span[is="inline-price"]');return s.length>1&&s.length===o.querySelectorAll('span[data-template="strikethrough"]').length*2&&s.forEach(c=>{c.dataset.template!=="strikethrough"&&c.options&&!c.options.alternativePrice&&!c.isFailed&&(c.options.alternativePrice=!0,c.innerHTML=n.buildPriceHTML(t,c.options))}),!0}}else{let o=new Error(`Not provided: ${this.options?.wcsOsi??"-"}`);if(this.masElement.toggleFailed(i,o,this.options))return this.innerHTML="",!0}return!1}};m(ir,"is","inline-price"),m(ir,"tag","span");var Me=ir;window.customElements.get(Me.is)||window.customElements.define(Me.is,Me,{extends:Me.tag});function As({literals:e,providers:r,settings:t}){function a(o,s=null){let c={country:t.country,language:t.language,locale:t.locale,literals:{...e.price}};if(s&&r?.price)for(let N of r.price)N(s,c);let{displayOldPrice:l,displayPerUnit:d,displayRecurrence:p,displayTax:u,displayPlanType:h,forceTaxExclusive:g,perpetual:f,displayAnnual:x,promotionCode:y,quantity:A,alternativePrice:b,wcsOsi:C,...H}=Object.assign(c,s?.dataset??{},o??{});return c=_r(Object.assign({...c,...H,displayOldPrice:E(l),displayPerUnit:E(d),displayRecurrence:E(p),displayTax:E(u),displayPlanType:E(h),forceTaxExclusive:E(g),perpetual:E(f),displayAnnual:E(x),promotionCode:Lr(y).effectivePromoCode,quantity:St(A,R.quantity),alternativePrice:E(b),wcsOsi:Ir(C)})),c}function i(o,s){if(!Array.isArray(o)||!o.length||!s)return"";let{template:c}=s,l;switch(c){case"discount":l=ws;break;case"strikethrough":l=ps;break;case"promo-strikethrough":l=ms;break;case"annual":l=us;break;case"legal":l=bs;break;default:s.template==="optical"&&s.alternativePrice?l=gs:s.template==="optical"?l=hs:s.displayAnnual&&o[0].planType==="ABM"?l=s.promotionCode&&o[0].promotion?xs:vs:s.alternativePrice?l=fs:l=s.promotionCode&&o[0].promotion?ds:ls}let[d]=o;return d={...d,...d.priceDetails},l({...t,...s},d)}let n=Me.createInlinePrice;return{InlinePrice:Me,buildPriceHTML:i,collectPriceOptions:a,createInlinePrice:n}}function Yd({locale:e=void 0,country:r=void 0,language:t=void 0}={}){return t??(t=e?.split("_")?.[0]||R.language),r??(r=e?.split("_")?.[1]||R.country),e??(e=`${t}_${r}`),{locale:e,country:r,language:t}}function Cs(e={},r){let t=r.featureFlags[Te],{commerce:a={}}=e,i=xe.PRODUCTION,n=xa,o=z("checkoutClientId",a)??R.checkoutClientId,s=Wt(z("checkoutWorkflowStep",a),ie,R.checkoutWorkflowStep),c=E(z("displayOldPrice",a),R.displayOldPrice),l=R.displayPerUnit,d=E(z("displayRecurrence",a),R.displayRecurrence),p=E(z("displayTax",a),R.displayTax),u=E(z("displayPlanType",a),R.displayPlanType),h=E(z("entitlement",a),R.entitlement),g=E(z("modal",a),R.modal),f=E(z("forceTaxExclusive",a),R.forceTaxExclusive),x=z("promotionCode",a)??R.promotionCode,y=St(z("quantity",a)),A=z("wcsApiKey",a)??R.wcsApiKey,b=a?.env==="stage",C=Ne.PUBLISHED;["true",""].includes(a.allowOverride)&&(b=(z(fa,a,{metadata:!1})?.toLowerCase()??a?.env)==="stage",C=Wt(z(va,a),Ne,C)),b&&(i=xe.STAGE,n=ba);let N=z(ga)??e.preview,$=typeof N<"u"&&N!=="off"&&N!=="false",V={};$&&(V={preview:$});let J=z("mas-io-url")??e.masIOUrl,Q=Ui(J)?J:`https://www${i===xe.STAGE?".stage":""}.adobe.com/mas/io`,B=z("preselect-plan")??void 0,O=z("instant")??e.instant;return{...Yd(e),...V,displayOldPrice:c,checkoutClientId:o,checkoutWorkflowStep:s,displayPerUnit:l,displayRecurrence:d,displayTax:p,displayPlanType:u,entitlement:h,extraOptions:R.extraOptions,modal:g,env:i,forceTaxExclusive:f,promotionCode:x,quantity:y,alternativePrice:R.alternativePrice,wcsApiKey:A,wcsURL:n,landscape:C,masIOUrl:Q,...B&&{preselectPlan:B},...O&&{instant:O}}}async function Ts(e,r={},t=2,a=100){let i;for(let n=0;n<=t;n++)try{let o=await fetch(e,r);return o.retryCount=n,o}catch(o){if(i=o,i.retryCount=n,n>t)break;await new Promise(s=>setTimeout(s,a*(n+1)))}throw i}var Ci="wcs";function _s({settings:e}){let r=oe.module(Ci),{env:t,wcsApiKey:a}=e,i=new Map,n=new Map,o,s=new Map;async function c(g,f,x=!0){let y=se(),A=pa;r.debug("Fetching:",g);let b="",C;if(g.offerSelectorIds.length>1)throw new Error("Multiple OSIs are not supported anymore");let H=new Map(f),[N]=g.offerSelectorIds,$=Date.now()+Math.random().toString(36).substring(2,7),V=`${Ci}:${N}:${$}${wa}`,J=`${Ci}:${N}:${$}${Ea}`,Q;try{if(performance.mark(V),b=new URL(e.wcsURL),b.searchParams.set("offer_selector_ids",N),b.searchParams.set("country",g.country),b.searchParams.set("locale",g.locale),b.searchParams.set("landscape",t===xe.STAGE?"ALL":e.landscape),b.searchParams.set("api_key",a),g.language&&b.searchParams.set("language",g.language),g.promotionCode&&b.searchParams.set("promotion_code",g.promotionCode),g.currency&&b.searchParams.set("currency",g.currency),C=await Ts(b.toString(),{credentials:"omit"}),C.ok){let B=[];try{let O=await C.json();r.debug("Fetched:",g,O),B=O.resolvedOffers??[]}catch(O){r.error(`Error parsing JSON: ${O.message}`,{...O.context,...y?.duration})}B=B.map(Mr),f.forEach(({resolve:O},re)=>{let de=B.filter(({offerSelectorIds:at})=>at.includes(re)).flat();de.length&&(H.delete(re),f.delete(re),O(de))})}else A=ha}catch(B){A=`Network error: ${B.message}`}finally{Q=performance.measure(J,V),performance.clearMarks(V),performance.clearMeasures(J)}if(x&&f.size){r.debug("Missing:",{offerSelectorIds:[...f.keys()]});let B=io(C);f.forEach(O=>{O.reject(new At(A,{...g,...B,response:C,measure:ur(Q),...y?.duration}))})}}function l(){clearTimeout(o);let g=[...n.values()];n.clear(),g.forEach(({options:f,promises:x})=>c(f,x))}function d(g){if(!g||typeof g!="object")throw new TypeError("Cache must be a Map or similar object");let f=t===xe.STAGE?"stage":"prod",x=g[f];if(!x||typeof x!="object"){r.warn(`No cache found for environment: ${t}`);return}for(let[y,A]of Object.entries(x))i.set(y,Promise.resolve(A.map(Mr)));r.debug(`Prefilled WCS cache with ${x.size} entries`)}function p(){let g=i.size;s=new Map(i),i.clear(),r.debug(`Moved ${g} cache entries to stale cache`)}function u(g,f,x){let y=g!=="GB"&&!x?"MULT":"en",A=Sa.includes(g)?g:R.country;return{validCountry:A,validLanguage:y,locale:`${f}_${A}`}}function h({country:g,language:f,perpetual:x=!1,promotionCode:y="",wcsOsi:A=[]}){let{validCountry:b,validLanguage:C,locale:H}=u(g,f,x),N=[b,C,y].filter($=>$).join("-").toLowerCase();return A.map($=>{let V=`${$}-${N}`;if(i.has(V))return i.get(V);let J=new Promise((Q,B)=>{let O=n.get(N);O||(O={options:{country:b,locale:H,...C==="MULT"&&{language:C},offerSelectorIds:[]},promises:new Map},n.set(N,O)),y&&(O.options.promotionCode=y),O.options.offerSelectorIds.push($),O.promises.set($,{resolve:Q,reject:B}),l()}).catch(Q=>{if(s.has(V))return s.get(V);throw Q});return i.set(V,J),J})}return{Commitment:$e,PlanType:Wn,Term:he,applyPlanType:Mr,resolveOfferSelectors:h,flushWcsCacheInternal:p,prefillWcsCache:d,normalizeCountryLanguageAndLocale:u}}var ks="mas-commerce-service",Ps="mas-commerce-service:start",Ls="mas-commerce-service:ready",nr,Tt,tt,Ms,_i,Ti=class extends HTMLElement{constructor(){super(...arguments);M(this,tt);M(this,nr);M(this,Tt);m(this,"lastLoggingTime",0)}async registerCheckoutAction(t){typeof t=="function"&&(this.buildCheckoutAction=async(a,i,n)=>{let o=await t?.(a,i,this.imsSignedInPromise,n);return o||null})}get featureFlags(){return v(this,Tt)||T(this,Tt,{[Te]:j(this,tt,_i).call(this,Te),[nt]:j(this,tt,_i).call(this,nt)}),v(this,Tt)}activate(){let t=v(this,tt,Ms),a=Cs(t,this);Rr(t.lana);let i=oe.init(t.hostEnv).module("service");i.debug("Activating:",t);let o={price:Mo(a)},s={checkout:new Set,price:new Set},c={literals:o,providers:s,settings:a};Object.defineProperties(this,Object.getOwnPropertyDescriptors({...ko(c),...Po(c),...As(c),..._s(c),...Aa,Log:oe,resolvePriceTaxFlags:Ai,get defaults(){return R},get log(){return oe},get providers(){return{checkout(d){return s.checkout.add(d),()=>s.checkout.delete(d)},price(d){return s.price.add(d),()=>s.price.delete(d)},has:d=>s.price.has(d)||s.checkout.has(d)}},get settings(){return a}})),i.debug("Activated:",{literals:o,settings:a});let l=new CustomEvent(hr,{bubbles:!0,cancelable:!1,detail:this});performance.mark(Ls),T(this,nr,performance.measure(Ls,Ps)),this.dispatchEvent(l),setTimeout(()=>{this.logFailedRequests()},1e4)}connectedCallback(){performance.mark(Ps),this.activate()}flushWcsCache(){this.flushWcsCacheInternal(),this.log.debug("Flushed WCS cache")}isPreview(){let t=this.getAttribute("preview");return t!=null&&["true","on",!0].includes(t)}refreshOffers(){this.flushWcsCacheInternal(),document.querySelectorAll(ea).forEach(t=>t.requestUpdate(!0)),this.log.debug("Refreshed WCS offers"),this.logFailedRequests()}refreshFragments(){this.flushWcsCacheInternal(),customElements.get("aem-fragment")?.cache.clear(),document.querySelectorAll("aem-fragment").forEach(t=>t.refresh(!1)),this.log.debug("Refreshed AEM fragments"),this.logFailedRequests()}get duration(){return{"mas-commerce-service:measure":ur(v(this,nr))}}logFailedRequests(){let t=[...performance.getEntriesByType("resource")].filter(({startTime:i})=>i>this.lastLoggingTime).filter(({transferSize:i,duration:n,responseStatus:o})=>i===0&&n===0&&o<200||o>=400),a=Array.from(new Map(t.map(i=>[i.name,i])).values());if(a.some(({name:i})=>/(\/fragment\?|web_commerce_artifact)/.test(i))){let i=a.map(({name:n})=>n);this.log.error("Failed requests:",{failedUrls:i,...this.duration})}this.lastLoggingTime=performance.now().toFixed(3)}};nr=new WeakMap,Tt=new WeakMap,tt=new WeakSet,Ms=function(){let t=this.getAttribute("env")??"prod",a={commerce:{env:t},hostEnv:{name:t},lana:{tags:this.getAttribute("lana-tags"),sampleRate:parseInt(this.getAttribute("lana-sample-rate")??1,10),isProdDomain:t==="prod"},masIOUrl:this.getAttribute("mas-io-url")};return["locale","country","language","preview","instant"].forEach(i=>{let n=this.getAttribute(i);n&&(a[i]=n)}),["checkout-workflow-step","force-tax-exclusive","checkout-client-id","allow-override","wcs-api-key"].forEach(i=>{let n=this.getAttribute(i);if(n!=null){let o=i.replace(/-([a-z])/g,s=>s[1].toUpperCase());a.commerce[o]=n}}),a},_i=function(t){return["on","true",!0].includes(this.getAttribute(`data-${t}`)||z(t))};window.customElements.get(ks)||window.customElements.define(ks,Ti);var Is="merch-card-collection",Xd=3e4,Kd={catalog:["four-merch-cards"],plans:["four-merch-cards"],plansTwoColumns:["two-merch-cards"],plansThreeColumns:["three-merch-cards"],product:["four-merch-cards"],productTwoColumns:["two-merch-cards"],productThreeColumns:["three-merch-cards"],segment:["four-merch-cards"],segmentTwoColumns:["two-merch-cards"],segmentThreeColumns:["three-merch-cards"],"special-offers":["three-merch-cards"],image:["three-merch-cards"],"mini-compare-chart":["three-merch-cards"],"mini-compare-chartTwoColumns":["two-merch-cards"],"mini-compare-chart-mweb":["three-merch-cards"],"mini-compare-chart-mwebTwoColumns":["two-merch-cards"]},Qd={plans:!0},Zd=(e,{filter:r})=>e.filter(t=>t?.filters&&t?.filters.hasOwnProperty(r)),Jd=(e,{types:r})=>r?(r=r.split(","),e.filter(t=>r.some(a=>t.types.includes(a)))):e,eh=e=>e.sort((r,t)=>(r.title??"").localeCompare(t.title??"","en",{sensitivity:"base"})),th=(e,{filter:r})=>e.sort((t,a)=>a.filters[r]?.order==null||isNaN(a.filters[r]?.order)?-1:t.filters[r]?.order==null||isNaN(t.filters[r]?.order)?1:t.filters[r].order-a.filters[r].order),rh=(e,{search:r})=>r?.length?(r=r.toLowerCase(),e.filter(t=>(t.title??"").toLowerCase().includes(r))):e,Be,kt,rt,sr,Yr,Ds,_t=class extends Os{constructor(){super();M(this,Yr);M(this,Be,{});M(this,kt);M(this,rt);M(this,sr);this.id=null,this.filter="all",this.hasMore=!1,this.resultCount=void 0,this.displayResult=!1,this.data=null,this.variant=null,this.hydrating=!1,this.hydrationReady=null,this.literalsHandlerAttached=!1,this.onUnmount=[],this.resizeHandlerDebounced=Bi(this.resizeHandler.bind(this),300)}resizeHandler(){this.firstChild?.variantLayout?.resizeHandler?.()}render(){return Re` <slot></slot>
            ${this.footer}`}checkReady(){if(!this.querySelector("aem-fragment"))return Promise.resolve(!0);let a=new Promise(i=>setTimeout(()=>i(!1),Xd));return Promise.race([this.hydrationReady,a])}updated(t){if(!this.querySelector("merch-card"))return;let a=window.scrollY||document.documentElement.scrollTop,i=[...this.children].filter(l=>l.tagName==="MERCH-CARD"&&!l.failed);if(i.length===0)return;t.has("singleApp")&&this.singleApp&&i.forEach(l=>{l.updateFilters(l.name===this.singleApp)});let n=this.sort===fe.alphabetical?eh:th,s=[Zd,Jd,rh,n].reduce((l,d)=>d(l,this),i).map((l,d)=>[l,d]);if(this.resultCount=s.length,this.page&&this.limit){let l=this.page*this.limit;this.hasMore=s.length>l,s=s.filter(([,d])=>d<l)}let c=new Map(s.reverse());for(let l of c.keys())this.prepend(l);i.forEach(l=>{c.has(l)?(l.size=l.filters[this.filter]?.size,l.style.removeProperty("display"),l.requestUpdate()):(l.style.display="none",l.size=void 0)}),window.scrollTo(0,a),this.updateComplete.then(()=>{this.dispatchLiteralsChanged(),this.sidenav&&!this.literalsHandlerAttached&&(this.sidenav.addEventListener(ia,()=>{this.dispatchLiteralsChanged()}),this.literalsHandlerAttached=!0)})}dispatchLiteralsChanged(){this.dispatchEvent(new CustomEvent(ue,{detail:{resultCount:this.resultCount,searchTerm:this.search,filter:this.sidenav?.filters?.selectedText}}))}buildOverrideMap(){T(this,Be,{}),this.overrides?.split(",").forEach(t=>{let[a,i]=t?.split(":");a&&i&&(v(this,Be)[a]=i)})}connectedCallback(){super.connectedCallback(),T(this,kt,It()),v(this,kt)&&T(this,rt,v(this,kt).Log.module(Is)),T(this,sr,customElements.get("merch-card")),this.buildOverrideMap(),this.init(),window.addEventListener("resize",this.resizeHandlerDebounced)}async init(){await this.hydrate(),this.sidenav=this.parentElement.querySelector("merch-sidenav"),this.filtered?(this.filter=this.filtered,this.page=1):this.startDeeplink(),this.initializePlaceholders()}disconnectedCallback(){super.disconnectedCallback(),this.stopDeeplink?.();for(let t of this.onUnmount)t();window.removeEventListener("resize",this.resizeHandlerDebounced)}initializeHeader(){let t=document.createElement("merch-card-collection-header");t.collection=this,t.classList.add(this.variant),this.parentElement.insertBefore(t,this),this.header=t,this.querySelectorAll("[placeholder]").forEach(i=>{let n=i.getAttribute("slot");this.header.placeholderKeys.includes(n)&&this.header.append(i)})}initializePlaceholders(){let t=this.data?.placeholders||{};!t.searchText&&this.data?.sidenavSettings?.searchText&&(t.searchText=this.data.sidenavSettings.searchText);for(let a of Object.keys(t)){let i=t[a],n=i.includes("<p>")?"div":"p",o=document.createElement(n);o.setAttribute("slot",a),o.setAttribute("placeholder",""),o.innerHTML=i,this.append(o)}}attachSidenav(t,a=!0){if(!t)return;a&&this.parentElement.prepend(t),this.sidenav=t,this.sidenav.variant=this.variant,this.sidenav.classList.add(this.variant),Qd[this.variant]&&this.sidenav.setAttribute("autoclose",""),this.initializeHeader(),this.dispatchEvent(new CustomEvent(Rt));let i=v(this,sr)?.getCollectionOptions(this.variant)?.onSidenavAttached;i&&i(this)}async hydrate(){if(this.hydrating)return!1;let t=this.querySelector("aem-fragment");if(!t)return;this.id=t.getAttribute("fragment"),this.hydrating=!0;let a;this.hydrationReady=new Promise(s=>{a=s});let i=this;function n(s){let c;return s.fields?.checkboxGroups?c=s.fields.checkboxGroups:s.fields?.tagFilters&&(c=[{title:s.fields?.tagFiltersTitle,label:"types",deeplink:"types",checkboxes:s.fields.tagFilters.map(l=>{let d=l.split("/").pop(),p=s.settings?.tagLabels?.[d]||d;return p=p.startsWith("coll-tag-filter")?d.charAt(0).toUpperCase()+d.slice(1):p,{name:d,label:p}})}]),{searchText:s.fields?.searchText,tagFilters:c,linksTitle:s.fields?.linksTitle,link:s.fields?.link,linkText:s.fields?.linkText,linkIcon:s.fields?.linkIcon}}function o(s,c){let l={cards:[],hierarchy:[],placeholders:s.placeholders,sidenavSettings:n(s)};function d(p,u){for(let h of u){if(h.fieldName==="variations")continue;if(h.fieldName==="cards"){if(l.cards.findIndex(b=>b.id===h.identifier)!==-1)continue;if(!s.references[h.identifier]?.value){v(i,rt)?.error(`Reference not found for card: ${h.identifier}`);continue}l.cards.push(s.references[h.identifier].value);continue}let g=s.references[h.identifier]?.value,f=h.referencesTree,x=c[h.identifier];if(x){let b=document.querySelector(`aem-fragment[fragment="${x}"]`)?.rawData;if(b?.fields)g=b,f=b.referencesTree,s.references={...s.references,...b.references};else{v(i,rt)?.error(`Override fragment ${x} not found or invalid:`);continue}}if(!g?.fields)continue;let{fields:y}=g,A={label:y.label||"",icon:y.icon,iconLight:y.iconLight,queryLabel:y.queryLabel,cards:y.cards?y.cards.map(b=>c[b]||b):[],collections:[]};y.defaultchild&&(A.defaultchild=c[y.defaultchild]||y.defaultchild),p.push(A),d(A.collections,f)}}return d(l.hierarchy,s.referencesTree),l.hierarchy.length===0&&(i.filtered="all"),l}t.addEventListener(oa,s=>{j(this,Yr,Ds).call(this,"Error loading AEM fragment",s.detail),this.hydrating=!1,t.remove()}),t.addEventListener(na,async s=>{this.limit=27,this.data=o(s.detail,v(this,Be)),s.detail.variationId&&this.setAttribute("variation-id",s.detail.variationId);let{cards:c,hierarchy:l}=this.data,d=l.length===0&&s.detail.fields?.defaultchild?v(this,Be)[s.detail.fields.defaultchild]||s.detail.fields.defaultchild:null;t.cache.add(...c);let p=(g,f)=>{for(let x of g)if(x.defaultchild===f||x.collections&&p(x.collections,f))return!0;return!1};for(let g of c){let b=function(H){for(let N of H){let $=N.cards.indexOf(x);if($===-1)continue;let V=N.queryLabel??N?.label?.toLowerCase()??"";f.filters[V]={order:$+1,size:g.fields.size},b(N.collections)}},f=document.createElement("merch-card"),x=v(this,Be)[g.id]||g.id;f.setAttribute("consonant",""),f.setAttribute("style","");let y=g.fields.tags?.filter(H=>H.startsWith("mas:types/")).map(H=>H.split("/")[1]).join(",");y&&f.setAttribute("types",y),fr(g.fields.variant)?.supportsDefaultChild&&(d?x===d:p(l,x))&&f.setAttribute("data-default-card","true"),b(l);let C=document.createElement("aem-fragment");C.setAttribute("fragment",x),f.append(C),Object.keys(f.filters).length===0&&(f.filters={all:{order:c.indexOf(g)+1,size:g.fields.size}}),this.append(f)}let u="",h=so(c[0]?.fields?.variant);this.variant=h,h==="plans"&&(c.length===2||c.length===3)&&!c.some(g=>g.fields?.size?.includes("wide"))||(h==="segment"||h==="product")&&(c.length===2||c.length===3)?u=c.length===2?"TwoColumns":"ThreeColumns":(h==="mini-compare-chart"||h==="mini-compare-chart-mweb")&&c.length<=2&&(u=c.length===1?"":"TwoColumns"),h&&this.classList.add("merch-card-collection",h,...Kd[`${h}${u}`]||[]),this.displayResult=!0,this.hydrating=!1,t.remove(),a(!0)}),await this.hydrationReady}get footer(){if(!this.filtered)return Re`<div id="footer">
            <sp-theme color="light" scale="medium">
                ${this.showMoreButton}
            </sp-theme>
        </div>`}get showMoreButton(){if(this.hasMore)return Re`<sp-button
            variant="secondary"
            treatment="outline"
            style="order: 1000;"
            @click="${this.showMore}"
        ...
        </sp-button>`}sortChanged(t){t.target.value===fe.authored?Mt({sort:void 0}):Mt({sort:t.target.value}),this.dispatchEvent(new CustomEvent(ra,{bubbles:!0,composed:!0,detail:{value:t.target.value}}))}async showMore(){this.dispatchEvent(new CustomEvent(aa,{bubbles:!0,composed:!0}));let t=this.page+1;Mt({page:t}),this.page=t,await this.updateComplete}startDeeplink(){this.stopDeeplink=Hi(({category:t,filter:a,types:i,sort:n,search:o,single_app:s,page:c})=>{a=a||t,!this.filtered&&a&&a!==this.filter&&setTimeout(()=>{Mt({page:void 0}),this.page=1},1),this.filtered||(this.filter=a??this.filter),this.types=i??"",this.search=o??"",this.singleApp=s,this.sort=n,this.page=Number(c)||1})}openFilters(t){this.sidenav?.showModal(t)}};Be=new WeakMap,kt=new WeakMap,rt=new WeakMap,sr=new WeakMap,Yr=new WeakSet,Ds=function(t,a={},i=!0){v(this,rt)?.error(`merch-card-collection: ${t}`,a),this.failed=!0,i&&this.dispatchEvent(new CustomEvent(sa,{detail:{...a,message:t},bubbles:!0,composed:!0}))},m(_t,"properties",{id:{type:String,attribute:"id",reflect:!0},displayResult:{type:Boolean,attribute:"display-result"},filter:{type:String,attribute:"filter",reflect:!0},filtered:{type:String,attribute:"filtered",reflect:!0},hasMore:{type:Boolean},limit:{type:Number,attribute:"limit"},overrides:{type:String},page:{type:Number,attribute:"page",reflect:!0},resultCount:{type:Number},search:{type:String,attribute:"search",reflect:!0},sidenav:{type:Object},singleApp:{type:String,attribute:"single-app",reflect:!0},sort:{type:String,attribute:"sort",default:fe.authored,reflect:!0},types:{type:String,attribute:"types",reflect:!0}}),m(_t,"styles",Ns`
        #footer {
            grid-column: 1 / -1;
    ...
    `);_t.SortOrder=fe;customElements.define(Is,_t);var ah={filters:["noResultText","resultText","resultsText"],filtersMobile:["noResultText","resultMobileText","resultsMobileText"],search:["noSearchResultsText","searchResultText","searchResultsText"],searchMobile:["noSearchResultsMobileText","searchResultMobileText","searchResultsMobileText"]},ih=(e,r,t)=>{e.querySelectorAll(`[data-placeholder="${r}"]`).forEach(i=>{i.innerText=t||""})},nh={search:["mobile","tablet"],filter:["mobile","tablet"],sort:!0,result:!0,custom:!1},oh={catalog:"l"},ce,Pt,or=class extends Os{constructor(){super();M(this,ce);M(this,Pt);m(this,"tablet",new Lt(this,I));m(this,"desktop",new Lt(this,_));this.collection=null,T(this,ce,{search:!1,filter:!1,sort:!1,result:!1,custom:!1}),this.updateLiterals=this.updateLiterals.bind(this),this.handleSidenavAttached=this.handleSidenavAttached.bind(this)}connectedCallback(){super.connectedCallback(),this.collection?.addEventListener(ue,this.updateLiterals),this.collection?.addEventListener(Rt,this.handleSidenavAttached),T(this,Pt,customElements.get("merch-card"))}disconnectedCallback(){super.disconnectedCallback(),this.collection?.removeEventListener(ue,this.updateLiterals),this.collection?.removeEventListener(Rt,this.handleSidenavAttached)}willUpdate(){v(this,ce).search=this.getVisibility("search"),v(this,ce).filter=this.getVisibility("filter"),v(this,ce).sort=this.getVisibility("sort"),v(this,ce).result=this.getVisibility("result"),v(this,ce).custom=this.getVisibility("custom")}parseVisibilityOptions(t,a){if(!t||!Object.hasOwn(t,a))return null;let i=t[a];return i===!1?!1:i===!0?!0:i.includes(this.currentMedia)}getVisibility(t){let a=v(this,Pt)?.getCollectionOptions(this.collection?.variant)?.headerVisibility,i=this.parseVisibilityOptions(a,t);return i!==null?i:this.parseVisibilityOptions(nh,t)}get sidenav(){return this.collection?.sidenav}get search(){return this.collection?.search}get resultCount(){return this.collection?.resultCount}get variant(){return this.collection?.variant}get isMobile(){return!this.isTablet&&!this.isDesktop}get isTablet(){return this.tablet.matches&&!this.desktop.matches}get isDesktop(){return this.desktop.matches}get currentMedia(){return this.isDesktop?"desktop":this.isTablet?"tablet":"mobile"}get searchAction(){if(!v(this,ce).search)return ve;let t=Nt(this,"searchText");return t?Re`
            <merch-search deeplink="search" id="search">
                <sp-search
                    id="search-bar"
                    placeholder="${t}"
                    .size=${oh[this.variant]}
                    aria-label="${t}"
                ></sp-search>
            </merch-search>
        `:ve}get filterAction(){return v(this,ce).filter?this.sidenav?Re`
            <sp-action-button
                id="filter"
                variant="secondary"
                treatment="outline"
            ...
            ></sp-action-button>
        `:ve:ve}get sortAction(){if(!v(this,ce).sort)return ve;let t=Nt(this,"sortText");if(!t)return;let a=Nt(this,"popularityText"),i=Nt(this,"alphabeticallyText");if(!(a&&i))return;let n=this.collection?.sort===fe.alphabetical;return Re`
            <sp-action-menu
                id="sort"
                size="m"
        ...
        `}get resultSlotName(){let t=`${this.search?"search":"filters"}${this.isMobile||this.isTablet?"Mobile":""}`;return ah[t][Math.min(this.resultCount,2)]}get resultLabel(){if(!v(this,ce).result)return ve;if(!this.sidenav)return ve;let t=this.search?"search":"filter",a=this.resultCount?this.resultCount===1?"single":"multiple":"none";return Re` <div
            id="result"
            aria-live="polite"
            type=${t}
            quantity=${a}
        ...
        </div>`}get customArea(){if(!v(this,ce).custom)return ve;let t=v(this,Pt)?.getCollectionOptions(this.collection?.variant)?.customHeaderArea;if(!t)return ve;let a=t(this.collection);return!a||a===ve?ve:Re`<div id="custom" role="heading" aria-level="2">
            ${a}
        </div>`}openFilters(t){this.sidenav.showModal(t)}updateLiterals(t){Object.keys(t.detail).forEach(a=>{ih(this,a,t.detail[a])}),this.requestUpdate()}handleSidenavAttached(){this.requestUpdate()}render(){return Re`
            <sp-theme color="light" scale="medium">
                <div id="header">
                    ${this.searchAction}${this.filterAction}${this.sortAction}${this.resultLabel}${this.customArea}
                </div>
            </sp-theme>
        `}get placeholderKeys(){return["searchText","filtersText","sortText","popularityText","alphabeticallyText","noResultText","resultText","resultsText","resultMobileText","resultsMobileText","noSearchResultsText","searchResultText","searchResultsText","noSearchResultsMobileText","searchResultMobileText","searchResultsMobileText"]}};ce=new WeakMap,Pt=new WeakMap,m(or,"styles",Ns`
        :host {
    ...
    `);customElements.define("merch-card-collection-header",or);export{_t as MerchCardCollection,or as default};
