var Nr=Object.defineProperty;var Ir=a=>{throw TypeError(a)};var Bi=(a,r,e)=>r in a?Nr(a,r,{enumerable:!0,configurable:!0,writable:!0,value:e}):a[r]=e;var qi=(a,r)=>()=>(a&&(r=a(a=0)),r);var Ui=(a,r)=>{for(var e in r)Nr(a,e,{get:r[e],enumerable:!0})};var h=(a,r,e)=>Bi(a,typeof r!="symbol"?r+"":r,e),ir=(a,r,e)=>r.has(a)||Ir("Cannot "+e);var s=(a,r,e)=>(ir(a,r,"read from private field"),e?e.call(a):r.get(a)),g=(a,r,e)=>r.has(a)?Ir("Cannot add the same private member more than once"):r instanceof WeakSet?r.add(a):r.set(a,e),m=(a,r,e,t)=>(ir(a,r,"write to private field"),t?t.call(a,e):r.set(a,e),e),w=(a,r,e)=>(ir(a,r,"access private method"),e);var Fr=(a,r,e,t)=>({set _(i){m(a,r,i,e)},get _(){return s(a,r,t)}});var nr={};Ui(nr,{default:()=>it});import{LitElement as ji,html as ze,css as Gi,nothing as Vi}from"./lit-all.min.js";import{unsafeHTML as Gr}from"./lit-all.min.js";import{ifDefined as Wi}from"./lit-all.min.js";function Ki(){return customElements.get("sp-tooltip")!==void 0&&customElements.get("overlay-trigger")!==void 0&&document.querySelector("sp-theme")!==null}var N,it,or=qi(()=>{N=class N extends ji{constructor(){super(),this.content="",this.placement="top",this.variant="",this.size="xs",this.smartPlacement=!1,this.tooltipVisible=!1,this.lastPointerType=null,this.handleClickOutside=this.handleClickOutside.bind(this),this._tooltipTop=0,this._tooltipLeft=0,this._arrowOffset=0,this._computedPlacement="top"}connectedCallback(){super.connectedCallback(),window.addEventListener("mousedown",this.handleClickOutside),!this.smartPlacement&&this.closest('merch-card[variant="fries"]')&&(this.smartPlacement=!0)}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener("mousedown",this.handleClickOutside)}handleClickOutside(r){let e=r.composedPath();N.activeTooltip===this&&!e.includes(this)&&this.hideTooltip()}_computeTooltipPosition(){let r=this.shadowRoot?.querySelector(".css-tooltip");if(!r)return;let e=r.getBoundingClientRect(),t=window.innerWidth,i=window.innerHeight,n=14,o=200,c=60,l=this.shadowRoot?.querySelector(".css-tooltip-body"),d=l?l.offsetWidth:o,p=l?l.offsetHeight:c,f=this.effectivePlacement;f==="top"&&e.top-p-n<0?f="bottom":f==="bottom"&&e.bottom+p+n>i?f="top":f==="left"&&e.left-d-n<0?f="right":f==="right"&&e.right+d+n>t&&(f="left");let k=e.left+e.width/2,x=e.top+e.height/2,T=6,H=(Fi,$i,Hi)=>Math.max(Fi,Math.min($i,Hi)),B,_t,ar;f==="top"||f==="bottom"?(B=f==="top"?e.top-p-n:e.bottom+n,_t=H(0,t-d,k-d/2),ar=H(T,d-T*2,k-_t-T)):(_t=f==="left"?e.left-d-n:e.right+n,B=H(0,i-p,x-p/2),ar=H(T,p-T*2,x-B-T)),this._tooltipTop=B,this._tooltipLeft=_t,this._arrowOffset=ar,this._computedPlacement=f}showTooltip(){N.activeTooltip&&N.activeTooltip!==this&&(N.activeTooltip.closeOverlay(),N.activeTooltip.tooltipVisible=!1,N.activeTooltip.requestUpdate()),N.activeTooltip=this,this.smartPlacement&&this._computeTooltipPosition(),this.tooltipVisible=!0,this.smartPlacement&&this.updateComplete.then(()=>this._computeTooltipPosition())}hideTooltip(){N.activeTooltip===this&&(N.activeTooltip=null),this.tooltipVisible=!1}handleTap(r){r.preventDefault(),this.tooltipVisible?this.hideTooltip():this.showTooltip()}closeOverlay(){let r=this.shadowRoot?.querySelector("overlay-trigger");r?.open!==void 0&&(r.open=!1)}get effectiveContent(){return this.tooltipText||this.mnemonicText||this.content||this.textContent?.trim()||""}get effectivePlacement(){return this.tooltipPlacement||this.mnemonicPlacement||this.placement||"top"}renderIcon(){return this.src?ze`<merch-icon
            src="${this.src}"
            size="${this.size}"
        ></merch-icon>`:ze`<slot></slot>`}render(){let r=this.effectiveContent,e=this.effectivePlacement;if(!r)return ze`<span class="icon-only">${this.renderIcon()}</span>`;if(Ki())return ze`
                <overlay-trigger
                    placement="${e}"
            ...
            `;let i=r.replace(/<[^>]*>/g,""),n=this.tooltipVisible?"tooltip-visible":"",o={pointerdown:u=>{this.lastPointerType=u.pointerType},pointerenter:u=>u.pointerType!=="touch"&&this.showTooltip(),pointerleave:u=>u.pointerType!=="touch"&&this.hideTooltip(),click:u=>{this.lastPointerType==="touch"&&this.handleTap(u),this.lastPointerType=null}},c=this._computedPlacement,l=c==="top"||c==="bottom",d=this.smartPlacement?`top:${this._tooltipTop}px;left:${this._tooltipLeft}px;`:void 0,p=l?`left:${this._arrowOffset}px`:`top:${this._arrowOffset}px`;return ze`
            <span
            ...
            >
                ${this.renderIcon()}
                <span class="css-tooltip-body" style=${Wi(d)}>
                    ${Gr(r)}
                    ${this.smartPlacement?ze`<span
                              aria-hidden="true"
                              role="presentation"
    ...
    `);it=N;customElements.define("mas-mnemonic",it)});import{LitElement as Qo}from"./lit-all.min.js";import{css as qr,unsafeCSS as Br}from"./lit-all.min.js";var S="(max-width: 767px)",z="(max-width: 1199px)",E="(min-width: 768px)",b="(min-width: 1200px)",R="(min-width: 1600px)",$r="(min-width: 1280px)",Hr={matchMobile:window.matchMedia(S),matchDesktop:window.matchMedia(`${b} and (not ${R})`),matchDesktopOrUp:window.matchMedia(b),matchLargeDesktop:window.matchMedia(R),get isMobile(){return this.matchMobile.matches},get isDesktop(){return this.matchDesktop.matches},get isDesktopOrUp(){return this.matchDesktopOrUp.matches}},y=Hr;function Mt(){return Hr.isDesktop}var Ur=qr`
    :host {
...
`,jr=()=>[qr`
        ...
        `];import{LitElement as Yi,html as Vr,css as Qi}from"./lit-all.min.js";function Zi(){return customElements.get("sp-tooltip")!==void 0||document.querySelector("sp-theme")!==null}var Pe=class extends Yi{constructor(){super(),this.size="m",this.alt="",this.loading="lazy"}connectedCallback(){super.connectedCallback(),setTimeout(()=>this.handleTooltips(),0)}handleTooltips(){if(Zi())return;this.querySelectorAll("sp-tooltip, overlay-trigger").forEach(e=>{let t="",i="top";if(e.tagName==="SP-TOOLTIP")t=e.textContent,i=e.getAttribute("placement")||"top";else if(e.tagName==="OVERLAY-TRIGGER"){let n=e.querySelector("sp-tooltip");n&&(t=n.textContent,i=n.getAttribute("placement")||e.getAttribute("placement")||"top")}if(t){let n=document.createElement("mas-mnemonic");n.setAttribute("content",t),n.setAttribute("placement",i);let o=this.querySelector("img"),c=this.querySelector("a");c&&c.contains(o)?n.appendChild(c):o&&n.appendChild(o),this.innerHTML="",this.appendChild(n),Promise.resolve().then(()=>or())}e.remove()})}render(){let{href:r}=this;return r?Vr`<a href="${r}">
                  ...
                  alt="${this.alt}"
                  loading="${this.loading}"
              />`}};h(Pe,"properties",{size:{type:String,attribute:!0},src:{type:String,attribute:!0},alt:{type:String,attribute:!0},href:{type:String,attribute:!0},loading:{type:String,attribute:!0}}),h(Pe,"styles",Qi`
        :host {
            --img-width: 32px;
            --img-height: 32px;
            display: block;
    ...
    `);customElements.define("merch-icon",Pe);var hc=Object.freeze({MONTH:"MONTH",YEAR:"YEAR",TWO_YEARS:"TWO_YEARS",THREE_YEARS:"THREE_YEARS",PERPETUAL:"PERPETUAL",TERM_LICENSE:"TERM_LICENSE",ACCESS_PASS:"ACCESS_PASS",THREE_MONTHS:"THREE_MONTHS",SIX_MONTHS:"SIX_MONTHS"}),pc=Object.freeze({ANNUAL:"ANNUAL",MONTHLY:"MONTHLY",TWO_YEARS:"TWO_YEARS",THREE_YEARS:"THREE_YEARS",P1D:"P1D",P1Y:"P1Y",P3Y:"P3Y",P10Y:"P10Y",P15Y:"P15Y",P3D:"P3D",P7D:"P7D",P30D:"P30D",HALF_YEARLY:"HALF_YEARLY",QUARTERLY:"QUARTERLY"});var _e=2e4;var C='span[is="inline-price"][data-wcs-osi]',ae='a[is="checkout-link"][data-wcs-osi],button[is="checkout-button"][data-wcs-osi]';var Xi='a[is="upt-link"]',Wr=`${C},${ae},${Xi}`;var Kr="merch-offer-select:ready",Yr="merch-card:action-menu-toggle";var O="merch-quantity-selector:change",nt="merch-card-quantity:change",cr="merch-modal:addon-and-quantity-update";var Me="merch-card-collection:literals-changed";var Re="aem:load",Oe="aem:error",fe="mas:ready",Qr="mas:error";var Zr="placeholder-failed",Xr="placeholder-pending",Jr="placeholder-resolved";var ea="mas:failed",G="mas:resolved",ta="mas/commerce";var se="failed",ve="pending",le="resolved";var Rt="X-Request-Id",mc=Object.freeze({SEGMENTATION:"segmentation",BUNDLE:"bundle",COMMITMENT:"commitment",RECOMMENDATION:"recommendation",EMAIL:"email",PAYMENT:"payment",CHANGE_PLAN_TEAM_PLANS:"change-plan/team-upgrade/plans",CHANGE_PLAN_TEAM_PAYMENT:"change-plan/team-upgrade/payment"});var gc=Object.freeze({STAGE:"STAGE",PRODUCTION:"PRODUCTION",LOCAL:"LOCAL"});var Ot=":start",Dt=":duration";var D="legal",ra="mas-ff-defaults";var Ji="mas-commerce-service";function aa(a,r){let e;return function(){let t=this,i=arguments;clearTimeout(e),e=setTimeout(()=>a.apply(t,i),r)}}function M(a,r={},e=null,t=null){let i=t?document.createElement(a,{is:t}):document.createElement(a);e instanceof HTMLElement?i.appendChild(e):i.innerHTML=e;for(let[n,o]of Object.entries(r))i.setAttribute(n,o);return i}function De(a){return`startTime:${a.startTime.toFixed(2)}|duration:${a.duration.toFixed(2)}`}function sr(){return window.matchMedia("(max-width: 1024px)").matches}function be(){return document.getElementsByTagName(Ji)?.[0]}function ot(a){let r=window.getComputedStyle(a);return a.offsetHeight+parseFloat(r.marginTop)+parseFloat(r.marginBottom)}function ia(a){let r=a.nextElementSibling?.nodeName==="BR"?a.nextElementSibling.nextElementSibling:a.nextElementSibling;return a.dataset.template==="strikethrough"&&(a.nextSibling?.nodeName!=="#text"||a.nextSibling.textContent.trim().length<2)&&r?.isInlinePrice&&r?.dataset?.template==="price"}var en=/^([a-z0-9]+(-[a-z0-9]+)*)(--([a-z0-9]+(-[a-z0-9]+)*)){0,2}$/,tn=100,rn=["live","page"];function na(a,r="live"){if(!a||a.trim()===""||!rn.includes(r))return null;let e=a.trim().toLowerCase();if(e==="local")return"http://localhost:3000";if(e.length>tn||!en.test(e))return null;let t=e.includes("--")?e:`${e}--mas--adobecom`,i;try{i=new URL(`https://${t}.aem.${r}`)}catch{return null}return i.hostname.endsWith(`.aem.${r}`)?i.origin:null}var ct,xe,st,lt,Ne,Nt=class extends HTMLElement{constructor(){super();g(this,ct,"");g(this,xe);g(this,st,[]);g(this,lt,[]);g(this,Ne);m(this,Ne,aa(()=>{this.isConnected&&(this.parentElement.style.background=this.value,s(this,xe)?this.parentElement.style.borderRadius=s(this,xe):s(this,xe)===""&&(this.parentElement.style.borderRadius=""))},1))}static get observedAttributes(){return["colors","positions","angle","border-radius"]}get value(){let e=s(this,st).map((t,i)=>{let n=s(this,lt)[i]||"";return`${t} ${n}`}).join(", ");return`linear-gradient(${s(this,ct)}, ${e})`}connectedCallback(){s(this,Ne).call(this)}attributeChangedCallback(e,t,i){e==="border-radius"&&m(this,xe,i?.trim()),e==="colors"&&i?m(this,st,i?.split(",").map(n=>n.trim())??[]):e==="positions"&&i?m(this,lt,i?.split(",").map(n=>n.trim())??[]):e==="angle"&&m(this,ct,i?.trim()??""),s(this,Ne).call(this)}};ct=new WeakMap,xe=new WeakMap,st=new WeakMap,lt=new WeakMap,Ne=new WeakMap;customElements.define("merch-gradient",Nt);import{LitElement as an,html as nn,css as on}from"./lit-all.min.js";var Ie=class extends an{constructor(){super(),this.planType=void 0,this.checked=!1,this.updatePlanType=this.updatePlanType.bind(this),this.handleChange=this.handleChange.bind(this),this.handleCustomClick=this.handleCustomClick.bind(this)}getOsi(r,e){let n=({TRIAL:["TRIAL"],BASE:["BASE","PROMOTION","TRIAL"],PROMOTION:["PROMOTION","BASE","TRIAL"]}[e]||[e]).map(c=>`p[data-plan-type="${r}"] ${C}[data-offer-type="${c}"]`).join(", ");return this.querySelector(n)?.dataset?.wcsOsi}connectedCallback(){super.connectedCallback(),this.addEventListener(G,this.updatePlanType),this.background&&this.style.setProperty("--merch-addon-background",this.background)}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener(G,this.updatePlanType)}updatePlanType(r){if(r.target.tagName!=="SPAN")return;let e=r.target,t=e?.value?.[0];if(!t)return;e.setAttribute("data-offer-type",t.offerType);let i=e.closest("p");if(i.getAttribute("data-plan-type"))return;let n=this.querySelector(`p[data-plan-type="${t.planType}"]`);n&&n!==i||i.setAttribute("data-plan-type",t.planType)}handleChange(r){this.checked=r.target.checked,this.dispatchEvent(new CustomEvent("change",{detail:{checked:this.checked},bubbles:!0,composed:!0}))}handleCustomClick(){this.shadowRoot.querySelector("input").click()}handleKeyDown(r){r.key===" "&&(r.preventDefault(),this.handleCustomClick())}render(){return nn` <input
                type="checkbox"
                id="addon-checkbox"
            ...
            <label id="custom-checkbox-label" for="addon-checkbox">
                <slot></slot>
            </label>`}};h(Ie,"properties",{planType:{type:String,attribute:"plan-type",reflect:!0},checked:{type:Boolean,reflect:!0},customCheckbox:{type:Boolean,attribute:"custom-checkbox",reflect:!0},background:{type:String,attribute:"background"}}),h(Ie,"styles",on`
        :host {
            --merch-addon-gap: 9px;
    ...
    `);customElements.define("merch-addon",Ie);import{html as It,nothing as cn}from"./lit-all.min.js";var Fe,dt=class dt{constructor(r){h(this,"card");g(this,Fe);this.card=r,this.insertVariantStyle()}getContainer(){return m(this,Fe,s(this,Fe)??this.card.closest('merch-card-collection, [class*="-merch-cards"]')??this.card.parentElement),s(this,Fe)}insertVariantStyle(){let r=this.constructor.name;if(!dt.styleMap[r]){dt.styleMap[r]=!0;let e=document.createElement("style");e.innerHTML=this.getGlobalCSS(),document.head.appendChild(e)}}updateCardElementMinHeight(r,e){if(!r||this.card.heightSync===!1)return;let t=`--consonant-merch-card-${this.card.variant}-${e}-height`,i=Math.max(0,parseInt(window.getComputedStyle(r).height)||0),n=this.getContainer(),o=parseInt(n.style.getPropertyValue(t))||0;i>o&&n.style.setProperty(t,`${i}px`)}syncRowHeights(r){if(this.card.heightSync===!1)return;let e=this.getContainer();if(!e)return;let t=this.card.variant,i=Array.from(e.querySelectorAll(`merch-card[variant="${t}"]`)).filter(o=>o.variantLayout?.card?.heightSync!==!1);if(i.length===0)return;for(let{name:o}of r){let c=`--consonant-merch-card-${t}-${o}-height`;e.style.getPropertyValue(c)&&e.style.removeProperty(c)}let n=new Map;for(let o of i){let c=o.getBoundingClientRect();if(c.width<=2)continue;let l=Math.round(c.top),d=n.get(l);d||(d=[],n.set(l,d)),d.push(o)}for(let o of n.values())for(let{name:c,getElement:l}of r){let d=`--consonant-merch-card-${t}-${c}-height`,p=o.map(f=>f.style.getPropertyValue(d)),u=0;for(let f of o){f.style.removeProperty(d);let k=l(f);if(!k)continue;let x=Math.max(0,parseInt(window.getComputedStyle(k).height)||0);x>u&&(u=x)}o.forEach((f,k)=>{u>0?f.style.setProperty(d,`${u}px`):p[k]&&f.style.setProperty(d,p[k])})}}get legalDisplayDot(){return!0}get badge(){let r;if(!(!this.card.badgeBackgroundColor||!this.card.badgeColor||!this.card.badgeText))return this.evergreen&&(r=`border: 1px solid ${this.card.badgeBackgroundColor}; border-right: none;`),It`
            <div
                id="badge"
        ...
        `}get cardImage(){return It` <div class="image">
            ...
            ${this.badge}
              ...
              >`:cn}get secureLabelFooter(){return It`<footer>
            ${this.secureLabel}<slot name="footer"></slot>
        </footer>`}async postCardUpdateHook(){if(this.card.isConnected&&(await this.card.updateComplete,this.card.prices?.length>0)){let r=Promise.allSettled(this.card.prices.map(i=>i.onceSettled?.()||Promise.resolve())),e,t=new Promise(i=>{e=setTimeout(i,_e)});await Promise.race([r,t]),clearTimeout(e)}}connectedCallbackHook(){}disconnectedCallbackHook(){}syncHeights(){}renderLayout(){}get aemFragmentMapping(){return Ft(this.card.variant)}};Fe=new WeakMap,h(dt,"styleMap",{});var v=dt;import{html as lr,css as sn}from"./lit-all.min.js";var oa=`
:root {
...
merch-card[variant="catalog"] [slot="footer"] .spectrum-Link--primary {
  ...
  font-weight: 700;
            ...
            <slot></slot>`}getGlobalCSS(){return oa}setAriaExpanded(e,t){e.setAttribute("aria-expanded",t)}connectedCallbackHook(){this.card.addEventListener("mouseenter",this.showActionMenuOnHover),this.card.addEventListener("mouseleave",this.toggleActionMenuFromCard),this.card.addEventListener("focusin",this.showActionMenuOnHover),this.card.addEventListener("focusout",this.handleCardFocusOut),this.card.addEventListener("keydown",this.handleKeyDown)}disconnectedCallbackHook(){this.card.removeEventListener("mouseenter",this.showActionMenuOnHover),this.card.removeEventListener("mouseleave",this.toggleActionMenuFromCard),this.card.removeEventListener("focusin",this.showActionMenuOnHover),this.card.removeEventListener("focusout",this.handleCardFocusOut),this.card.removeEventListener("keydown",this.handleKeyDown)}};h($e,"variantStyle",sn`
    ...
    `);import{html as ht,css as ln}from"./lit-all.min.js";var sa=`
:root {
...
`;var la={cardName:{attribute:"name"},badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300-plans"},badgeIcon:!0,borderColor:{attribute:"border-color"},allowedBadgeColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-gray-700-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],allowedBorderColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],ctas:{slot:"footer",size:"m"},description:{tag:"div",slot:"body-xs"},mnemonics:{size:"l"},prices:{tag:"h3",slot:"heading-xs"},promoText:{tag:"p",slot:"promo-text"},size:["wide","super-wide"],title:{tag:"h3",slot:"heading-xs"},subtitle:{tag:"p",slot:"body-xxs"},backgroundImage:{tag:"div",slot:"bg-image"}},ye=class extends v{constructor(r){super(r)}getGlobalCSS(){return sa}renderLayout(){return ht`<div class="image">
                <slot name="bg-image"></slot>
            ...
            <div class="body">
                ...
                <slot name="heading-xs"></slot>
                <slot name="body-xxs"></slot>
                ${this.promoBottom?ht`<slot name="body-xs"></slot
                          ><slot name="promo-text"></slot>`:ht`<slot name="promo-text"></slot
                          ><slot name="body-xs"></slot>`}
            </div>
            ${this.evergreen?ht`
                      <div
    ...
    `);import{html as ha}from"./lit-all.min.js";var da=`
:root {
...
`;var $t=class extends v{constructor(r){super(r)}getGlobalCSS(){return da}renderLayout(){return ha` ${this.badge}
            <div class="body">
                <div class="top-section">
                    <slot name="icons"></slot>
                    <slot name="heading-xs"></slot>
            ...
            ${this.card.customHr?"":ha`<hr />`} ${this.secureLabelFooter}`}};import{html as de,css as dn,unsafeCSS as ma}from"./lit-all.min.js";var pa=`
  :root {
...
`;var hn=32,ga={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},subtitle:{tag:"p",slot:"subtitle"},prices:{tag:"p",slot:"heading-m-price"},promoText:{tag:"div",slot:"promo-text"},shortDescription:{tag:"div",slot:"body-xxs"},description:{tag:"div",slot:"body-m"},mnemonics:{size:"l"},quantitySelect:{tag:"div",slot:"quantity-select"},callout:{tag:"div",slot:"callout-content"},addon:!0,secureLabel:!0,planType:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300-plans"},allowedBadgeColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-gray-700-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],allowedBorderColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],whatsIncludedDividerColor:{attribute:"whats-included-divider-color"},allowedWhatsIncludedDividerColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],borderColor:{attribute:"border-color"},size:["wide","super-wide"],whatsIncluded:{tag:"div",slot:"footer-rows"},ctas:{slot:"footer",size:"l"},style:"consonant"},He=class extends v{constructor(e){super(e);h(this,"getRowMinHeightPropertyName",e=>`--consonant-merch-card-footer-row-${e}-min-height`);h(this,"getMiniCompareFooter",()=>{let e=this.card.secureLabel?de`<slot name="secure-transaction-label">
    ...
    `);import{html as Ht,css as pn,unsafeCSS as dr,nothing as mn}from"./lit-all.min.js";var ua=`
  :root {
...
`;var gn=32,fa={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},subtitle:{tag:"p",slot:"subtitle"},prices:{tag:"p",slot:"heading-m-price"},promoText:{tag:"div",slot:"promo-text"},shortDescription:{tag:"div",slot:"body-m"},description:{tag:"div",slot:"body-xs"},mnemonics:{size:"l"},secureLabel:!0,planType:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300-plans"},allowedBadgeColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-gray-700-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],allowedBorderColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],borderColor:{attribute:"border-color"},size:["wide","super-wide"],ctas:{slot:"footer",size:"l"},style:"consonant"},X,Be=class extends v{constructor(e){super(e);g(this,X);h(this,"getRowMinHeightPropertyName",e=>`--consonant-merch-card-footer-row-${e}-min-height`);h(this,"getMiniCompareFooter",()=>Ht` <footer>
        ...
        </div>`);this.updatePriceQuantity=this.updatePriceQuantity.bind(this)}connectedCallbackHook(){this.card.addEventListener(O,this.updatePriceQuantity)}disconnectedCallbackHook(){this.card.removeEventListener(O,this.updatePriceQuantity),this._syncObserver?.disconnect(),this._syncObserver=null,s(this,X)?.disconnect(),m(this,X,null)}updatePriceQuantity({detail:e}){!this.mainPrice||!e?.option||(this.mainPrice.dataset.quantity=e.option)}syncHeights(){if(this.card.getBoundingClientRect().width<=2){s(this,X)||(m(this,X,new ResizeObserver(()=>{this.card.getBoundingClientRect().width>2&&(s(this,X)?.disconnect(),m(this,X,null),this.syncHeights())})),s(this,X).observe(this.card));return}let e=["heading-xs","subtitle","heading-m-price","promo-text","body-m","body-xs"];this.syncRowHeights(e.map(t=>({name:t,getElement:i=>i.querySelector(`[slot="${t}"]`)}))),this.adjustMiniCompareFooterRows()}priceOptionsProvider(e,t){if(e.dataset.template===D){t.displayPlanType=this.card?.settings?.displayPlanType??!1;return}(e.dataset.template==="strikethrough"||e.dataset.template==="price")&&(t.displayPerUnit=!1)}getGlobalCSS(){return ua}adjustMiniCompareBodySlots(){if(this.card.getBoundingClientRect().width<=2){this._syncObserver||(this._syncObserver=new ResizeObserver(()=>{this.card.getBoundingClientRect().width>2&&(this._syncObserver?.disconnect(),this._syncObserver=null,this.adjustMiniCompareBodySlots(),this.adjustMiniCompareFooterRows())}),this._syncObserver.observe(this.card));return}["heading-xs","subtitle","heading-m-price","price-wrapping","promo-text","body-m","body-xs","footer-rows"].forEach(t=>{let n=this.card.querySelector(`[slot="${t}"]`)??this.card.shadowRoot.querySelector(`slot[name="${t}"]`);this.updateCardElementMinHeight(n,t)}),[['slot[name="promo-text"]',"promo-text"],["footer","footer"]].forEach(([t,i])=>{this.updateCardElementMinHeight(this.card.shadowRoot.querySelector(t),i)})}adjustMiniCompareFooterRows(){if(this.card.getBoundingClientRect().width===0)return;let e=this.card.querySelector('[slot="footer-rows"] ul');!e||!e.children||[...e.children].forEach((t,i)=>{let n=Math.max(gn,parseFloat(window.getComputedStyle(t).height)||0),o=parseFloat(this.getContainer().style.getPropertyValue(this.getRowMinHeightPropertyName(i+1)))||0;n>o&&this.getContainer().style.setProperty(this.getRowMinHeightPropertyName(i+1),`${n}px`)})}removeEmptyRows(){this.card.querySelectorAll(".footer-row-cell").forEach(t=>{let i=t.querySelector(".footer-row-cell-description");i&&!i.textContent.trim()&&t.remove()})}setupToggle(){if(this.toggleSetupDone)return;let e=this.card.querySelector('[slot="body-xs"]');if(!e)return;let t=e.querySelector("p"),i=e.querySelector("ul");if(!t||!i||e.querySelector(".footer-rows-title"))return;this.toggleSetupDone=!0;let n=t.textContent.trim(),o=this.card.querySelector("h3")?.id,c=o?`${o}-list`:`mweb-list-${Date.now()}`;i.setAttribute("id",c),i.classList.add("checkmark-copy-container");let l=M("h4",{class:"footer-rows-title"},n);if(y.isMobile){let d=M("button",{class:"toggle-icon","aria-label":n,"aria-expanded":"false","aria-controls":c});l.appendChild(d),l.addEventListener("click",()=>{let p=i.classList.toggle("open");d.classList.toggle("expanded",p),d.setAttribute("aria-expanded",String(p))})}else i.classList.add("open");t.replaceWith(l)}get legalDisplayDot(){return!1}get mainPrice(){return this.card.querySelector(`[slot="heading-m-price"] ${C}[data-template="price"]`)}async adjustLegal(){if(!this.legalAdjusted)try{this.legalAdjusted=!0,await this.card.updateComplete,await customElements.whenDefined("inline-price");let e=this.mainPrice;if(!e)return;let t=e.cloneNode(!0);if(await e.onceSettled(),!e?.options)return;e.options.displayPerUnit&&(e.dataset.displayPerUnit="false"),e.options.displayTax&&(e.dataset.displayTax="false"),e.options.displayPlanType&&(e.dataset.displayPlanType="false"),t.setAttribute("data-template","legal"),e.parentNode.insertBefore(t,e.nextSibling),await t.onceSettled()}catch{}}get icons(){return!this.card.querySelector('[slot="icons"]')&&!this.card.getAttribute("id")?mn:Ht`<slot name="icons"></slot>`}renderLayout(){return Ht`
            ${this.badge}
            <div class="body">
                <div class="body-main">
                    ${this.icons}
        ...
        `}async postCardUpdateHook(){if(this.legalAdjusted||await this.adjustLegal(),this.setupToggle(),y.isMobile&&this.removeEmptyRows(),await super.postCardUpdateHook(),window.matchMedia("(min-width: 768px)").matches){let e=this.card.parentElement,t=Array.from(e.querySelectorAll(`merch-card[variant="${this.card.variant}"]`));await Promise.all(t.map(i=>i.updateComplete)),await new Promise(i=>setTimeout(i,100)),this.card===e.firstElementChild&&requestAnimationFrame(()=>{this.syncHeights()})}}};X=new WeakMap,h(Be,"variantStyle",pn`
        ...
        @media screen and ${dr(b)} {
            :host([variant='mini-compare-chart-mweb']) footer {
                padding: 0;
            }
        }

        @media screen and ${dr(E)} {
            :host([variant='mini-compare-chart-mweb'])
                .price-wrapping
                > slot[name='subtitle'] {
                min-height: var(
    ...
    `);import{html as pt,css as un,nothing as Bt}from"./lit-all.min.js";var va=`
:root {
...
`;var qt={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},subtitle:{tag:"p",slot:"subtitle"},prices:{tag:"p",slot:"heading-m"},promoText:{tag:"p",slot:"promo-text"},description:{tag:"div",slot:"body-xs"},mnemonics:{size:"l"},callout:{tag:"div",slot:"callout-content"},quantitySelect:{tag:"div",slot:"quantity-select"},addon:!0,secureLabel:!0,planType:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300-plans"},allowedBadgeColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-gray-700-plans","spectrum-green-900-plans","gradient-purple-blue"],allowedBorderColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-green-900-plans","gradient-purple-blue"],borderColor:{attribute:"border-color"},size:["wide","super-wide"],whatsIncluded:{tag:"div",slot:"whats-included"},ctas:{slot:"footer",size:"m"},style:"consonant",perUnitLabel:{tag:"span",slot:"per-unit-label"}},ba={...function(){let{whatsIncluded:a,size:r,...e}=qt;return e}(),title:{tag:"h3",slot:"heading-s"},secureLabel:!1},xa={...function(){let{subtitle:a,whatsIncluded:r,size:e,quantitySelect:t,...i}=qt;return i}()},J,ee,I=class extends v{constructor(e){super(e);g(this,J);g(this,ee);this.adaptForMedia=this.adaptForMedia.bind(this)}priceOptionsProvider(e,t){e.dataset.template===D&&(t.displayPlanType=this.card?.settings?.displayPlanType??!1)}getGlobalCSS(){return va}adjustSlotPlacement(e,t,i){let n=this.card.shadowRoot,o=n.querySelector("footer"),c=this.card.getAttribute("size");if(!c)return;let l=n.querySelector(`footer slot[name="${e}"]`),d=n.querySelector(`.body slot[name="${e}"]`),p=n.querySelector(".body");if(c.includes("wide")||(o?.classList.remove("wide-footer"),l&&l.remove()),!!t.includes(c)){if(o?.classList.toggle("wide-footer",y.isDesktopOrUp),!i&&l){if(d)l.remove();else{let u=p.querySelector(`[data-placeholder-for="${e}"]`);u?u.replaceWith(l):p.appendChild(l)}return}if(i&&d){let u=document.createElement("div");if(u.setAttribute("data-placeholder-for",e),u.classList.add("slot-placeholder"),!l){let f=d.cloneNode(!0);o.prepend(f)}d.replaceWith(u)}}}adaptForMedia(){if(!this.card.closest("merch-card-collection,overlay-trigger,.two-merch-cards,.three-merch-cards,.four-merch-cards, .columns")){this.card.removeAttribute("size");return}this.adjustSlotPlacement("addon",["super-wide"],y.isDesktopOrUp),this.adjustSlotPlacement("callout-content",["super-wide"],y.isDesktopOrUp)}adjustCallout(){let e=this.card.querySelector('[slot="callout-content"] .icon-button');e&&e.title&&(e.dataset.tooltip=e.title,e.removeAttribute("title"),e.classList.add("hide-tooltip"),document.addEventListener("touchstart",t=>{t.preventDefault(),t.target!==e?e.classList.add("hide-tooltip"):t.target.classList.toggle("hide-tooltip")}),document.addEventListener("mouseover",t=>{t.preventDefault(),t.target!==e?e.classList.add("hide-tooltip"):t.target.classList.remove("hide-tooltip")}))}syncHeights(){if(this.card.getBoundingClientRect().width<=2){s(this,J)||(m(this,J,new ResizeObserver(()=>{this.card.getBoundingClientRect().width>2&&(s(this,J)?.disconnect(),m(this,J,null),this.syncHeights())})),s(this,J).observe(this.card));return}let e=["heading-xs","subtitle","heading-m","promo-text","body-xs"];this.syncRowHeights(e.map(t=>({name:t,getElement:i=>i.querySelector(`[slot="${t}"]`)})))}async adjustEduLists(){if(this.card.variant!=="plans-education"||this.card.querySelector(".spacer"))return;let t=this.card.querySelector('[slot="body-xs"]');if(!t)return;let i=t.querySelector("ul");if(!i)return;let n=i.previousElementSibling,o=document.createElement("div");o.classList.add("spacer"),t.insertBefore(o,n);let c=new IntersectionObserver(([l])=>{if(l.boundingClientRect.height===0)return;let d=0,p=this.card.querySelector('[slot="heading-s"]');p&&(d+=ot(p));let u=this.card.querySelector('[slot="subtitle"]');u&&(d+=ot(u));let f=this.card.querySelector('[slot="heading-m"]');f&&(d+=8+ot(f));for(let x of t.childNodes){if(x.classList.contains("spacer"))break;d+=ot(x)}let k=this.card.parentElement.style.getPropertyValue("--merch-card-plans-edu-list-max-offset");d>(parseFloat(k)||0)&&this.card.parentElement.style.setProperty("--merch-card-plans-edu-list-max-offset",`${d}px`),this.card.style.setProperty("--merch-card-plans-edu-list-offset",`${d}px`),c.disconnect()});c.observe(this.card)}async postCardUpdateHook(){this.adaptForMedia(),this.adjustAddon(),this.adjustCallout(),this.legalAdjusted||(await this.adjustLegal(),await this.adjustEduLists()),await super.postCardUpdateHook(),window.matchMedia("(min-width: 768px)").matches&&this.card===this.card.parentElement.firstElementChild&&requestAnimationFrame(()=>{this.syncHeights()})}get headingM(){return this.card.querySelector('[slot="heading-m"]')}get mainPrice(){return this.headingM?.querySelector(`${C}[data-template="price"]`)}get divider(){return this.card.variant==="plans-education"?pt`<div class="divider"></div>`:Bt}async adjustLegal(){if(!this.legalAdjusted)try{this.legalAdjusted=!0,await this.card.updateComplete,await customElements.whenDefined("inline-price");let e=[],t=this.card.querySelector(`[slot="heading-m"] ${C}[data-template="price"]`);t&&e.push(t);let i=e.map(async n=>{let o=n.cloneNode(!0);await n.onceSettled(),n?.options&&(n.options.displayPerUnit&&(n.dataset.displayPerUnit="false"),n.options.displayTax&&(n.dataset.displayTax="false"),n.options.displayPlanType&&(n.dataset.displayPlanType="false"),o.setAttribute("data-template","legal"),n.parentNode.insertBefore(o,n.nextSibling),await o.onceSettled())});await Promise.all(i)}catch{}}async adjustAddon(){await this.card.updateComplete;let e=this.card.addon;if(!e)return;e.setAttribute("custom-checkbox","");let t=this.mainPrice;if(!t)return;await t.onceSettled?.();let i=t.value?.[0]?.planType;i&&(e.planType=i)}get stockCheckbox(){return this.card.checkboxLabel?pt`<label id="stock-checkbox">
                <input type="checkbox" @change=${this.card.toggleStockOffer}></input>
                <span></span>
                ${this.card.checkboxLabel}
            </label>`:Bt}get icons(){return!this.card.querySelector('[slot="icons"]')&&!this.card.getAttribute("id")?Bt:pt`<slot name="icons"></slot>`}resizeHandler(){s(this,ee)&&cancelAnimationFrame(s(this,ee)),m(this,ee,requestAnimationFrame(()=>{m(this,ee,null),window.matchMedia("(min-width: 768px)").matches&&this.syncHeights()}))}connectedCallbackHook(){y.matchMobile.addEventListener("change",this.adaptForMedia),y.matchDesktopOrUp.addEventListener("change",this.adaptForMedia)}disconnectedCallbackHook(){y.matchMobile.removeEventListener("change",this.adaptForMedia),y.matchDesktopOrUp.removeEventListener("change",this.adaptForMedia),s(this,J)?.disconnect(),m(this,J,null),s(this,ee)&&(cancelAnimationFrame(s(this,ee)),m(this,ee,null))}renderLayout(){return pt` ${this.badge}
            <div class="body">
                ${this.icons}
                <slot name="heading-xs"></slot>
            ...
            ${this.secureLabelFooter}
            <slot></slot>`}};J=new WeakMap,ee=new WeakMap,h(I,"variantStyle",un`
        :host([variant^='plans']) {
            min-height: 273px;
    ...
    `),h(I,"collectionOptions",{customHeaderArea:e=>e.sidenav?pt`<slot name="resultsText"></slot>`:Bt,headerVisibility:{search:!1,sort:!1,result:["mobile","tablet"],custom:["desktop"]},onSidenavAttached:e=>{let t=()=>{let i=e.querySelectorAll("merch-card");for(let o of i)o.hasAttribute("data-size")&&(o.setAttribute("size",o.getAttribute("data-size")),o.removeAttribute("data-size"));if(!y.isDesktop)return;let n=0;for(let o of i){if(o.style.display==="none")continue;let c=o.getAttribute("size"),l=c==="wide"?2:c==="super-wide"?3:1;l===2&&n%3===2&&(o.setAttribute("data-size",c),o.removeAttribute("size"),l=1),n+=l}};y.matchDesktop.addEventListener("change",t),e.addEventListener(Me,t),e.onUnmount.push(()=>{y.matchDesktop.removeEventListener("change",t),e.removeEventListener(Me,t)})}});import{html as ie,css as fn,unsafeCSS as wa,nothing as Ut}from"./lit-all.min.js";var ya=`
:root {
...
`)[0].trim()}updateShortDescriptionVisibility(){let r=this.card.querySelector('[slot="short-description"]');if(!r)return;let e=r.querySelector("strong, b, p");e&&(y.isMobile?e.style.display="none":e.style.display="")}toggleShortDescription(){this.shortDescriptionExpanded=!this.shortDescriptionExpanded,this.card.requestUpdate()}get shortDescriptionToggle(){return this.hasShortDescription?y.isMobile?ie`
        ...
        `:ie`
            ...
            `:Ut}get icons(){return this.card.querySelector('[slot="icons"]')||this.card.getAttribute("id")?ie`<slot name="icons"></slot>`:Ut}get secureLabelFooter(){return ie`<footer>
            ${this.secureLabel}<slot name="quantity-select"></slot
            ><slot name="footer"></slot>
        </footer>`}connectedCallbackHook(){this.handleMediaChange=()=>{this.adaptForMedia(),this.updateShortDescriptionVisibility(),this.card.requestUpdate(),window.matchMedia("(min-width: 768px)").matches&&requestAnimationFrame(()=>{this.syncHeights()})},y.matchMobile.addEventListener("change",this.handleMediaChange),y.matchDesktopOrUp.addEventListener("change",this.handleMediaChange),this.handleResize=()=>{this._resizeFrame&&cancelAnimationFrame(this._resizeFrame),this._resizeFrame=requestAnimationFrame(()=>{this._resizeFrame=null,window.matchMedia("(min-width: 768px)").matches&&this.syncHeights()})},window.addEventListener("resize",this.handleResize),this.visibilityObserver=new IntersectionObserver(([r])=>{r.boundingClientRect.height!==0&&r.isIntersecting&&(window.matchMedia("(min-width: 768px)").matches&&requestAnimationFrame(()=>{this.syncHeights()}),this.visibilityObserver.disconnect())}),this.visibilityObserver.observe(this.card)}disconnectedCallbackHook(){y.matchMobile.removeEventListener("change",this.handleMediaChange),y.matchDesktopOrUp.removeEventListener("change",this.handleMediaChange),this.handleResize&&(window.removeEventListener("resize",this.handleResize),this.handleResize=null),this._resizeFrame&&(cancelAnimationFrame(this._resizeFrame),this._resizeFrame=null),this.visibilityObserver?.disconnect()}renderLayout(){let e=this.card.getAttribute("size")==="wide";return ie` ${this.badge}
            <div class="body">
                ${e?ie`
            ...
            <slot></slot>`}};h(he,"variantStyle",fn`
    ...
    `),h(he,"collectionOptions",{customHeaderArea:r=>r.sidenav?ie`<slot name="resultsText"></slot>`:Ut,headerVisibility:{search:!1,sort:!1,result:["mobile","tablet"],custom:["desktop"]},onSidenavAttached:r=>{let e=()=>{let t=r.querySelectorAll("merch-card");if(t.forEach(n=>{n.hasAttribute("data-size")&&(n.setAttribute("size",n.getAttribute("data-size")),n.removeAttribute("data-size"))}),!y.isDesktop)return;let i=0;t.forEach(n=>{if(n.style.display==="none")return;let o=n.getAttribute("size"),c=o==="wide"?2:o==="super-wide"?3:1;c===2&&i%3===2&&(n.setAttribute("data-size",o),n.removeAttribute("size"),c=1),i+=c})};y.matchDesktop.addEventListener("change",e),r.addEventListener(Me,e),r.onUnmount.push(()=>{y.matchDesktop.removeEventListener("change",e),r.removeEventListener(Me,e)})}});import{html as pe,css as vn,nothing as mt,unsafeCSS as bn}from"./lit-all.min.js";var ka=`
:root {
...
`;var[Hs,Bs,Ca,Sa,Aa,Ta]=["ArrowLeft","ArrowRight","ArrowUp","ArrowDown","Enter","Tab"];var xn="pro",La=`--consonant-merch-card-${xn}-top-card-height`,za={cardName:{attribute:"name"},subtitle:{tag:"p",slot:"subtitle"},title:{tag:"h3",slot:"heading-xs"},description:{tag:"div",slot:"body-xs"},mnemonics:{size:"s"},size:["wide","edu"],prices:{tag:"p",slot:"heading-m"},promoText:{tag:"p",slot:"promo-text"},perUnitLabel:{tag:"span",slot:"per-unit-label"},callout:{tag:"div",slot:"callout-content",editorLabel:"License callout"},quantitySelect:{tag:"div",slot:"quantity-select"},shortDescription:{tag:"div",slot:"legal-text"},secureLabel:!0,planType:!0,addon:!0,ctas:{slot:"footer",size:"m"},whatsIncluded:{tag:"div",slot:"whats-included"},backgroundColor:{attribute:"background-color",editorLabel:"Theme",specialValues:{Light:"light",Dark:"dark"}},borderColor:{attribute:"border-color",specialValues:{Black:"black"}},allowedBorderColors:[],style:"consonant"},ne,we,vt,P,Pa,gt,_a,ut,hr,jt,Gt=class Gt extends v{constructor(e){super(e);g(this,P);h(this,"expanded",!1);h(this,"licenseOpen",!1);h(this,"licenseQty",null);h(this,"licenseHighlightedIndex",0);g(this,ne,null);g(this,we,null);h(this,"lastSyncKey",null);g(this,vt,({detail:e})=>{let t=e?.quantity==null?null:String(e.quantity);t==null||t===this.licenseQty||this.licenseOptions?.includes(t)&&(this.licenseQty=t,this.card.requestUpdate())});h(this,"toggleExpanded",e=>{e.preventDefault();let t=!this.expanded;for(let i of w(this,P,Pa).call(this)){let n=i.variantLayout;n instanceof Gt&&(n.expanded=t,i._proExpanded=t,i.requestUpdate())}});h(this,"toggleLicensePopover",e=>{e.preventDefault(),e.stopPropagation(),this.licenseOpen?w(this,P,hr).call(this):w(this,P,ut).call(this),this.card.requestUpdate()});g(this,jt,e=>{let t=this.licenseOptions;if(!t?.length)return;let i=t.length-1;switch(e.key){case Sa:e.preventDefault(),this.licenseOpen?this.licenseHighlightedIndex=(this.licenseHighlightedIndex+1)%t.length:w(this,P,ut).call(this);break;case Ca:e.preventDefault(),this.licenseOpen?this.licenseHighlightedIndex=(this.licenseHighlightedIndex-1+t.length)%t.length:w(this,P,ut).call(this);break;case"Home":if(!this.licenseOpen)return;e.preventDefault(),this.licenseHighlightedIndex=0;break;case"End":if(!this.licenseOpen)return;e.preventDefault(),this.licenseHighlightedIndex=i;break;case Aa:case" ":if(e.preventDefault(),this.licenseOpen){this.selectLicenseQty(t[this.licenseHighlightedIndex]);return}w(this,P,ut).call(this);break;case"Escape":if(!this.licenseOpen)return;e.preventDefault(),w(this,P,hr).call(this);break;case Ta:this.licenseOpen&&this.selectLicenseQty(t[this.licenseHighlightedIndex]);return;default:return}this.card.requestUpdate()});h(this,"selectLicenseQty",e=>{this.licenseQty=e,this.licenseOpen=!1,w(this,P,gt).call(this);let t=this.quantitySelectEl;t&&(t.selectedValue=Number(e),t.dispatchEvent(new CustomEvent(O,{detail:{option:Number(e)},bubbles:!0}))),this.card.requestUpdate()});this.updatePriceQuantity=this.updatePriceQuantity.bind(this),this.expanded=e._proExpanded??!1}getGlobalCSS(){return ka}priceOptionsProvider(e,t){e.dataset.template===D&&(t.displayPlanType=this.card?.settings?.displayPlanType??!1)}async adjustLegal(){if(!this.legalAdjusted)try{this.legalAdjusted=!0,await this.card.updateComplete,await customElements.whenDefined("inline-price");let e=this.mainPrice;if(!e)return;let t=e.cloneNode(!0);if(await e.onceSettled(),!e?.options)return;e.options.displayTax&&(e.dataset.displayTax="false"),e.options.displayPlanType&&(e.dataset.displayPlanType="false"),t.setAttribute("data-template","legal"),t.dataset.displayPerUnit="false",e.parentNode.insertBefore(t,e.nextSibling),await t.onceSettled(),this.legalResolvedHandler||(this.legalResolvedHandler=()=>this.adjustShortDescription(),t.addEventListener(G,this.legalResolvedHandler)),this.adjustShortDescription()}catch{}}adjustShortDescription(){let e=this.card.querySelector('[slot="legal-text"]')?.textContent?.trim();if(!e)return;let t=this.card.querySelector('[slot="heading-m"] [data-template="legal"]'),i=t?.querySelector(".price-plan-type");if(!i)return;i.textContent=e;let n=t.querySelector(".price-tax-inclusivity:not(.disabled)");n?.textContent&&!/\s$/.test(n.textContent)&&(n.textContent+=". ")}get hasWhatsIncluded(){return!!this.card.querySelector('[slot="whats-included"]')}get whatsIncludedToggleLabel(){return this.card.querySelector('[slot="whats-included"] .whats-included-label')?.textContent.trim()||"See what's included:"}get hasCallout(){return!!this.card.querySelector('[slot="callout-content"]')}get hasQuantitySelect(){let e=this.quantitySelectEl;return e?!!e.getAttribute("title")||parseInt(e.getAttribute("min"),10)>0||parseInt(e.getAttribute("step"),10)>0:!1}get hasAddOn(){return!!this.card.querySelector('[slot="addon"]')}get mainPrice(){return this.card.querySelector(`[slot="heading-m"] ${C}[data-template="price"]`)}updatePriceQuantity({detail:e}){!this.mainPrice||!e?.option||(this.mainPrice.dataset.quantity=e.option)}async adjustAddon(){await this.card.updateComplete;let e=this.card.addon;if(!e)return;e.setAttribute("custom-checkbox","");let t=this.mainPrice;if(!t)return;await t.onceSettled?.();let i=t.value?.[0]?.planType;i&&(e.planType=i)}async postCardUpdateHook(){await this.adjustAddon(),this.legalAdjusted||await this.adjustLegal(),this.adjustShortDescription(),await super.postCardUpdateHook(),window.matchMedia("(min-width: 768px)").matches&&this.syncHeights()}async waitForContentFonts(){let e=[this.card.querySelector('[slot="heading-xs"]'),this.card.querySelector('[slot="body-xs"]')].filter(Boolean);document.fonts?.load&&await Promise.all(e.map(t=>{let i=window.getComputedStyle(t),n=`${i.fontWeight} ${i.fontSize} ${i.fontFamily}`;return document.fonts.load(n,t.textContent).catch(()=>null)})),await document.fonts?.ready}async syncHeights(){if(this.card.heightSync===!1)return;await this.waitForContentFonts(),await new Promise(c=>requestAnimationFrame(c)),await new Promise(c=>requestAnimationFrame(c));let e=this.getContainer();if(!e||this.card.getBoundingClientRect().width<=2)return;let t=this.card.variant,i=La,n=[...e.querySelectorAll(`merch-card[variant="${t}"]`)].filter(c=>c.getBoundingClientRect().width>2&&c.variantLayout?.card?.heightSync!==!1),o=new Map;for(let c of n){let l=o.get(c.offsetTop)??[];l.push(c),o.set(c.offsetTop,l)}for(let c of o.values()){let l=0;for(let d of c){d.style.removeProperty(i);let p=d.shadowRoot?.querySelector(".top-card");p&&(l=Math.max(l,parseInt(getComputedStyle(p).height)||0))}l>0&&c.length>1&&c.forEach(d=>d.style.setProperty(i,`${l}px`))}}resyncOnReflow(){let e=this.card.getBoundingClientRect().width;if(e<=2)return;let t=this.card.querySelector('[slot="body-xs"]'),i=t?Math.round(t.getBoundingClientRect().height):0,n=`${Math.round(e)}:${i}`;n!==this.lastSyncKey&&(this.lastSyncKey=n,this.syncHeights())}connectedCallbackHook(){if(!this.card||(this.card.addEventListener(nt,s(this,vt)),this.card.addEventListener(O,this.updatePriceQuantity),typeof ResizeObserver>"u"))return;m(this,we,new ResizeObserver(()=>this.resyncOnReflow())),s(this,we).observe(this.card);let e=this.card.querySelector('[slot="body-xs"]');e&&s(this,we).observe(e)}disconnectedCallbackHook(){this.card?.removeEventListener(O,this.updatePriceQuantity),w(this,P,gt).call(this),s(this,we)?.disconnect(),this.card?.removeEventListener(nt,s(this,vt))}get quantitySelectEl(){return this.card.querySelector("merch-quantity-select")}get licenseOptions(){let e=this.quantitySelectEl;if(!e)return null;let t=parseInt(e.getAttribute("min"),10),i=parseInt(e.getAttribute("max"),10),n=parseInt(e.getAttribute("step"),10)||1;if(Number.isNaN(t)||Number.isNaN(i)||i<t)return null;let o=[];for(let c=t;c<=i;c+=n)o.push(String(c));return o.length?o:null}licenseLabel(e){let t=this.quantitySelectEl?.getAttribute("title")||"License",[i,n]=t.split("|").map(o=>o.trim());return Number(e)===1?i:n||i}get hasLicenseSelector(){return(this.licenseOptions?.length??0)>0}get currentLicenseValue(){let e=this.licenseOptions;if(!e?.length)return null;if(this.licenseQty!=null)return this.licenseQty;let t=this.quantitySelectEl?.getAttribute("default-value");return t!=null&&e.includes(t)?t:e[0]}renderLicenseSelector(){if(!this.hasLicenseSelector)return pe`<slot name="quantity-select"></slot>`;let e=this.licenseOptions,t=this.currentLicenseValue,i=!!this.licenseOpen,n=this.licenseLabel(Number(t));return pe`
            <div class="license-select" ?data-open=${i}>
                <div
                    ...
                    aria-activedescendant=${i?`license-option-${this.licenseHighlightedIndex}`:mt}
        ...
        `}renderLayout(){let e=!!this.expanded;return pe`
            ...
            ${this.hasWhatsIncluded?pe`
                  ...
                  `:mt}
            <slot></slot>
        `}};ne=new WeakMap,we=new WeakMap,vt=new WeakMap,P=new WeakSet,Pa=function(){let e=this.card.offsetTop,t=Array.from(this.getContainer()?.querySelectorAll(`merch-card[variant="${this.card.variant}"]`)??[]).filter(i=>i.getBoundingClientRect().width>2&&i.offsetTop===e);return t.length?t:[this.card]},gt=function(){s(this,ne)&&(document.removeEventListener("mousedown",s(this,ne)),m(this,ne,null))},_a=function(){let e=this.licenseOptions?.indexOf(this.currentLicenseValue);return e>0?e:0},ut=function(){this.licenseOpen=!0,this.licenseHighlightedIndex=w(this,P,_a).call(this),s(this,ne)||(m(this,ne,e=>{e.composedPath().includes(this.card)||(this.licenseOpen=!1,this.card.requestUpdate(),w(this,P,gt).call(this))}),document.addEventListener("mousedown",s(this,ne)))},hr=function(){this.licenseOpen=!1,w(this,P,gt).call(this)},jt=new WeakMap,h(Gt,"variantStyle",vn`
        :host([variant='pro']) {
            display: flex;
            flex-direction: column;
            background: var(
    ...
    `);var ft=Gt;import{html as pr,css as yn}from"./lit-all.min.js";var Ma=`
:root {
...
`;var Ra={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},prices:{tag:"p",slot:"heading-xs"},promoText:{tag:"p",slot:"promo-text"},description:{tag:"div",slot:"body-xs"},shortDescription:{tag:"div",slot:"short-description"},mnemonics:{size:"l"},callout:{tag:"div",slot:"callout-content"},quantitySelect:{tag:"div",slot:"quantity-select"},secureLabel:!0,planType:!0,addon:!0,addonBackground:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"color-yellow-300-variation"},allowedBadgeColors:["color-yellow-300-variation","color-gray-300-variation","color-gray-700-variation","color-green-900-variation","gradient-purple-blue"],allowedBorderColors:["color-yellow-300-variation","color-gray-300-variation","color-green-900-variation","gradient-purple-blue"],borderColor:{attribute:"border-color"},whatsIncluded:{tag:"div",slot:"whats-included"},ctas:{slot:"footer",size:"m"},style:"consonant",perUnitLabel:{tag:"span",slot:"per-unit-label"}},te,qe=class extends v{constructor(e){super(e);g(this,te);this.postCardUpdateHook=this.postCardUpdateHook.bind(this),this.updatePriceQuantity=this.updatePriceQuantity.bind(this)}getGlobalCSS(){return Ma}priceOptionsProvider(e,t){e.dataset.template===D&&(t.displayPlanType=this.card?.settings?.displayPlanType??!1,(e.dataset.template==="strikethrough"||e.dataset.template==="price")&&(t.displayPerUnit=!1))}adjustProductBodySlots(){if(this.card.getBoundingClientRect().width===0)return;["heading-xs","body-xxs","body-xs","promo-text","callout-content","addon","body-lower"].forEach(t=>this.updateCardElementMinHeight(this.card.shadowRoot.querySelector(`slot[name="${t}"]`),t))}renderLayout(){return pr` ${this.badge}
            ...
            <hr />
            ${this.secureLabelFooter}`}connectedCallbackHook(){this.handleResize=()=>{s(this,te)&&cancelAnimationFrame(s(this,te)),m(this,te,requestAnimationFrame(()=>{m(this,te,null),this.postCardUpdateHook()}))},this.adjustShortDescriptionBound=this.adjustShortDescription.bind(this),window.addEventListener("resize",this.handleResize),this.card.addEventListener(O,this.updatePriceQuantity),this.card.addEventListener(fe,this.adjustShortDescriptionBound)}disconnectedCallbackHook(){this.handleResize&&(window.removeEventListener("resize",this.handleResize),this.handleResize=null),s(this,te)&&(cancelAnimationFrame(s(this,te)),m(this,te,null)),this.card.removeEventListener(O,this.updatePriceQuantity),this.card.removeEventListener(fe,this.adjustShortDescriptionBound)}adjustShortDescription(){let e=this.card.querySelector('[slot="short-description"]');if(!e?.textContent?.trim())return;let t=this.card.querySelector('span[data-template="legal"]');if(!t)return;this.card.querySelector(".merch-short-description")?.remove();let i=document.createElement("span");i.className="merch-short-description";let n=e.querySelector("p")??e;i.innerHTML=n.innerHTML,i.querySelectorAll(".icon-button").forEach(o=>{o.dataset.eventsWired||(o.dataset.eventsWired="1",["mouseenter","focus"].forEach(c=>o.addEventListener(c,()=>o.classList.add("tooltip-visible"))),["mouseleave","blur"].forEach(c=>o.addEventListener(c,()=>o.classList.remove("tooltip-visible"))),o.addEventListener("keydown",c=>{c.key==="Escape"&&o.classList.remove("tooltip-visible")}))}),t.after(i),e.hidden=!0}async postCardUpdateHook(){this.card.isConnected&&(this.adjustAddon(),y.isMobile||this.adjustProductBodySlots(),this.legalAdjusted||await this.adjustLegal(),await super.postCardUpdateHook())}async adjustLegal(){if(!(this.legalAdjusted||!this.card.id))try{this.legalAdjusted=!0,await this.card.updateComplete,await customElements.whenDefined("inline-price");let e=this.mainPrice;if(!e)return;let t=e.cloneNode(!0);if(await e.onceSettled(),!e?.options)return;e.options.displayTax&&(e.dataset.displayTax="false"),e.options.displayPlanType&&(e.dataset.displayPlanType="false"),t.setAttribute("data-template","legal"),e.closest('[slot="heading-xs"]').appendChild(t),await t.onceSettled(),t.querySelector(".price-unit-type")?.remove()}catch{}}get headingXSSlot(){return this.card.shadowRoot.querySelector('slot[name="heading-xs"]').assignedElements()[0]}get mainPrice(){return this.card.querySelector(`[slot="heading-xs"] ${C}[data-template="price"]`)}updatePriceQuantity({detail:e}){!this.mainPrice||!e?.option||(this.mainPrice.dataset.quantity=e.option)}toggleAddon(e){let t=this.mainPrice,i=this.headingXSSlot;if(!t&&i){let n=e?.getAttribute("plan-type"),o=null;if(e&&n&&(o=e.querySelector(`p[data-plan-type="${n}"]`)?.querySelector('span[is="inline-price"]')),this.card.querySelectorAll('p[slot="heading-xs"]').forEach(c=>c.remove()),e.checked){if(o){let c=M("p",{class:"addon-heading-xs-price-addon",slot:"heading-xs"},o.innerHTML);this.card.appendChild(c)}}else{let c=M("p",{class:"card-heading",id:"free",slot:"heading-xs"},"Free");this.card.appendChild(c)}}}async adjustAddon(){await this.card.updateComplete;let e=this.card.addon;if(!e)return;let t=this.mainPrice,i=this.card.planType;t&&(await t.onceSettled?.(),i=t.value?.[0]?.planType),i&&(e.planType=i)}};te=new WeakMap,h(qe,"variantStyle",yn`
    ...
    `);import{html as mr,css as wn}from"./lit-all.min.js";var Oa=`
:root {
...
`;var Da={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},prices:{tag:"p",slot:"heading-xs"},promoText:{tag:"p",slot:"promo-text"},description:{tag:"div",slot:"body-xs"},callout:{tag:"div",slot:"callout-content"},planType:!0,secureLabel:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"color-red-700-variation"},allowedBadgeColors:["color-yellow-300-variation","color-gray-300-variation","color-gray-700-variation","color-green-900-variation","color-red-700-variation","gradient-purple-blue"],allowedBorderColors:["color-yellow-300-variation","color-gray-300-variation","color-green-900-variation","color-red-700-variation","gradient-purple-blue"],borderColor:{attribute:"border-color"},ctas:{slot:"footer",size:"m"},style:"consonant",perUnitLabel:{tag:"span",slot:"per-unit-label"}},Ue=class extends v{constructor(r){super(r)}priceOptionsProvider(r,e){r.dataset.template===D&&(e.displayPlanType=this.card?.settings?.displayPlanType??!1,(r.dataset.template==="strikethrough"||r.dataset.template==="price")&&(e.displayPerUnit=!1))}getGlobalCSS(){return Oa}get badgeElement(){return this.card.querySelector('[slot="badge"]')}get mainPrice(){return this.card.querySelector(`[slot="heading-xs"] ${C}[data-template="price"]`)}async postCardUpdateHook(){this.legalAdjusted||await this.adjustLegal(),await super.postCardUpdateHook()}async adjustLegal(){if(!(this.legalAdjusted||!this.card.id))try{this.legalAdjusted=!0,await this.card.updateComplete,await customElements.whenDefined("inline-price");let r=this.mainPrice;if(!r)return;let e=r.cloneNode(!0);if(await r.onceSettled(),!r?.options)return;r.options.displayPerUnit&&(r.dataset.displayPerUnit="false"),r.options.displayTax&&(r.dataset.displayTax="false"),r.options.displayPlanType&&(r.dataset.displayPlanType="false"),e.setAttribute("data-template","legal"),r.parentNode.insertBefore(e,r.nextSibling),await e.onceSettled()}catch{}}renderLayout(){return mr`
            ${this.badge}
            <div class="body">
                <slot name="heading-xs"></slot>
                <slot name="body-xxs"></slot>
    ...
    `);import{html as En,css as kn}from"./lit-all.min.js";var Na=`
...
`;var Ia={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},subtitle:{tag:"p",slot:"body-xxs"},description:{tag:"div",slot:"body-xs"},ctas:{slot:"footer",size:"m"},backgroundImage:{tag:"div",slot:"bg-image"},style:"consonant"},je=class extends v{constructor(r){super(r)}getGlobalCSS(){return Na}removeFocusFromModalClose(){let r=this.card.closest(".dialog-modal");r&&r.querySelector(".dialog-close")?.blur()}async postCardUpdateHook(){this.removeFocusFromModalClose(),await super.postCardUpdateHook()}renderLayout(){return En`
            <div class="media-row">
                <div class="text">
                    <slot name="body-xxs"></slot>
                    <slot name="heading-xs"></slot>
    ...
    `);import{html as gr,css as Cn}from"./lit-all.min.js";var Fa=`
:root {
...
`;var $a={cardName:{attribute:"name"},backgroundImage:{tag:"div",slot:"bg-image"},subtitle:{tag:"p",slot:"detail-m"},title:{tag:"h3",slot:"heading-xs"},prices:{tag:"p",slot:"heading-xs-price"},description:{tag:"div",slot:"body-xs"},ctas:{slot:"footer",size:"l"},badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300-special-offers"},allowedBadgeColors:["spectrum-yellow-300-special-offers","spectrum-gray-300-special-offers","spectrum-green-900-special-offers"],allowedBorderColors:["spectrum-yellow-300-special-offers","spectrum-gray-300-special-offers","spectrum-green-900-special-offers"],borderColor:{attribute:"border-color"}},Ge=class extends v{constructor(r){super(r)}get headingSelector(){return'[slot="detail-m"]'}getGlobalCSS(){return Fa}renderLayout(){return gr`${this.cardImage}
            ...
            ${this.evergreen?gr`
                  ...
                  `:gr`
                      ...
                      ${this.secureLabelFooter}
                  `}
            <slot></slot>`}};h(Ge,"variantStyle",Cn`
    ...
    `);import{html as Sn,css as An}from"./lit-all.min.js";var Ha=`
:root {
...
`;var ur={title:{tag:"h3",slot:"heading-xs",maxCount:250,withSuffix:!0},badge:{tag:"div",slot:"badge",default:"spectrum-blue-400"},allowedBadgeColors:["spectrum-blue-400","spectrum-gray-300","spectrum-yellow-300","gradient-purple-blue","gradient-firefly-spectrum"],description:{tag:"div",slot:"body-xs",maxCount:2e3,withSuffix:!1},prices:{tag:"div",slot:"price"},callout:{tag:"div",slot:"callout-content",editorLabel:"Price description"},ctas:{slot:"cta",size:"XL"},borderColor:{attribute:"border-color",specialValues:{gray:"var(--spectrum-gray-300)",blue:"var(--spectrum-blue-400)","gradient-purple-blue":"linear-gradient(96deg, #B539C8 0%, #7155FA 66%, #3B63FB 100%)","gradient-firefly-spectrum":"linear-gradient(96deg, #D73220 0%, #D92361 33%, #7155FA 100%)"}},disabledAttributes:["badgeColor","badgeBorderColor","trialBadgeColor","trialBadgeBorderColor"],supportsDefaultChild:!0},Ve=class extends v{getGlobalCSS(){return Ha}get aemFragmentMapping(){return ur}get headingSelector(){return'[slot="heading-xs"]'}get badge(){return this.card.querySelector('[slot="badge"]')}syncHeights(){if(this.card.getBoundingClientRect().width===0)return;let r=this.card.shadowRoot;if(!r)return;["header","price-container","cta"].forEach(i=>this.updateCardElementMinHeight(r.querySelector(`.${i}`),i));let e=this.card.querySelector('[slot="body-xs"]');e&&this.updateCardElementMinHeight(e,"description");let t=this.card.querySelector('[slot="body-xs"] p:has(mas-mnemonic)');t&&this.updateCardElementMinHeight(t,"icons")}async postCardUpdateHook(){if(!this.card.isConnected)return;await super.postCardUpdateHook();let r=this.getContainer();if(!r)return;let e=r.querySelectorAll(`merch-card[variant="${this.card.variant}"]`),t=34;e.forEach(i=>{i.classList.remove("small-font-size-button"),i.querySelectorAll('[slot="cta"] sp-button, [slot="cta"] button, [slot="cta"] a.con-button, [slot="cta"] a.spectrum-Button, a[slot="cta"]').forEach(o=>{let c=o.textContent.trim().length>t;o.classList.toggle("small-font-size-button",c)})}),y.isDesktopOrUp&&e.forEach(i=>i.variantLayout?.syncHeights?.())}connectedCallbackHook(){!this.card||this.card.failed||(this.setupAccordion(),this.card?.hasAttribute("data-default-card")&&!Mt()&&this.card.setAttribute("data-expanded","true"),this.observeVisibility())}resyncSiblings(){let r=this.getContainer();r&&r.querySelectorAll(`merch-card[variant="${this.card.variant}"]`).forEach(e=>e.variantLayout?.syncHeights?.())}observeVisibility(){typeof ResizeObserver>"u"||(this.lastSyncedWidth=0,this.sizeObserver=new ResizeObserver(()=>{let r=this.card.getBoundingClientRect().width;r<=2||r===this.lastSyncedWidth||(this.lastSyncedWidth=r,this.resyncSiblings())}),this.sizeObserver.observe(this.card))}setupAccordion(){let r=this.card;if(!r)return;let e=()=>{if(Mt())r.removeAttribute("data-expanded");else{let i=r.hasAttribute("data-default-card");r.setAttribute("data-expanded",i?"true":"false")}};e();let t=window.matchMedia(S);this.mediaQueryListener=()=>{e()},t.addEventListener("change",this.mediaQueryListener)}disconnectedCallbackHook(){this.mediaQueryListener&&window.matchMedia(S).removeEventListener("change",this.mediaQueryListener),this.sizeObserver?.disconnect(),this.sizeObserver=null}handleChevronClick(r){r.preventDefault(),r.stopPropagation(),this.toggleExpanded()}handleCardClick(r){r.target.closest('.chevron-button, mas-mnemonic, button, a, [role="button"]')||(r.preventDefault(),this.toggleExpanded())}toggleExpanded(){let r=this.card;if(!r||Mt())return;let i=r.getAttribute("data-expanded")==="true"?"false":"true";r.setAttribute("data-expanded",i)}renderLayout(){return Sn`
    ...
    `);import{html as qa,css as Tn}from"./lit-all.min.js";var Ba=`
:root {
...
`;var fr={title:{tag:"h3",slot:"heading-xs",maxCount:250,withSuffix:!0},badge:{tag:"div",slot:"badge",default:"spectrum-blue-400"},allowedBadgeColors:["spectrum-blue-400","spectrum-gray-300","spectrum-yellow-300","gradient-purple-blue","gradient-firefly-spectrum"],description:{tag:"div",slot:"body-s",maxCount:2e3,withSuffix:!1},shortDescription:{tag:"div",slot:"short-description",maxCount:3e3,withSuffix:!1},callout:{tag:"div",slot:"callout-content",editorLabel:"Price description"},prices:{tag:"div",slot:"price"},trialBadge:{tag:"div",slot:"trial-badge"},ctas:{slot:"cta",size:"XL"},mnemonics:{size:"xs"},borderColor:{attribute:"border-color",specialValues:{gray:"var(--spectrum-gray-300)",blue:"var(--spectrum-blue-400)","gradient-purple-blue":"linear-gradient(96deg, #B539C8 0%, #7155FA 66%, #3B63FB 100%)","gradient-firefly-spectrum":"linear-gradient(96deg, #D73220 0%, #D92361 33%, #7155FA 100%)"}},showAllSpectrumColors:!0,multiWhatsIncluded:"true",disabledAttributes:[]},bt=class bt extends v{getGlobalCSS(){return Ba}get aemFragmentMapping(){return fr}get headingSelector(){return'[slot="heading-xs"]'}get badgeElement(){return this.card.querySelector('[slot="badge"]')}get badge(){return qa`
        ...
        `}async waitForTitleFont(){let r=this.card.querySelector(this.headingSelector);if(r&&document.fonts?.load){let e=window.getComputedStyle(r),t=`${e.fontWeight} ${e.fontSize} ${e.fontFamily}`;await document.fonts.load(t,r.textContent).catch(()=>null)}await document.fonts.ready}async syncHeights(){if(await this.waitForTitleFont(),await new Promise(c=>requestAnimationFrame(c)),await new Promise(c=>requestAnimationFrame(c)),this.card.getBoundingClientRect().width<=2)return;let r=bt.SYNCED_SECTIONS.map(c=>({name:c,getElement:l=>l.shadowRoot?.querySelector(`.${c}`)})),e=this.getContainer(),t=e?e.querySelectorAll(`merch-card[variant="${this.card.variant}"]`):[this.card],i='[slot="body-s"] > *',n=Math.max(0,...Array.from(t,c=>c.querySelectorAll(i).length)),o=Array.from({length:n},(c,l)=>({name:`description-row-${l}`,getElement:d=>d.querySelectorAll(i)[l]}));this.syncRowHeights([...r,...o])}async postCardUpdateHook(){if(!this.card.isConnected)return;await super.postCardUpdateHook();let r=this.getContainer();if(r){let e=r.querySelectorAll(`merch-card[variant="${this.card.variant}"]`),t=49;e.forEach(i=>{i.classList.remove("small-font-size-button"),i.querySelectorAll('[slot="cta"] sp-button, [slot="cta"] button, [slot="cta"] a.con-button, [slot="cta"] a.spectrum-Button, a[slot="cta"]').forEach(o=>{let c=o.textContent.trim().length>t;o.classList.toggle("small-font-size-button",c)})})}window.matchMedia("(min-width: 768px)").matches&&this.syncHeights()}resyncOnReflow(){let r=this.card.getBoundingClientRect().width;if(r<=2)return;let e=this.card.querySelector(this.headingSelector),t=e?Math.round(e.getBoundingClientRect().height):0,i=`${Math.round(r)}:${t}`;i!==this.lastSyncedKey&&(this.lastSyncedKey=i,this.syncHeights())}connectedCallbackHook(){if(!this.card||typeof ResizeObserver>"u")return;this.lastSyncedKey="",this.sizeObserver=new ResizeObserver(()=>this.resyncOnReflow()),this.sizeObserver.observe(this.card);let r=this.card.querySelector(this.headingSelector);r&&this.sizeObserver.observe(r)}disconnectedCallbackHook(){this.sizeObserver?.disconnect(),this.sizeObserver=null}renderLayout(){return qa`
            ...
            <slot></slot>
        `}};h(bt,"SYNCED_SECTIONS",["header","short-description","price-container","cta"]),h(bt,"variantStyle",Tn`
    ...
    `);var xt=bt;import{html as vr,css as Ln,nothing as zn}from"./lit-all.min.js";var Ua=`
...
`;var ja={cardName:{attribute:"name"},title:{tag:"p",slot:"heading-xs"},cardTitle:{tag:"p",slot:"heading-xs"},subtitle:{tag:"p",slot:"body-xxs"},description:{tag:"div",slot:"body-xs"},promoText:{tag:"p",slot:"promo-text"},shortDescription:{tag:"p",slot:"short-description"},callout:{tag:"div",slot:"callout-content"},quantitySelect:{tag:"div",slot:"quantity-select"},whatsIncluded:{tag:"div",slot:"whats-included"},addonConfirmation:{tag:"div",slot:"addon-confirmation"},badge:{tag:"div",slot:"badge"},trialBadge:{tag:"div",slot:"trial-badge"},prices:{tag:"p",slot:"prices"},backgroundImage:{tag:"div",slot:"bg-image"},ctas:{slot:"footer",size:"m"},addon:!0,secureLabel:!0,borderColor:{attribute:"border-color"},backgroundColor:{attribute:"background-color"},size:[],mnemonics:{size:"m"}},Pn=[{slot:"bg-image",label:"Background Image"},{slot:"badge",label:"Badge"},{slot:"icons",label:"Mnemonic icon"},{slot:"heading-xs",label:"Title"},{slot:"body-xxs",label:"Subtitle"},{slot:"body-xs",label:"Product description"},{slot:"promo-text",label:"Promo Text"},{slot:"callout-content",label:"Callout text"},{slot:"short-description",label:"Short Description"},{slot:"trial-badge",label:"Trial Badge"},{slot:"prices",label:"Product price"},{slot:"quantity-select",label:"Quantity select"},{slot:"addon",label:"Addon"},{slot:"whats-included",label:"What's included"},{slot:"addon-confirmation",label:"Addon confirmation"},{slot:"footer",label:"CTAs"}],We=class extends v{constructor(r){super(r)}getGlobalCSS(){return Ua}renderLayout(){return vr`
    ...
    `);import{css as _n,html as Mn}from"./lit-all.min.js";var Ga=`
...
`;var Va={title:{tag:"p",slot:"title"},prices:{tag:"p",slot:"prices"},description:{tag:"p",slot:"description"},planType:!0,ctas:{slot:"ctas",size:"S"}},Ke=class extends v{constructor(){super(...arguments);h(this,"legal")}async postCardUpdateHook(){await super.postCardUpdateHook(),this.adjustLegal()}getGlobalCSS(){return Ga}get headingSelector(){return'[slot="title"]'}priceOptionsProvider(e,t){t.literals={...t.literals,strikethroughAriaLabel:"",alternativePriceAriaLabel:""},t.space=!0,t.displayAnnual=this.card.settings?.displayAnnual??!1}adjustLegal(){if(this.legal!==void 0)return;let e=this.card.querySelector(`${C}[data-template="price"]`);if(!e)return;let t=e.cloneNode(!0);this.legal=t,e.dataset.displayTax="false",e.dataset.displayPerUnit="false",t.dataset.template="legal",t.dataset.displayPlanType=this.card?.settings?.displayPlanType??!0,t.setAttribute("slot","legal"),this.card.appendChild(t)}renderLayout(){return Mn`
            ${this.badge}
            <div class="body">
    ...
    `);import{html as Rn,css as On}from"./lit-all.min.js";var Wa=`
...
`;var br={mnemonics:{size:"l"},title:{tag:"h3",slot:"header",maxCount:100},prices:{tag:"p",slot:"price"},description:{tag:"div",slot:"detail",maxCount:1e3},ctas:{slot:"cta",size:"M"},features:{tag:"div",slot:"features",unwrap:!0}},Dn=[{key:"header",selector:".seg-header"},{key:"price",selector:".seg-price"},{key:"detail",selector:".seg-detail"},{key:"cta",selector:".seg-cta"}],Vt,Ka,Ye=class extends v{constructor(e){super(e);g(this,Vt);this.postCardUpdateHook=this.postCardUpdateHook.bind(this)}getGlobalCSS(){return Wa}get aemFragmentMapping(){return br}getContainer(){return this.card.closest("mas-compare-chart")??this.card.parentElement}connectedCallbackHook(){window.addEventListener("resize",this.postCardUpdateHook)}disconnectedCallbackHook(){window.removeEventListener("resize",this.postCardUpdateHook)}async postCardUpdateHook(){this.card.isConnected&&(await this.card.updateComplete,w(this,Vt,Ka).call(this))}renderLayout(){return Rn`
            <div class="card">
            ...
            <slot></slot>
        `}};Vt=new WeakSet,Ka=function(){if(this.card.getBoundingClientRect().width===0)return;let e=this.card.shadowRoot;Dn.forEach(({key:t,selector:i})=>this.updateCardElementMinHeight(e.querySelector(i),t))},h(Ye,"variantStyle",On`
    ...
    `);import{html as Nn,css as In}from"./lit-all.min.js";var Ya=`
...
`;var xr={mnemonics:{size:"s"},title:{tag:"h3",slot:"heading-xxs",maxCount:250,withSuffix:!0},description:{tag:"div",slot:"body-s",maxCount:2e3,withSuffix:!1},whatsIncluded:{tag:"div",slot:"whats-included"},badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300"},trialBadge:{tag:"div",slot:"trial-badge",default:"spectrum-green-800"},prices:{tag:"p",slot:"price"},ctas:{slot:"cta",size:"M"},addonConfirmation:{tag:"div",slot:"addon-confirmation"},borderColor:{attribute:"border-color",specialValues:{gray:"--spectrum-gray-300","gradient-purple-blue":"var(--gradient-purple-blue)","gradient-firefly-spectrum":"var(--gradient-firefly-spectrum)"}}},Qe=class extends v{getGlobalCSS(){return Ya}get aemFragmentMapping(){return xr}renderLayout(){return Nn`
    ...
    `);var Wt=new Map,Qa=new WeakMap,Za=new Map,A=(a,r,e=null,t=null,i)=>{Wt.set(a,{class:r,fragmentMapping:e,style:t,collectionOptions:i})};A("catalog",$e,ca,$e.variantStyle);A("image",ye);A("inline-heading",$t);A("mini-compare-chart",He,ga,He.variantStyle);A("mini-compare-chart-mweb",Be,fa,Be.variantStyle);A("plans",I,qt,I.variantStyle,I.collectionOptions);A("plans-students",I,xa,I.variantStyle,I.collectionOptions);A("plans-education",I,ba,I.variantStyle,I.collectionOptions);A("plans-v2",he,Ea,he.variantStyle,he.collectionOptions);A("pro",ft,za,ft.variantStyle);A("product",qe,Ra,qe.variantStyle);A("segment",Ue,Da,Ue.variantStyle);A("media",je,Ia,je.variantStyle);A("headless",We,ja,We.variantStyle);A("special-offers",Ge,$a,Ge.variantStyle);A("simplified-pricing-express",Ve,ur,Ve.variantStyle);A("full-pricing-express",xt,fr,xt.variantStyle);A("mini",Ke,Va,Ke.variantStyle);A("image",ye,la,ye.variantStyle);A("compare-chart-column",Ye,br,Ye.variantStyle);A("fries",Qe,xr,Qe.variantStyle);var Fn=(a,r,e)=>{try{let t=Za.get(a.variant);if(t||(t=new CSSStyleSheet,t.replaceSync(r.cssText),Za.set(a.variant,t)),e?.styleSheet&&e.styleSheet!==t){let i=a.shadowRoot.adoptedStyleSheets.indexOf(e.styleSheet);i!==-1&&a.shadowRoot.adoptedStyleSheets.splice(i,1)}return a.shadowRoot.adoptedStyleSheets.includes(t)||a.shadowRoot.adoptedStyleSheets.push(t),{styleSheet:t}}catch{let i=document.createElement("style");i.textContent=r.cssText,i.setAttribute("data-variant-style",a.variant);let n=e?.styleElement||a.shadowRoot.querySelector("[data-variant-style]");return n&&n.remove(),a.shadowRoot.appendChild(i),{styleElement:i}}},yr=a=>{let r=Wt.get(a.variant);if(!r)return;let{class:e,style:t}=r,i=Qa.get(a);if(i?.appliedVariant===a.variant)return new e(a);let n=t?Fn(a,t,i):{};return Qa.set(a,{appliedVariant:a.variant,...n}),new e(a)};function Ft(a){return Wt.get(a)?.fragmentMapping}function Xa(a){return Wt.get(a)?.collectionOptions}var Ja=document.createElement("style");Ja.innerHTML=`
:root {
...
`;document.head.appendChild(Ja);function Kt(a,r={},{metadata:e=!0,search:t=!0,storage:i=!0}={}){let n;if(t&&n==null){let o=new URLSearchParams(window.location.search),c=wr(t)?t:a;n=o.get(c)}if(i&&n==null){let o=wr(i)?i:a;n=window.sessionStorage.getItem(o)??window.localStorage.getItem(o)}if(e&&n==null){let o=Hn(wr(e)?e:a);n=document.documentElement.querySelector(`meta[name="${o}"]`)?.content}return n??r[a]}var $n=a=>typeof a=="boolean",Yt=a=>typeof a=="function";var wr=a=>typeof a=="string";function ei(a,r){if($n(a))return a;let e=String(a);return e==="1"||e==="true"?!0:e==="0"||e==="false"?!1:r}function Hn(a=""){return String(a).replace(/(\p{Lowercase_Letter})(\p{Uppercase_Letter})/gu,(r,e,t)=>`${e}-${t}`).replace(/\W+/gu,"-").toLowerCase()}var me=class a extends Error{constructor(r,e,t){if(super(r,{cause:t}),this.name="MasError",e.response){let i=e.response.headers?.get(Rt);i&&(e.requestId=i),e.response.status&&(e.status=e.response.status,e.statusText=e.response.statusText),e.response.url&&(e.url=e.response.url)}delete e.response,this.context=e,Error.captureStackTrace&&Error.captureStackTrace(this,a)}toString(){let r=Object.entries(this.context||{}).map(([t,i])=>`${t}: ${JSON.stringify(i)}`).join(", "),e=`${this.name}: ${this.message}`;return r&&(e+=` (${r})`),this.cause&&(e+=`
Caused by: ${this.cause}`),e}};var Ee={clientId:"merch-at-scale",delimiter:"\xB6",ignoredProperties:["analytics","literals","element"],serializableTypes:["Array","Object"],sampleRate:1,severity:"e",tags:"acom",isProdDomain:!1},ti=1e3;function Bn(a){return a instanceof Error||typeof a?.originatingRequest=="string"}function ri(a){if(a==null)return;let r=typeof a;if(r==="function")return a.name?`function ${a.name}`:"function";if(r==="object"){if(a instanceof Error)return a.message;if(typeof a.originatingRequest=="string"){let{message:t,originatingRequest:i,status:n}=a;return[t,n,i].filter(Boolean).join(" ")}let e=a[Symbol.toStringTag]??Object.getPrototypeOf(a).constructor.name;if(!Ee.serializableTypes.includes(e))return e}return a}function qn(a,r){if(!Ee.ignoredProperties.includes(a))return ri(r)}var Er={append(a){if(a.level!=="error")return;let{message:r,params:e}=a,t=[],i=[],n=r;e.forEach(d=>{d!=null&&(Bn(d)?t:i).push(d)}),t.length&&(n+=` ${t.map(ri).join(" ")}`);let{pathname:o,search:c}=window.location,l=`${Ee.delimiter}page=${o}${c}`;l.length>ti&&(l=`${l.slice(0,ti)}<trunc>`),n+=l,i.length&&(n+=`${Ee.delimiter}facts=`,n+=JSON.stringify(i,qn)),window.lana?.log(n,Ee)}};function ai(a){Object.assign(Ee,Object.fromEntries(Object.entries(a).filter(([r,e])=>r in Ee&&e!==""&&e!==null&&e!==void 0&&!Number.isNaN(e))))}var ii={LOCAL:"local",PROD:"prod",STAGE:"stage"},kr={DEBUG:"debug",ERROR:"error",INFO:"info",WARN:"warn"},Cr=new Set,Sr=new Set,ni=new Map,oi={append({level:a,message:r,params:e,timestamp:t,source:i}){console[a](`${t}ms [${i}] %c${r}`,"font-weight: bold;",...e)}},ci={filter:({level:a})=>a!==kr.DEBUG},Un={filter:()=>!1};function jn(a,r,e,t,i){return{level:a,message:r,namespace:e,get params(){return t.length===1&&Yt(t[0])&&(t=t[0](),Array.isArray(t)||(t=[t])),t},source:i,timestamp:performance.now().toFixed(3)}}function Gn(a){[...Sr].every(r=>r(a))&&Cr.forEach(r=>r(a))}function si(a){let r=(ni.get(a)??0)+1;ni.set(a,r);let e=`${a} #${r}`,t={id:e,namespace:a,module:i=>si(`${t.namespace}/${i}`),updateConfig:ai};return Object.values(kr).forEach(i=>{t[i]=(n,...o)=>Gn(jn(i,n,a,o,e))}),Object.seal(t)}function Qt(...a){a.forEach(r=>{let{append:e,filter:t}=r;Yt(t)&&Sr.add(t),Yt(e)&&Cr.add(e)})}function Vn(a={}){let{name:r}=a,e=ei(Kt("commerce.debug",{search:!0,storage:!0}),r===ii.LOCAL);return Qt(e?oi:ci),r===ii.PROD&&Qt(Er),yt}function Wn(){Cr.clear(),Sr.clear()}var yt={...si(ta),Level:kr,Plugins:{consoleAppender:oi,debugFilter:ci,quietFilter:Un,lanaAppender:Er},init:Vn,reset:Wn,use:Qt};var Kn="mas-commerce-service",Ud=yt.module("utilities"),Yn={requestId:Rt,etag:"Etag",lastModified:"Last-Modified",serverTiming:"server-timing"};var Zt=a=>window.setTimeout(a);function Ar(){return document.getElementsByTagName(Kn)?.[0]}function li(a){let r={};if(!a?.headers)return r;let e=a.headers;for(let[t,i]of Object.entries(Yn)){let n=e.get(i);n&&(n=n.replace(/[,;]/g,"|"),n=n.replace(/[| ]+/g,"|"),r[t]=n)}return r}async function di(a,r={},e=2,t=100){let i;for(let n=0;n<=e;n++)try{let o=await fetch(a,r);return o.retryCount=n,o}catch(o){if(i=o,i.retryCount=n,n>e)break;await new Promise(c=>setTimeout(c,t*(n+1)))}throw i}var hi="fragment",pi="author",mi="preview",gi="loading",ui="mask",fi="pzn",vi="timeout",Tr="aem-fragment",bi="eager",xi="cache",Qn=[bi,xi],V,ke,F,Lr=class{constructor(){g(this,V,new Map);g(this,ke,new Map);g(this,F,new Map)}clear(){s(this,V).clear(),s(this,ke).clear(),s(this,F).clear()}add(r,e=!0){if(!this.has(r.id)&&!this.has(r.fields?.originalId)){if(s(this,V).set(r.id,r),r.fields?.originalId&&s(this,V).set(r.fields.originalId,r),s(this,F).has(r.id)){let[,t]=s(this,F).get(r.id);t()}if(s(this,F).has(r.fields?.originalId)){let[,t]=s(this,F).get(r.fields?.originalId);t()}if(!(!e||typeof r.references!="object"||Array.isArray(r.references)))for(let t in r.references){let{type:i,value:n}=r.references[t];i==="content-fragment"&&(n.settings={...r?.settings,...n.settings},n.placeholders={...r?.placeholders,...n.placeholders},n.dictionary={...r?.dictionary,...n.dictionary},n.priceLiterals={...r?.priceLiterals,...n.priceLiterals},this.add(n,r))}}}has(r){return s(this,V).has(r)}entries(){return s(this,V).entries()}get(r){return s(this,V).get(r)}getAsPromise(r){let[e]=s(this,F).get(r)??[];if(e)return e;let t;return e=new Promise(i=>{t=i,this.has(r)&&i()}),s(this,F).set(r,[e,t]),e}getFetchInfo(r){let e=s(this,ke).get(r);return e||(e={url:null,retryCount:0,stale:!1,measure:null,status:null},s(this,ke).set(r,e)),e}set(r,e){if(s(this,V).set(r,e),s(this,F).has(r)){let[,t]=s(this,F).get(r);t()}}remove(r){s(this,V).delete(r),s(this,ke).delete(r),s(this,F).delete(r)}};V=new WeakMap,ke=new WeakMap,F=new WeakMap;var oe=new Lr,Ze,q,ce,$,W,_,wt,K,Y,Et,Q,kt,Ct,Xe,Z,yi,wi,zr,Ei,Xt=class extends HTMLElement{constructor(){super(...arguments);g(this,Z);h(this,"cache",oe);g(this,Ze);g(this,q,null);g(this,ce,null);g(this,$,null);g(this,W);g(this,_);g(this,wt,bi);g(this,K);g(this,Y);g(this,Et,5e3);g(this,Q);g(this,kt,!1);g(this,Ct,0);g(this,Xe)}static get observedAttributes(){return[hi,gi,vi,pi,mi,ui,fi]}cacheKey(){return`${s(this,W)}${s(this,Y)?`-p_${s(this,Y)}`:""}${s(this,K)?`-m_${s(this,K)}`:""}`}attributeChangedCallback(e,t,i){e===hi&&(m(this,W,i),m(this,_,oe.getFetchInfo(this.cacheKey()))),e===ui&&m(this,K,i),e===fi&&m(this,Y,i),e===gi&&Qn.includes(i)&&m(this,wt,i),e===vi&&m(this,Et,parseInt(i,10)),e===pi&&m(this,kt,["","true"].includes(i)),e===mi&&m(this,Xe,i)}connectedCallback(){if(!s(this,Q)){if(s(this,$)??m(this,$,be(this)),m(this,Xe,s(this,$).settings?.preview),s(this,Ze)??m(this,Ze,s(this,$).log.module(`${Tr}[${s(this,W)}]`)),!s(this,W)||s(this,W)==="#"){s(this,_)??m(this,_,oe.getFetchInfo("missing-fragment-id")),w(this,Z,zr).call(this,"Missing fragment id");return}this.refresh(!1)}}get fetchInfo(){return Object.fromEntries(Object.entries(s(this,_)).filter(([e,t])=>t!=null).map(([e,t])=>[`aem-fragment:${e}`,t]))}async refresh(e=!0){if(s(this,Q)&&!await Promise.race([s(this,Q),Promise.resolve(!1)]))return;e&&oe.remove(this.cacheKey()),s(this,wt)===xi&&await Promise.race([oe.getAsPromise(this.cacheKey()),new Promise(c=>setTimeout(c,s(this,Et)))]);try{m(this,Q,w(this,Z,Ei).call(this)),await s(this,Q)}catch(c){return w(this,Z,zr).call(this,c.message),!1}let{references:t,referencesTree:i,placeholders:n,wcs:o}=s(this,q)||{};return o&&!Kt("mas.disableWcsCache")&&s(this,$).prefillWcsCache(o),this.dispatchEvent(new CustomEvent(Re,{detail:{...this.data,references:t,referencesTree:i,placeholders:n,...s(this,_)},bubbles:!0,composed:!0})),s(this,Q)}get updateComplete(){return s(this,Q)??Promise.reject(new Error("AEM fragment cannot be loaded"))}get data(){return s(this,ce)?s(this,ce):(s(this,kt)?this.transformAuthorData():this.transformPublishData(),s(this,ce))}get rawData(){return s(this,q)}transformAuthorData(){let{fields:e,id:t,maskId:i,tags:n,variationId:o,promoProject:c,promoVariationProject:l,settings:d={},priceLiterals:p={},dictionary:u={},placeholders:f={}}=s(this,q);m(this,ce,e.reduce((k,{name:x,multiple:T,values:H})=>(k.fields[x]=T?H:H[0],k),{fields:{},id:t,tags:n,settings:d,priceLiterals:p,dictionary:u,maskId:i,placeholders:f,variationId:o,promoProject:c,promoVariationProject:l}))}transformPublishData(){if(!s(this,q))return;let{fields:e,id:t,tags:i,settings:n={},priceLiterals:o={},dictionary:c={},maskId:l,placeholders:d={},variationId:p,promoProject:u,promoVariationProject:f}=s(this,q);m(this,ce,Object.entries(e).reduce((k,[x,T])=>(k.fields[x]=T?.mimeType?T.value:T??"",k),{fields:{},id:t,tags:i,settings:n,priceLiterals:o,dictionary:c,maskId:l,placeholders:d,variationId:p,promoProject:u,promoVariationProject:f}))}getFragmentClientUrl(){let e=new URLSearchParams(window.location.search),{hostname:t}=window.location,i=t.endsWith(".page")?"page":"live";return`${na(e.get("maslibs"),i)??"https://mas.adobe.com"}/studio/libs/fragment-client.js`}async generatePreview(){let e=this.getFragmentClientUrl(),{previewFragment:t}=await import(e),i={locale:s(this,$).settings.locale,apiKey:s(this,$).settings.wcsApiKey,fullContext:!0},n=new URLSearchParams(window.location.search).get("instant")??s(this,$).settings.instant,o={...i,...n!=null?{instant:n}:{},...s(this,K)!=null?{mask:s(this,K)}:{},...s(this,Y)!=null?{pzn:s(this,Y)}:{}};return await t(s(this,W),o)}};Ze=new WeakMap,q=new WeakMap,ce=new WeakMap,$=new WeakMap,W=new WeakMap,_=new WeakMap,wt=new WeakMap,K=new WeakMap,Y=new WeakMap,Et=new WeakMap,Q=new WeakMap,kt=new WeakMap,Ct=new WeakMap,Xe=new WeakMap,Z=new WeakSet,yi=async function(e){Fr(this,Ct)._++;let t=`${Tr}:${this.cacheKey()}:${s(this,Ct)}`,i=`${t}${Ot}`,n=`${t}${Dt}`;if(s(this,Xe)){let c=await this.generatePreview();if(c.status===200)return c.body;throw new me(`Failed to generate preview: ${c.message}`,{})}performance.mark(i);let o;try{if(s(this,_).stale=!1,s(this,_).url=e,o=await di(e,{cache:"default",credentials:"omit"}),w(this,Z,wi).call(this,o),s(this,_).status=o?.status,s(this,_).measure=De(performance.measure(n,i)),s(this,_).retryCount=o.retryCount,!o?.ok)throw new me("Unexpected fragment response",{response:o,...s(this,$).duration});return await o.json()}catch(c){if(s(this,_).measure=De(performance.measure(n,i)),s(this,_).retryCount=c.retryCount,s(this,q))return s(this,_).stale=!0,s(this,Ze).error("Serving stale data",s(this,_)),s(this,q);let l=c.message??"unknown";throw new me(`Failed to fetch fragment: ${l}`,{})}},wi=function(e){Object.assign(s(this,_),li(e))},zr=function(e){m(this,Q,null),s(this,_).message=e,this.classList.add("error");let t={...s(this,_),...s(this,$).duration};s(this,Ze).error(e,t),this.dispatchEvent(new CustomEvent(Oe,{detail:t,bubbles:!0,composed:!0}))},Ei=async function(){var l;this.classList.remove("error"),m(this,ce,null);let e=oe.get(this.cacheKey());if(e)return m(this,q,e),!0;let{masIOUrl:t,wcsApiKey:i,country:n,locale:o}=s(this,$).settings,c=`${t}/fragment?id=${s(this,W)}&api_key=${i}&locale=${o}`;return n&&!o.endsWith(`_${n}`)&&(c+=`&country=${n}`),s(this,K)&&(c+=`&mask=${s(this,K)}`),s(this,Y)&&(c+=`&pzn=${s(this,Y)}`),e=await w(this,Z,yi).call(this,c),(l=e.fields).originalId??(l.originalId=s(this,W)),s(this,K)||s(this,Y)?oe.set(this.cacheKey(),e):oe.add(e),m(this,q,e),!0},h(Xt,"cache",oe);customElements.define(Tr,Xt);import{LitElement as Zn,html as Pr,css as Xn,nothing as Jn}from"./lit-all.min.js";import{unsafeHTML as eo}from"./lit-all.min.js";var to=a=>a?a.startsWith("sp-icon-")?Pr`${eo(`<${a} class="badge-icon"></${a}>`)}`:Pr`<img src="${a}" class="badge-icon" />`:Jn,Je=class extends Zn{constructor(){super(),this.color="",this.variant="",this.backgroundColor="",this.borderColor="",this.text=this.textContent,this.icon=""}connectedCallback(){this.borderColor&&this.borderColor!=="transparent"?this.style.setProperty("--merch-badge-border",`1px solid var(--${this.borderColor})`):this.backgroundColor.startsWith("gradient-")||this.style.setProperty("--merch-badge-border",`1px solid var(--${this.backgroundColor})`),this.style.setProperty("--merch-badge-background-color",`var(--${this.backgroundColor})`),(!this.borderColor||this.borderColor==="transparent")&&this.backgroundColor.startsWith("gradient-")?this.style.setProperty("--merch-badge-padding","3px 11px 4px 11px"):this.style.setProperty("--merch-badge-padding","2px 10px 3px 10px"),this.style.setProperty("--merch-badge-color",this.color),this.style.setProperty("--merch-badge-font-size","var(--consonant-merch-card-body-xs-font-size)"),this.querySelector('span[is="inline-price"]')||(this.textContent="");let r=this.closest("merch-card"),e=r?.getAttribute("size"),t=r?.querySelectorAll(":scope > merch-icon").length||0;this.style.setProperty("--merch-badge-offset",t),this.style.setProperty("--merch-badge-with-offset",t?1:0),this.style.setProperty("--merch-badge-card-size",e?2:1),super.connectedCallback()}render(){return Pr`<div class="badge">
            ${to(this.icon)}<slot>${this.text}</slot>
        </div>`}};h(Je,"properties",{color:{type:String},variant:{type:String},backgroundColor:{type:String,attribute:"background-color"},borderColor:{type:String,attribute:"border-color"},icon:{type:String}}),h(Je,"styles",Xn`
        :host {
            display: block;
    ...
    `);customElements.define("merch-badge",Je);import{html as ro,css as ao,LitElement as io}from"./lit-all.min.js";var St=class extends io{constructor(){super()}render(){return ro`
            <slot name="icon"></slot>
    ...
    `),h(St,"properties",{description:{type:String,attribute:!0}});customElements.define("merch-mnemonic-list",St);import{html as _r,css as no,LitElement as oo,nothing as ki}from"./lit-all.min.js";var At=class extends oo{updated(){this.hideSeeMoreEls()}hideSeeMoreEls(){this.isMobile&&this.rows.forEach((r,e)=>{e>=5&&(r.style.display=this.showAll?"flex":"none")})}constructor(){super(),this.showAll=!1,this.mobileRows=this.mobileRows===void 0?5:this.mobileRows}toggle(){this.showAll=!this.showAll,this.dispatchEvent(new CustomEvent("hide-see-more-elements",{bubbles:!0,composed:!0})),this.requestUpdate()}render(){return _r`<slot name="heading"></slot>
            <slot name="contentBullets"></slot>
            ${!this.isMobile||!this.bulletsAdded?_r`<slot name="content"></slot>`:ki}
            ${this.isMobile&&this.rows.length>this.mobileRows&&!this.bulletsAdded?_r`<div @click=${this.toggle} class="see-more">
                      ${this.showAll?"- See less":"+ See more"}
                  </div>`:ki}`}get isMobile(){return window.matchMedia("(max-width: 767px)").matches}get rows(){return this.querySelectorAll('[slot="content"] merch-mnemonic-list')}get bulletsAdded(){return!!this.querySelector('[slot="contentBullets"] merch-mnemonic-list')}};h(At,"styles",no`
        :host {
            display: flex;
            flex-wrap: wrap;
            align-items: center;
    ...
    `),h(At,"properties",{heading:{type:String,attribute:!0},mobileRows:{type:Number,attribute:!0}});customElements.define("merch-whats-included",At);var co={[se]:Zr,[ve]:Xr,[le]:Jr},so={[se]:ea,[le]:G},Tt,Jt=class{constructor(r){g(this,Tt);h(this,"changes",new Map);h(this,"connected",!1);h(this,"error");h(this,"log");h(this,"options");h(this,"promises",[]);h(this,"state",ve);h(this,"timer",null);h(this,"value");h(this,"version",0);h(this,"wrapperElement");this.wrapperElement=r,this.log=yt.module("mas-element")}update(){[se,ve,le].forEach(r=>{this.wrapperElement.classList.toggle(co[r],r===this.state)})}notify(){(this.state===le||this.state===se)&&(this.state===le?this.promises.forEach(({resolve:e})=>e(this.wrapperElement)):this.state===se&&this.promises.forEach(({reject:e})=>e(this.error)),this.promises=[]);let r=this.error;this.error instanceof me&&(r={message:this.error.message,...this.error.context}),this.wrapperElement.dispatchEvent(new CustomEvent(so[this.state],{bubbles:!0,composed:!0,detail:r}))}attributeChangedCallback(r,e,t){this.changes.set(r,t),this.requestUpdate()}connectedCallback(){m(this,Tt,Ar()),this.requestUpdate(!0)}disconnectedCallback(){this.connected&&(this.connected=!1,this.log?.debug("Disconnected:",{element:this.wrapperElement}))}onceSettled(){let{error:r,promises:e,state:t}=this;return le===t?Promise.resolve(this.wrapperElement):se===t?Promise.reject(r):new Promise((i,n)=>{e.push({resolve:i,reject:n})})}toggleResolved(r,e,t){return r!==this.version?!1:(t!==void 0&&(this.options=t),this.state=le,this.value=e,this.update(),this.log?.debug("Resolved:",{element:this.wrapperElement,value:e}),Zt(()=>this.notify()),!0)}toggleFailed(r,e,t){if(r!==this.version)return!1;t!==void 0&&(this.options=t),this.error=e,this.state=se,this.update();let i=this.wrapperElement.getAttribute("is");return this.log?.error(`${i}: Failed to render: ${e.message}`,{element:this.wrapperElement,...e.context,...s(this,Tt)?.duration}),Zt(()=>this.notify()),!0}togglePending(r){return this.version++,r&&(this.options=r),this.state=ve,this.update(),this.log?.debug("Pending:",{osi:this.wrapperElement?.options?.wcsOsi}),this.version}requestUpdate(r=!1){if(!this.wrapperElement.isConnected||!Ar()||this.timer)return;let{error:e,options:t,state:i,value:n,version:o}=this;this.state=ve,this.timer=Zt(async()=>{this.timer=null;let c=null;if(this.changes.size&&(c=Object.fromEntries(this.changes.entries()),this.changes.clear()),this.connected?this.log?.debug("Updated:",{element:this.wrapperElement,changes:c}):(this.connected=!0,this.log?.debug("Connected:",{element:this.wrapperElement,changes:c})),c||r)try{await this.wrapperElement.render?.()===!1&&this.state===ve&&this.version===o&&(this.state=i,this.error=e,this.value=n,this.update(),this.notify())}catch(l){this.toggleFailed(this.version,l,t)}})}};Tt=new WeakMap;function lo(a){return`https://${a==="PRODUCTION"?"www.adobe.com":"www.stage.adobe.com"}/offers/promo-terms.html`}var Se,Ce=class Ce extends HTMLAnchorElement{constructor(){super();h(this,"masElement",new Jt(this));g(this,Se);this.setAttribute("is",Ce.is)}get isUptLink(){return!0}initializeWcsData(e,t){this.setAttribute("data-wcs-osi",e),t&&this.setAttribute("data-promotion-code",t)}attributeChangedCallback(e,t,i){this.masElement.attributeChangedCallback(e,t,i)}connectedCallback(){this.masElement.connectedCallback(),m(this,Se,be()),s(this,Se)&&(this.log=s(this,Se).log.module("upt-link"))}disconnectedCallback(){this.masElement.disconnectedCallback(),m(this,Se,void 0)}requestUpdate(e=!1){this.masElement.requestUpdate(e)}onceSettled(){return this.masElement.onceSettled()}async render(){let e=be();if(!e)return!1;this.dataset.imsCountry||e.imsCountryPromise.then(o=>{o&&(this.dataset.imsCountry=o)});let t=e.collectCheckoutOptions({},this);if(!t.wcsOsi)return this.log.error("Missing 'data-wcs-osi' attribute on upt-link."),!1;let i=this.masElement.togglePending(t),n=e.resolveOfferSelectors(t);try{let[[o]]=await Promise.all(n),{country:c,language:l,env:d}=t,p=`locale=${l}_${c}&country=${c}&offer_id=${o.offerId}`,u=this.getAttribute("data-promotion-code");u&&(p+=`&promotion_code=${encodeURIComponent(u)}`),this.href=`${lo(d)}?${p}`,this.masElement.toggleResolved(i,o,t)}catch(o){let c=new Error(`Could not resolve offer selectors for id: ${t.wcsOsi}.`,o.message);return this.masElement.toggleFailed(i,c,t),!1}}static createFrom(e){let t=new Ce;for(let i of e.attributes)i.name!=="is"&&(i.name==="class"&&i.value.includes("upt-link")?t.setAttribute("class",i.value.replace("upt-link","").trim()):t.setAttribute(i.name,i.value));return t.innerHTML=e.innerHTML,t.setAttribute("tabindex",0),t}};Se=new WeakMap,h(Ce,"is","upt-link"),h(Ce,"tag","a"),h(Ce,"observedAttributes",["data-wcs-osi","data-promotion-code","data-ims-country"]);var ge=Ce;window.customElements.get(ge.is)||window.customElements.define(ge.is,ge,{extends:ge.tag});var ho="cta-group",po=["accent","primary"],Ci=/-(outline|link)$/;function Si(a,{groupCTAs:r}={}){if(!r||!a.length)return a;let e=a.findIndex(i=>{let n=i?i.replace(Ci,""):"";return po.includes(n)}),t=e===-1?0:e;return a.map((i,n)=>n===t?i:`secondary${i?Ci.exec(i)?.[0]??"":""}`)}function Ai(a){return a?ho:void 0}var mo="#000000",Mr="#F8D904",go="#EAEAEA",uo="#31A547",Li=/(accent|primary|secondary)(-(outline|link))?/,fo="mas:product_code/",vo="daa-ll",er="daa-lh",bo=["XL","L","M","S"],Rr="...",xo=new Set(["free-trial","start-free-trial","seven-day-trial","fourteen-day-trial","thirty-day-trial"]);function U(a,r,e,t){let i=t[a];if(r[a]&&i){let n={slot:i?.slot,...i?.attributes},o=r[a];if(i.maxCount&&typeof o=="string"){let[l,d]=Bo(o,i.maxCount,i.withSuffix);l!==o&&(n.title=d,o=l)}let c=M(i.tag,n,o);e.append(c)}}function yo(a,r,e){let i=(a.mnemonicIcon||[]).filter(o=>o).map((o,c)=>({icon:o,alt:a.mnemonicAlt?.[c]??"",link:a.mnemonicLink?.[c]??""}));i?.forEach(({icon:o,alt:c,link:l})=>{if(l&&!/^https?:/.test(l))try{l=new URL(`https://${l}`).href.toString()}catch{l="#"}let d={slot:"icons",src:o,loading:r.loading,size:e?.size??"l"};c&&(d.alt=c),l&&(d.href=l);let p=M("merch-icon",d);r.append(p)});let n=r.shadowRoot.querySelector('slot[name="icons"]');n&&(n.style.display=i?.length?null:"none")}function wo(a,r,e){if(e.badge?.slot){if(a.badge?.length&&!a.badge?.startsWith("<merch-badge")){let t=Mr,i=!1;e.allowedBadgeColors?.includes(e.badge?.default)&&(t=e.badge?.default,a.borderColor||(i=!0));let n=a.badgeBackgroundColor||t,o=a.borderColor||"";i&&(o=e.badge?.default,a.borderColor=e.badge?.default),a.badge=`<merch-badge variant="${a.variant}" background-color="${n}" border-color="${o}">${a.badge}</merch-badge>`}U("badge",a,r,e)}else a.badge?(r.setAttribute("badge-text",a.badge),e.disabledAttributes?.includes("badgeColor")||r.setAttribute("badge-color",a.badgeColor||mo),e.disabledAttributes?.includes("badgeBackgroundColor")||r.setAttribute("badge-background-color",a.badgeBackgroundColor||Mr),r.setAttribute("border-color",a.badgeBackgroundColor||Mr)):r.setAttribute("border-color",a.borderColor||go)}function Eo(a,r,e){if(e.trialBadge&&a.trialBadge){if(!a.trialBadge.startsWith("<merch-badge")){let t=!e.disabledAttributes?.includes("trialBadgeBorderColor")&&a.trialBadgeBorderColor||uo;a.trialBadge=`<merch-badge variant="${a.variant}" border-color="${t}">${a.trialBadge}</merch-badge>`}U("trialBadge",a,r,e)}}function ko(a,r,e){e?.includes(a.size)&&r.setAttribute("size",a.size)}function Co(a,r){a.cardName&&r.setAttribute("name",a.cardName)}function So(a,r,e){a.cardTitle&&(a.cardTitle=et(a.cardTitle)),U("cardTitle",a,r,{cardTitle:e})}function Ao(a,r,e){U("subtitle",a,r,e)}function To(a,r,e,t){if(!a.backgroundColor||a.backgroundColor.toLowerCase()==="default"){r.style.removeProperty("--merch-card-custom-background-color"),r.removeAttribute("background-color");return}e?.[a.backgroundColor]?(r.style.setProperty("--merch-card-custom-background-color",`var(${e[a.backgroundColor]})`),r.setAttribute("background-color",a.backgroundColor)):t?.attribute&&a.backgroundColor&&(r.setAttribute(t.attribute,a.backgroundColor),r.style.removeProperty("--merch-card-custom-background-color"))}function Lo(a,r,e){let t=e?.borderColor,i="--consonant-merch-card-border-color";if(a.borderColor?.toLowerCase()==="transparent")r.style.setProperty(i,"transparent");else if(a.borderColor&&t){let o=t?.specialValues?.[a.borderColor]?.includes("gradient")||/-gradient/.test(a.borderColor),c=/^spectrum-.*-(plans|special-offers)$/.test(a.borderColor);if(o){r.setAttribute("gradient-border","true");let l=a.borderColor;if(t?.specialValues){for(let[d,p]of Object.entries(t.specialValues))if(p===a.borderColor){l=d;break}}r.setAttribute("border-color",l),r.style.removeProperty(i)}else c?(r.setAttribute("border-color",a.borderColor),r.style.setProperty(i,`var(--${a.borderColor})`)):r.style.setProperty(i,`var(--${a.borderColor})`)}}var zo=new Set(["","default"]);function Po(a,r,e){let t=e?.whatsIncludedDividerColor,i="--consonant-merch-card-whats-included-divider-color";if(!t)return;let o=(r.querySelector('[slot="footer-rows"] merch-whats-included')??r.querySelector("merch-whats-included"))?.getAttribute("whats-included-divider-color")?.trim(),c=a.whatsIncludedDividerColor!=null?String(a.whatsIncludedDividerColor).trim():"",l=o||c;if(l==null||zo.has(String(l).trim().toLowerCase())){r.removeAttribute("whats-included-divider-color"),r.style.removeProperty(i);return}let d=String(l).trim();if(d.toLowerCase()==="transparent"){r.removeAttribute("whats-included-divider-color"),r.style.setProperty(i,"transparent");return}let u=t.specialValues?.[d]?.includes("gradient")||/-gradient/.test(d)||/^gradient-/.test(d),f=/^spectrum-.*-(plans|special-offers)$/.test(d);if(u){let k=d;if(t.specialValues){for(let[x,T]of Object.entries(t.specialValues))if(T===d){k=x;break}}r.setAttribute("whats-included-divider-color",k),r.style.removeProperty(i)}else f?(r.setAttribute("whats-included-divider-color",d),r.style.setProperty(i,`var(--${d})`)):(r.removeAttribute("whats-included-divider-color"),r.style.setProperty(i,`var(--${d})`))}function _o(a,r,e){if(a.backgroundImage){let t={loading:r.loading??"lazy",src:a.backgroundImage};if(a.backgroundImageAltText?t.alt=a.backgroundImageAltText:t.role="none",!e)return;if(e?.attribute){r.setAttribute(e.attribute,a.backgroundImage);return}r.append(M(e.tag,{slot:e.slot},M("img",t)))}}function et(a){return!a||typeof a!="string"||a.includes("<mas-mnemonic")&&Promise.resolve().then(()=>(or(),nr)).catch(console.error),a}function Mo(a,r,e){a.prices&&(a.prices=et(a.prices)),U("prices",a,r,e)}function Or(a){if(a==null||a==="")return[];if(typeof a=="string")return a.trim()?[a]:[];if(Array.isArray(a))return a.flatMap(Or);if(typeof a=="object"){if(typeof a.value=="string")return a.value.trim()?[a.value]:[];if(Array.isArray(a.value))return a.value.flatMap(Or);if(typeof a.content=="string")return a.content.trim()?[a.content]:[];if(typeof a.html=="string")return a.html.trim()?[a.html]:[]}return[]}function Ro(a,r,e){let t=Or(a.features).filter(n=>n.trim());if(!t.length)return;let i=M("div",{slot:e?.features?.slot??"features",hidden:"","data-compare-chart-features":""});t.forEach(n=>{let o;try{o=new DOMParser().parseFromString(n,"text/html")}catch{return}let c=o.body.querySelector("p[name]");if(c){i.append(c);return}i.insertAdjacentHTML("beforeend",n)}),i.children.length&&r.append(i),Do(r,e)}function zi(a,r,e){let t=a.hasAttribute("data-wcs-osi")&&!!a.getAttribute("data-wcs-osi"),i=a.className||"",n=Li.exec(i)?.[0]??"accent",o=n.includes("accent"),c=n.includes("primary"),l=n.includes("secondary"),d=n.includes("-outline"),p=n.includes("-link");a.classList.remove("accent","primary","secondary");let u;if(r.consonant)u=Go(a,o,t,p,c,l,e?.ctas?.size);else if(p)u=a;else{let f;o?f="accent":c?f="primary":l&&(f="secondary"),u=r.spectrum==="swc"?jo(a,e,d,f,t):Uo(a,e,d,f,t)}return u}function Oo(a,r){let{slot:e}=r?.description;Pi(a,r,e)}function Do(a,r){let e=r?.features?.slot;e&&Pi(a,r,e)}function Pi(a,r,e){let t=a.querySelectorAll(`[slot="${e}"] a[data-wcs-osi]`);t.length&&t.forEach(i=>{let n=zi(i,a,r);i.replaceWith(n)})}function No(a,r,e,t){a.description&&(a.description=et(a.description)),a.promoText&&(a.promoText=et(a.promoText)),a.shortDescription&&(a.shortDescription=et(a.shortDescription)),U("promoText",a,r,e),U("description",a,r,e),U("shortDescription",a,r,e),a.shortDescription&&(r.setAttribute("action-menu","true"),a.actionMenuLabel||r.setAttribute("action-menu-label","More options")),Oo(r,e),U("callout",a,r,e),Io(a,r,e,t),U("whatsIncluded",a,r,e)}function Io(a,r,e,t={}){e.quantitySelect&&(a.quantitySelect||(a.quantitySelect=t.quantitySelect),U("quantitySelect",a,r,e))}function Fo(a,r,e,t={}){if(!e.addon)return;let n=(a.addon??t.addon)?.replace(/[{}]/g,"");if(!n||/disabled/.test(n))return;let o,c=n,l=document.createElement("div");l.innerHTML=n;let d=l.firstElementChild;d?.tagName?.toLowerCase()==="merch-addon"&&(o=d.getAttribute("background")||void 0,c=d.innerHTML);let p={slot:"addon"};o&&(p.background=o);let u=M("merch-addon",p,c);[...u.querySelectorAll(C)].forEach(f=>{let k=f.parentElement;k?.nodeName==="P"&&(k.hasAttribute("data-plan-type")||k.setAttribute("data-plan-type",""))}),r.append(u)}function $o(a,r,e){a.addonConfirmation&&U("addonConfirmation",a,r,e)}function Ho(a,r,e,t){t?.secureLabel&&e?.secureLabel&&r.setAttribute("secure-label",t.secureLabel)}function Bo(a,r,e=!0){try{let t=typeof a!="string"?"":a,i=Ti(t);if(i.length<=r)return[t,i];let n=0,o=!1,c=e?r-Rr.length<1?1:r-Rr.length:r,l=[];for(let u of t){if(n++,u==="<")if(o=!0,t[n]==="/")l.pop();else{let f="";for(let k of t.substring(n)){if(k===" "||k===">")break;f+=k}l.push(f)}if(u==="/"&&t[n]===">"&&l.pop(),u===">"){o=!1;continue}if(!o&&(c--,c===0))break}let d=t.substring(0,n).trim();if(l.length>0){l[0]==="p"&&l.shift();for(let u of l.reverse())d+=`</${u}>`}return[`${d}${e?Rr:""}`,i]}catch{let i=typeof a=="string"?a:"",n=Ti(i);return[i,n]}}function Ti(a){if(!a)return"";let r="",e=!1;for(let t of a){if(t==="<"&&(e=!0),t===">"){e=!1;continue}e||(r+=t)}return r}function qo(a,r){r.querySelectorAll("a.upt-link").forEach(t=>{let i=ge.createFrom(t);t.replaceWith(i),i.initializeWcsData(a.osi,a.promoCode)})}function Uo(a,r,e,t,i){let n=a;i?n=customElements.get("checkout-button").createCheckoutButton({},a.innerHTML):n.innerHTML=`<span>${n.textContent}</span>`,n.setAttribute("tabindex",0);for(let p of a.attributes)["class","is"].includes(p.name)||n.setAttribute(p.name,p.value);n.firstElementChild?.classList.add("spectrum-Button-label");let o=r?.ctas?.size??"M",c=`spectrum-Button--${t}`,l=bo.includes(o)?`spectrum-Button--size${o}`:"spectrum-Button--sizeM",d=["spectrum-Button",c,l];return e&&d.push("spectrum-Button--outline"),n.classList.add(...d),n}function jo(a,r,e,t,i){let n=a;i&&(n=customElements.get("checkout-button").createCheckoutButton(a.dataset),n.connectedCallback(),n.render());let o="fill";e&&(o="outline");let c=M("sp-button",{treatment:o,variant:t,tabIndex:0,size:r?.ctas?.size??"m",...a.dataset.analyticsId&&{"data-analytics-id":a.dataset.analyticsId}},a.innerHTML);return c.source=n,(i?n.onceSettled():Promise.resolve(n)).then(l=>{c.setAttribute("data-navigation-url",l.href)}),c.addEventListener("click",l=>{l.defaultPrevented||n.click()}),c}function Go(a,r,e,t,i,n,o){let c=a;if(e)try{let l=customElements.get("checkout-link");l&&(c=l.createCheckoutLink(a.dataset,a.innerHTML)??a)}catch{}return t||(c.classList.add("button","con-button"),o&&o!=="m"&&c.classList.add(`button-${o}`),r&&c.classList.add("blue"),i&&c.classList.add("primary"),n&&c.classList.add("secondary")),c}function Vo(a,r,e,t,i){if(a.ctas){a.ctas=et(a.ctas);let{slot:n}=e.ctas,o=M("div",{slot:n},a.ctas),c=[...o.querySelectorAll("a")],l=i?.hideTrialCTAs?c.filter(x=>!xo.has(x.dataset.analyticsId)):c,d=l.length>0?l:c,p=d.map(x=>Li.exec(x.className)?.[0]??""),u=Si(p,{groupCTAs:i?.groupCTAs});d.forEach((x,T)=>{let H=p[T],B=u[T];B!==H&&(H?x.className=x.className.replace(H,B):x.className=x.className?`${x.className} ${B}`:B)});let f=d.map(x=>zi(x,r,e));o.textContent="";let k=Ai(i?.groupCTAs);k&&o.classList.add(k),o.append(...f),r.append(o),i?.hideTrialCTAs&&l.length>0&&f.forEach(x=>{let T=x.source??x;T.onceSettled&&(x.hidden=!0,T.onceSettled().then(()=>{T.value?.[0]?.offerType==="TRIAL"&&f.some(B=>B!==x&&!B.hidden)?x.remove():x.hidden=!1}).catch(()=>{x.hidden=!1}))})}}function Wo(a,r){let{tags:e}=a,t=e?.find(n=>typeof n=="string"&&n.startsWith(fo))?.split("/").pop();if(!t)return;r.setAttribute(er,t),[...r.shadowRoot.querySelectorAll("a[data-analytics-id],button[data-analytics-id]"),...r.querySelectorAll("a[data-analytics-id],button[data-analytics-id]")].forEach((n,o)=>{n.setAttribute(vo,`${n.dataset.analyticsId}-${o+1}`)})}function Ko(a){a.spectrum==="css"&&[["primary-link","primary"],["secondary-link","secondary"]].forEach(([r,e])=>{a.querySelectorAll(`a.${r}`).forEach(t=>{t.classList.remove(r),t.classList.add("spectrum-Link",`spectrum-Link--${e}`)})})}function Yo(a){a.querySelectorAll("[slot]").forEach(t=>{t.remove()}),a.variant=void 0,["checkbox-label","stock-offer-osis","secure-label","background-image","background-color","border-color","whats-included-divider-color","badge-background-color","badge-color","badge-text","gradient-border","size",er].forEach(t=>a.removeAttribute(t));let e=["wide-strip","thin-strip"];a.classList.remove(...e)}async function _i(a,r){if(!a){let l=r?.id||"unknown";throw console.error(`hydrate: Fragment is undefined. Cannot hydrate card (merchCard id: ${l}).`),new Error(`hydrate: Fragment is undefined for card (merchCard id: ${l}).`)}if(!a.fields){let l=a.id||"unknown",d=r?.id||"unknown";throw console.error(`hydrate: Fragment for card ID '${l}' (merchCard id: ${d}) is missing 'fields'. Cannot hydrate.`),new Error(`hydrate: Fragment for card ID '${l}' (merchCard id: ${d}) is missing 'fields'.`)}let{id:e,fields:t,settings:i={},priceLiterals:n}=a;t.variant==="bizpro"&&(t.variant="pro");let{variant:o}=t;if(!o)throw new Error(`hydrate: no template found in payload ${e}`);Yo(r),r.compatVersion=t.compatVersion,r.contextPromotionCode=t.promoCode,r.settings=i,n&&(r.priceLiterals=n),r.id??(r.id=a.id),a.variationId&&r.setAttribute("variation-id",a.variationId),a.maskId&&r.setAttribute("mask-id",a.maskId),a.promoProject&&r.setAttribute("data-promotion-project",a.promoProject),a.promoVariationProject&&r.setAttribute("data-promotion-variation-project",a.promoVariationProject),r.variant=o,await r.updateComplete;let{aemFragmentMapping:c}=r.variantLayout;if(!c)throw new Error(`hydrate: variant mapping not found for ${e}`);c.style==="consonant"&&r.setAttribute("consonant",!0),yo(t,r,c.mnemonics),Eo(t,r,c),ko(t,r,c.size),Co(t,r),So(t,r,c.title),wo(t,r,c),Ao(t,r,c),Mo(t,r,c),_o(t,r,c.backgroundImage),To(t,r,c.allowedColors,c.backgroundColor),Lo(t,r,c),No(t,r,c,i),Ro(t,r,c),Po(t,r,c),Fo(t,r,c,i),$o(t,r,c),Ho(t,r,c,i);try{qo(t,r)}catch{}Vo(t,r,c,o,i),Wo(t,r),Ko(r)}var rr="merch-card",Mi="merch-card:",Ni=["full-pricing-express","simplified-pricing-express"],Ii=["segment","product","plans-education","mini-compare-chart-mweb"];function Ri(a,r){let e=a.closest(rr);if(!e)return r;e.priceLiterals&&(r.literals??(r.literals={}),Object.assign(r.literals,e.priceLiterals)),ia(a)&&(r.displayPerUnit=!1,r.displayTax=!1),!r.promotionCode&&(e.compatVersion>=1||e.hasAttribute("data-promotion-project"))&&(r.promotionCode=e.contextPromotionCode),e.aemFragment&&(r[ra]=!0),e.variantLayout?.priceOptionsProvider?.(a,r),a.dataset.template===D&&(r.displayDot??(r.displayDot=e.variantLayout?.legalDisplayDot??!0))}function Oi(a,r){let e=a.closest(rr);if(!e)return r;!r.promotionCode&&(e.compatVersion>=1||e.hasAttribute("data-promotion-project"))&&(r.promotionCode=e.contextPromotionCode)}function Zo(a){a.providers.has(Ri)||a.providers.price(Ri),a.providers.has(Oi)||a.providers.checkout(Oi)}var Lt=new IntersectionObserver(a=>{a.forEach(r=>{let e=r.target;if(Ni.includes(e.variant)){if(e.clientHeight===0)return;Lt.unobserve(e),e.requestUpdate();return}if(Ii.includes(e.variant)){if(r.boundingClientRect.width===0)return;if((e.variant==="product"||e.variant==="mini-compare-chart-mweb"||e.variant==="plans-education")&&e.querySelector('merch-icon[slot="icons"]')){Lt.unobserve(e);return}let t=e.getBoundingClientRect().width,i=e.querySelector('[slot="badge"] > merch-badge'),n=i?.getBoundingClientRect().width||0;if(t===0||!i){Lt.unobserve(e);return}e.style.setProperty("--consonant-merch-card-heading-xs-max-width",`${Math.round(t-n-16)}px`),Lt.unobserve(e)}})}),Xo=0,Pt,tt,rt,at,re,Te,j,Le,L,Ae,zt,Dr,tr,ue=class extends Qo{constructor(){super();g(this,L);g(this,Pt);g(this,tt);g(this,rt);g(this,at);g(this,re);g(this,Te);g(this,j);g(this,Le,new Promise(e=>{m(this,j,e)}));h(this,"compatVersion");h(this,"customerSegment");h(this,"marketSegment");h(this,"variantLayout");this.id=null,this.failed=!1,this.filters={},this.types="",this.selected=!1,this.spectrum="css",this.loading="lazy",this.handleAemFragmentEvents=this.handleAemFragmentEvents.bind(this),this.handleMasReady=this.handleMasReady.bind(this),this.handleMerchOfferSelectReady=this.handleMerchOfferSelectReady.bind(this)}get contextPromotionCode(){return s(this,Pt)}set contextPromotionCode(e){m(this,Pt,e),e?this.setAttribute("data-promotion-code",e):this.removeAttribute("data-promotion-code")}firstUpdated(){this.variantLayout=yr(this),this.variantLayout?.connectedCallbackHook()}willUpdate(e){(e.has("variant")||!this.variantLayout)&&(this.variantLayout?.disconnectedCallbackHook(),this.variantLayout=yr(this),this.variantLayout?.connectedCallbackHook())}updated(e){!this.style.getPropertyValue("--consonant-merch-card-border-color")&&this.computedBorderColor&&(e.has("badgeBackgroundColor")||e.has("borderColor"))&&this.style.setProperty("--consonant-merch-card-border-color",this.computedBorderColor),e.has("backgroundColor")&&this.style.setProperty("--merch-card-custom-background-color",this.backgroundColor?`var(--${this.backgroundColor})`:"");try{this.variantLayoutPromise=this.variantLayout?.postCardUpdateHook(e)}catch(t){w(this,L,Ae).call(this,`Error in postCardUpdateHook: ${t.message}`,{},!1)}}get theme(){return this.closest("sp-theme")}get dir(){return this.closest("[dir]")?.getAttribute("dir")??"ltr"}render(){if(!(!this.isConnected||!this.variantLayout||this.style.display==="none"))return this.variantLayout.renderLayout()}get computedBorderColor(){return["ccd-slice","ccd-suggested","ah-promoted-plans","simplified-pricing-express","full-pricing-express"].includes(this.variant)?"":this.borderColor?this.borderColor:this.badgeBackgroundColor}get badgeElement(){return this.shadowRoot.getElementById("badge")}get headingmMSlot(){return this.shadowRoot.querySelector('slot[name="heading-m"]').assignedElements()[0]}get footerSlot(){return this.shadowRoot.querySelector('slot[name="footer"]')?.assignedElements()[0]}get descriptionSlot(){return this.shadowRoot.querySelector('slot[name="body-xs"')?.assignedElements()[0]}get descriptionSlotCompare(){return this.shadowRoot.querySelector('slot[name="body-m"')?.assignedElements()[0]}get iconButton(){return this.querySelector('[slot="callout-content"] .icon-button')}get price(){return this.headingmMSlot?.querySelector(C)}get checkoutLinks(){return[...this.footerSlot?.querySelectorAll(ae)??[]]}get checkoutLinksDescription(){return[...this.descriptionSlot?.querySelectorAll(ae)??[]]}get checkoutLinkDescriptionCompare(){return[...this.descriptionSlotCompare?.querySelectorAll(ae)??[]]}get activeDescriptionLinks(){return this.variant==="mini-compare-chart"||this.variant==="mini-compare-chart-mweb"?this.checkoutLinkDescriptionCompare:this.checkoutLinksDescription}async toggleStockOffer({target:e}){if(!this.stockOfferOsis)return;let t=this.checkoutLinks;if(t.length!==0)for(let i of t){await i.onceSettled();let n=i.value?.[0]?.planType;if(!n)return;let o=this.stockOfferOsis[n];if(!o)return;let c=i.dataset.wcsOsi.split(",").filter(l=>l!==o);e.checked&&c.push(o),i.dataset.wcsOsi=c.join(",")}}changeHandler(e){e.target.tagName==="MERCH-ADDON"&&this.toggleAddon(e.target)}toggleAddon(e){this.variantLayout?.toggleAddon?.(e);let t=[...this.checkoutLinks,...this.activeDescriptionLinks??[]];if(t.length===0)return;let i=n=>{let{offerType:o,planType:c}=n.value?.[0]??{};if(!o||!c)return;let l=e.getOsi(c,o),d=(n.dataset.wcsOsi||"").split(",").filter(p=>p&&p!==l);e.checked&&d.push(l),n.dataset.wcsOsi=d.join(",")};t.forEach(i)}handleQuantitySelection(e){let t=[...this.checkoutLinks,...this.activeDescriptionLinks??[]];if(t.length!==0)for(let i of t)i.dataset.quantity=e.detail.option}get titleElement(){return this.querySelector(this.variantLayout?.headingSelector||".card-heading")}get title(){return this.titleElement?.textContent?.trim()}get description(){return this.querySelector('[slot="body-xs"]')?.textContent?.trim()}updateFilters(e){let t={...this.filters};Object.keys(t).forEach(i=>{if(e){t[i].order=Math.min(t[i].order||2,2);return}let n=t[i].order;n===1||isNaN(n)||(t[i].order=Number(n)+1)}),this.filters=t}showInfoTooltip(e,t){let i="tooltip-left",n="tooltip-right";window.screen.width<600&&e.getAttribute("data-tooltip")?.length>12&&(this.iconButton.classList.remove(i),this.iconButton.classList.remove(n),e.getBoundingClientRect().x<100&&this.iconButton.classList.add(i),e.getBoundingClientRect().x>window.screen.width-100&&this.iconButton.classList.add(n)),this.iconButton.classList.add(t)}handleInfoIconEvents(){let e="tooltip-visible";this.iconButton&&(["mouseenter","focus"].forEach(t=>this.iconButton.addEventListener(t,i=>this.showInfoTooltip(i.target,e),!1)),["mouseleave","blur"].forEach(t=>this.iconButton.addEventListener(t,()=>this.iconButton.classList.remove(e),!1)),this.iconButton.addEventListener("keydown",t=>{t.key==="Escape"&&this.iconButton.classList.remove(e)}))}additionalModalTriggers(){if(!this.settings?.additionalModalTriggers)return;let e=this.variantLayout.aemFragmentMapping.title;this.makeElementModalTrigger(e?.tag,e?.slot),this.makeElementModalTrigger("merch-icon","icons")}handleMasReady(){this.handleInfoIconEvents(),this.additionalModalTriggers()}includes(e){return this.textContent.match(new RegExp(e,"i"))!==null}connectedCallback(){var t;super.connectedCallback(),s(this,rt)||m(this,rt,Xo++),this.aemFragment||((t=s(this,j))==null||t.call(this),m(this,j,void 0)),this.id??(this.id=this.getAttribute("id")??this.aemFragment?.getAttribute("fragment"));let e=this.id??s(this,rt);m(this,Te,`${Mi}${e}${Ot}`),m(this,tt,`${Mi}${e}${Dt}`),performance.mark(s(this,Te)),m(this,re,be()),Zo(s(this,re)),m(this,at,s(this,re).Log.module(rr)),this.addEventListener(O,this.handleQuantitySelection),this.addEventListener(cr,this.handleAddonAndQuantityUpdate),this.addEventListener(Kr,this.handleMerchOfferSelectReady),this.addEventListener(Oe,this.handleAemFragmentEvents),this.addEventListener(Re,this.handleAemFragmentEvents),this.addEventListener(fe,this.handleMasReady),this.addEventListener("change",this.changeHandler),this.variantLayout&&this.variantLayout.connectedCallbackHook(),this.aemFragment||setTimeout(()=>this.checkReady(),0)}makeElementModalTrigger(e,t){let i=e==="merch-icon",n=this.querySelector(`${e}[slot="${t}"]:not(.modal-trigger)`);if(!n)return;let o=this.querySelector("a.button.placeholder-resolved[data-modal]");if(!o)return;n.setAttribute("tabindex","0"),n.addEventListener("click",d=>{o.checkoutActionHandler?.(d)}),n.addEventListener("keypress",d=>{d.code==="Enter"&&o.checkoutActionHandler?.(d)}),n.classList.add("modal-trigger");let l=`${this.title.replace(/\s+/g,"-").toLowerCase()}${i?"-icon":""}--${this.analyticsId}--card`;n.setAttribute("daa-ll",l),n.setAttribute("role","link"),i&&n.setAttribute("alt",this.title)}disconnectedCallback(){super.disconnectedCallback(),this.variantLayout?.disconnectedCallbackHook(),this.removeEventListener(O,this.handleQuantitySelection),this.removeEventListener(Oe,this.handleAemFragmentEvents),this.removeEventListener(Re,this.handleAemFragmentEvents),this.removeEventListener(fe,this.handleMasReady),this.removeEventListener("change",this.changeHandler),this.removeEventListener(cr,this.handleAddonAndQuantityUpdate)}async handleAemFragmentEvents(e){var t;if(this.isConnected&&(e.type===Oe&&w(this,L,Ae).call(this,"AEM fragment cannot be loaded"),e.type===Re&&(this.failed=!1,e.target.nodeName==="AEM-FRAGMENT"))){let i=e.detail;try{s(this,j)||m(this,Le,new Promise(n=>{m(this,j,n)})),await _i(i,this)}catch(n){w(this,L,Ae).call(this,`hydration has failed: ${n.message}`)}finally{(t=s(this,j))==null||t.call(this),m(this,j,void 0)}this.checkReady()}}async checkReady(){if(!this.isConnected||this.failed)return;s(this,Le)&&(await s(this,Le),(Ni.includes(this.variant)||Ii.includes(this.variant))&&Lt.observe(this),m(this,Le,void 0)),this.variantLayoutPromise&&(await this.variantLayoutPromise,this.variantLayoutPromise=void 0);let e=new Promise(l=>setTimeout(()=>l("timeout"),_e));if(this.aemFragment){let l=await Promise.race([this.aemFragment.updateComplete,e]);if(l===!1||l==="timeout"){let d=l==="timeout"?`AEM fragment was not resolved within ${_e} timeout`:"AEM fragment cannot be loaded";w(this,L,Ae).call(this,d,{},!1);return}}let t=[...this.querySelectorAll(Wr)],i=Promise.all(t.map(l=>{let d=l.onceSettled?.();return d?d.catch(()=>l):Promise.resolve(l)})).then(l=>{let d=l.filter(p=>p.isConnected);return d.length===0||d.every(p=>p.classList.contains("placeholder-resolved"))}),n=await Promise.race([i,e]);if(!this.isConnected)return;let o=t.filter(l=>l.isConnected);if(o.length===0||o.every(l=>l.classList.contains("placeholder-resolved"))){this.measure=performance.measure(s(this,tt),s(this,Te));let l={...this.aemFragment?.fetchInfo,...s(this,re).duration,measure:De(this.measure)};return this.dispatchEvent(new CustomEvent(fe,{bubbles:!0,composed:!0,detail:l})),this}else{this.measure=performance.measure(s(this,tt),s(this,Te));let l={measure:De(this.measure),...s(this,re).duration};if(n==="timeout")w(this,L,Ae).call(this,`Contains offers that were not resolved within ${_e} timeout`,l);else{let d=o.some(p=>p.matches(ae)&&p.classList.contains("placeholder-failed"));w(this,L,Ae).call(this,d?"CTA has an invalid offer":"Contains unresolved offers",l)}}}get aemFragment(){return this.querySelector("aem-fragment")}get addon(){return this.querySelector("merch-addon")}get quantitySelect(){return this.querySelector("merch-quantity-select")}get addonCheckbox(){return this.querySelector("merch-addon")}displayFooterElementsInColumn(){if(!this.classList.contains("product"))return;let e=this.shadowRoot.querySelector(".secure-transaction-label");(this.footerSlot?.querySelectorAll(ae)).length===2&&e&&e.parentElement.classList.add("footer-column")}handleMerchOfferSelectReady(){this.offerSelect&&!this.offerSelect.planType||this.displayFooterElementsInColumn()}get dynamicPrice(){return this.querySelector('[slot="price"]')}handleAddonAndQuantityUpdate({detail:{id:e,items:t}}){if(!e||!t?.length||this.closest('[role="tabpanel"][hidden="true"]'))return;let n=this.checkoutLinks.find(p=>p.getAttribute("data-modal-id")===e);if(!n)return;let c=new URL(n.getAttribute("href")).searchParams.get("pa"),l=t.find(p=>p.productArrangementCode===c)?.quantity,d=!!t.find(p=>p.productArrangementCode!==c);if(l&&this.quantitySelect?.dispatchEvent(new CustomEvent(nt,{detail:{quantity:l},bubbles:!0,composed:!0})),this.addonCheckbox&&this.addonCheckbox.checked!==d){this.toggleStockOffer({target:this.addonCheckbox});let p=new Event("change",{bubbles:!0,cancelable:!0});Object.defineProperty(p,"target",{writable:!1,value:{checked:d}}),this.addonCheckbox.handleChange(p)}}get prices(){return Array.from(this.querySelectorAll(C))}get promoPrice(){if(!this.querySelector("span.price-strikethrough"))return;let e=this.querySelector(".price.price-alternative");if(e||(e=this.querySelector(`${C}[data-template="price"] > span`)),!!e)return e=e.innerText,e}get regularPrice(){return s(this,L,zt)?.innerText}get promotionCode(){let e=[...this.querySelectorAll(`${C}[data-promotion-code],${ae}[data-promotion-code]`)].map(i=>i.dataset.promotionCode).filter(i=>![void 0,"cancel-context"].includes(i));if(e.length===0)return this.contextPromotionCode;let t=[...new Set(e)];return t.length>1&&s(this,at)?.warn(`Multiple different promotion codes found: ${t.join(", ")}`),e[0]}get annualPrice(){return this.querySelector(`${C}[data-template="price"] > .price.price-annual`)?.innerText}get promoText(){}get taxText(){return(s(this,L,Dr)??s(this,L,zt))?.querySelector("span.price-tax-inclusivity")?.textContent?.trim()||void 0}get recurrenceText(){return s(this,L,zt)?.querySelector("span.price-recurrence")?.textContent?.trim()}get unitText(){let e=".price-unit-type";return s(this,L,Dr)?.querySelector(e)?.textContent?.trim()??s(this,L,zt)?.querySelector(e)?.textContent?.trim()??this.querySelector(e)?.textContent?.trim()??void 0}get planTypeText(){return this.querySelector('[is="inline-price"][data-template="legal"] span.price-plan-type')?.textContent?.trim()}get seeTermsInfo(){let e=this.querySelector('a[is="upt-link"]');if(e)return w(this,L,tr).call(this,e)}get renewalText(){return this.querySelector("span.renewal-text")?.textContent?.trim()}get promoDurationText(){return this.querySelector("span.promo-duration-text")?.textContent?.trim()}get ctas(){let e=this.querySelector('[slot="ctas"], [slot="footer"]')?.querySelectorAll(`${ae}, a`);return Array.from(e??[])}get primaryCta(){return w(this,L,tr).call(this,this.ctas.find(e=>e.variant==="accent"||e.matches(".spectrum-Button--accent,.con-button.blue")))}get secondaryCta(){return w(this,L,tr).call(this,this.ctas.find(e=>e.variant!=="accent"&&!e.matches(".spectrum-Button--accent,.con-button.blue")))}};Pt=new WeakMap,tt=new WeakMap,rt=new WeakMap,at=new WeakMap,re=new WeakMap,Te=new WeakMap,j=new WeakMap,Le=new WeakMap,L=new WeakSet,Ae=function(e,t={},i=!0){var l;if(!this.isConnected)return;let n=this.aemFragment,o=n?.getAttribute("fragment");o=`[${o}]`;let c={...n?.fetchInfo,...s(this,re).duration,...t,message:e};s(this,at).error(`merch-card${o}: ${e}`,c),this.failed=!0,(l=s(this,j))==null||l.call(this),m(this,j,void 0),s(this,re).isPreview()||(this.style.display="none"),i&&this.dispatchEvent(new CustomEvent(Qr,{bubbles:!0,composed:!0,detail:c}))},zt=function(){return this.querySelector("span.price-strikethrough")??this.querySelector(`${C}[data-template="price"] > span`)},Dr=function(){return this.querySelector(`${C}[data-template="legal"]`)},tr=function(e){if(e)return{text:e.innerText.trim(),analyticsId:e.dataset.analyticsId,href:e.getAttribute("href")??e.dataset.href}},h(ue,"properties",{id:{type:String,attribute:"id",reflect:!0},name:{type:String,attribute:"name",reflect:!0},variant:{type:String,reflect:!0},size:{type:String,attribute:"size",reflect:!0},badgeColor:{type:String,attribute:"badge-color",reflect:!0},borderColor:{type:String,attribute:"border-color",reflect:!0},backgroundColor:{type:String,attribute:"background-color",reflect:!0},badgeBackgroundColor:{type:String,attribute:"badge-background-color",reflect:!0},backgroundImage:{type:String,attribute:"background-image",reflect:!0},badgeText:{type:String,attribute:"badge-text"},actionMenu:{type:Boolean,attribute:"action-menu"},actionMenuLabel:{type:String,attribute:"action-menu-label"},customHr:{type:Boolean,attribute:"custom-hr"},consonant:{type:Boolean,attribute:"consonant"},failed:{type:Boolean,attribute:"failed",reflect:!0},spectrum:{type:String,attribute:"spectrum"},detailBg:{type:String,attribute:"detail-bg"},secureLabel:{type:String,attribute:"secure-label"},checkboxLabel:{type:String,attribute:"checkbox-label"},addonTitle:{type:String,attribute:"addon-title"},addonOffers:{type:Object,attribute:"addon-offers"},selected:{type:Boolean,attribute:"aria-selected",reflect:!0},storageOption:{type:String,attribute:"storage",reflect:!0},planType:{type:String,attribute:"plan-type",reflect:!0},heightSync:{type:Boolean,attribute:"height-sync"},settings:{type:Object,attribute:!1},stockOfferOsis:{type:Object,attribute:"stock-offer-osis",converter:{fromAttribute:e=>{if(!e)return;let[t,i,n]=e.split(",");return{PUF:t,ABM:i,M2M:n}}}},filters:{type:String,reflect:!0,converter:{fromAttribute:e=>Object.fromEntries(e.split(",").map(t=>{let[i,n,o]=t.split(":"),c=Number(n);return[i,{order:isNaN(c)?void 0:c,size:o}]})),toAttribute:e=>Object.entries(e).map(([t,{order:i,size:n}])=>[t,i,n].filter(o=>o!=null).join(":")).join(",")}},types:{type:String,attribute:"types",reflect:!0},merchOffer:{type:Object},analyticsId:{type:String,attribute:er,reflect:!0},loading:{type:String},priceLiterals:{type:Object}}),h(ue,"styles",[Ur,...jr()]),h(ue,"registerVariant",A),h(ue,"getCollectionOptions",Xa),h(ue,"getFragmentMapping",Ft);customElements.define(rr,ue);export{ue as MerchCard};
