var qr=Object.defineProperty;var Ur=a=>{throw TypeError(a)};var Wi=(a,r,e)=>r in a?qr(a,r,{enumerable:!0,configurable:!0,writable:!0,value:e}):a[r]=e;var Ki=(a,r)=>()=>(a&&(r=a(a=0)),r);var Yi=(a,r)=>{for(var e in r)qr(a,e,{get:r[e],enumerable:!0})};var h=(a,r,e)=>Wi(a,typeof r!="symbol"?r+"":r,e),dr=(a,r,e)=>r.has(a)||Ur("Cannot "+e);var s=(a,r,e)=>(dr(a,r,"read from private field"),e?e.call(a):r.get(a)),u=(a,r,e)=>r.has(a)?Ur("Cannot add the same private member more than once"):r instanceof WeakSet?r.add(a):r.set(a,e),m=(a,r,e,t)=>(dr(a,r,"write to private field"),t?t.call(a,e):r.set(a,e),e),y=(a,r,e)=>(dr(a,r,"access private method"),e);var jr=(a,r,e,t)=>({set _(i){m(a,r,i,e)},get _(){return s(a,r,t)}});var hr={};Yi(hr,{default:()=>nt});import{LitElement as Qi,html as Pe,css as Zi,nothing as Xi}from"./lit-all.min.js";import{unsafeHTML as Zr}from"./lit-all.min.js";import{ifDefined as Ji}from"./lit-all.min.js";function en(){return customElements.get("sp-tooltip")!==void 0&&customElements.get("overlay-trigger")!==void 0&&document.querySelector("sp-theme")!==null}var F,nt,pr=Ki(()=>{F=class F extends Qi{constructor(){super(),this.content="",this.placement="top",this.variant="",this.size="xs",this.smartPlacement=!1,this.tooltipVisible=!1,this.lastPointerType=null,this.handleClickOutside=this.handleClickOutside.bind(this),this._tooltipTop=0,this._tooltipLeft=0,this._arrowOffset=0,this._computedPlacement="top"}connectedCallback(){super.connectedCallback(),window.addEventListener("mousedown",this.handleClickOutside),!this.smartPlacement&&this.closest('merch-card[variant="fries"]')&&(this.smartPlacement=!0)}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener("mousedown",this.handleClickOutside)}handleClickOutside(r){let e=r.composedPath();F.activeTooltip===this&&!e.includes(this)&&this.hideTooltip()}_computeTooltipPosition(){let r=this.shadowRoot?.querySelector(".css-tooltip");if(!r)return;let e=r.getBoundingClientRect(),t=window.innerWidth,i=window.innerHeight,n=14,o=200,c=60,l=this.shadowRoot?.querySelector(".css-tooltip-body"),d=l?l.offsetWidth:o,p=l?l.offsetHeight:c,f=this.effectivePlacement;f==="top"&&e.top-p-n<0?f="bottom":f==="bottom"&&e.bottom+p+n>i?f="top":f==="left"&&e.left-d-n<0?f="right":f==="right"&&e.right+d+n>t&&(f="left");let E=e.left+e.width/2,D=e.top+e.height/2,N=6,fe=(ji,Gi,Vi)=>Math.max(ji,Math.min(Gi,Vi)),Mt,Rt,lr;f==="top"||f==="bottom"?(Mt=f==="top"?e.top-p-n:e.bottom+n,Rt=fe(0,t-d,E-d/2),lr=fe(N,d-N*2,E-Rt-N)):(Rt=f==="left"?e.left-d-n:e.right+n,Mt=fe(0,i-p,D-p/2),lr=fe(N,p-N*2,D-Mt-N)),this._tooltipTop=Mt,this._tooltipLeft=Rt,this._arrowOffset=lr,this._computedPlacement=f}showTooltip(){F.activeTooltip&&F.activeTooltip!==this&&(F.activeTooltip.closeOverlay(),F.activeTooltip.tooltipVisible=!1,F.activeTooltip.requestUpdate()),F.activeTooltip=this,this.smartPlacement&&this._computeTooltipPosition(),this.tooltipVisible=!0,this.smartPlacement&&this.updateComplete.then(()=>this._computeTooltipPosition())}hideTooltip(){F.activeTooltip===this&&(F.activeTooltip=null),this.tooltipVisible=!1}handleTap(r){r.preventDefault(),this.tooltipVisible?this.hideTooltip():this.showTooltip()}closeOverlay(){let r=this.shadowRoot?.querySelector("overlay-trigger");r?.open!==void 0&&(r.open=!1)}get effectiveContent(){return this.tooltipText||this.mnemonicText||this.content||this.textContent?.trim()||""}get effectivePlacement(){return this.tooltipPlacement||this.mnemonicPlacement||this.placement||"top"}renderIcon(){return this.src?Pe`<merch-icon
            src="${this.src}"
            size="${this.size}"
        ...
        `}};h(F,"activeTooltip",null),h(F,"properties",{content:{type:String},placement:{type:String},variant:{type:String},src:{type:String},size:{type:String},tooltipText:{type:String,attribute:"tooltip-text"},tooltipPlacement:{type:String,attribute:"tooltip-placement"},mnemonicText:{type:String,attribute:"mnemonic-text"},mnemonicPlacement:{type:String,attribute:"mnemonic-placement"},alt:{type:String},smartPlacement:{type:Boolean,attribute:"smart-placement"},tooltipVisible:{type:Boolean,state:!0},_tooltipTop:{type:Number,state:!0},_tooltipLeft:{type:Number,state:!0},_arrowOffset:{type:Number,state:!0},_computedPlacement:{type:String,state:!0}}),h(F,"styles",Zi`
        :host {
            display: contents;
            overflow: visible;
        }
    ...
    `);nt=F;customElements.define("mas-mnemonic",nt)});import{LitElement as nc}from"./lit-all.min.js";import{css as Kr,unsafeCSS as Wr}from"./lit-all.min.js";var C="(max-width: 767px)",T="(max-width: 1199px)",w="(min-width: 768px)",b="(min-width: 1200px)",_="(min-width: 1600px)",Gr="(min-width: 1280px)",Vr={matchMobile:window.matchMedia(C),matchDesktop:window.matchMedia(`${b} and (not ${_})`),matchDesktopOrUp:window.matchMedia(b),matchLargeDesktop:window.matchMedia(_),get isMobile(){return this.matchMobile.matches},get isDesktop(){return this.matchDesktop.matches},get isDesktopOrUp(){return this.matchDesktopOrUp.matches}},x=Vr;function Ot(){return Vr.isDesktop}var Yr=Kr`
    :host {
...
`,Qr=()=>[Kr`
    ...
    `);customElements.define("merch-icon",_e);var yc=Object.freeze({MONTH:"MONTH",YEAR:"YEAR",TWO_YEARS:"TWO_YEARS",THREE_YEARS:"THREE_YEARS",PERPETUAL:"PERPETUAL",TERM_LICENSE:"TERM_LICENSE",ACCESS_PASS:"ACCESS_PASS",THREE_MONTHS:"THREE_MONTHS",SIX_MONTHS:"SIX_MONTHS"}),wc=Object.freeze({ANNUAL:"ANNUAL",MONTHLY:"MONTHLY",TWO_YEARS:"TWO_YEARS",THREE_YEARS:"THREE_YEARS",P1D:"P1D",P1Y:"P1Y",P3Y:"P3Y",P10Y:"P10Y",P15Y:"P15Y",P3D:"P3D",P7D:"P7D",P30D:"P30D",HALF_YEARLY:"HALF_YEARLY",QUARTERLY:"QUARTERLY"});var Me=2e4;var k='span[is="inline-price"][data-wcs-osi]',ae='a[is="checkout-link"][data-wcs-osi],button[is="checkout-button"][data-wcs-osi]';var nn='a[is="upt-link"]',Jr=`${k},${ae},${nn}`;var ea="merch-offer-select:ready",ta="merch-card:action-menu-toggle";var R="merch-quantity-selector:change",ot="merch-card-quantity:change",mr="merch-modal:addon-and-quantity-update";var Re="merch-card-collection:literals-changed";var Oe="aem:load",De="aem:error",ve="mas:ready",ra="mas:error";var aa="placeholder-failed",ia="placeholder-pending",na="placeholder-resolved";var oa="mas:failed",j="mas:resolved",ca="mas/commerce";var se="failed",be="pending",le="resolved";var Dt="X-Request-Id",Ec=Object.freeze({SEGMENTATION:"segmentation",BUNDLE:"bundle",COMMITMENT:"commitment",RECOMMENDATION:"recommendation",EMAIL:"email",PAYMENT:"payment",CHANGE_PLAN_TEAM_PLANS:"change-plan/team-upgrade/plans",CHANGE_PLAN_TEAM_PAYMENT:"change-plan/team-upgrade/payment"});var kc=Object.freeze({STAGE:"STAGE",PRODUCTION:"PRODUCTION",LOCAL:"LOCAL"});var Nt=":start",Ft=":duration";var O="legal",sa="mas-ff-defaults";var on="mas-commerce-service";function la(a,r){let e;return function(){let t=this,i=arguments;clearTimeout(e),e=setTimeout(()=>a.apply(t,i),r)}}function P(a,r={},e=null,t=null){let i=t?document.createElement(a,{is:t}):document.createElement(a);e instanceof HTMLElement?i.appendChild(e):i.innerHTML=e;for(let[n,o]of Object.entries(r))i.setAttribute(n,o);return i}function Ne(a){return`startTime:${a.startTime.toFixed(2)}|duration:${a.duration.toFixed(2)}`}function gr(){return window.matchMedia("(max-width: 1024px)").matches}function xe(){return document.getElementsByTagName(on)?.[0]}function ct(a){let r=window.getComputedStyle(a);return a.offsetHeight+parseFloat(r.marginTop)+parseFloat(r.marginBottom)}function da(a){let r=a.nextElementSibling?.nodeName==="BR"?a.nextElementSibling.nextElementSibling:a.nextElementSibling;return a.dataset.template==="strikethrough"&&(a.nextSibling?.nodeName!=="#text"||a.nextSibling.textContent.trim().length<2)&&r?.isInlinePrice&&r?.dataset?.template==="price"}var cn=/^([a-z0-9]+(-[a-z0-9]+)*)(--([a-z0-9]+(-[a-z0-9]+)*)){0,2}$/,sn=100,ln=["live","page"];function ha(a,r="live"){if(!a||a.trim()===""||!ln.includes(r))return null;let e=a.trim().toLowerCase();if(e==="local")return"http://localhost:3000";if(e.length>sn||!cn.test(e))return null;let t=e.includes("--")?e:`${e}--mas--adobecom`,i;try{i=new URL(`https://${t}.aem.${r}`)}catch{return null}return i.hostname.endsWith(`.aem.${r}`)?i.origin:null}var st,ye,lt,dt,Fe,It=class extends HTMLElement{constructor(){super();u(this,st,"");u(this,ye);u(this,lt,[]);u(this,dt,[]);u(this,Fe);m(this,Fe,la(()=>{this.isConnected&&(this.parentElement.style.background=this.value,s(this,ye)?this.parentElement.style.borderRadius=s(this,ye):s(this,ye)===""&&(this.parentElement.style.borderRadius=""))},1))}static get observedAttributes(){return["colors","positions","angle","border-radius"]}get value(){let e=s(this,lt).map((t,i)=>{let n=s(this,dt)[i]||"";return`${t} ${n}`}).join(", ");return`linear-gradient(${s(this,st)}, ${e})`}connectedCallback(){s(this,Fe).call(this)}attributeChangedCallback(e,t,i){e==="border-radius"&&m(this,ye,i?.trim()),e==="colors"&&i?m(this,lt,i?.split(",").map(n=>n.trim())??[]):e==="positions"&&i?m(this,dt,i?.split(",").map(n=>n.trim())??[]):e==="angle"&&m(this,st,i?.trim()??""),s(this,Fe).call(this)}};st=new WeakMap,ye=new WeakMap,lt=new WeakMap,dt=new WeakMap,Fe=new WeakMap;customElements.define("merch-gradient",It);import{LitElement as dn,html as hn,css as pn}from"./lit-all.min.js";var Ie=class extends dn{constructor(){super(),this.planType=void 0,this.checked=!1,this.updatePlanType=this.updatePlanType.bind(this),this.handleChange=this.handleChange.bind(this),this.handleCustomClick=this.handleCustomClick.bind(this)}getOsi(r,e){let n=({TRIAL:["TRIAL"],BASE:["BASE","PROMOTION","TRIAL"],PROMOTION:["PROMOTION","BASE","TRIAL"]}[e]||[e]).map(c=>`p[data-plan-type="${r}"] ${k}[data-offer-type="${c}"]`).join(", ");return this.querySelector(n)?.dataset?.wcsOsi}connectedCallback(){super.connectedCallback(),this.addEventListener(j,this.updatePlanType),this.background&&this.style.setProperty("--merch-addon-background",this.background)}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener(j,this.updatePlanType)}updatePlanType(r){if(r.target.tagName!=="SPAN")return;let e=r.target,t=e?.value?.[0];if(!t)return;e.setAttribute("data-offer-type",t.offerType);let i=e.closest("p");if(i.getAttribute("data-plan-type"))return;let n=this.querySelector(`p[data-plan-type="${t.planType}"]`);n&&n!==i||i.setAttribute("data-plan-type",t.planType)}handleChange(r){this.checked=r.target.checked,this.dispatchEvent(new CustomEvent("change",{detail:{checked:this.checked},bubbles:!0,composed:!0}))}handleCustomClick(){this.shadowRoot.querySelector("input").click()}handleKeyDown(r){r.key===" "&&(r.preventDefault(),this.handleCustomClick())}render(){return hn` <input
                type="checkbox"
                id="addon-checkbox"
    ...
    `);customElements.define("merch-addon",Ie);import{html as $t,nothing as mn}from"./lit-all.min.js";var $e,ht=class ht{constructor(r){h(this,"card");u(this,$e);this.card=r,this.insertVariantStyle()}getContainer(){return m(this,$e,s(this,$e)??this.card.closest('merch-card-collection, [class*="-merch-cards"]')??this.card.parentElement),s(this,$e)}insertVariantStyle(){let r=this.constructor.name;if(!ht.styleMap[r]){ht.styleMap[r]=!0;let e=document.createElement("style");e.innerHTML=this.getGlobalCSS(),document.head.appendChild(e)}}updateCardElementMinHeight(r,e){if(!r||this.card.heightSync===!1)return;let t=`--consonant-merch-card-${this.card.variant}-${e}-height`,i=Math.max(0,parseInt(window.getComputedStyle(r).height)||0),n=this.getContainer(),o=parseInt(n.style.getPropertyValue(t))||0;i>o&&n.style.setProperty(t,`${i}px`)}syncRowHeights(r){if(this.card.heightSync===!1)return;let e=this.getContainer();if(!e)return;let t=this.card.variant,i=Array.from(e.querySelectorAll(`merch-card[variant="${t}"]`)).filter(o=>o.variantLayout?.card?.heightSync!==!1);if(i.length===0)return;for(let{name:o}of r){let c=`--consonant-merch-card-${t}-${o}-height`;e.style.getPropertyValue(c)&&e.style.removeProperty(c)}let n=new Map;for(let o of i){let c=o.getBoundingClientRect();if(c.width<=2)continue;let l=Math.round(c.top),d=n.get(l);d||(d=[],n.set(l,d)),d.push(o)}for(let o of n.values())for(let{name:c,getElement:l}of r){let d=`--consonant-merch-card-${t}-${c}-height`,p=o.map(f=>f.style.getPropertyValue(d)),g=0;for(let f of o){f.style.removeProperty(d);let E=l(f);if(!E)continue;let D=Math.max(0,parseInt(window.getComputedStyle(E).height)||0);D>g&&(g=D)}o.forEach((f,E)=>{g>0?f.style.setProperty(d,`${g}px`):p[E]&&f.style.setProperty(d,p[E])})}}get legalDisplayDot(){return!0}get badge(){let r;if(!(!this.card.badgeBackgroundColor||!this.card.badgeColor||!this.card.badgeText))return this.evergreen&&(r=`border: 1px solid ${this.card.badgeBackgroundColor}; border-right: none;`),$t`
            <div
                id="badge"
...
merch-card[variant="catalog"] [slot="footer"] .spectrum-Link--primary {
  ...
  font-weight: 700;
    ...
    `);import{html as pt,css as un}from"./lit-all.min.js";var ga=`
:root {
...
`;var Bt=class extends v{constructor(r){super(r)}getGlobalCSS(){return fa}renderLayout(){return va` ${this.badge}
            <div class="body">
                <div class="top-section">
                    <slot name="icons"></slot>
                    <slot name="heading-xs"></slot>
            ...
            ${this.card.customHr?"":va`<hr />`} ${this.secureLabelFooter}`}};import{html as de,css as fn,unsafeCSS as xa}from"./lit-all.min.js";var ba=`
  :root {
...
`;var vn=32,ya={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},subtitle:{tag:"p",slot:"subtitle"},prices:{tag:"p",slot:"heading-m-price"},promoText:{tag:"div",slot:"promo-text"},shortDescription:{tag:"div",slot:"body-xxs"},description:{tag:"div",slot:"body-m"},mnemonics:{size:"l"},quantitySelect:{tag:"div",slot:"quantity-select"},callout:{tag:"div",slot:"callout-content"},addon:!0,secureLabel:!0,planType:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300-plans"},allowedBadgeColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-gray-700-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],allowedBorderColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],whatsIncludedDividerColor:{attribute:"whats-included-divider-color"},allowedWhatsIncludedDividerColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],borderColor:{attribute:"border-color"},size:["wide","super-wide"],whatsIncluded:{tag:"div",slot:"footer-rows"},ctas:{slot:"footer",size:"l"},style:"consonant"},Be=class extends v{constructor(e){super(e);h(this,"getRowMinHeightPropertyName",e=>`--consonant-merch-card-footer-row-${e}-min-height`);h(this,"getMiniCompareFooter",()=>{let e=this.card.secureLabel?de`<slot name="secure-transaction-label">
    ...
    `);import{html as qt,css as bn,unsafeCSS as fr,nothing as xn}from"./lit-all.min.js";var wa=`
  :root {
...
`;var yn=32,Ea={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},subtitle:{tag:"p",slot:"subtitle"},prices:{tag:"p",slot:"heading-m-price"},promoText:{tag:"div",slot:"promo-text"},shortDescription:{tag:"div",slot:"body-m"},description:{tag:"div",slot:"body-xs"},mnemonics:{size:"l"},secureLabel:!0,planType:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300-plans"},allowedBadgeColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-gray-700-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],allowedBorderColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-green-900-plans","spectrum-red-700-plans","gradient-purple-blue"],borderColor:{attribute:"border-color"},size:["wide","super-wide"],ctas:{slot:"footer",size:"l"},style:"consonant"},X,qe=class extends v{constructor(e){super(e);u(this,X);h(this,"getRowMinHeightPropertyName",e=>`--consonant-merch-card-footer-row-${e}-min-height`);h(this,"getMiniCompareFooter",()=>qt` <footer>
        ...
        @media screen and ${fr(b)} {
            :host([variant='mini-compare-chart-mweb']) footer {
                padding: 0;
            }
        }

        @media screen and ${fr(w)} {
            :host([variant='mini-compare-chart-mweb'])
                .price-wrapping
                > slot[name='subtitle'] {
                min-height: var(
    ...
    `);import{html as mt,css as wn,nothing as Ut}from"./lit-all.min.js";var ka=`
:root {
...
`;var jt={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},subtitle:{tag:"p",slot:"subtitle"},prices:{tag:"p",slot:"heading-m"},promoText:{tag:"p",slot:"promo-text"},description:{tag:"div",slot:"body-xs"},mnemonics:{size:"l"},callout:{tag:"div",slot:"callout-content"},quantitySelect:{tag:"div",slot:"quantity-select"},addon:!0,secureLabel:!0,planType:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300-plans"},allowedBadgeColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-gray-700-plans","spectrum-green-900-plans","gradient-purple-blue"],allowedBorderColors:["spectrum-yellow-300-plans","spectrum-gray-300-plans","spectrum-green-900-plans","gradient-purple-blue"],borderColor:{attribute:"border-color"},size:["wide","super-wide"],whatsIncluded:{tag:"div",slot:"whats-included"},ctas:{slot:"footer",size:"m"},style:"consonant",perUnitLabel:{tag:"span",slot:"per-unit-label"}},Ca={...function(){let{whatsIncluded:a,size:r,...e}=jt;return e}(),title:{tag:"h3",slot:"heading-s"},secureLabel:!1},Sa={...function(){let{subtitle:a,whatsIncluded:r,size:e,quantitySelect:t,...i}=jt;return i}()},J,ee,I=class extends v{constructor(e){super(e);u(this,J);u(this,ee);this.adaptForMedia=this.adaptForMedia.bind(this)}priceOptionsProvider(e,t){e.dataset.template===O&&(t.displayPlanType=this.card?.settings?.displayPlanType??!1)}getGlobalCSS(){return ka}adjustSlotPlacement(e,t,i){let n=this.card.shadowRoot,o=n.querySelector("footer"),c=this.card.getAttribute("size");if(!c)return;let l=n.querySelector(`footer slot[name="${e}"]`),d=n.querySelector(`.body slot[name="${e}"]`),p=n.querySelector(".body");if(c.includes("wide")||(o?.classList.remove("wide-footer"),l&&l.remove()),!!t.includes(c)){if(o?.classList.toggle("wide-footer",x.isDesktopOrUp),!i&&l){if(d)l.remove();else{let g=p.querySelector(`[data-placeholder-for="${e}"]`);g?g.replaceWith(l):p.appendChild(l)}return}if(i&&d){let g=document.createElement("div");if(g.setAttribute("data-placeholder-for",e),g.classList.add("slot-placeholder"),!l){let f=d.cloneNode(!0);o.prepend(f)}d.replaceWith(g)}}}adaptForMedia(){if(!this.card.closest("merch-card-collection,overlay-trigger,.two-merch-cards,.three-merch-cards,.four-merch-cards, .columns")){this.card.removeAttribute("size");return}this.adjustSlotPlacement("addon",["super-wide"],x.isDesktopOrUp),this.adjustSlotPlacement("callout-content",["super-wide"],x.isDesktopOrUp)}adjustCallout(){let e=this.card.querySelector('[slot="callout-content"] .icon-button');e&&e.title&&(e.dataset.tooltip=e.title,e.removeAttribute("title"),e.classList.add("hide-tooltip"),document.addEventListener("touchstart",t=>{t.preventDefault(),t.target!==e?e.classList.add("hide-tooltip"):t.target.classList.toggle("hide-tooltip")}),document.addEventListener("mouseover",t=>{t.preventDefault(),t.target!==e?e.classList.add("hide-tooltip"):t.target.classList.remove("hide-tooltip")}))}syncHeights(){if(this.card.getBoundingClientRect().width<=2){s(this,J)||(m(this,J,new ResizeObserver(()=>{this.card.getBoundingClientRect().width>2&&(s(this,J)?.disconnect(),m(this,J,null),this.syncHeights())})),s(this,J).observe(this.card));return}let e=["heading-xs","subtitle","heading-m","promo-text","body-xs"];this.syncRowHeights(e.map(t=>({name:t,getElement:i=>i.querySelector(`[slot="${t}"]`)})))}async adjustEduLists(){if(this.card.variant!=="plans-education"||this.card.querySelector(".spacer"))return;let t=this.card.querySelector('[slot="body-xs"]');if(!t)return;let i=t.querySelector("ul");if(!i)return;let n=i.previousElementSibling,o=document.createElement("div");o.classList.add("spacer"),t.insertBefore(o,n);let c=new IntersectionObserver(([l])=>{if(l.boundingClientRect.height===0)return;let d=0,p=this.card.querySelector('[slot="heading-s"]');p&&(d+=ct(p));let g=this.card.querySelector('[slot="subtitle"]');g&&(d+=ct(g));let f=this.card.querySelector('[slot="heading-m"]');f&&(d+=8+ct(f));for(let D of t.childNodes){if(D.classList.contains("spacer"))break;d+=ct(D)}let E=this.card.parentElement.style.getPropertyValue("--merch-card-plans-edu-list-max-offset");d>(parseFloat(E)||0)&&this.card.parentElement.style.setProperty("--merch-card-plans-edu-list-max-offset",`${d}px`),this.card.style.setProperty("--merch-card-plans-edu-list-offset",`${d}px`),c.disconnect()});c.observe(this.card)}async postCardUpdateHook(){this.adaptForMedia(),this.adjustAddon(),this.adjustCallout(),this.legalAdjusted||(await this.adjustLegal(),await this.adjustEduLists()),await super.postCardUpdateHook(),window.matchMedia("(min-width: 768px)").matches&&this.card===this.card.parentElement.firstElementChild&&requestAnimationFrame(()=>{this.syncHeights()})}get headingM(){return this.card.querySelector('[slot="heading-m"]')}get mainPrice(){return this.headingM?.querySelector(`${k}[data-template="price"]`)}get divider(){return this.card.variant==="plans-education"?mt`<div class="divider"></div>`:Ut}async adjustLegal(){if(!this.legalAdjusted)try{this.legalAdjusted=!0,await this.card.updateComplete,await customElements.whenDefined("inline-price");let e=[],t=this.card.querySelector(`[slot="heading-m"] ${k}[data-template="price"]`);t&&e.push(t);let i=e.map(async n=>{let o=n.cloneNode(!0);await n.onceSettled(),n?.options&&(n.options.displayPerUnit&&(n.dataset.displayPerUnit="false"),n.options.displayTax&&(n.dataset.displayTax="false"),n.options.displayPlanType&&(n.dataset.displayPlanType="false"),o.setAttribute("data-template","legal"),n.parentNode.insertBefore(o,n.nextSibling),await o.onceSettled())});await Promise.all(i)}catch{}}async adjustAddon(){await this.card.updateComplete;let e=this.card.addon;if(!e)return;e.setAttribute("custom-checkbox","");let t=this.mainPrice;if(!t)return;await t.onceSettled?.();let i=t.value?.[0]?.planType;i&&(e.planType=i)}get stockCheckbox(){return this.card.checkboxLabel?mt`<label id="stock-checkbox">
            ...
            ${this.secureLabelFooter}
            <slot></slot>`}};J=new WeakMap,ee=new WeakMap,h(I,"variantStyle",wn`
        :host([variant^='plans']) {
            min-height: 273px;
    ...
    `),h(I,"collectionOptions",{customHeaderArea:e=>e.sidenav?mt`<slot name="resultsText"></slot>`:Ut,headerVisibility:{search:!1,sort:!1,result:["mobile","tablet"],custom:["desktop"]},onSidenavAttached:e=>{let t=()=>{let i=e.querySelectorAll("merch-card");for(let o of i)o.hasAttribute("data-size")&&(o.setAttribute("size",o.getAttribute("data-size")),o.removeAttribute("data-size"));if(!x.isDesktop)return;let n=0;for(let o of i){if(o.style.display==="none")continue;let c=o.getAttribute("size"),l=c==="wide"?2:c==="super-wide"?3:1;l===2&&n%3===2&&(o.setAttribute("data-size",c),o.removeAttribute("size"),l=1),n+=l}};x.matchDesktop.addEventListener("change",t),e.addEventListener(Re,t),e.onUnmount.push(()=>{x.matchDesktop.removeEventListener("change",t),e.removeEventListener(Re,t)})}});import{html as ie,css as En,unsafeCSS as Ta,nothing as Gt}from"./lit-all.min.js";var Aa=`
:root {
...
`)[0].trim()}updateShortDescriptionVisibility(){let r=this.card.querySelector('[slot="short-description"]');if(!r)return;let e=r.querySelector("strong, b, p");e&&(x.isMobile?e.style.display="none":e.style.display="")}toggleShortDescription(){this.shortDescriptionExpanded=!this.shortDescriptionExpanded,this.card.requestUpdate()}get shortDescriptionToggle(){return this.hasShortDescription?x.isMobile?ie`
        ...
        `:ie`
            ...
            <slot></slot>`}};h(he,"variantStyle",En`
    ...
    `),h(he,"collectionOptions",{customHeaderArea:r=>r.sidenav?ie`<slot name="resultsText"></slot>`:Gt,headerVisibility:{search:!1,sort:!1,result:["mobile","tablet"],custom:["desktop"]},onSidenavAttached:r=>{let e=()=>{let t=r.querySelectorAll("merch-card");if(t.forEach(n=>{n.hasAttribute("data-size")&&(n.setAttribute("size",n.getAttribute("data-size")),n.removeAttribute("data-size"))}),!x.isDesktop)return;let i=0;t.forEach(n=>{if(n.style.display==="none")return;let o=n.getAttribute("size"),c=o==="wide"?2:o==="super-wide"?3:1;c===2&&i%3===2&&(n.setAttribute("data-size",o),n.removeAttribute("size"),c=1),i+=c})};x.matchDesktop.addEventListener("change",e),r.addEventListener(Re,e),r.onUnmount.push(()=>{x.matchDesktop.removeEventListener("change",e),r.removeEventListener(Re,e)})}});import{html as pe,css as kn,nothing as gt,unsafeCSS as Cn}from"./lit-all.min.js";var za=`
:root {
...
`;var[Ys,Qs,Pa,_a,Ma,Ra]=["ArrowLeft","ArrowRight","ArrowUp","ArrowDown","Enter","Tab"];var Sn="pro",Oa=`--consonant-merch-card-${Sn}-top-card-height`,Da={cardName:{attribute:"name"},subtitle:{tag:"p",slot:"subtitle"},title:{tag:"h3",slot:"heading-xs"},description:{tag:"div",slot:"body-xs"},mnemonics:{size:"s"},size:["wide","edu"],prices:{tag:"p",slot:"heading-m"},promoText:{tag:"p",slot:"promo-text"},perUnitLabel:{tag:"span",slot:"per-unit-label"},callout:{tag:"div",slot:"callout-content",editorLabel:"License callout"},quantitySelect:{tag:"div",slot:"quantity-select"},shortDescription:{tag:"div",slot:"legal-text"},secureLabel:!0,planType:!0,addon:!0,ctas:{slot:"footer",size:"m"},whatsIncluded:{tag:"div",slot:"whats-included"},backgroundColor:{attribute:"background-color",editorLabel:"Theme",specialValues:{Light:"light",Dark:"dark"}},borderColor:{attribute:"border-color",specialValues:{Black:"black"}},allowedBorderColors:[],style:"consonant"},ne,Ee,bt,L,Na,ut,Fa,ft,vr,Vt,Wt=class Wt extends v{constructor(e){super(e);u(this,L);h(this,"expanded",!1);h(this,"licenseOpen",!1);h(this,"licenseQty",null);h(this,"licenseHighlightedIndex",0);u(this,ne,null);u(this,Ee,null);h(this,"lastSyncKey",null);u(this,bt,({detail:e})=>{let t=e?.quantity==null?null:String(e.quantity);t==null||t===this.licenseQty||this.licenseOptions?.includes(t)&&(this.licenseQty=t,this.card.requestUpdate())});h(this,"toggleExpanded",e=>{e.preventDefault();let t=!this.expanded;for(let i of y(this,L,Na).call(this)){let n=i.variantLayout;n instanceof Wt&&(n.expanded=t,i._proExpanded=t,i.requestUpdate())}});h(this,"toggleLicensePopover",e=>{e.preventDefault(),e.stopPropagation(),this.licenseOpen?y(this,L,vr).call(this):y(this,L,ft).call(this),this.card.requestUpdate()});u(this,Vt,e=>{let t=this.licenseOptions;if(!t?.length)return;let i=t.length-1;switch(e.key){case _a:e.preventDefault(),this.licenseOpen?this.licenseHighlightedIndex=(this.licenseHighlightedIndex+1)%t.length:y(this,L,ft).call(this);break;case Pa:e.preventDefault(),this.licenseOpen?this.licenseHighlightedIndex=(this.licenseHighlightedIndex-1+t.length)%t.length:y(this,L,ft).call(this);break;case"Home":if(!this.licenseOpen)return;e.preventDefault(),this.licenseHighlightedIndex=0;break;case"End":if(!this.licenseOpen)return;e.preventDefault(),this.licenseHighlightedIndex=i;break;case Ma:case" ":if(e.preventDefault(),this.licenseOpen){this.selectLicenseQty(t[this.licenseHighlightedIndex]);return}y(this,L,ft).call(this);break;case"Escape":if(!this.licenseOpen)return;e.preventDefault(),y(this,L,vr).call(this);break;case Ra:this.licenseOpen&&this.selectLicenseQty(t[this.licenseHighlightedIndex]);return;default:return}this.card.requestUpdate()});h(this,"selectLicenseQty",e=>{this.licenseQty=e,this.licenseOpen=!1,y(this,L,ut).call(this);let t=this.quantitySelectEl;t&&(t.selectedValue=Number(e),t.dispatchEvent(new CustomEvent(R,{detail:{option:Number(e)},bubbles:!0}))),this.card.requestUpdate()});this.updatePriceQuantity=this.updatePriceQuantity.bind(this),this.expanded=e._proExpanded??!1}getGlobalCSS(){return za}priceOptionsProvider(e,t){e.dataset.template===O&&(t.displayPlanType=this.card?.settings?.displayPlanType??!1)}async adjustLegal(){if(!this.legalAdjusted)try{this.legalAdjusted=!0,await this.card.updateComplete,await customElements.whenDefined("inline-price");let e=this.mainPrice;if(!e)return;let t=e.cloneNode(!0);if(await e.onceSettled(),!e?.options)return;e.options.displayTax&&(e.dataset.displayTax="false"),e.options.displayPlanType&&(e.dataset.displayPlanType="false"),t.setAttribute("data-template","legal"),t.dataset.displayPerUnit="false",e.parentNode.insertBefore(t,e.nextSibling),await t.onceSettled(),this.legalResolvedHandler||(this.legalResolvedHandler=()=>this.adjustShortDescription(),t.addEventListener(j,this.legalResolvedHandler)),this.adjustShortDescription()}catch{}}adjustShortDescription(){let e=this.card.querySelector('[slot="legal-text"]')?.textContent?.trim();if(!e)return;let t=this.card.querySelector('[slot="heading-m"] [data-template="legal"]'),i=t?.querySelector(".price-plan-type");if(!i)return;i.textContent=e;let n=t.querySelector(".price-tax-inclusivity:not(.disabled)");n?.textContent&&!/\s$/.test(n.textContent)&&(n.textContent+=". ")}get hasWhatsIncluded(){return!!this.card.querySelector('[slot="whats-included"]')}get whatsIncludedToggleLabel(){return this.card.querySelector('[slot="whats-included"] .whats-included-label')?.textContent.trim()||"See what's included:"}get hasCallout(){return!!this.card.querySelector('[slot="callout-content"]')}get hasQuantitySelect(){let e=this.quantitySelectEl;return e?!!e.getAttribute("title")||parseInt(e.getAttribute("min"),10)>0||parseInt(e.getAttribute("step"),10)>0:!1}get hasAddOn(){return!!this.card.querySelector('[slot="addon"]')}get mainPrice(){return this.card.querySelector(`[slot="heading-m"] ${k}[data-template="price"]`)}updatePriceQuantity({detail:e}){!this.mainPrice||!e?.option||(this.mainPrice.dataset.quantity=e.option)}async adjustAddon(){await this.card.updateComplete;let e=this.card.addon;if(!e)return;e.setAttribute("custom-checkbox","");let t=this.mainPrice;if(!t)return;await t.onceSettled?.();let i=t.value?.[0]?.planType;i&&(e.planType=i)}async postCardUpdateHook(){await this.adjustAddon(),this.legalAdjusted||await this.adjustLegal(),this.adjustShortDescription(),await super.postCardUpdateHook(),window.matchMedia("(min-width: 768px)").matches&&this.syncHeights()}async waitForContentFonts(){let e=[this.card.querySelector('[slot="heading-xs"]'),this.card.querySelector('[slot="body-xs"]')].filter(Boolean);document.fonts?.load&&await Promise.all(e.map(t=>{let i=window.getComputedStyle(t),n=`${i.fontWeight} ${i.fontSize} ${i.fontFamily}`;return document.fonts.load(n,t.textContent).catch(()=>null)})),await document.fonts?.ready}async syncHeights(){if(this.card.heightSync===!1)return;await this.waitForContentFonts(),await new Promise(c=>requestAnimationFrame(c)),await new Promise(c=>requestAnimationFrame(c));let e=this.getContainer();if(!e||this.card.getBoundingClientRect().width<=2)return;let t=this.card.variant,i=Oa,n=[...e.querySelectorAll(`merch-card[variant="${t}"]`)].filter(c=>c.getBoundingClientRect().width>2&&c.variantLayout?.card?.heightSync!==!1),o=new Map;for(let c of n){let l=o.get(c.offsetTop)??[];l.push(c),o.set(c.offsetTop,l)}for(let c of o.values()){let l=0;for(let d of c){d.style.removeProperty(i);let p=d.shadowRoot?.querySelector(".top-card");p&&(l=Math.max(l,parseInt(getComputedStyle(p).height)||0))}l>0&&c.length>1&&c.forEach(d=>d.style.setProperty(i,`${l}px`))}}resyncOnReflow(){let e=this.card.getBoundingClientRect().width;if(e<=2)return;let t=this.card.querySelector('[slot="body-xs"]'),i=t?Math.round(t.getBoundingClientRect().height):0,n=`${Math.round(e)}:${i}`;n!==this.lastSyncKey&&(this.lastSyncKey=n,this.syncHeights())}connectedCallbackHook(){if(!this.card||(this.card.addEventListener(ot,s(this,bt)),this.card.addEventListener(R,this.updatePriceQuantity),typeof ResizeObserver>"u"))return;m(this,Ee,new ResizeObserver(()=>this.resyncOnReflow())),s(this,Ee).observe(this.card);let e=this.card.querySelector('[slot="body-xs"]');e&&s(this,Ee).observe(e)}disconnectedCallbackHook(){this.card?.removeEventListener(R,this.updatePriceQuantity),y(this,L,ut).call(this),s(this,Ee)?.disconnect(),this.card?.removeEventListener(ot,s(this,bt))}get quantitySelectEl(){return this.card.querySelector("merch-quantity-select")}get licenseOptions(){let e=this.quantitySelectEl;if(!e)return null;let t=parseInt(e.getAttribute("min"),10),i=parseInt(e.getAttribute("max"),10),n=parseInt(e.getAttribute("step"),10)||1;if(Number.isNaN(t)||Number.isNaN(i)||i<t)return null;let o=[];for(let c=t;c<=i;c+=n)o.push(String(c));return o.length?o:null}licenseLabel(e){let t=this.quantitySelectEl?.getAttribute("title")||"License",[i,n]=t.split("|").map(o=>o.trim());return Number(e)===1?i:n||i}get hasLicenseSelector(){return(this.licenseOptions?.length??0)>0}get currentLicenseValue(){let e=this.licenseOptions;if(!e?.length)return null;if(this.licenseQty!=null)return this.licenseQty;let t=this.quantitySelectEl?.getAttribute("default-value");return t!=null&&e.includes(t)?t:e[0]}renderLicenseSelector(){if(!this.hasLicenseSelector)return pe`<slot name="quantity-select"></slot>`;let e=this.licenseOptions,t=this.currentLicenseValue,i=!!this.licenseOpen,n=this.licenseLabel(Number(t));return pe`
        ...
        `}renderLayout(){let e=!!this.expanded;return pe`
            <div class="top-card">
                <div class="mnemonic">
                    <slot name="icons"></slot>
                    <slot name="subtitle"></slot>
            ...
            ${this.hasWhatsIncluded?pe`
                  ...
                  `:gt}
            <slot></slot>
        `}};ne=new WeakMap,Ee=new WeakMap,bt=new WeakMap,L=new WeakSet,Na=function(){let e=this.card.offsetTop,t=Array.from(this.getContainer()?.querySelectorAll(`merch-card[variant="${this.card.variant}"]`)??[]).filter(i=>i.getBoundingClientRect().width>2&&i.offsetTop===e);return t.length?t:[this.card]},ut=function(){s(this,ne)&&(document.removeEventListener("mousedown",s(this,ne)),m(this,ne,null))},Fa=function(){let e=this.licenseOptions?.indexOf(this.currentLicenseValue);return e>0?e:0},ft=function(){this.licenseOpen=!0,this.licenseHighlightedIndex=y(this,L,Fa).call(this),s(this,ne)||(m(this,ne,e=>{e.composedPath().includes(this.card)||(this.licenseOpen=!1,this.card.requestUpdate(),y(this,L,ut).call(this))}),document.addEventListener("mousedown",s(this,ne)))},vr=function(){this.licenseOpen=!1,y(this,L,ut).call(this)},Vt=new WeakMap,h(Wt,"variantStyle",kn`
        :host([variant='pro']) {
            display: flex;
            flex-direction: column;
            background: var(
    ...
    `);var vt=Wt;import{html as br,css as An}from"./lit-all.min.js";var Ia=`
:root {
...
`;var $a={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},prices:{tag:"p",slot:"heading-xs"},promoText:{tag:"p",slot:"promo-text"},description:{tag:"div",slot:"body-xs"},shortDescription:{tag:"div",slot:"short-description"},mnemonics:{size:"l"},callout:{tag:"div",slot:"callout-content"},quantitySelect:{tag:"div",slot:"quantity-select"},secureLabel:!0,planType:!0,addon:!0,addonBackground:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"color-yellow-300-variation"},allowedBadgeColors:["color-yellow-300-variation","color-gray-300-variation","color-gray-700-variation","color-green-900-variation","gradient-purple-blue"],allowedBorderColors:["color-yellow-300-variation","color-gray-300-variation","color-green-900-variation","gradient-purple-blue"],borderColor:{attribute:"border-color"},whatsIncluded:{tag:"div",slot:"whats-included"},ctas:{slot:"footer",size:"m"},style:"consonant",perUnitLabel:{tag:"span",slot:"per-unit-label"}},te,Ue=class extends v{constructor(e){super(e);u(this,te);this.postCardUpdateHook=this.postCardUpdateHook.bind(this),this.updatePriceQuantity=this.updatePriceQuantity.bind(this)}getGlobalCSS(){return Ia}priceOptionsProvider(e,t){e.dataset.template===O&&(t.displayPlanType=this.card?.settings?.displayPlanType??!1,(e.dataset.template==="strikethrough"||e.dataset.template==="price")&&(t.displayPerUnit=!1))}adjustProductBodySlots(){if(this.card.getBoundingClientRect().width===0)return;["heading-xs","body-xxs","body-xs","promo-text","callout-content","addon","body-lower"].forEach(t=>this.updateCardElementMinHeight(this.card.shadowRoot.querySelector(`slot[name="${t}"]`),t))}renderLayout(){return br` ${this.badge}
            <div class="body" aria-live="polite">
                <slot name="icons"></slot>
                <slot name="heading-xs"></slot>
                ${this.promoBottom?"":br`<slot name="promo-text"></slot>`}
                <slot name="body-xs"></slot>
                <slot name="short-description"></slot>
                <slot name="addon"></slot>
                ${this.promoBottom?br`<slot name="promo-text"></slot>`:""}
    ...
    `);import{html as xr,css as Tn}from"./lit-all.min.js";var Ha=`
:root {
...
`;var Ba={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},prices:{tag:"p",slot:"heading-xs"},promoText:{tag:"p",slot:"promo-text"},description:{tag:"div",slot:"body-xs"},callout:{tag:"div",slot:"callout-content"},planType:!0,secureLabel:!0,badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"color-red-700-variation"},allowedBadgeColors:["color-yellow-300-variation","color-gray-300-variation","color-gray-700-variation","color-green-900-variation","color-red-700-variation","gradient-purple-blue"],allowedBorderColors:["color-yellow-300-variation","color-gray-300-variation","color-green-900-variation","color-red-700-variation","gradient-purple-blue"],borderColor:{attribute:"border-color"},ctas:{slot:"footer",size:"m"},style:"consonant",perUnitLabel:{tag:"span",slot:"per-unit-label"}},je=class extends v{constructor(r){super(r)}priceOptionsProvider(r,e){r.dataset.template===O&&(e.displayPlanType=this.card?.settings?.displayPlanType??!1,(r.dataset.template==="strikethrough"||r.dataset.template==="price")&&(e.displayPerUnit=!1))}getGlobalCSS(){return Ha}get badgeElement(){return this.card.querySelector('[slot="badge"]')}get mainPrice(){return this.card.querySelector(`[slot="heading-xs"] ${k}[data-template="price"]`)}async postCardUpdateHook(){this.legalAdjusted||await this.adjustLegal(),await super.postCardUpdateHook()}async adjustLegal(){if(!(this.legalAdjusted||!this.card.id))try{this.legalAdjusted=!0,await this.card.updateComplete,await customElements.whenDefined("inline-price");let r=this.mainPrice;if(!r)return;let e=r.cloneNode(!0);if(await r.onceSettled(),!r?.options)return;r.options.displayPerUnit&&(r.dataset.displayPerUnit="false"),r.options.displayTax&&(r.dataset.displayTax="false"),r.options.displayPlanType&&(r.dataset.displayPlanType="false"),e.setAttribute("data-template","legal"),r.parentNode.insertBefore(e,r.nextSibling),await e.onceSettled()}catch{}}renderLayout(){return xr`
            ${this.badge}
            <div class="body">
                <slot name="heading-xs"></slot>
                <slot name="body-xxs"></slot>
    ...
    `);import{html as Ln,css as zn}from"./lit-all.min.js";var qa=`
...
`;var Ua={cardName:{attribute:"name"},title:{tag:"h3",slot:"heading-xs"},subtitle:{tag:"p",slot:"body-xxs"},description:{tag:"div",slot:"body-xs"},ctas:{slot:"footer",size:"m"},backgroundImage:{tag:"div",slot:"bg-image"},style:"consonant"},Ge=class extends v{constructor(r){super(r)}getGlobalCSS(){return qa}removeFocusFromModalClose(){let r=this.card.closest(".dialog-modal");r&&r.querySelector(".dialog-close")?.blur()}async postCardUpdateHook(){this.removeFocusFromModalClose(),await super.postCardUpdateHook()}renderLayout(){return Ln`
    ...
    `);import{html as yr,css as Pn}from"./lit-all.min.js";var ja=`
:root {
...
`;var Ga={cardName:{attribute:"name"},backgroundImage:{tag:"div",slot:"bg-image"},subtitle:{tag:"p",slot:"detail-m"},title:{tag:"h3",slot:"heading-xs"},prices:{tag:"p",slot:"heading-xs-price"},description:{tag:"div",slot:"body-xs"},ctas:{slot:"footer",size:"l"},badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300-special-offers"},allowedBadgeColors:["spectrum-yellow-300-special-offers","spectrum-gray-300-special-offers","spectrum-green-900-special-offers"],allowedBorderColors:["spectrum-yellow-300-special-offers","spectrum-gray-300-special-offers","spectrum-green-900-special-offers"],borderColor:{attribute:"border-color"}},Ve=class extends v{constructor(r){super(r)}get headingSelector(){return'[slot="detail-m"]'}getGlobalCSS(){return ja}renderLayout(){return yr`${this.cardImage}
    ...
    `);import{html as _n,css as Mn}from"./lit-all.min.js";var Va=`
:root {
...
`;var wr={title:{tag:"h3",slot:"heading-xs",maxCount:250,withSuffix:!0},badge:{tag:"div",slot:"badge",default:"spectrum-blue-400"},allowedBadgeColors:["spectrum-blue-400","spectrum-gray-300","spectrum-yellow-300","gradient-purple-blue","gradient-firefly-spectrum"],description:{tag:"div",slot:"body-xs",maxCount:2e3,withSuffix:!1},prices:{tag:"div",slot:"price"},callout:{tag:"div",slot:"callout-content",editorLabel:"Price description"},ctas:{slot:"cta",size:"XL"},borderColor:{attribute:"border-color",specialValues:{gray:"var(--spectrum-gray-300)",blue:"var(--spectrum-blue-400)","gradient-purple-blue":"linear-gradient(96deg, #B539C8 0%, #7155FA 66%, #3B63FB 100%)","gradient-firefly-spectrum":"linear-gradient(96deg, #D73220 0%, #D92361 33%, #7155FA 100%)"}},disabledAttributes:["badgeColor","badgeBorderColor","trialBadgeColor","trialBadgeBorderColor"],supportsDefaultChild:!0},We=class extends v{getGlobalCSS(){return Va}get aemFragmentMapping(){return wr}get headingSelector(){return'[slot="heading-xs"]'}get badge(){return this.card.querySelector('[slot="badge"]')}syncHeights(){if(this.card.getBoundingClientRect().width===0)return;let r=this.card.shadowRoot;if(!r)return;["header","price-container","cta"].forEach(i=>this.updateCardElementMinHeight(r.querySelector(`.${i}`),i));let e=this.card.querySelector('[slot="body-xs"]');e&&this.updateCardElementMinHeight(e,"description");let t=this.card.querySelector('[slot="body-xs"] p:has(mas-mnemonic)');t&&this.updateCardElementMinHeight(t,"icons")}async postCardUpdateHook(){if(!this.card.isConnected)return;await super.postCardUpdateHook();let r=this.getContainer();if(!r)return;let e=r.querySelectorAll(`merch-card[variant="${this.card.variant}"]`),t=34;e.forEach(i=>{i.classList.remove("small-font-size-button"),i.querySelectorAll('[slot="cta"] sp-button, [slot="cta"] button, [slot="cta"] a.con-button, [slot="cta"] a.spectrum-Button, a[slot="cta"]').forEach(o=>{let c=o.textContent.trim().length>t;o.classList.toggle("small-font-size-button",c)})}),x.isDesktopOrUp&&e.forEach(i=>i.variantLayout?.syncHeights?.())}connectedCallbackHook(){!this.card||this.card.failed||(this.setupAccordion(),this.card?.hasAttribute("data-default-card")&&!Ot()&&this.card.setAttribute("data-expanded","true"),this.observeVisibility())}resyncSiblings(){let r=this.getContainer();r&&r.querySelectorAll(`merch-card[variant="${this.card.variant}"]`).forEach(e=>e.variantLayout?.syncHeights?.())}observeVisibility(){typeof ResizeObserver>"u"||(this.lastSyncedWidth=0,this.sizeObserver=new ResizeObserver(()=>{let r=this.card.getBoundingClientRect().width;r<=2||r===this.lastSyncedWidth||(this.lastSyncedWidth=r,this.resyncSiblings())}),this.sizeObserver.observe(this.card))}setupAccordion(){let r=this.card;if(!r)return;let e=()=>{if(Ot())r.removeAttribute("data-expanded");else{let i=r.hasAttribute("data-default-card");r.setAttribute("data-expanded",i?"true":"false")}};e();let t=window.matchMedia(C);this.mediaQueryListener=()=>{e()},t.addEventListener("change",this.mediaQueryListener)}disconnectedCallbackHook(){this.mediaQueryListener&&window.matchMedia(C).removeEventListener("change",this.mediaQueryListener),this.sizeObserver?.disconnect(),this.sizeObserver=null}handleChevronClick(r){r.preventDefault(),r.stopPropagation(),this.toggleExpanded()}handleCardClick(r){r.target.closest('.chevron-button, mas-mnemonic, button, a, [role="button"]')||(r.preventDefault(),this.toggleExpanded())}toggleExpanded(){let r=this.card;if(!r||Ot())return;let i=r.getAttribute("data-expanded")==="true"?"false":"true";r.setAttribute("data-expanded",i)}renderLayout(){return _n`
    ...
    `);import{html as Ka,css as Rn}from"./lit-all.min.js";var Wa=`
:root {
...
@media screen and ${b} and (max-width: 1399px) {
    merch-card-collection.full-pricing-express {
        grid-template-columns: repeat(2, 1fr);
...
`;var Er={title:{tag:"h3",slot:"heading-xs",maxCount:250,withSuffix:!0},badge:{tag:"div",slot:"badge",default:"spectrum-blue-400"},allowedBadgeColors:["spectrum-blue-400","spectrum-gray-300","spectrum-yellow-300","gradient-purple-blue","gradient-firefly-spectrum"],description:{tag:"div",slot:"body-s",maxCount:2e3,withSuffix:!1},shortDescription:{tag:"div",slot:"short-description",maxCount:3e3,withSuffix:!1},callout:{tag:"div",slot:"callout-content",editorLabel:"Price description"},prices:{tag:"div",slot:"price"},trialBadge:{tag:"div",slot:"trial-badge"},ctas:{slot:"cta",size:"XL"},mnemonics:{size:"xs"},borderColor:{attribute:"border-color",specialValues:{gray:"var(--spectrum-gray-300)",blue:"var(--spectrum-blue-400)","gradient-purple-blue":"linear-gradient(96deg, #B539C8 0%, #7155FA 66%, #3B63FB 100%)","gradient-firefly-spectrum":"linear-gradient(96deg, #D73220 0%, #D92361 33%, #7155FA 100%)"}},showAllSpectrumColors:!0,multiWhatsIncluded:"true",disabledAttributes:[]},xt=class xt extends v{getGlobalCSS(){return Wa}get aemFragmentMapping(){return Er}get headingSelector(){return'[slot="heading-xs"]'}get badgeElement(){return this.card.querySelector('[slot="badge"]')}get badge(){return Ka`
        ...
        `}async waitForTitleFont(){let r=this.card.querySelector(this.headingSelector);if(r&&document.fonts?.load){let e=window.getComputedStyle(r),t=`${e.fontWeight} ${e.fontSize} ${e.fontFamily}`;await document.fonts.load(t,r.textContent).catch(()=>null)}await document.fonts.ready}async syncHeights(){if(await this.waitForTitleFont(),await new Promise(c=>requestAnimationFrame(c)),await new Promise(c=>requestAnimationFrame(c)),this.card.getBoundingClientRect().width<=2)return;let r=xt.SYNCED_SECTIONS.map(c=>({name:c,getElement:l=>l.shadowRoot?.querySelector(`.${c}`)})),e=this.getContainer(),t=e?e.querySelectorAll(`merch-card[variant="${this.card.variant}"]`):[this.card],i='[slot="body-s"] > *',n=Math.max(0,...Array.from(t,c=>c.querySelectorAll(i).length)),o=Array.from({length:n},(c,l)=>({name:`description-row-${l}`,getElement:d=>d.querySelectorAll(i)[l]}));this.syncRowHeights([...r,...o])}async postCardUpdateHook(){if(!this.card.isConnected)return;await super.postCardUpdateHook();let r=this.getContainer();if(r){let e=r.querySelectorAll(`merch-card[variant="${this.card.variant}"]`),t=49;e.forEach(i=>{i.classList.remove("small-font-size-button"),i.querySelectorAll('[slot="cta"] sp-button, [slot="cta"] button, [slot="cta"] a.con-button, [slot="cta"] a.spectrum-Button, a[slot="cta"]').forEach(o=>{let c=o.textContent.trim().length>t;o.classList.toggle("small-font-size-button",c)})})}window.matchMedia("(min-width: 768px)").matches&&this.syncHeights()}resyncOnReflow(){let r=this.card.getBoundingClientRect().width;if(r<=2)return;let e=this.card.querySelector(this.headingSelector),t=e?Math.round(e.getBoundingClientRect().height):0,i=`${Math.round(r)}:${t}`;i!==this.lastSyncedKey&&(this.lastSyncedKey=i,this.syncHeights())}connectedCallbackHook(){if(!this.card||typeof ResizeObserver>"u")return;this.lastSyncedKey="",this.sizeObserver=new ResizeObserver(()=>this.resyncOnReflow()),this.sizeObserver.observe(this.card);let r=this.card.querySelector(this.headingSelector);r&&this.sizeObserver.observe(r)}disconnectedCallbackHook(){this.sizeObserver?.disconnect(),this.sizeObserver=null}renderLayout(){return Ka`
            ...
            <slot></slot>
        `}};h(xt,"SYNCED_SECTIONS",["header","short-description","price-container","cta"]),h(xt,"variantStyle",Rn`
    ...
    `);var yt=xt;import{html as kr,css as On,unsafeCSS as Ke,nothing as Dn}from"./lit-all.min.js";var Ya=`
...
`;var Qa={cardName:{attribute:"name"},title:{tag:"p",slot:"heading-xs"},cardTitle:{tag:"p",slot:"heading-xs"},subtitle:{tag:"p",slot:"body-xxs"},description:{tag:"div",slot:"body-xs"},promoText:{tag:"p",slot:"promo-text"},shortDescription:{tag:"p",slot:"short-description"},callout:{tag:"div",slot:"callout-content"},quantitySelect:{tag:"div",slot:"quantity-select"},whatsIncluded:{tag:"div",slot:"whats-included"},addonConfirmation:{tag:"div",slot:"addon-confirmation"},badge:{tag:"div",slot:"badge"},trialBadge:{tag:"div",slot:"trial-badge"},prices:{tag:"p",slot:"prices"},backgroundImage:{tag:"div",slot:"bg-image"},ctas:{slot:"footer",size:"m"},addon:!0,secureLabel:!0,borderColor:{attribute:"border-color"},backgroundColor:{attribute:"background-color"},size:[],mnemonics:{size:"m"}},Nn=[{slot:"bg-image",label:"Background Image"},{slot:"badge",label:"Badge"},{slot:"icons",label:"Mnemonic icon"},{slot:"heading-xs",label:"Title"},{slot:"body-xxs",label:"Subtitle"},{slot:"body-xs",label:"Product description"},{slot:"promo-text",label:"Promo Text"},{slot:"callout-content",label:"Callout text"},{slot:"short-description",label:"Short Description"},{slot:"trial-badge",label:"Trial Badge"},{slot:"prices",label:"Product price"},{slot:"quantity-select",label:"Quantity select"},{slot:"addon",label:"Addon"},{slot:"whats-included",label:"What's included"},{slot:"addon-confirmation",label:"Addon confirmation"},{slot:"footer",label:"CTAs"}],G=class G extends v{constructor(r){super(r)}getGlobalCSS(){return Ya}get fields(){return Nn}renderLayout(){return kr`
        ...
        `}static hostSelector(r=""){return G.variantNames.map(e=>`:host([variant='${e}'])${r}`).join(", ")}};h(G,"variantNames",["headless","headless-marquee","headless-faq","headless-offer-terms","headless-promo-bar"]),h(G,"variantStyle",On`
        ${Ke(G.hostSelector())} {
            border: none;
            background: transparent;
            box-shadow: none;
        }
        ${Ke(G.hostSelector(" .headless"))} {
            display: flex;
            flex-direction: column;
            padding: var(--consonant-merch-spacing-xs, 8px);
        }
        ${Ke(G.hostSelector(" .headless-row"))} {
            display: flex;
            gap: var(--consonant-merch-spacing-xs, 8px);
            padding: var(--consonant-merch-spacing-xxs, 4px) 0;
        }
        ${Ke(G.hostSelector(" .headless-label"))} {
            flex-shrink: 0;
            font-weight: 600;
            min-width: 8em;
        }
        ${Ke(G.hostSelector(" .headless-value"))} {
            flex: 1;
        }
        ${Ke(G.hostSelector(" .headless-value::slotted(*)"))} {
            display: inline;
        }
    `);var M=G;var Za={cardName:{attribute:"name"},title:{tag:"p",slot:"heading-xs"},cardTitle:{tag:"p",slot:"heading-xs"},description:{tag:"div",slot:"body-xs",editorLabel:"Description"},shortDescription:{tag:"p",slot:"short-description"},prices:{tag:"p",slot:"prices",editorLabel:"Price"},ctas:{slot:"footer",size:"m",editorLabel:"CTAs"}},Fn=[{slot:"heading-xs",label:"Title"},{slot:"body-xs",label:"Description"},{slot:"short-description",label:"Short Description"},{slot:"prices",label:"Price"},{slot:"footer",label:"CTAs"}],Kt=class extends M{get fields(){return Fn}};var Xa={cardName:{attribute:"name"},description:{tag:"div",slot:"body-xs",editorLabel:"FAQ answer 1"},shortDescription:{tag:"p",slot:"short-description",editorLabel:"FAQ answer 2"},prices:{tag:"p",slot:"prices",editorLabel:"Price"}},In=[{slot:"body-xs",label:"FAQ answer 1"},{slot:"short-description",label:"FAQ answer 2"},{slot:"prices",label:"Price"}],Yt=class extends M{get fields(){return In}};var Ja={cardName:{attribute:"name"},description:{tag:"div",slot:"body-xs",editorLabel:"Terms"}},$n=[{slot:"body-xs",label:"Terms"}],Qt=class extends M{get fields(){return $n}};var ei={cardName:{attribute:"name"},description:{tag:"div",slot:"body-xs",editorLabel:"Sticky banner description"},ctas:{slot:"footer",size:"m",editorLabel:"Sticky banner CTAs"},shortDescription:{tag:"p",slot:"short-description",editorLabel:"Blade description"},callout:{tag:"div",slot:"callout-content",editorLabel:"Blade CTAs"}},Hn=[{slot:"body-xs",label:"Sticky banner description"},{slot:"footer",label:"Sticky banner CTAs"},{slot:"short-description",label:"Blade description"},{slot:"callout-content",label:"Blade CTAs"}],Zt=class extends M{get fields(){return Hn}};import{css as Bn,html as qn}from"./lit-all.min.js";var ti=`
...
`;var ri={title:{tag:"p",slot:"title"},prices:{tag:"p",slot:"prices"},description:{tag:"p",slot:"description"},planType:!0,ctas:{slot:"ctas",size:"S"}},Ye=class extends v{constructor(){super(...arguments);h(this,"legal")}async postCardUpdateHook(){await super.postCardUpdateHook(),this.adjustLegal()}getGlobalCSS(){return ti}get headingSelector(){return'[slot="title"]'}priceOptionsProvider(e,t){t.literals={...t.literals,strikethroughAriaLabel:"",alternativePriceAriaLabel:""},t.space=!0,t.displayAnnual=this.card.settings?.displayAnnual??!1}adjustLegal(){if(this.legal!==void 0)return;let e=this.card.querySelector(`${k}[data-template="price"]`);if(!e)return;let t=e.cloneNode(!0);this.legal=t,e.dataset.displayTax="false",e.dataset.displayPerUnit="false",t.dataset.template="legal",t.dataset.displayPlanType=this.card?.settings?.displayPlanType??!0,t.setAttribute("slot","legal"),this.card.appendChild(t)}renderLayout(){return qn`
            ${this.badge}
            <div class="body">
    ...
    `);import{html as Un,css as jn}from"./lit-all.min.js";var ai=`
...
`;var Cr={mnemonics:{size:"l"},title:{tag:"h3",slot:"header",maxCount:100},prices:{tag:"p",slot:"price"},description:{tag:"div",slot:"detail",maxCount:1e3},ctas:{slot:"cta",size:"M"},features:{tag:"div",slot:"features",unwrap:!0}},Gn=[{key:"header",selector:".seg-header"},{key:"price",selector:".seg-price"},{key:"detail",selector:".seg-detail"},{key:"cta",selector:".seg-cta"}],Xt,ii,Qe=class extends v{constructor(e){super(e);u(this,Xt);this.postCardUpdateHook=this.postCardUpdateHook.bind(this)}getGlobalCSS(){return ai}get aemFragmentMapping(){return Cr}getContainer(){return this.card.closest("mas-compare-chart")??this.card.parentElement}connectedCallbackHook(){window.addEventListener("resize",this.postCardUpdateHook)}disconnectedCallbackHook(){window.removeEventListener("resize",this.postCardUpdateHook)}async postCardUpdateHook(){this.card.isConnected&&(await this.card.updateComplete,y(this,Xt,ii).call(this))}renderLayout(){return Un`
            <div class="card">
            ...
            <slot></slot>
        `}};Xt=new WeakSet,ii=function(){if(this.card.getBoundingClientRect().width===0)return;let e=this.card.shadowRoot;Gn.forEach(({key:t,selector:i})=>this.updateCardElementMinHeight(e.querySelector(i),t))},h(Qe,"variantStyle",jn`
    ...
    `);import{html as Vn,css as Wn}from"./lit-all.min.js";var ni=`
...
`;var Sr={mnemonics:{size:"s"},title:{tag:"h3",slot:"heading-xxs",maxCount:250,withSuffix:!0},description:{tag:"div",slot:"body-s",maxCount:2e3,withSuffix:!1},whatsIncluded:{tag:"div",slot:"whats-included"},badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300"},trialBadge:{tag:"div",slot:"trial-badge",default:"spectrum-green-800"},prices:{tag:"p",slot:"price"},ctas:{slot:"cta",size:"M"},addonConfirmation:{tag:"div",slot:"addon-confirmation"},borderColor:{attribute:"border-color",specialValues:{gray:"--spectrum-gray-300","gradient-purple-blue":"var(--gradient-purple-blue)","gradient-firefly-spectrum":"var(--gradient-firefly-spectrum)"}}},Ze=class extends v{getGlobalCSS(){return ni}get aemFragmentMapping(){return Sr}renderLayout(){return Vn`
    ...
    `);var Jt=new Map,oi=new WeakMap,ci=new Map,S=(a,r,e=null,t=null,i)=>{Jt.set(a,{class:r,fragmentMapping:e,style:t,collectionOptions:i})};S("catalog",He,ma,He.variantStyle);S("image",we);S("inline-heading",Bt);S("mini-compare-chart",Be,ya,Be.variantStyle);S("mini-compare-chart-mweb",qe,Ea,qe.variantStyle);S("plans",I,jt,I.variantStyle,I.collectionOptions);S("plans-students",I,Sa,I.variantStyle,I.collectionOptions);S("plans-education",I,Ca,I.variantStyle,I.collectionOptions);S("plans-v2",he,La,he.variantStyle,he.collectionOptions);S("pro",vt,Da,vt.variantStyle);S("product",Ue,$a,Ue.variantStyle);S("segment",je,Ba,je.variantStyle);S("media",Ge,Ua,Ge.variantStyle);S("headless",M,Qa,M.variantStyle);S("headless-marquee",Kt,Za,M.variantStyle);S("headless-faq",Yt,Xa,M.variantStyle);S("headless-offer-terms",Qt,Ja,M.variantStyle);S("headless-promo-bar",Zt,ei,M.variantStyle);S("special-offers",Ve,Ga,Ve.variantStyle);S("simplified-pricing-express",We,wr,We.variantStyle);S("full-pricing-express",yt,Er,yt.variantStyle);S("mini",Ye,ri,Ye.variantStyle);S("image",we,ua,we.variantStyle);S("compare-chart-column",Qe,Cr,Qe.variantStyle);S("fries",Ze,Sr,Ze.variantStyle);var Kn=(a,r,e)=>{try{let t=ci.get(a.variant);if(t||(t=new CSSStyleSheet,t.replaceSync(r.cssText),ci.set(a.variant,t)),e?.styleSheet&&e.styleSheet!==t){let i=a.shadowRoot.adoptedStyleSheets.indexOf(e.styleSheet);i!==-1&&a.shadowRoot.adoptedStyleSheets.splice(i,1)}return a.shadowRoot.adoptedStyleSheets.includes(t)||a.shadowRoot.adoptedStyleSheets.push(t),{styleSheet:t}}catch{let i=document.createElement("style");i.textContent=r.cssText,i.setAttribute("data-variant-style",a.variant);let n=e?.styleElement||a.shadowRoot.querySelector("[data-variant-style]");return n&&n.remove(),a.shadowRoot.appendChild(i),{styleElement:i}}},Ar=a=>{let r=Jt.get(a.variant);if(!r)return;let{class:e,style:t}=r,i=oi.get(a);if(i?.appliedVariant===a.variant)return new e(a);let n=t?Kn(a,t,i):{};return oi.set(a,{appliedVariant:a.variant,...n}),new e(a)};function Ht(a){return Jt.get(a)?.fragmentMapping}function si(a){return Jt.get(a)?.collectionOptions}var li=document.createElement("style");li.innerHTML=`
:root {
...
`;document.head.appendChild(li);function er(a,r={},{metadata:e=!0,search:t=!0,storage:i=!0}={}){let n;if(t&&n==null){let o=new URLSearchParams(window.location.search),c=Tr(t)?t:a;n=o.get(c)}if(i&&n==null){let o=Tr(i)?i:a;n=window.sessionStorage.getItem(o)??window.localStorage.getItem(o)}if(e&&n==null){let o=Qn(Tr(e)?e:a);n=document.documentElement.querySelector(`meta[name="${o}"]`)?.content}return n??r[a]}var Yn=a=>typeof a=="boolean",tr=a=>typeof a=="function";var Tr=a=>typeof a=="string";function di(a,r){if(Yn(a))return a;let e=String(a);return e==="1"||e==="true"?!0:e==="0"||e==="false"?!1:r}function Qn(a=""){return String(a).replace(/(\p{Lowercase_Letter})(\p{Uppercase_Letter})/gu,(r,e,t)=>`${e}-${t}`).replace(/\W+/gu,"-").toLowerCase()}var me=class a extends Error{constructor(r,e,t){if(super(r,{cause:t}),this.name="MasError",e.response){let i=e.response.headers?.get(Dt);i&&(e.requestId=i),e.response.status&&(e.status=e.response.status,e.statusText=e.response.statusText),e.response.url&&(e.url=e.response.url)}delete e.response,this.context=e,Error.captureStackTrace&&Error.captureStackTrace(this,a)}toString(){let r=Object.entries(this.context||{}).map(([t,i])=>`${t}: ${JSON.stringify(i)}`).join(", "),e=`${this.name}: ${this.message}`;return r&&(e+=` (${r})`),this.cause&&(e+=`
Caused by: ${this.cause}`),e}};var ke={clientId:"merch-at-scale",delimiter:"\xB6",ignoredProperties:["analytics","literals","element"],serializableTypes:["Array","Object"],sampleRate:1,severity:"e",tags:"acom",isProdDomain:!1},hi=1e3;function Zn(a){return a instanceof Error||typeof a?.originatingRequest=="string"}function pi(a){if(a==null)return;let r=typeof a;if(r==="function")return a.name?`function ${a.name}`:"function";if(r==="object"){if(a instanceof Error)return a.message;if(typeof a.originatingRequest=="string"){let{message:t,originatingRequest:i,status:n}=a;return[t,n,i].filter(Boolean).join(" ")}let e=a[Symbol.toStringTag]??Object.getPrototypeOf(a).constructor.name;if(!ke.serializableTypes.includes(e))return e}return a}function Xn(a,r){if(!ke.ignoredProperties.includes(a))return pi(r)}var Lr={append(a){if(a.level!=="error")return;let{message:r,params:e}=a,t=[],i=[],n=r;e.forEach(d=>{d!=null&&(Zn(d)?t:i).push(d)}),t.length&&(n+=` ${t.map(pi).join(" ")}`);let{pathname:o,search:c}=window.location,l=`${ke.delimiter}page=${o}${c}`;l.length>hi&&(l=`${l.slice(0,hi)}<trunc>`),n+=l,i.length&&(n+=`${ke.delimiter}facts=`,n+=JSON.stringify(i,Xn)),window.lana?.log(n,ke)}};function mi(a){Object.assign(ke,Object.fromEntries(Object.entries(a).filter(([r,e])=>r in ke&&e!==""&&e!==null&&e!==void 0&&!Number.isNaN(e))))}var gi={LOCAL:"local",PROD:"prod",STAGE:"stage"},zr={DEBUG:"debug",ERROR:"error",INFO:"info",WARN:"warn"},Pr=new Set,_r=new Set,ui=new Map,fi={append({level:a,message:r,params:e,timestamp:t,source:i}){console[a](`${t}ms [${i}] %c${r}`,"font-weight: bold;",...e)}},vi={filter:({level:a})=>a!==zr.DEBUG},Jn={filter:()=>!1};function eo(a,r,e,t,i){return{level:a,message:r,namespace:e,get params(){return t.length===1&&tr(t[0])&&(t=t[0](),Array.isArray(t)||(t=[t])),t},source:i,timestamp:performance.now().toFixed(3)}}function to(a){[..._r].every(r=>r(a))&&Pr.forEach(r=>r(a))}function bi(a){let r=(ui.get(a)??0)+1;ui.set(a,r);let e=`${a} #${r}`,t={id:e,namespace:a,module:i=>bi(`${t.namespace}/${i}`),updateConfig:mi};return Object.values(zr).forEach(i=>{t[i]=(n,...o)=>to(eo(i,n,a,o,e))}),Object.seal(t)}function rr(...a){a.forEach(r=>{let{append:e,filter:t}=r;tr(t)&&_r.add(t),tr(e)&&Pr.add(e)})}function ro(a={}){let{name:r}=a,e=di(er("commerce.debug",{search:!0,storage:!0}),r===gi.LOCAL);return rr(e?fi:vi),r===gi.PROD&&rr(Lr),wt}function ao(){Pr.clear(),_r.clear()}var wt={...bi(ca),Level:zr,Plugins:{consoleAppender:fi,debugFilter:vi,quietFilter:Jn,lanaAppender:Lr},init:ro,reset:ao,use:rr};var io="mas-commerce-service",dh=wt.module("utilities"),no={requestId:Dt,etag:"Etag",lastModified:"Last-Modified",serverTiming:"server-timing"};var ar=a=>window.setTimeout(a);function Mr(){return document.getElementsByTagName(io)?.[0]}function xi(a){let r={};if(!a?.headers)return r;let e=a.headers;for(let[t,i]of Object.entries(no)){let n=e.get(i);n&&(n=n.replace(/[,;]/g,"|"),n=n.replace(/[| ]+/g,"|"),r[t]=n)}return r}async function yi(a,r={},e=2,t=100){let i;for(let n=0;n<=e;n++)try{let o=await fetch(a,r);return o.retryCount=n,o}catch(o){if(i=o,i.retryCount=n,n>e)break;await new Promise(c=>setTimeout(c,t*(n+1)))}throw i}var wi="fragment",Ei="author",ki="preview",Ci="loading",Si="mask",Ai="pzn",Ti="timeout",Rr="aem-fragment",Li="eager",zi="cache",oo=[Li,zi],V,Ce,$,Or=class{constructor(){u(this,V,new Map);u(this,Ce,new Map);u(this,$,new Map)}clear(){s(this,V).clear(),s(this,Ce).clear(),s(this,$).clear()}add(r,e=!0){if(!this.has(r.id)&&!this.has(r.fields?.originalId)){if(s(this,V).set(r.id,r),r.fields?.originalId&&s(this,V).set(r.fields.originalId,r),s(this,$).has(r.id)){let[,t]=s(this,$).get(r.id);t()}if(s(this,$).has(r.fields?.originalId)){let[,t]=s(this,$).get(r.fields?.originalId);t()}if(!(!e||typeof r.references!="object"||Array.isArray(r.references)))for(let t in r.references){let{type:i,value:n}=r.references[t];i==="content-fragment"&&(n.settings={...r?.settings,...n.settings},n.placeholders={...r?.placeholders,...n.placeholders},n.dictionary={...r?.dictionary,...n.dictionary},n.priceLiterals={...r?.priceLiterals,...n.priceLiterals},this.add(n,r))}}}has(r){return s(this,V).has(r)}entries(){return s(this,V).entries()}get(r){return s(this,V).get(r)}getAsPromise(r){let[e]=s(this,$).get(r)??[];if(e)return e;let t;return e=new Promise(i=>{t=i,this.has(r)&&i()}),s(this,$).set(r,[e,t]),e}getFetchInfo(r){let e=s(this,Ce).get(r);return e||(e={url:null,retryCount:0,stale:!1,measure:null,status:null},s(this,Ce).set(r,e)),e}set(r,e){if(s(this,V).set(r,e),s(this,$).has(r)){let[,t]=s(this,$).get(r);t()}}remove(r){s(this,V).delete(r),s(this,Ce).delete(r),s(this,$).delete(r)}};V=new WeakMap,Ce=new WeakMap,$=new WeakMap;var oe=new Or,Xe,B,ce,H,W,z,Et,K,Y,kt,Q,Ct,St,Je,Z,Pi,_i,Dr,Mi,ir=class extends HTMLElement{constructor(){super(...arguments);u(this,Z);h(this,"cache",oe);u(this,Xe);u(this,B,null);u(this,ce,null);u(this,H,null);u(this,W);u(this,z);u(this,Et,Li);u(this,K);u(this,Y);u(this,kt,5e3);u(this,Q);u(this,Ct,!1);u(this,St,0);u(this,Je)}static get observedAttributes(){return[wi,Ci,Ti,Ei,ki,Si,Ai]}cacheKey(){return`${s(this,W)}${s(this,Y)?`-p_${s(this,Y)}`:""}${s(this,K)?`-m_${s(this,K)}`:""}`}attributeChangedCallback(e,t,i){e===wi&&(m(this,W,i),m(this,z,oe.getFetchInfo(this.cacheKey()))),e===Si&&m(this,K,i),e===Ai&&m(this,Y,i),e===Ci&&oo.includes(i)&&m(this,Et,i),e===Ti&&m(this,kt,parseInt(i,10)),e===Ei&&m(this,Ct,["","true"].includes(i)),e===ki&&m(this,Je,i)}connectedCallback(){if(!s(this,Q)){if(s(this,H)??m(this,H,xe(this)),m(this,Je,s(this,H).settings?.preview),s(this,Xe)??m(this,Xe,s(this,H).log.module(`${Rr}[${s(this,W)}]`)),!s(this,W)||s(this,W)==="#"){s(this,z)??m(this,z,oe.getFetchInfo("missing-fragment-id")),y(this,Z,Dr).call(this,"Missing fragment id");return}this.refresh(!1)}}get fetchInfo(){return Object.fromEntries(Object.entries(s(this,z)).filter(([e,t])=>t!=null).map(([e,t])=>[`aem-fragment:${e}`,t]))}async refresh(e=!0){if(s(this,Q)&&!await Promise.race([s(this,Q),Promise.resolve(!1)]))return;e&&oe.remove(this.cacheKey()),s(this,Et)===zi&&await Promise.race([oe.getAsPromise(this.cacheKey()),new Promise(c=>setTimeout(c,s(this,kt)))]);try{m(this,Q,y(this,Z,Mi).call(this)),await s(this,Q)}catch(c){return y(this,Z,Dr).call(this,c.message),!1}let{references:t,referencesTree:i,placeholders:n,wcs:o}=s(this,B)||{};return o&&!er("mas.disableWcsCache")&&s(this,H).prefillWcsCache(o),this.dispatchEvent(new CustomEvent(Oe,{detail:{...this.data,references:t,referencesTree:i,placeholders:n,...s(this,z)},bubbles:!0,composed:!0})),s(this,Q)}get updateComplete(){return s(this,Q)??Promise.reject(new Error("AEM fragment cannot be loaded"))}get data(){return s(this,ce)?s(this,ce):(s(this,Ct)?this.transformAuthorData():this.transformPublishData(),s(this,ce))}get rawData(){return s(this,B)}transformAuthorData(){let{fields:e,id:t,maskId:i,tags:n,variationId:o,promoProject:c,promoVariationProject:l,settings:d={},priceLiterals:p={},dictionary:g={},placeholders:f={}}=s(this,B);m(this,ce,e.reduce((E,{name:D,multiple:N,values:fe})=>(E.fields[D]=N?fe:fe[0],E),{fields:{},id:t,tags:n,settings:d,priceLiterals:p,dictionary:g,maskId:i,placeholders:f,variationId:o,promoProject:c,promoVariationProject:l}))}transformPublishData(){if(!s(this,B))return;let{fields:e,id:t,tags:i,settings:n={},priceLiterals:o={},dictionary:c={},maskId:l,placeholders:d={},variationId:p,promoProject:g,promoVariationProject:f}=s(this,B);m(this,ce,Object.entries(e).reduce((E,[D,N])=>(E.fields[D]=N?.mimeType?N.value:N??"",E),{fields:{},id:t,tags:i,settings:n,priceLiterals:o,dictionary:c,maskId:l,placeholders:d,variationId:p,promoProject:g,promoVariationProject:f}))}getFragmentClientUrl(){let e=new URLSearchParams(window.location.search),{hostname:t}=window.location,i=t.endsWith(".page")?"page":"live";return`${ha(e.get("maslibs"),i)??"https://mas.adobe.com"}/studio/libs/fragment-client.js`}async generatePreview(){let e=this.getFragmentClientUrl(),{previewFragment:t}=await import(e),i={locale:s(this,H).settings.locale,apiKey:s(this,H).settings.wcsApiKey,fullContext:!0},n=new URLSearchParams(window.location.search).get("instant")??s(this,H).settings.instant,o={...i,...n!=null?{instant:n}:{},...s(this,K)!=null?{mask:s(this,K)}:{},...s(this,Y)!=null?{pzn:s(this,Y)}:{}};return await t(s(this,W),o)}};Xe=new WeakMap,B=new WeakMap,ce=new WeakMap,H=new WeakMap,W=new WeakMap,z=new WeakMap,Et=new WeakMap,K=new WeakMap,Y=new WeakMap,kt=new WeakMap,Q=new WeakMap,Ct=new WeakMap,St=new WeakMap,Je=new WeakMap,Z=new WeakSet,Pi=async function(e){jr(this,St)._++;let t=`${Rr}:${this.cacheKey()}:${s(this,St)}`,i=`${t}${Nt}`,n=`${t}${Ft}`;if(s(this,Je)){let c=await this.generatePreview();if(c.status===200)return c.body;throw new me(`Failed to generate preview: ${c.message}`,{})}performance.mark(i);let o;try{if(s(this,z).stale=!1,s(this,z).url=e,o=await yi(e,{cache:"default",credentials:"omit"}),y(this,Z,_i).call(this,o),s(this,z).status=o?.status,s(this,z).measure=Ne(performance.measure(n,i)),s(this,z).retryCount=o.retryCount,!o?.ok)throw new me("Unexpected fragment response",{response:o,...s(this,H).duration});return await o.json()}catch(c){if(s(this,z).measure=Ne(performance.measure(n,i)),s(this,z).retryCount=c.retryCount,s(this,B))return s(this,z).stale=!0,s(this,Xe).error("Serving stale data",s(this,z)),s(this,B);let l=c.message??"unknown";throw new me(`Failed to fetch fragment: ${l}`,{})}},_i=function(e){Object.assign(s(this,z),xi(e))},Dr=function(e){m(this,Q,null),s(this,z).message=e,this.classList.add("error");let t={...s(this,z),...s(this,H).duration};s(this,Xe).error(e,t),this.dispatchEvent(new CustomEvent(De,{detail:t,bubbles:!0,composed:!0}))},Mi=async function(){var l;this.classList.remove("error"),m(this,ce,null);let e=oe.get(this.cacheKey());if(e)return m(this,B,e),!0;let{masIOUrl:t,wcsApiKey:i,country:n,locale:o}=s(this,H).settings,c=`${t}/fragment?id=${s(this,W)}&api_key=${i}&locale=${o}`;return n&&!o.endsWith(`_${n}`)&&(c+=`&country=${n}`),s(this,K)&&(c+=`&mask=${s(this,K)}`),s(this,Y)&&(c+=`&pzn=${s(this,Y)}`),e=await y(this,Z,Pi).call(this,c),(l=e.fields).originalId??(l.originalId=s(this,W)),s(this,K)||s(this,Y)?oe.set(this.cacheKey(),e):oe.add(e),m(this,B,e),!0},h(ir,"cache",oe);customElements.define(Rr,ir);import{LitElement as co,html as Nr,css as so,nothing as lo}from"./lit-all.min.js";import{unsafeHTML as ho}from"./lit-all.min.js";var po=a=>a?a.startsWith("sp-icon-")?Nr`${ho(`<${a} class="badge-icon"></${a}>`)}`:Nr`<img src="${a}" class="badge-icon" />`:lo,et=class extends co{constructor(){super(),this.color="",this.variant="",this.backgroundColor="",this.borderColor="",this.text=this.textContent,this.icon=""}connectedCallback(){this.borderColor&&this.borderColor!=="transparent"?this.style.setProperty("--merch-badge-border",`1px solid var(--${this.borderColor})`):this.backgroundColor.startsWith("gradient-")||this.style.setProperty("--merch-badge-border",`1px solid var(--${this.backgroundColor})`),this.style.setProperty("--merch-badge-background-color",`var(--${this.backgroundColor})`),(!this.borderColor||this.borderColor==="transparent")&&this.backgroundColor.startsWith("gradient-")?this.style.setProperty("--merch-badge-padding","3px 11px 4px 11px"):this.style.setProperty("--merch-badge-padding","2px 10px 3px 10px"),this.style.setProperty("--merch-badge-color",this.color),this.style.setProperty("--merch-badge-font-size","var(--consonant-merch-card-body-xs-font-size)"),this.querySelector('span[is="inline-price"]')||(this.textContent="");let r=this.closest("merch-card"),e=r?.getAttribute("size"),t=r?.querySelectorAll(":scope > merch-icon").length||0;this.style.setProperty("--merch-badge-offset",t),this.style.setProperty("--merch-badge-with-offset",t?1:0),this.style.setProperty("--merch-badge-card-size",e?2:1),super.connectedCallback()}render(){return Nr`<div class="badge">
            ${po(this.icon)}<slot>${this.text}</slot>
        </div>`}};h(et,"properties",{color:{type:String},variant:{type:String},backgroundColor:{type:String,attribute:"background-color"},borderColor:{type:String,attribute:"border-color"},icon:{type:String}}),h(et,"styles",so`
        :host {
            display: block;
    ...
    `);customElements.define("merch-badge",et);import{html as mo,css as go,LitElement as uo}from"./lit-all.min.js";var At=class extends uo{constructor(){super()}render(){return mo`
            <slot name="icon"></slot>
    ...
    `),h(At,"properties",{description:{type:String,attribute:!0}});customElements.define("merch-mnemonic-list",At);import{html as Fr,css as fo,LitElement as vo,nothing as Ri}from"./lit-all.min.js";var Tt=class extends vo{updated(){this.hideSeeMoreEls()}hideSeeMoreEls(){this.isMobile&&this.rows.forEach((r,e)=>{e>=5&&(r.style.display=this.showAll?"flex":"none")})}constructor(){super(),this.showAll=!1,this.mobileRows=this.mobileRows===void 0?5:this.mobileRows}toggle(){this.showAll=!this.showAll,this.dispatchEvent(new CustomEvent("hide-see-more-elements",{bubbles:!0,composed:!0})),this.requestUpdate()}render(){return Fr`<slot name="heading"></slot>
            <slot name="contentBullets"></slot>
            ${!this.isMobile||!this.bulletsAdded?Fr`<slot name="content"></slot>`:Ri}
            ${this.isMobile&&this.rows.length>this.mobileRows&&!this.bulletsAdded?Fr`<div @click=${this.toggle} class="see-more">
                      ${this.showAll?"- See less":"+ See more"}
                  </div>`:Ri}`}get isMobile(){return window.matchMedia("(max-width: 767px)").matches}get rows(){return this.querySelectorAll('[slot="content"] merch-mnemonic-list')}get bulletsAdded(){return!!this.querySelector('[slot="contentBullets"] merch-mnemonic-list')}};h(Tt,"styles",fo`
        :host {
            display: flex;
            flex-wrap: wrap;
            align-items: center;
    ...
    `),h(Tt,"properties",{heading:{type:String,attribute:!0},mobileRows:{type:Number,attribute:!0}});customElements.define("merch-whats-included",Tt);var bo={[se]:aa,[be]:ia,[le]:na},xo={[se]:oa,[le]:j},Lt,nr=class{constructor(r){u(this,Lt);h(this,"changes",new Map);h(this,"connected",!1);h(this,"error");h(this,"log");h(this,"options");h(this,"promises",[]);h(this,"state",be);h(this,"timer",null);h(this,"value");h(this,"version",0);h(this,"wrapperElement");this.wrapperElement=r,this.log=wt.module("mas-element")}update(){[se,be,le].forEach(r=>{this.wrapperElement.classList.toggle(bo[r],r===this.state)})}notify(){(this.state===le||this.state===se)&&(this.state===le?this.promises.forEach(({resolve:e})=>e(this.wrapperElement)):this.state===se&&this.promises.forEach(({reject:e})=>e(this.error)),this.promises=[]);let r=this.error;this.error instanceof me&&(r={message:this.error.message,...this.error.context}),this.wrapperElement.dispatchEvent(new CustomEvent(xo[this.state],{bubbles:!0,composed:!0,detail:r}))}attributeChangedCallback(r,e,t){this.changes.set(r,t),this.requestUpdate()}connectedCallback(){m(this,Lt,Mr()),this.requestUpdate(!0)}disconnectedCallback(){this.connected&&(this.connected=!1,this.log?.debug("Disconnected:",{element:this.wrapperElement}))}onceSettled(){let{error:r,promises:e,state:t}=this;return le===t?Promise.resolve(this.wrapperElement):se===t?Promise.reject(r):new Promise((i,n)=>{e.push({resolve:i,reject:n})})}toggleResolved(r,e,t){return r!==this.version?!1:(t!==void 0&&(this.options=t),this.state=le,this.value=e,this.update(),this.log?.debug("Resolved:",{element:this.wrapperElement,value:e}),ar(()=>this.notify()),!0)}toggleFailed(r,e,t){if(r!==this.version)return!1;t!==void 0&&(this.options=t),this.error=e,this.state=se,this.update();let i=this.wrapperElement.getAttribute("is");return this.log?.error(`${i}: Failed to render: ${e.message}`,{element:this.wrapperElement,...e.context,...s(this,Lt)?.duration}),ar(()=>this.notify()),!0}togglePending(r){return this.version++,r&&(this.options=r),this.state=be,this.update(),this.log?.debug("Pending:",{osi:this.wrapperElement?.options?.wcsOsi}),this.version}requestUpdate(r=!1){if(!this.wrapperElement.isConnected||!Mr()||this.timer)return;let{error:e,options:t,state:i,value:n,version:o}=this;this.state=be,this.timer=ar(async()=>{this.timer=null;let c=null;if(this.changes.size&&(c=Object.fromEntries(this.changes.entries()),this.changes.clear()),this.connected?this.log?.debug("Updated:",{element:this.wrapperElement,changes:c}):(this.connected=!0,this.log?.debug("Connected:",{element:this.wrapperElement,changes:c})),c||r)try{await this.wrapperElement.render?.()===!1&&this.state===be&&this.version===o&&(this.state=i,this.error=e,this.value=n,this.update(),this.notify())}catch(l){this.toggleFailed(this.version,l,t)}})}};Lt=new WeakMap;function yo(a){return`https://${a==="PRODUCTION"?"www.adobe.com":"www.stage.adobe.com"}/offers/promo-terms.html`}var Ae,Se=class Se extends HTMLAnchorElement{constructor(){super();h(this,"masElement",new nr(this));u(this,Ae);this.setAttribute("is",Se.is)}get isUptLink(){return!0}initializeWcsData(e,t){this.setAttribute("data-wcs-osi",e),t&&this.setAttribute("data-promotion-code",t)}attributeChangedCallback(e,t,i){this.masElement.attributeChangedCallback(e,t,i)}connectedCallback(){this.masElement.connectedCallback(),m(this,Ae,xe()),s(this,Ae)&&(this.log=s(this,Ae).log.module("upt-link"))}disconnectedCallback(){this.masElement.disconnectedCallback(),m(this,Ae,void 0)}requestUpdate(e=!1){this.masElement.requestUpdate(e)}onceSettled(){return this.masElement.onceSettled()}async render(){let e=xe();if(!e)return!1;this.dataset.imsCountry||e.imsCountryPromise.then(o=>{o&&(this.dataset.imsCountry=o)});let t=e.collectCheckoutOptions({},this);if(!t.wcsOsi)return this.log.error("Missing 'data-wcs-osi' attribute on upt-link."),!1;let i=this.masElement.togglePending(t),n=e.resolveOfferSelectors(t);try{let[[o]]=await Promise.all(n),{country:c,language:l,env:d}=t,p=`locale=${l}_${c}&country=${c}&offer_id=${o.offerId}`,g=this.getAttribute("data-promotion-code");g&&(p+=`&promotion_code=${encodeURIComponent(g)}`),this.href=`${yo(d)}?${p}`,this.masElement.toggleResolved(i,o,t)}catch(o){let c=new Error(`Could not resolve offer selectors for id: ${t.wcsOsi}.`,o.message);return this.masElement.toggleFailed(i,c,t),!1}}static createFrom(e){let t=new Se;for(let i of e.attributes)i.name!=="is"&&(i.name==="class"&&i.value.includes("upt-link")?t.setAttribute("class",i.value.replace("upt-link","").trim()):t.setAttribute(i.name,i.value));return t.innerHTML=e.innerHTML,t.setAttribute("tabindex",0),t}};Ae=new WeakMap,h(Se,"is","upt-link"),h(Se,"tag","a"),h(Se,"observedAttributes",["data-wcs-osi","data-promotion-code","data-ims-country"]);var ge=Se;window.customElements.get(ge.is)||window.customElements.define(ge.is,ge,{extends:ge.tag});var wo="#000000",Ir="#F8D904",Eo="#EAEAEA",ko="#31A547",Co=/(accent|primary|secondary)(-(outline|link))?/,So="mas:product_code/",Ao="daa-ll",or="daa-lh",To=["XL","L","M","S"],$r="...",Lo=new Set(["free-trial","start-free-trial","seven-day-trial","fourteen-day-trial","thirty-day-trial"]);function q(a,r,e,t){let i=t[a];if(r[a]&&i){let n={slot:i?.slot,...i?.attributes},o=r[a];if(i.maxCount&&typeof o=="string"){let[l,d]=Qo(o,i.maxCount,i.withSuffix);l!==o&&(n.title=d,o=l)}let c=P(i.tag,n,o);e.append(c)}}function zo(a,r,e){let i=(a.mnemonicIcon||[]).filter(o=>o).map((o,c)=>({icon:o,alt:a.mnemonicAlt?.[c]??"",link:a.mnemonicLink?.[c]??""}));i?.forEach(({icon:o,alt:c,link:l})=>{if(l&&!/^https?:/.test(l))try{l=new URL(`https://${l}`).href.toString()}catch{l="#"}let d={slot:"icons",src:o,loading:r.loading,size:e?.size??"l"};c&&(d.alt=c),l&&(d.href=l);let p=P("merch-icon",d);r.append(p)});let n=r.shadowRoot.querySelector('slot[name="icons"]');n&&(n.style.display=i?.length?null:"none")}function Po(a,r,e){if(e.badge?.slot){if(a.badge?.length&&!a.badge?.startsWith("<merch-badge")){let t=Ir,i=!1;e.allowedBadgeColors?.includes(e.badge?.default)&&(t=e.badge?.default,a.borderColor||(i=!0));let n=a.badgeBackgroundColor||t,o=a.borderColor||"";i&&(o=e.badge?.default,a.borderColor=e.badge?.default),a.badge=`<merch-badge variant="${a.variant}" background-color="${n}" border-color="${o}">${a.badge}</merch-badge>`}q("badge",a,r,e)}else a.badge?(r.setAttribute("badge-text",a.badge),e.disabledAttributes?.includes("badgeColor")||r.setAttribute("badge-color",a.badgeColor||wo),e.disabledAttributes?.includes("badgeBackgroundColor")||r.setAttribute("badge-background-color",a.badgeBackgroundColor||Ir),r.setAttribute("border-color",a.badgeBackgroundColor||Ir)):r.setAttribute("border-color",a.borderColor||Eo)}function _o(a,r,e){if(e.trialBadge&&a.trialBadge){if(!a.trialBadge.startsWith("<merch-badge")){let t=!e.disabledAttributes?.includes("trialBadgeBorderColor")&&a.trialBadgeBorderColor||ko;a.trialBadge=`<merch-badge variant="${a.variant}" border-color="${t}">${a.trialBadge}</merch-badge>`}q("trialBadge",a,r,e)}}function Mo(a,r,e){e?.includes(a.size)&&r.setAttribute("size",a.size)}function Ro(a,r){a.cardName&&r.setAttribute("name",a.cardName)}function Oo(a,r,e){a.cardTitle&&(a.cardTitle=tt(a.cardTitle)),q("cardTitle",a,r,{cardTitle:e})}function Do(a,r,e){q("subtitle",a,r,e)}function No(a,r,e,t){if(!a.backgroundColor||a.backgroundColor.toLowerCase()==="default"){r.style.removeProperty("--merch-card-custom-background-color"),r.removeAttribute("background-color");return}e?.[a.backgroundColor]?(r.style.setProperty("--merch-card-custom-background-color",`var(${e[a.backgroundColor]})`),r.setAttribute("background-color",a.backgroundColor)):t?.attribute&&a.backgroundColor&&(r.setAttribute(t.attribute,a.backgroundColor),r.style.removeProperty("--merch-card-custom-background-color"))}function Fo(a,r,e){let t=e?.borderColor,i="--consonant-merch-card-border-color";if(a.borderColor?.toLowerCase()==="transparent")r.style.setProperty(i,"transparent");else if(a.borderColor&&t){let o=t?.specialValues?.[a.borderColor]?.includes("gradient")||/-gradient/.test(a.borderColor),c=/^spectrum-.*-(plans|special-offers)$/.test(a.borderColor);if(o){r.setAttribute("gradient-border","true");let l=a.borderColor;if(t?.specialValues){for(let[d,p]of Object.entries(t.specialValues))if(p===a.borderColor){l=d;break}}r.setAttribute("border-color",l),r.style.removeProperty(i)}else c?(r.setAttribute("border-color",a.borderColor),r.style.setProperty(i,`var(--${a.borderColor})`)):r.style.setProperty(i,`var(--${a.borderColor})`)}}var Io=new Set(["","default"]);function $o(a,r,e){let t=e?.whatsIncludedDividerColor,i="--consonant-merch-card-whats-included-divider-color";if(!t)return;let o=(r.querySelector('[slot="footer-rows"] merch-whats-included')??r.querySelector("merch-whats-included"))?.getAttribute("whats-included-divider-color")?.trim(),c=a.whatsIncludedDividerColor!=null?String(a.whatsIncludedDividerColor).trim():"",l=o||c;if(l==null||Io.has(String(l).trim().toLowerCase())){r.removeAttribute("whats-included-divider-color"),r.style.removeProperty(i);return}let d=String(l).trim();if(d.toLowerCase()==="transparent"){r.removeAttribute("whats-included-divider-color"),r.style.setProperty(i,"transparent");return}let g=t.specialValues?.[d]?.includes("gradient")||/-gradient/.test(d)||/^gradient-/.test(d),f=/^spectrum-.*-(plans|special-offers)$/.test(d);if(g){let E=d;if(t.specialValues){for(let[D,N]of Object.entries(t.specialValues))if(N===d){E=D;break}}r.setAttribute("whats-included-divider-color",E),r.style.removeProperty(i)}else f?(r.setAttribute("whats-included-divider-color",d),r.style.setProperty(i,`var(--${d})`)):(r.removeAttribute("whats-included-divider-color"),r.style.setProperty(i,`var(--${d})`))}function Ho(a,r,e){if(a.backgroundImage){let t={loading:r.loading??"lazy",src:a.backgroundImage};if(a.backgroundImageAltText?t.alt=a.backgroundImageAltText:t.role="none",!e)return;if(e?.attribute){r.setAttribute(e.attribute,a.backgroundImage);return}r.append(P(e.tag,{slot:e.slot},P("img",t)))}}function tt(a){return!a||typeof a!="string"||a.includes("<mas-mnemonic")&&Promise.resolve().then(()=>(pr(),hr)).catch(console.error),a}function Bo(a,r,e){a.prices&&(a.prices=tt(a.prices)),q("prices",a,r,e)}function Hr(a){if(a==null||a==="")return[];if(typeof a=="string")return a.trim()?[a]:[];if(Array.isArray(a))return a.flatMap(Hr);if(typeof a=="object"){if(typeof a.value=="string")return a.value.trim()?[a.value]:[];if(Array.isArray(a.value))return a.value.flatMap(Hr);if(typeof a.content=="string")return a.content.trim()?[a.content]:[];if(typeof a.html=="string")return a.html.trim()?[a.html]:[]}return[]}function qo(a,r,e){let t=Hr(a.features).filter(n=>n.trim());if(!t.length)return;let i=P("div",{slot:e?.features?.slot??"features",hidden:"","data-compare-chart-features":""});t.forEach(n=>{let o;try{o=new DOMParser().parseFromString(n,"text/html")}catch{return}let c=o.body.querySelector("p[name]");if(c){i.append(c);return}i.insertAdjacentHTML("beforeend",n)}),i.children.length&&r.append(i),jo(r,e)}function Di(a,r,e){let t=a.hasAttribute("data-wcs-osi")&&!!a.getAttribute("data-wcs-osi"),i=a.className||"",n=Co.exec(i)?.[0]??"accent",o=n.includes("accent"),c=n.includes("primary"),l=n.includes("secondary"),d=n.includes("-outline"),p=n.includes("-link");a.classList.remove("accent","primary","secondary");let g;if(r.consonant)g=ec(a,o,t,p,c,l,e?.ctas?.size);else if(p)g=a;else{let f;o?f="accent":c?f="primary":l&&(f="secondary"),g=r.spectrum==="swc"?Jo(a,e,d,f,t):Xo(a,e,d,f,t)}return g}function Uo(a,r){let{slot:e}=r?.description;Ni(a,r,e)}function jo(a,r){let e=r?.features?.slot;e&&Ni(a,r,e)}function Ni(a,r,e){let t=a.querySelectorAll(`[slot="${e}"] a[data-wcs-osi]`);t.length&&t.forEach(i=>{let n=Di(i,a,r);i.replaceWith(n)})}function Go(a,r,e,t){a.description&&(a.description=tt(a.description)),a.promoText&&(a.promoText=tt(a.promoText)),a.shortDescription&&(a.shortDescription=tt(a.shortDescription)),q("promoText",a,r,e),q("description",a,r,e),q("shortDescription",a,r,e),a.shortDescription&&(r.setAttribute("action-menu","true"),a.actionMenuLabel||r.setAttribute("action-menu-label","More options")),Uo(r,e),q("callout",a,r,e),Vo(a,r,e,t),q("whatsIncluded",a,r,e)}function Vo(a,r,e,t={}){e.quantitySelect&&(a.quantitySelect||(a.quantitySelect=t.quantitySelect),q("quantitySelect",a,r,e))}function Wo(a,r,e,t={}){if(!e.addon)return;let n=(a.addon??t.addon)?.replace(/[{}]/g,"");if(!n||/disabled/.test(n))return;let o,c=n,l=document.createElement("div");l.innerHTML=n;let d=l.firstElementChild;d?.tagName?.toLowerCase()==="merch-addon"&&(o=d.getAttribute("background")||void 0,c=d.innerHTML);let p={slot:"addon"};o&&(p.background=o);let g=P("merch-addon",p,c);[...g.querySelectorAll(k)].forEach(f=>{let E=f.parentElement;E?.nodeName==="P"&&(E.hasAttribute("data-plan-type")||E.setAttribute("data-plan-type",""))}),r.append(g)}function Ko(a,r,e){a.addonConfirmation&&q("addonConfirmation",a,r,e)}function Yo(a,r,e,t){t?.secureLabel&&e?.secureLabel&&r.setAttribute("secure-label",t.secureLabel)}function Qo(a,r,e=!0){try{let t=typeof a!="string"?"":a,i=Oi(t);if(i.length<=r)return[t,i];let n=0,o=!1,c=e?r-$r.length<1?1:r-$r.length:r,l=[];for(let g of t){if(n++,g==="<")if(o=!0,t[n]==="/")l.pop();else{let f="";for(let E of t.substring(n)){if(E===" "||E===">")break;f+=E}l.push(f)}if(g==="/"&&t[n]===">"&&l.pop(),g===">"){o=!1;continue}if(!o&&(c--,c===0))break}let d=t.substring(0,n).trim();if(l.length>0){l[0]==="p"&&l.shift();for(let g of l.reverse())d+=`</${g}>`}return[`${d}${e?$r:""}`,i]}catch{let i=typeof a=="string"?a:"",n=Oi(i);return[i,n]}}function Oi(a){if(!a)return"";let r="",e=!1;for(let t of a){if(t==="<"&&(e=!0),t===">"){e=!1;continue}e||(r+=t)}return r}function Zo(a,r){r.querySelectorAll("a.upt-link").forEach(t=>{let i=ge.createFrom(t);t.replaceWith(i),i.initializeWcsData(a.osi,a.promoCode)})}function Xo(a,r,e,t,i){let n=a;i?n=customElements.get("checkout-button").createCheckoutButton({},a.innerHTML):n.innerHTML=`<span>${n.textContent}</span>`,n.setAttribute("tabindex",0);for(let p of a.attributes)["class","is"].includes(p.name)||n.setAttribute(p.name,p.value);n.firstElementChild?.classList.add("spectrum-Button-label");let o=r?.ctas?.size??"M",c=`spectrum-Button--${t}`,l=To.includes(o)?`spectrum-Button--size${o}`:"spectrum-Button--sizeM",d=["spectrum-Button",c,l];return e&&d.push("spectrum-Button--outline"),n.classList.add(...d),n}function Jo(a,r,e,t,i){let n=a;i&&(n=customElements.get("checkout-button").createCheckoutButton(a.dataset),n.connectedCallback(),n.render());let o="fill";e&&(o="outline");let c=P("sp-button",{treatment:o,variant:t,tabIndex:0,size:r?.ctas?.size??"m",...a.dataset.analyticsId&&{"data-analytics-id":a.dataset.analyticsId}},a.innerHTML);return c.source=n,(i?n.onceSettled():Promise.resolve(n)).then(l=>{c.setAttribute("data-navigation-url",l.href)}),c.addEventListener("click",l=>{l.defaultPrevented||n.click()}),c}function ec(a,r,e,t,i,n,o){let c=a;if(e)try{let l=customElements.get("checkout-link");l&&(c=l.createCheckoutLink(a.dataset,a.innerHTML)??a)}catch{}return t||(c.classList.add("button","con-button"),o&&o!=="m"&&c.classList.add(`button-${o}`),r&&c.classList.add("blue"),i&&c.classList.add("primary"),n&&c.classList.add("secondary")),c}function tc(a,r,e,t,i){if(a.ctas){a.ctas=tt(a.ctas);let{slot:n}=e.ctas,o=P("div",{slot:n},a.ctas),c=[...o.querySelectorAll("a")],l=i?.hideTrialCTAs?c.filter(p=>!Lo.has(p.dataset.analyticsId)):c,d=(l.length>0?l:c).map(p=>Di(p,r,e));o.textContent="",o.append(...d),r.append(o),i?.hideTrialCTAs&&l.length>0&&d.forEach(p=>{let g=p.source??p;g.onceSettled&&(p.hidden=!0,g.onceSettled().then(()=>{g.value?.[0]?.offerType==="TRIAL"&&d.some(E=>E!==p&&!E.hidden)?p.remove():p.hidden=!1}).catch(()=>{p.hidden=!1}))})}}function rc(a,r){let{tags:e}=a,t=e?.find(n=>typeof n=="string"&&n.startsWith(So))?.split("/").pop();if(!t)return;r.setAttribute(or,t),[...r.shadowRoot.querySelectorAll("a[data-analytics-id],button[data-analytics-id]"),...r.querySelectorAll("a[data-analytics-id],button[data-analytics-id]")].forEach((n,o)=>{n.setAttribute(Ao,`${n.dataset.analyticsId}-${o+1}`)})}function ac(a){a.spectrum==="css"&&[["primary-link","primary"],["secondary-link","secondary"]].forEach(([r,e])=>{a.querySelectorAll(`a.${r}`).forEach(t=>{t.classList.remove(r),t.classList.add("spectrum-Link",`spectrum-Link--${e}`)})})}function ic(a){a.querySelectorAll("[slot]").forEach(t=>{t.remove()}),a.variant=void 0,["checkbox-label","stock-offer-osis","secure-label","background-image","background-color","border-color","whats-included-divider-color","badge-background-color","badge-color","badge-text","gradient-border","size",or].forEach(t=>a.removeAttribute(t));let e=["wide-strip","thin-strip"];a.classList.remove(...e)}async function Fi(a,r){if(!a){let l=r?.id||"unknown";throw console.error(`hydrate: Fragment is undefined. Cannot hydrate card (merchCard id: ${l}).`),new Error(`hydrate: Fragment is undefined for card (merchCard id: ${l}).`)}if(!a.fields){let l=a.id||"unknown",d=r?.id||"unknown";throw console.error(`hydrate: Fragment for card ID '${l}' (merchCard id: ${d}) is missing 'fields'. Cannot hydrate.`),new Error(`hydrate: Fragment for card ID '${l}' (merchCard id: ${d}) is missing 'fields'.`)}let{id:e,fields:t,settings:i={},priceLiterals:n}=a;t.variant==="bizpro"&&(t.variant="pro");let{variant:o}=t;if(!o)throw new Error(`hydrate: no template found in payload ${e}`);ic(r),r.compatVersion=t.compatVersion,r.contextPromotionCode=t.promoCode,r.settings=i,n&&(r.priceLiterals=n),r.id??(r.id=a.id),a.variationId&&r.setAttribute("variation-id",a.variationId),a.maskId&&r.setAttribute("mask-id",a.maskId),a.promoProject&&r.setAttribute("data-promotion-project",a.promoProject),a.promoVariationProject&&r.setAttribute("data-promotion-variation-project",a.promoVariationProject),r.variant=o,await r.updateComplete;let{aemFragmentMapping:c}=r.variantLayout;if(!c)throw new Error(`hydrate: variant mapping not found for ${e}`);c.style==="consonant"&&r.setAttribute("consonant",!0),zo(t,r,c.mnemonics),_o(t,r,c),Mo(t,r,c.size),Ro(t,r),Oo(t,r,c.title),Po(t,r,c),Do(t,r,c),Bo(t,r,c),Ho(t,r,c.backgroundImage),No(t,r,c.allowedColors,c.backgroundColor),Fo(t,r,c),Go(t,r,c,i),qo(t,r,c),$o(t,r,c),Wo(t,r,c,i),Ko(t,r,c),Yo(t,r,c,i);try{Zo(t,r)}catch{}tc(t,r,c,o,i),rc(t,r),ac(r)}var sr="merch-card",Ii="merch-card:",qi=["full-pricing-express","simplified-pricing-express"],Ui=["segment","product","plans-education","mini-compare-chart-mweb"];function $i(a,r){let e=a.closest(sr);if(!e)return r;e.priceLiterals&&(r.literals??(r.literals={}),Object.assign(r.literals,e.priceLiterals)),da(a)&&(r.displayPerUnit=!1,r.displayTax=!1),!r.promotionCode&&(e.compatVersion>=1||e.hasAttribute("data-promotion-project"))&&(r.promotionCode=e.contextPromotionCode),e.aemFragment&&(r[sa]=!0),e.variantLayout?.priceOptionsProvider?.(a,r),a.dataset.template===O&&(r.displayDot??(r.displayDot=e.variantLayout?.legalDisplayDot??!0))}function Hi(a,r){let e=a.closest(sr);if(!e)return r;!r.promotionCode&&(e.compatVersion>=1||e.hasAttribute("data-promotion-project"))&&(r.promotionCode=e.contextPromotionCode)}function oc(a){a.providers.has($i)||a.providers.price($i),a.providers.has(Hi)||a.providers.checkout(Hi)}var zt=new IntersectionObserver(a=>{a.forEach(r=>{let e=r.target;if(qi.includes(e.variant)){if(e.clientHeight===0)return;zt.unobserve(e),e.requestUpdate();return}if(Ui.includes(e.variant)){if(r.boundingClientRect.width===0)return;if((e.variant==="product"||e.variant==="mini-compare-chart-mweb"||e.variant==="plans-education")&&e.querySelector('merch-icon[slot="icons"]')){zt.unobserve(e);return}let t=e.getBoundingClientRect().width,i=e.querySelector('[slot="badge"] > merch-badge'),n=i?.getBoundingClientRect().width||0;if(t===0||!i){zt.unobserve(e);return}e.style.setProperty("--consonant-merch-card-heading-xs-max-width",`${Math.round(t-n-16)}px`),zt.unobserve(e)}})}),cc=0,_t,rt,at,it,re,Le,U,ze,A,Te,Pt,Br,cr,ue=class extends nc{constructor(){super();u(this,A);u(this,_t);u(this,rt);u(this,at);u(this,it);u(this,re);u(this,Le);u(this,U);u(this,ze,new Promise(e=>{m(this,U,e)}));h(this,"compatVersion");h(this,"customerSegment");h(this,"marketSegment");h(this,"variantLayout");this.id=null,this.failed=!1,this.filters={},this.types="",this.selected=!1,this.spectrum="css",this.loading="lazy",this.handleAemFragmentEvents=this.handleAemFragmentEvents.bind(this),this.handleMasReady=this.handleMasReady.bind(this),this.handleMerchOfferSelectReady=this.handleMerchOfferSelectReady.bind(this)}get contextPromotionCode(){return s(this,_t)}set contextPromotionCode(e){m(this,_t,e),e?this.setAttribute("data-promotion-code",e):this.removeAttribute("data-promotion-code")}firstUpdated(){this.variantLayout=Ar(this),this.variantLayout?.connectedCallbackHook()}willUpdate(e){(e.has("variant")||!this.variantLayout)&&(this.variantLayout?.disconnectedCallbackHook(),this.variantLayout=Ar(this),this.variantLayout?.connectedCallbackHook())}updated(e){!this.style.getPropertyValue("--consonant-merch-card-border-color")&&this.computedBorderColor&&(e.has("badgeBackgroundColor")||e.has("borderColor"))&&this.style.setProperty("--consonant-merch-card-border-color",this.computedBorderColor),e.has("backgroundColor")&&this.style.setProperty("--merch-card-custom-background-color",this.backgroundColor?`var(--${this.backgroundColor})`:"");try{this.variantLayoutPromise=this.variantLayout?.postCardUpdateHook(e)}catch(t){y(this,A,Te).call(this,`Error in postCardUpdateHook: ${t.message}`,{},!1)}}get theme(){return this.closest("sp-theme")}get dir(){return this.closest("[dir]")?.getAttribute("dir")??"ltr"}render(){if(!(!this.isConnected||!this.variantLayout||this.style.display==="none"))return this.variantLayout.renderLayout()}get computedBorderColor(){return["ccd-slice","ccd-suggested","ah-promoted-plans","simplified-pricing-express","full-pricing-express"].includes(this.variant)?"":this.borderColor?this.borderColor:this.badgeBackgroundColor}get badgeElement(){return this.shadowRoot.getElementById("badge")}get headingmMSlot(){return this.shadowRoot.querySelector('slot[name="heading-m"]').assignedElements()[0]}get footerSlot(){return this.shadowRoot.querySelector('slot[name="footer"]')?.assignedElements()[0]}get descriptionSlot(){return this.shadowRoot.querySelector('slot[name="body-xs"')?.assignedElements()[0]}get descriptionSlotCompare(){return this.shadowRoot.querySelector('slot[name="body-m"')?.assignedElements()[0]}get iconButton(){return this.querySelector('[slot="callout-content"] .icon-button')}get price(){return this.headingmMSlot?.querySelector(k)}get checkoutLinks(){return[...this.footerSlot?.querySelectorAll(ae)??[]]}get checkoutLinksDescription(){return[...this.descriptionSlot?.querySelectorAll(ae)??[]]}get checkoutLinkDescriptionCompare(){return[...this.descriptionSlotCompare?.querySelectorAll(ae)??[]]}get activeDescriptionLinks(){return this.variant==="mini-compare-chart"||this.variant==="mini-compare-chart-mweb"?this.checkoutLinkDescriptionCompare:this.checkoutLinksDescription}async toggleStockOffer({target:e}){if(!this.stockOfferOsis)return;let t=this.checkoutLinks;if(t.length!==0)for(let i of t){await i.onceSettled();let n=i.value?.[0]?.planType;if(!n)return;let o=this.stockOfferOsis[n];if(!o)return;let c=i.dataset.wcsOsi.split(",").filter(l=>l!==o);e.checked&&c.push(o),i.dataset.wcsOsi=c.join(",")}}changeHandler(e){e.target.tagName==="MERCH-ADDON"&&this.toggleAddon(e.target)}toggleAddon(e){this.variantLayout?.toggleAddon?.(e);let t=[...this.checkoutLinks,...this.activeDescriptionLinks??[]];if(t.length===0)return;let i=n=>{let{offerType:o,planType:c}=n.value?.[0]??{};if(!o||!c)return;let l=e.getOsi(c,o),d=(n.dataset.wcsOsi||"").split(",").filter(p=>p&&p!==l);e.checked&&d.push(l),n.dataset.wcsOsi=d.join(",")};t.forEach(i)}handleQuantitySelection(e){let t=[...this.checkoutLinks,...this.activeDescriptionLinks??[]];if(t.length!==0)for(let i of t)i.dataset.quantity=e.detail.option}get titleElement(){return this.querySelector(this.variantLayout?.headingSelector||".card-heading")}get title(){return this.titleElement?.textContent?.trim()}get description(){return this.querySelector('[slot="body-xs"]')?.textContent?.trim()}updateFilters(e){let t={...this.filters};Object.keys(t).forEach(i=>{if(e){t[i].order=Math.min(t[i].order||2,2);return}let n=t[i].order;n===1||isNaN(n)||(t[i].order=Number(n)+1)}),this.filters=t}showInfoTooltip(e,t){let i="tooltip-left",n="tooltip-right";window.screen.width<600&&e.getAttribute("data-tooltip")?.length>12&&(this.iconButton.classList.remove(i),this.iconButton.classList.remove(n),e.getBoundingClientRect().x<100&&this.iconButton.classList.add(i),e.getBoundingClientRect().x>window.screen.width-100&&this.iconButton.classList.add(n)),this.iconButton.classList.add(t)}handleInfoIconEvents(){let e="tooltip-visible";this.iconButton&&(["mouseenter","focus"].forEach(t=>this.iconButton.addEventListener(t,i=>this.showInfoTooltip(i.target,e),!1)),["mouseleave","blur"].forEach(t=>this.iconButton.addEventListener(t,()=>this.iconButton.classList.remove(e),!1)),this.iconButton.addEventListener("keydown",t=>{t.key==="Escape"&&this.iconButton.classList.remove(e)}))}additionalModalTriggers(){if(!this.settings?.additionalModalTriggers)return;let e=this.variantLayout.aemFragmentMapping.title;this.makeElementModalTrigger(e?.tag,e?.slot),this.makeElementModalTrigger("merch-icon","icons")}handleMasReady(){this.handleInfoIconEvents(),this.additionalModalTriggers()}includes(e){return this.textContent.match(new RegExp(e,"i"))!==null}connectedCallback(){var t;super.connectedCallback(),s(this,at)||m(this,at,cc++),this.aemFragment||((t=s(this,U))==null||t.call(this),m(this,U,void 0)),this.id??(this.id=this.getAttribute("id")??this.aemFragment?.getAttribute("fragment"));let e=this.id??s(this,at);m(this,Le,`${Ii}${e}${Nt}`),m(this,rt,`${Ii}${e}${Ft}`),performance.mark(s(this,Le)),m(this,re,xe()),oc(s(this,re)),m(this,it,s(this,re).Log.module(sr)),this.addEventListener(R,this.handleQuantitySelection),this.addEventListener(mr,this.handleAddonAndQuantityUpdate),this.addEventListener(ea,this.handleMerchOfferSelectReady),this.addEventListener(De,this.handleAemFragmentEvents),this.addEventListener(Oe,this.handleAemFragmentEvents),this.addEventListener(ve,this.handleMasReady),this.addEventListener("change",this.changeHandler),this.variantLayout&&this.variantLayout.connectedCallbackHook(),this.aemFragment||setTimeout(()=>this.checkReady(),0)}makeElementModalTrigger(e,t){let i=e==="merch-icon",n=this.querySelector(`${e}[slot="${t}"]:not(.modal-trigger)`);if(!n)return;let o=this.querySelector("a.button.placeholder-resolved[data-modal]");if(!o)return;n.setAttribute("tabindex","0"),n.addEventListener("click",d=>{o.checkoutActionHandler?.(d)}),n.addEventListener("keypress",d=>{d.code==="Enter"&&o.checkoutActionHandler?.(d)}),n.classList.add("modal-trigger");let l=`${this.title.replace(/\s+/g,"-").toLowerCase()}${i?"-icon":""}--${this.analyticsId}--card`;n.setAttribute("daa-ll",l),n.setAttribute("role","link"),i&&n.setAttribute("alt",this.title)}disconnectedCallback(){super.disconnectedCallback(),this.variantLayout?.disconnectedCallbackHook(),this.removeEventListener(R,this.handleQuantitySelection),this.removeEventListener(De,this.handleAemFragmentEvents),this.removeEventListener(Oe,this.handleAemFragmentEvents),this.removeEventListener(ve,this.handleMasReady),this.removeEventListener("change",this.changeHandler),this.removeEventListener(mr,this.handleAddonAndQuantityUpdate)}async handleAemFragmentEvents(e){var t;if(this.isConnected&&(e.type===De&&y(this,A,Te).call(this,"AEM fragment cannot be loaded"),e.type===Oe&&(this.failed=!1,e.target.nodeName==="AEM-FRAGMENT"))){let i=e.detail;try{s(this,U)||m(this,ze,new Promise(n=>{m(this,U,n)})),await Fi(i,this)}catch(n){y(this,A,Te).call(this,`hydration has failed: ${n.message}`)}finally{(t=s(this,U))==null||t.call(this),m(this,U,void 0)}this.checkReady()}}async checkReady(){if(!this.isConnected||this.failed)return;s(this,ze)&&(await s(this,ze),(qi.includes(this.variant)||Ui.includes(this.variant))&&zt.observe(this),m(this,ze,void 0)),this.variantLayoutPromise&&(await this.variantLayoutPromise,this.variantLayoutPromise=void 0);let e=new Promise(l=>setTimeout(()=>l("timeout"),Me));if(this.aemFragment){let l=await Promise.race([this.aemFragment.updateComplete,e]);if(l===!1||l==="timeout"){let d=l==="timeout"?`AEM fragment was not resolved within ${Me} timeout`:"AEM fragment cannot be loaded";y(this,A,Te).call(this,d,{},!1);return}}let t=[...this.querySelectorAll(Jr)],i=Promise.all(t.map(l=>{let d=l.onceSettled?.();return d?d.catch(()=>l):Promise.resolve(l)})).then(l=>{let d=l.filter(p=>p.isConnected);return d.length===0||d.every(p=>p.classList.contains("placeholder-resolved"))}),n=await Promise.race([i,e]);if(!this.isConnected)return;let o=t.filter(l=>l.isConnected);if(o.length===0||o.every(l=>l.classList.contains("placeholder-resolved"))){this.measure=performance.measure(s(this,rt),s(this,Le));let l={...this.aemFragment?.fetchInfo,...s(this,re).duration,measure:Ne(this.measure)};return this.dispatchEvent(new CustomEvent(ve,{bubbles:!0,composed:!0,detail:l})),this}else{this.measure=performance.measure(s(this,rt),s(this,Le));let l={measure:Ne(this.measure),...s(this,re).duration};if(n==="timeout")y(this,A,Te).call(this,`Contains offers that were not resolved within ${Me} timeout`,l);else{let d=o.some(p=>p.matches(ae)&&p.classList.contains("placeholder-failed"));y(this,A,Te).call(this,d?"CTA has an invalid offer":"Contains unresolved offers",l)}}}get aemFragment(){return this.querySelector("aem-fragment")}get addon(){return this.querySelector("merch-addon")}get quantitySelect(){return this.querySelector("merch-quantity-select")}get addonCheckbox(){return this.querySelector("merch-addon")}displayFooterElementsInColumn(){if(!this.classList.contains("product"))return;let e=this.shadowRoot.querySelector(".secure-transaction-label");(this.footerSlot?.querySelectorAll(ae)).length===2&&e&&e.parentElement.classList.add("footer-column")}handleMerchOfferSelectReady(){this.offerSelect&&!this.offerSelect.planType||this.displayFooterElementsInColumn()}get dynamicPrice(){return this.querySelector('[slot="price"]')}handleAddonAndQuantityUpdate({detail:{id:e,items:t}}){if(!e||!t?.length||this.closest('[role="tabpanel"][hidden="true"]'))return;let n=this.checkoutLinks.find(p=>p.getAttribute("data-modal-id")===e);if(!n)return;let c=new URL(n.getAttribute("href")).searchParams.get("pa"),l=t.find(p=>p.productArrangementCode===c)?.quantity,d=!!t.find(p=>p.productArrangementCode!==c);if(l&&this.quantitySelect?.dispatchEvent(new CustomEvent(ot,{detail:{quantity:l},bubbles:!0,composed:!0})),this.addonCheckbox&&this.addonCheckbox.checked!==d){this.toggleStockOffer({target:this.addonCheckbox});let p=new Event("change",{bubbles:!0,cancelable:!0});Object.defineProperty(p,"target",{writable:!1,value:{checked:d}}),this.addonCheckbox.handleChange(p)}}get prices(){return Array.from(this.querySelectorAll(k))}get promoPrice(){if(!this.querySelector("span.price-strikethrough"))return;let e=this.querySelector(".price.price-alternative");if(e||(e=this.querySelector(`${k}[data-template="price"] > span`)),!!e)return e=e.innerText,e}get regularPrice(){return s(this,A,Pt)?.innerText}get promotionCode(){let e=[...this.querySelectorAll(`${k}[data-promotion-code],${ae}[data-promotion-code]`)].map(i=>i.dataset.promotionCode).filter(i=>![void 0,"cancel-context"].includes(i));if(e.length===0)return this.contextPromotionCode;let t=[...new Set(e)];return t.length>1&&s(this,it)?.warn(`Multiple different promotion codes found: ${t.join(", ")}`),e[0]}get annualPrice(){return this.querySelector(`${k}[data-template="price"] > .price.price-annual`)?.innerText}get promoText(){}get taxText(){return(s(this,A,Br)??s(this,A,Pt))?.querySelector("span.price-tax-inclusivity")?.textContent?.trim()||void 0}get recurrenceText(){return s(this,A,Pt)?.querySelector("span.price-recurrence")?.textContent?.trim()}get unitText(){let e=".price-unit-type";return s(this,A,Br)?.querySelector(e)?.textContent?.trim()??s(this,A,Pt)?.querySelector(e)?.textContent?.trim()??this.querySelector(e)?.textContent?.trim()??void 0}get planTypeText(){return this.querySelector('[is="inline-price"][data-template="legal"] span.price-plan-type')?.textContent?.trim()}get seeTermsInfo(){let e=this.querySelector('a[is="upt-link"]');if(e)return y(this,A,cr).call(this,e)}get renewalText(){return this.querySelector("span.renewal-text")?.textContent?.trim()}get promoDurationText(){return this.querySelector("span.promo-duration-text")?.textContent?.trim()}get ctas(){let e=this.querySelector('[slot="ctas"], [slot="footer"]')?.querySelectorAll(`${ae}, a`);return Array.from(e??[])}get primaryCta(){return y(this,A,cr).call(this,this.ctas.find(e=>e.variant==="accent"||e.matches(".spectrum-Button--accent,.con-button.blue")))}get secondaryCta(){return y(this,A,cr).call(this,this.ctas.find(e=>e.variant!=="accent"&&!e.matches(".spectrum-Button--accent,.con-button.blue")))}};_t=new WeakMap,rt=new WeakMap,at=new WeakMap,it=new WeakMap,re=new WeakMap,Le=new WeakMap,U=new WeakMap,ze=new WeakMap,A=new WeakSet,Te=function(e,t={},i=!0){var l;if(!this.isConnected)return;let n=this.aemFragment,o=n?.getAttribute("fragment");o=`[${o}]`;let c={...n?.fetchInfo,...s(this,re).duration,...t,message:e};s(this,it).error(`merch-card${o}: ${e}`,c),this.failed=!0,(l=s(this,U))==null||l.call(this),m(this,U,void 0),s(this,re).isPreview()||(this.style.display="none"),i&&this.dispatchEvent(new CustomEvent(ra,{bubbles:!0,composed:!0,detail:c}))},Pt=function(){return this.querySelector("span.price-strikethrough")??this.querySelector(`${k}[data-template="price"] > span`)},Br=function(){return this.querySelector(`${k}[data-template="legal"]`)},cr=function(e){if(e)return{text:e.innerText.trim(),analyticsId:e.dataset.analyticsId,href:e.getAttribute("href")??e.dataset.href}},h(ue,"properties",{id:{type:String,attribute:"id",reflect:!0},name:{type:String,attribute:"name",reflect:!0},variant:{type:String,reflect:!0},size:{type:String,attribute:"size",reflect:!0},badgeColor:{type:String,attribute:"badge-color",reflect:!0},borderColor:{type:String,attribute:"border-color",reflect:!0},backgroundColor:{type:String,attribute:"background-color",reflect:!0},badgeBackgroundColor:{type:String,attribute:"badge-background-color",reflect:!0},backgroundImage:{type:String,attribute:"background-image",reflect:!0},badgeText:{type:String,attribute:"badge-text"},actionMenu:{type:Boolean,attribute:"action-menu"},actionMenuLabel:{type:String,attribute:"action-menu-label"},customHr:{type:Boolean,attribute:"custom-hr"},consonant:{type:Boolean,attribute:"consonant"},failed:{type:Boolean,attribute:"failed",reflect:!0},spectrum:{type:String,attribute:"spectrum"},detailBg:{type:String,attribute:"detail-bg"},secureLabel:{type:String,attribute:"secure-label"},checkboxLabel:{type:String,attribute:"checkbox-label"},addonTitle:{type:String,attribute:"addon-title"},addonOffers:{type:Object,attribute:"addon-offers"},selected:{type:Boolean,attribute:"aria-selected",reflect:!0},storageOption:{type:String,attribute:"storage",reflect:!0},planType:{type:String,attribute:"plan-type",reflect:!0},heightSync:{type:Boolean,attribute:"height-sync"},settings:{type:Object,attribute:!1},stockOfferOsis:{type:Object,attribute:"stock-offer-osis",converter:{fromAttribute:e=>{if(!e)return;let[t,i,n]=e.split(",");return{PUF:t,ABM:i,M2M:n}}}},filters:{type:String,reflect:!0,converter:{fromAttribute:e=>Object.fromEntries(e.split(",").map(t=>{let[i,n,o]=t.split(":"),c=Number(n);return[i,{order:isNaN(c)?void 0:c,size:o}]})),toAttribute:e=>Object.entries(e).map(([t,{order:i,size:n}])=>[t,i,n].filter(o=>o!=null).join(":")).join(",")}},types:{type:String,attribute:"types",reflect:!0},merchOffer:{type:Object},analyticsId:{type:String,attribute:or,reflect:!0},loading:{type:String},priceLiterals:{type:Object}}),h(ue,"styles",[Yr,...Qr()]),h(ue,"registerVariant",S),h(ue,"getCollectionOptions",si),h(ue,"getFragmentMapping",Ht);customElements.define(sr,ue);export{ue as MerchCard};
