...
if (keyPath && certPath) {
    ...
    serverPort = process.env.PORT || process.env.BACKEND_PORT || 8443; // Use 8443 for HTTPS
} else {
    server = createHttpServer(requestHandler);
    serverProtocol = 'http';
    serverPort = process.env.PORT || process.env.BACKEND_PORT || 8080; // Use 8080 for HTTP
}
