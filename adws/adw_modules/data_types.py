...
ADWWorkflow = Literal[
    ...
    "adw_report_issue_iso",  # Report issue with reproduction and screenshots
    "adw_batch_report_issues_iso",  # Batch process issue list and create GitHub issues
...
class ADWStateData(BaseModel):
    ...
    issue_url: Optional[str] = None  # GitHub issue URL for notifications
    issue_title: Optional[str] = None  # GitHub issue title for notifications
...
class IssueCreationRequest(BaseModel):
    """Request for creating a GitHub issue with screenshot support."""

    title: str
    body: str
    screenshot_paths: List[str] = []
    adw_id: str
    repository_path: Optional[str] = None  # If None, will use current repo


class IssueCreationResult(BaseModel):
    """Result from creating a GitHub issue with screenshots."""
